...
public final class LogUtil {
    ...
    public static /* synthetic */ void e$default(LogUtil logUtil, String str, String str2, Throwable th, int i, Object obj) {
        ...
        logUtil.m46e(str, str2, th);
    }

    /* renamed from: i */
    public final void m45i(String tag, String message, Throwable th) {
    ...
    /* renamed from: v */
    public final void m44v(String tag, String message, Throwable th) {
        Intrinsics.checkNotNullParameter(tag, "tag");
        Intrinsics.checkNotNullParameter(message, "message");
        DebugRepository debugRepository2 = debugRepository;
        boolean z = false;
    ...
    /* renamed from: d */
    public final void m47d(String tag, String message, Throwable th) {
        Intrinsics.checkNotNullParameter(tag, "tag");
        Intrinsics.checkNotNullParameter(message, "message");
        DebugRepository debugRepository2 = debugRepository;
        boolean z = false;
    ...
    /* renamed from: w */
    public final void m43w(String tag, String message, Throwable th) {
        Intrinsics.checkNotNullParameter(tag, "tag");
        Intrinsics.checkNotNullParameter(message, "message");
        DebugRepository debugRepository2 = debugRepository;
        boolean z = false;
    ...
    /* renamed from: e */
    public final void m46e(String tag, String message, Throwable th) {
        Intrinsics.checkNotNullParameter(tag, "tag");
        Intrinsics.checkNotNullParameter(message, "message");
        DebugRepository debugRepository2 = debugRepository;
        boolean z = false;
