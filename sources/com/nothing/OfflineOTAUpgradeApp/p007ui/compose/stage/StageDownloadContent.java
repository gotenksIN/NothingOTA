...
public final class StageDownloadContent {
    public static final void StageDownloadingContent(final Modifier modifier, final UpdateStage.StageDownloading stage, Composer composer, final int i, final int i2) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.stage.StageDownloadContentKt$StageDownloadingContent$1
            ...
            public final void invoke(Composer composer2, int i5) {
                StageDownloadContent.StageDownloadingContent(Modifier.this, stage, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public static final void StageDownloadPausedContent(final Modifier modifier, final UpdateStage.StageDownloadPaused stage, Composer composer, final int i, final int i2) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.stage.StageDownloadContentKt$StageDownloadPausedContent$1
            ...
            public final void invoke(Composer composer2, int i5) {
                StageDownloadContent.StageDownloadPausedContent(Modifier.this, stage, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public static final void StageDownloadContent(Modifier modifier, final String buildNumber, final double d, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            Text.m1785Text4IGK_g(StringResources_androidKt.stringResource(C1640R.string.stage_downloading_title, startRestartGroup, 6), (Modifier) null, ColorResources_androidKt.colorResource(C1640R.color.subtitle1_text, startRestartGroup, 6), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, Styles.getSubtitle1Style(), startRestartGroup, 0, 1572864, 65530);
            Text.m1785Text4IGK_g(StringResources_androidKt.stringResource(C1640R.string.stage_downloading_content_format, new Object[]{buildNumber}, startRestartGroup, 70), (Modifier) null, ColorResources_androidKt.colorResource(C1640R.color.subtitle2_text, startRestartGroup, 6), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, Styles.getSubtitle2Style(), startRestartGroup, 0, 1572864, 65530);
            int i5 = (int) (23 * d);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.stage.StageDownloadContentKt$StageDownloadContent$2
            ...
            public final void invoke(Composer composer2, int i6) {
                StageDownloadContent.StageDownloadContent(Modifier.this, buildNumber, d, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public static final void StageReadyToInstallDownloadedContent(Modifier modifier, final UpdateStage.StageReadyInstallDownloaded stage, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
            modifier2 = companion;
            Text.m1785Text4IGK_g(StringResources_androidKt.stringResource(C1640R.string.stage_ready_install_downloaded_title, startRestartGroup, 6), (Modifier) null, ColorResources_androidKt.colorResource(C1640R.color.subtitle1_text, startRestartGroup, 6), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, Styles.getSubtitle1Style(), startRestartGroup, 0, 1572864, 65530);
            Text.m1785Text4IGK_g(StringResources_androidKt.stringResource(C1640R.string.stage_ready_install_downloaded_content_format, new Object[]{stage.getBuildNumber()}, startRestartGroup, 70), (Modifier) null, ColorResources_androidKt.colorResource(C1640R.color.subtitle2_text, startRestartGroup, 6), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, Styles.getSubtitle2Style(), startRestartGroup, 0, 1572864, 65530);
            startRestartGroup = startRestartGroup;
            DotLiner.DotLiner(Padding.m720paddingqDBjuR0$default(Modifier.Companion, 0.0f, PrimitiveResources_androidKt.dimensionResource(C1640R.dimen.updating_dot_liner_top_padding, startRestartGroup, 6), 0.0f, 0.0f, 13, null), 23, 0, 23, false, startRestartGroup, 3120, 20);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endNode();
            startRestartGroup.endReplaceableGroup();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.stage.StageDownloadContentKt$StageReadyToInstallDownloadedContent$2
            ...
            public final void invoke(Composer composer2, int i5) {
                StageDownloadContent.StageReadyToInstallDownloadedContent(Modifier.this, stage, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
}
