...
@Metadata(m41d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u001f\u0010\u0000\u001a\u00020\u00012\b\b\u0002\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0007¢\u0006\u0002\u0010\u0006¨\u0006\u0007"}, m40d2 = {"StageReadyToDownloadContent", "", "modifier", "Landroidx/compose/ui/Modifier;", "stage", "Lcom/nothing/OfflineOTAUpgradeApp/state/UpdateStage$StageReadyToDownload;", "(Landroidx/compose/ui/Modifier;Lcom/nothing/OfflineOTAUpgradeApp/state/UpdateStage$StageReadyToDownload;Landroidx/compose/runtime/Composer;II)V", "NothingOfflineOtaUpdate_nothingRelease"}, m39k = 2, m38mv = {1, 9, 0}, m36xi = 48)
/* renamed from: com.nothing.OfflineOTAUpgradeApp.ui.compose.stage.StageReadyToDownloadContentKt */
/* loaded from: classes2.dex */
public final class StageReadyToDownloadContent {
    public static final void StageReadyToDownloadContent(Modifier modifier, final UpdateStage.StageReadyToDownload stage, Composer composer, final int i, final int i2) {
        Object obj;
        int i3;
        final Modifier modifier2;
        Composer composer2;
        Intrinsics.checkNotNullParameter(stage, "stage");
        Composer startRestartGroup = composer.startRestartGroup(-2132445001);
        ComposerKt.sourceInformation(startRestartGroup, "C(StageReadyToDownloadContent)");
        int i4 = i2 & 1;
        if (i4 != 0) {
            i3 = i | 6;
            obj = modifier;
        ...
        if ((i3 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-2132445001, i3, -1, "com.nothing.OfflineOTAUpgradeApp.ui.compose.stage.StageReadyToDownloadContent (StageReadyToDownloadContent.kt:19)");
            }
            ...
            modifier2 = companion;
            Text.m1785Text4IGK_g(StringResources_androidKt.stringResource(C1640R.string.stage_ready_to_download_title, startRestartGroup, 6), (Modifier) null, ColorResources_androidKt.colorResource(C1640R.color.subtitle1_text, startRestartGroup, 6), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, Styles.getSubtitle1Style(), startRestartGroup, 0, 1572864, 65530);
            composer2 = startRestartGroup;
            Text.m1785Text4IGK_g(StringResources_androidKt.stringResource(C1640R.string.stage_ready_to_download_content_format, new Object[]{stage.getBuildNumber(), stage.getSize()}, startRestartGroup, 70), (Modifier) null, ColorResources_androidKt.colorResource(C1640R.color.subtitle2_text, startRestartGroup, 6), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, Styles.getSubtitle2Style(), composer2, 0, 1572864, 65530);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.stage.StageReadyToDownloadContentKt$StageReadyToDownloadContent$2
            ...
            public final void invoke(Composer composer3, int i5) {
                StageReadyToDownloadContent.StageReadyToDownloadContent(Modifier.this, stage, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
}
