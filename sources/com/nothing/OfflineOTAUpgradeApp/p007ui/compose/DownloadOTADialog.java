...
public final class DownloadOTADialog {
    public static final void CheckUpdateFailDialog(final Functions<Unit> onCancelClicked, final Functions<Unit> onDismiss, Composer composer, final int i) {
        ...
        if ((i2 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            BaseDialog.BaseDialog(StringResources_androidKt.stringResource(C1640R.string.check_update_version_fail_dialog_title, startRestartGroup, 6), StringResources_androidKt.stringResource(C1640R.string.check_update_version_fail_dialog_message, startRestartGroup, 6), null, StringResources_androidKt.stringResource(C1640R.string.cancel, startRestartGroup, 6), null, onCancelClicked, true, onDismiss, startRestartGroup, ((i2 << 15) & 458752) | 1572864 | ((i2 << 18) & 29360128), 20);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.DownloadOTADialogKt$CheckUpdateFailDialog$1
            ...
            public final void invoke(Composer composer2, int i3) {
                DownloadOTADialog.CheckUpdateFailDialog(onCancelClicked, onDismiss, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }

    public static final void DownloadFailDialog(final DialogBundle.C1827DialogBundle dialogInfo, final Functions<Unit> onConfirmClicked, final Functions<Unit> onDismiss, Composer composer, final int i) {
        ...
        if (title.length() == 0) {
            title = StringResources_androidKt.stringResource(C1640R.string.download_fail_dialog_title, startRestartGroup, 6);
        }
        String str = title;
        ...
        if (message.length() == 0) {
            message = StringResources_androidKt.stringResource(C1640R.string.download_fail_dialog_message, startRestartGroup, 6);
        }
        startRestartGroup.endReplaceableGroup();
        BaseDialog.BaseDialog(str, message, StringResources_androidKt.stringResource(C1640R.string.confirm, startRestartGroup, 6), null, onConfirmClicked, null, true, onDismiss, startRestartGroup, ((i << 9) & 57344) | 1572864 | ((i << 15) & 29360128), 40);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.DownloadOTADialogKt$DownloadFailDialog$1
            ...
            public final void invoke(Composer composer2, int i2) {
                DownloadOTADialog.DownloadFailDialog(DialogBundle.C1827DialogBundle.this, onConfirmClicked, onDismiss, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }

    public static final void StopDownloadConfirmationDialog(final Functions<Unit> onConfirmClicked, final Functions<Unit> onCancelClicked, final Functions<Unit> onDismiss, Composer composer, final int i) {
        int i2;
        Intrinsics.checkNotNullParameter(onConfirmClicked, "onConfirmClicked");
        Intrinsics.checkNotNullParameter(onCancelClicked, "onCancelClicked");
        Intrinsics.checkNotNullParameter(onDismiss, "onDismiss");
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            int i3 = i2 << 12;
            BaseDialog.BaseDialog(StringResources_androidKt.stringResource(C1640R.string.stop_download_confirmation_dialog_title, startRestartGroup, 6), StringResources_androidKt.stringResource(C1640R.string.stop_download_confirmation_dialog_message, startRestartGroup, 6), StringResources_androidKt.stringResource(C1640R.string.confirm, startRestartGroup, 6), StringResources_androidKt.stringResource(C1640R.string.cancel, startRestartGroup, 6), onConfirmClicked, onCancelClicked, true, onDismiss, startRestartGroup, (i3 & 458752) | (57344 & i3) | 1572864 | ((i2 << 15) & 29360128), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.DownloadOTADialogKt$StopDownloadConfirmationDialog$1
            ...
            public final void invoke(Composer composer2, int i4) {
                DownloadOTADialog.StopDownloadConfirmationDialog(onConfirmClicked, onCancelClicked, onDismiss, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }

    public static final void CheckDownloadWithCellularDialog(final Functions<Unit> onConfirmClicked, final Functions<Unit> onCancelClicked, final Functions<Unit> onDismiss, Composer composer, final int i) {
        int i2;
        Intrinsics.checkNotNullParameter(onConfirmClicked, "onConfirmClicked");
        Intrinsics.checkNotNullParameter(onCancelClicked, "onCancelClicked");
        Intrinsics.checkNotNullParameter(onDismiss, "onDismiss");
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            int i3 = i2 << 12;
            BaseDialog.BaseDialog(StringResources_androidKt.stringResource(C1640R.string.check_download_with_cellular_title, startRestartGroup, 6), StringResources_androidKt.stringResource(C1640R.string.check_download_with_cellular_message, startRestartGroup, 6), StringResources_androidKt.stringResource(C1640R.string.download, startRestartGroup, 6), StringResources_androidKt.stringResource(C1640R.string.cancel, startRestartGroup, 6), onConfirmClicked, onCancelClicked, false, onDismiss, startRestartGroup, (i3 & 458752) | (57344 & i3) | 1572864 | ((i2 << 15) & 29360128), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.DownloadOTADialogKt$CheckDownloadWithCellularDialog$1
            ...
            public final void invoke(Composer composer2, int i4) {
                DownloadOTADialog.CheckDownloadWithCellularDialog(onConfirmClicked, onCancelClicked, onDismiss, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
}
