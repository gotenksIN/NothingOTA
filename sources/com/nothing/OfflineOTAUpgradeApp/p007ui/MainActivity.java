...
/* renamed from: com.nothing.OfflineOTAUpgradeApp.ui.MainActivity */
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C1640R.C1644layout.activity_main);
        this.mTextViewBuild = (TextView) findViewById(C1640R.C1643id.textViewBuild);
        this.mButtonStop = (Button) findViewById(C1640R.C1643id.buttonStop);
        this.mButtonReset = (Button) findViewById(C1640R.C1643id.buttonReset);
        this.mProgressBar = (ProgressBar) findViewById(C1640R.C1643id.progressBar);
        this.mTextViewUpdaterState = (TextView) findViewById(C1640R.C1643id.textViewUpdaterState);
        this.mTextViewEngineStatus = (TextView) findViewById(C1640R.C1643id.textViewEngineStatus);
        this.mTextViewEngineErrorCode = (TextView) findViewById(C1640R.C1643id.textViewEngineErrorCode);
        this.mSpinnerSdcardFilePath = (Spinner) findViewById(C1640R.C1643id.spinnerSdcardFilePath);
        this.mButtonDirectOTA = (Button) findViewById(C1640R.C1643id.buttonDirectOTA);
        this.mTextViewSelectPath = (TextView) findViewById(C1640R.C1643id.textSelectPath);
        this.mTextVerifyStatus = (TextView) findViewById(C1640R.C1643id.textVerifyStatus);
    ...
    public void onStopClick(View view) {
        new AlertDialog.Builder(this).setTitle(getResources().getString(C1640R.string.stop_ota_update_dialog_title)).setMessage(getResources().getString(C1640R.string.stop_ota_update_dialog_message)).setIcon(17301543).setPositiveButton(17039370, new DialogInterface.OnClickListener() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.MainActivity$$ExternalSyntheticLambda7
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                MainActivity.this.m49xfaad39ec(dialogInterface, i);
            }
        }).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).show();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onStopClick$0$com-nothing-OfflineOTAUpgradeApp-ui-MainActivity */
    public /* synthetic */ void m49xfaad39ec(DialogInterface dialogInterface, int i) {
        releaseWakeLock();
        if (this.mUpdateManager.getUpdaterState() == 2) {
            cancelRunningUpdate();
        }
    ...
    public void onResetClick(View view) {
        new AlertDialog.Builder(this).setTitle(getResources().getString(C1640R.string.reset_ota_update_dialog_title)).setMessage(getResources().getString(C1640R.string.reset_ota_update_dialog_message)).setIcon(17301543).setPositiveButton(17039370, new DialogInterface.OnClickListener() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.MainActivity$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                MainActivity.this.m50x10e435e0(dialogInterface, i);
            }
        }).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).show();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onResetClick$1$com-nothing-OfflineOTAUpgradeApp-ui-MainActivity */
    public /* synthetic */ void m50x10e435e0(DialogInterface dialogInterface, int i) {
        releaseWakeLock();
        resetUpdate();
    }
    ...
    public void onUpdaterStateChange(final int i) {
        ...
        runOnUiThread(new Runnable() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.MainActivity$$ExternalSyntheticLambda10
            ...
            public final void run() {
                MainActivity.this.m48x75a51800(i);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onUpdaterStateChange$2$com-nothing-OfflineOTAUpgradeApp-ui-MainActivity */
    public /* synthetic */ void m48x75a51800(int i) {
        setUiUpdaterState(i);
        if (i == 0) {
            uiStateIdle();
        } else if (i == 2) {
    ...
    public void onEngineStatusUpdate(final int i) {
        ...
        runOnUiThread(new Runnable() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.MainActivity$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                MainActivity.this.m51x2d311e5a(i);
            }
        });
    }
    ...
    public void onEnginePayloadApplicationComplete(final int i) {
        ...
        runOnUiThread(new Runnable() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.MainActivity$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                MainActivity.this.m52xa93d2219(i);
            }
        });
    }
    ...
    private void uiResetEngineText() {
        this.mTextViewEngineStatus.setText(C1640R.string.unknown);
        this.mTextViewEngineErrorCode.setText(C1640R.string.unknown);
    }
    ...
    private void createDialogToReboot() {
        ...
        builder.setTitle(getResources().getString(C1640R.string.update_ota_success_reboot_dialog_title));
        builder.setMessage(getResources().getString(C1640R.string.update_ota_success_reboot_dialog_title_message));
    ...
    public void resetOtaStateBySharePreference() {
        SharedPreferences.Editor edit = getSharedPreferences("ota_prefs", 0).edit();
        edit.putString("update_state", getResources().getString(C1640R.string.unknown));
        edit.putString("engine_state", getResources().getString(C1640R.string.unknown));
        edit.putString("engine_error_state", getResources().getString(C1640R.string.unknown));
        edit.apply();
    }

    private void updateOtaStateBySharePreference() {
        SharedPreferences sharedPreferences = getSharedPreferences("ota_prefs", 0);
        String string = sharedPreferences.getString("update_state", getResources().getString(C1640R.string.unknown));
        String str = string.split("/")[0];
        this.mTextViewUpdaterState.setText(string);
        this.mTextViewEngineStatus.setText(sharedPreferences.getString("engine_state", getResources().getString(C1640R.string.unknown)));
        this.mTextViewEngineErrorCode.setText(sharedPreferences.getString("engine_error_state", getResources().getString(C1640R.string.unknown)));
    ...
    public void onBackPressed() {
        if (this.mUpdateManager.getUpdaterState() == 2) {
            Toast.makeText(this, getResources().getString(C1640R.string.back_press_running_toast), 0).show();
        } else {
            super.onBackPressed();
        }
    }
    ...
    public void onDirectApplyOTAClick(View view) {
        new AlertDialog.Builder(this).setTitle(getResources().getString(C1640R.string.select_ota_file_dialog_title)).setMessage(getResources().getString(C1640R.string.select_ota_file_dialog_message)).setIcon(17301543).setPositiveButton(17039370, new DialogInterface.OnClickListener() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.MainActivity$$ExternalSyntheticLambda8
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                MainActivity.this.m53x902d7a5c(dialogInterface, i);
            }
        }).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).show();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onDirectApplyOTAClick$5$com-nothing-OfflineOTAUpgradeApp-ui-MainActivity */
    public /* synthetic */ void m53x902d7a5c(DialogInterface dialogInterface, int i) {
        uiResetWidgets();
        uiResetEngineText();
        uiStateRunning();
        directlyApplyUpdate();
    ...
    private boolean isSdcardPathContainFiles() {
        ...
        if (!z) {
            Toast.makeText(this, getResources().getString(C1640R.string.verify_sdcard_ota_patch_contain_file_fail), 0).show();
        }
        return z;
    }
    ...
    private int verifyMetaDataFile(HashMap<String, String> hashMap) {
        ...
        if (!hashMap.getOrDefault("pre-device", " ").equals(str)) {
            this.mTextVerifyStatus.setText(getResources().getString(C1640R.string.verify_error_1));
            i = -1;
        } else if (hashMap.containsKey("pre-build-incremental") && str2.compareTo(hashMap.get("pre-build-incremental")) != 0) {
            this.mTextVerifyStatus.setText(getResources().getString(C1640R.string.verify_error_2));
            i = -2;
        } else if (isHardwareAndVersionVerifyFail(hashMap)) {
            this.mTextVerifyStatus.setText(getResources().getString(C1640R.string.verify_error_3));
            i = -3;
        } else {
            i = 0;
        }
        if (i == 0) {
            this.mTextVerifyStatus.setText(getResources().getString(C1640R.string.verify_success));
        }
        return i;
    }

    /* JADX WARN: Removed duplicated region for block: B:15:0x0075  */
    /* JADX WARN: Removed duplicated region for block: B:34:0x0085 A[EDGE_INSN: B:34:0x0085->B:19:0x0085 ?: BREAK  , SYNTHETIC] */
    /*
    ...
    */
    private boolean isHardwareAndVersionVerifyFail(java.util.HashMap<java.lang.String, java.lang.String> r11) {
        /*
            ...
            r7 = 1
            boolean r8 = r11.containsKey(r1)     // Catch: java.lang.NumberFormatException -> L70
            if (r8 == 0) goto L70
            java.lang.Object r11 = r11.get(r1)     // Catch: java.lang.NumberFormatException -> L70
            java.lang.String r11 = (java.lang.String) r11     // Catch: java.lang.NumberFormatException -> L70
            java.lang.String r1 = "/"
            java.lang.String[] r11 = r11.split(r1)     // Catch: java.lang.NumberFormatException -> L70
            r1 = 2
            r11 = r11[r1]     // Catch: java.lang.NumberFormatException -> L70
            java.lang.String r1 = ":"
            java.lang.String[] r1 = r11.split(r1)     // Catch: java.lang.NumberFormatException -> L70
            r1 = r1[r7]     // Catch: java.lang.NumberFormatException -> L70
            int r1 = java.lang.Integer.parseInt(r1)     // Catch: java.lang.NumberFormatException -> L70
            r8 = 13
            if (r1 < r8) goto L4a
            java.lang.Boolean r8 = java.lang.Boolean.valueOf(r7)     // Catch: java.lang.NumberFormatException -> L70
            goto L4b
        L4a:
            r8 = r5
        L4b:
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch: java.lang.NumberFormatException -> L70
            r9.<init>(r2)     // Catch: java.lang.NumberFormatException -> L70
            java.lang.StringBuilder r2 = r9.append(r3)     // Catch: java.lang.NumberFormatException -> L70
            java.lang.String r9 = " ,post-build="
            java.lang.StringBuilder r2 = r2.append(r9)     // Catch: java.lang.NumberFormatException -> L70
            java.lang.StringBuilder r11 = r2.append(r11)     // Catch: java.lang.NumberFormatException -> L70
            java.lang.String r2 = " ,metaDataAndroidVersion="
            java.lang.StringBuilder r11 = r11.append(r2)     // Catch: java.lang.NumberFormatException -> L70
            java.lang.StringBuilder r11 = r11.append(r1)     // Catch: java.lang.NumberFormatException -> L70
            java.lang.String r11 = r11.toString()     // Catch: java.lang.NumberFormatException -> L70
            android.util.Log.d(r0, r11)     // Catch: java.lang.NumberFormatException -> L70
            goto L71
        L70:
            r8 = r5
        L71:
        ...
        Lb3:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nothing.OfflineOTAUpgradeApp.p007ui.MainActivity.isHardwareAndVersionVerifyFail(java.util.HashMap):boolean");
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.nothing.OfflineOTAUpgradeApp.ui.MainActivity$CopyFileTask */
    /* loaded from: classes2.dex */
        ...
        */
        public java.lang.Void doInBackground(java.lang.Void... r9) {
            ...
            L6b:
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nothing.OfflineOTAUpgradeApp.p007ui.MainActivity.CopyFileTask.doInBackground(java.lang.Void[]):java.lang.Void");
        }
        ...
        public void onPostExecute(Void r3) {
            ...
            MainActivity.this.mButtonDirectOTA.setEnabled(true);
            Toast.makeText(MainActivity.this.getApplicationContext(), MainActivity.this.getResources().getString(C1640R.string.copy_success_text), 0).show();
