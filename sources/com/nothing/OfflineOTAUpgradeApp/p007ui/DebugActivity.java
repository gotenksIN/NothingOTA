...
import com.nothing.OfflineOTAUpgradeApp.p007ui.compose.DebugScreenKt;
...
public final class DebugActivity extends AppCompatActivity {
    ...
    /* compiled from: DebugActivity.kt */
    @Metadata(m41d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tR\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, m40d2 = {"Lcom/nothing/OfflineOTAUpgradeApp/ui/DebugActivity$Companion;", "", "()V", "TAG", "", "kotlin.jvm.PlatformType", "newIntent", "Landroid/content/Intent;", "context", "Landroid/content/Context;", "NothingOfflineOtaUpdate_nothingRelease"}, m39k = 1, m38mv = {1, 9, 0}, m36xi = 48)
    /* renamed from: com.nothing.OfflineOTAUpgradeApp.ui.DebugActivity$Companion */
    /* loaded from: classes2.dex */
    ...
    private final void setView() {
        ComponentActivity.setContent$default(this, null, ComposableLambdaKt.composableLambdaInstance(1238620478, true, new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.DebugActivity$setView$1
            ...
            public final void invoke(Composer composer, int i) {
                if ((i & 11) != 2 || !composer.getSkipping()) {
                    ...
                    long colorResource = ColorResources_androidKt.colorResource(C1640R.color.updating_screen_background, composer, 6);
                    final DebugActivity debugActivity2 = DebugActivity.this;
                    ScaffoldKt.m1589ScaffoldTvnljyQ(null, ComposableLambdaKt.composableLambda(composer, 1113097986, true, new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.DebugActivity$setView$1.1
                        {
                            super(2);
                        }
                        ...
                        public final void invoke(Composer composer2, int i2) {
                            if ((i2 & 11) != 2 || !composer2.getSkipping()) {
                                ...
                                Function2<Composer, Integer, Unit> m5620getLambda1$NothingOfflineOtaUpdate_nothingRelease = ComposableSingletons$DebugActivityKt.INSTANCE.m5620getLambda1$NothingOfflineOtaUpdate_nothingRelease();
                                final DebugActivity debugActivity3 = DebugActivity.this;
                                AppBar.TopAppBar(m5620getLambda1$NothingOfflineOtaUpdate_nothingRelease, null, ComposableLambdaKt.composableLambda(composer2, 412454396, true, new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.DebugActivity.setView.1.1.1
                                    {
                                        super(2);
                                    }
                                    ...
                                    public final void invoke(Composer composer3, int i3) {
                                        if ((i3 & 11) != 2 || !composer3.getSkipping()) {
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventStart(412454396, i3, -1, "com.nothing.OfflineOTAUpgradeApp.ui.DebugActivity.setView.<anonymous>.<anonymous>.<anonymous> (DebugActivity.kt:71)");
                                            }
                                            final DebugActivity debugActivity4 = DebugActivity.this;
                                            IconButtonKt.IconButton(new Functions<Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.DebugActivity.setView.1.1.1.1
                                                {
                                                    super(0);
                                                }
                                            ...
                                            }, null, false, null, null, ComposableSingletons$DebugActivityKt.INSTANCE.m5621getLambda2$NothingOfflineOtaUpdate_nothingRelease(), composer3, ProfileVerifier.CompilationStatus.f184xf2722a21, 30);
                                            if (ComposerKt.isTraceInProgress()) {
                                ...
                                }), null, null, m1909topAppBarColorszjMxDiM, null, composer2, 390, 90);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                    return;
                                }
                        ...
                        public final void invoke(PaddingValues paddingValues, Composer composer2, int i2) {
                            ...
                            if ((i2 & 91) != 18 || !composer2.getSkipping()) {
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(344204941, i2, -1, "com.nothing.OfflineOTAUpgradeApp.ui.DebugActivity.setView.<anonymous>.<anonymous> (DebugActivity.kt:88)");
                                }
                                ...
                                DebugScreenKt.DebugScreen(debugViewModel, Padding.padding(Modifier.Companion, paddingValues), composer2, DebugViewModel.$stable, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                    return;
                                }
