...
import com.nothing.OfflineOTAUpgradeApp.ui.OTAUpdateActivity;
...
public class FeedbackSettingsIndexablesProvider extends SearchIndexablesProvider {
    ...
    public Cursor queryRawData(String[] strArr) {
        ...
        objArr[6] = context.getString(R.string.header_category_system);
        objArr[5] = context.getString(R.string.app_name);
