...
public final class InstallResultDialogKt {
    public static final void InstallSuccessDialog(final Function0<Unit> onConfirmClicked, final Function0<Unit> onCancelClicked, final Function0<Unit> onDismiss, Composer composer, final int i) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.InstallResultDialogKt$InstallSuccessDialog$1
            ...
            public final void invoke(Composer composer2, int i4) {
                InstallResultDialogKt.InstallSuccessDialog(onConfirmClicked, onCancelClicked, onDismiss, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }

    public static final void InstallFailureDialog(final Function0<Unit> onConfirmClicked, final Function0<Unit> onDismiss, Composer composer, final int i) {
        int i2;
        Intrinsics.checkNotNullParameter(onConfirmClicked, "onConfirmClicked");
        Intrinsics.checkNotNullParameter(onDismiss, "onDismiss");
        ...
        if ((i2 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            BaseDialogKt.BaseDialog(StringResources_androidKt.stringResource(com.nothing.OfflineOTAUpgradeApp.R.string.update_ota_failure_dialog_title, startRestartGroup, 6), StringResources_androidKt.stringResource(com.nothing.OfflineOTAUpgradeApp.R.string.update_ota_failure_dialog_message, startRestartGroup, 6), StringResources_androidKt.stringResource(com.nothing.OfflineOTAUpgradeApp.R.string.confirm, startRestartGroup, 6), null, onConfirmClicked, null, false, onDismiss, startRestartGroup, ((i2 << 12) & 57344) | 1572864 | ((i2 << 18) & 29360128), 40);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.InstallResultDialogKt$InstallFailureDialog$1
            ...
            public final void invoke(Composer composer2, int i3) {
                InstallResultDialogKt.InstallFailureDialog(onConfirmClicked, onDismiss, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }

    public static final void InstallCancelConfirmationDialog(final Function0<Unit> onConfirmClicked, final Function0<Unit> onCancelClicked, final Function0<Unit> onDismiss, Composer composer, final int i) {
        int i2;
        Intrinsics.checkNotNullParameter(onConfirmClicked, "onConfirmClicked");
        Intrinsics.checkNotNullParameter(onCancelClicked, "onCancelClicked");
        Intrinsics.checkNotNullParameter(onDismiss, "onDismiss");
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            int i3 = i2 << 12;
            BaseDialogKt.BaseDialog(StringResources_androidKt.stringResource(com.nothing.OfflineOTAUpgradeApp.R.string.reset_ota_update_dialog_title, startRestartGroup, 6), StringResources_androidKt.stringResource(com.nothing.OfflineOTAUpgradeApp.R.string.reset_ota_update_dialog_message, startRestartGroup, 6), StringResources_androidKt.stringResource(com.nothing.OfflineOTAUpgradeApp.R.string.confirm, startRestartGroup, 6), StringResources_androidKt.stringResource(com.nothing.OfflineOTAUpgradeApp.R.string.cancel, startRestartGroup, 6), onConfirmClicked, onCancelClicked, true, onDismiss, startRestartGroup, (i3 & 458752) | (57344 & i3) | 1572864 | ((i2 << 15) & 29360128), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.InstallResultDialogKt$InstallCancelConfirmationDialog$1
            ...
            public final void invoke(Composer composer2, int i4) {
                InstallResultDialogKt.InstallCancelConfirmationDialog(onConfirmClicked, onCancelClicked, onDismiss, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void InstallSuccessDialogPreview(Composer composer, final int i) {
        ...
        if (i != 0 || !startRestartGroup.getSkipping()) {
            ...
            InstallSuccessDialog(new Function0<Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.InstallResultDialogKt$InstallSuccessDialogPreview$1
            ...
            }, new Function0<Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.InstallResultDialogKt$InstallSuccessDialogPreview$2
                /* renamed from: invoke  reason: avoid collision after fix types in other method */
                public final void invoke2() {
                }
            ...
            }, new Function0<Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.InstallResultDialogKt$InstallSuccessDialogPreview$3
                /* renamed from: invoke  reason: avoid collision after fix types in other method */
                public final void invoke2() {
                }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.nothing.OfflineOTAUpgradeApp.ui.compose.InstallResultDialogKt$InstallSuccessDialogPreview$4
            ...
            public final void invoke(Composer composer2, int i2) {
                InstallResultDialogKt.InstallSuccessDialogPreview(composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
}
