...
public final class RepoContainer {
    ...
    public RepoContainer(MainApplication appContext) {
        ...
        this.debugRepository$delegate = LazyKt.lazy(new Functions<DebugRepository>() { // from class: com.nothing.OfflineOTAUpgradeApp.repo.RepoContainer$debugRepository$2
        ...
        this.remoteRepository$delegate = LazyKt.lazy(new Functions<RemoteRepository>() { // from class: com.nothing.OfflineOTAUpgradeApp.repo.RepoContainer$remoteRepository$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            public final RemoteRepository invoke() {
                MainApplication mainApplication;
                mainApplication = RepoContainer.this.appContext;
                return new RemoteRepository(mainApplication, CoroutineScopeKt.CoroutineScope(SupervisorKt.SupervisorJob$default((Job) null, 1, (Object) null).plus(Dispatchers.getMain())), Dispatchers.getIO(), new RemoteServiceHost(RepoContainer.this.getDebugRepository()), Utils.INSTANCE, EncryptUtil.INSTANCE, RepoContainer.this.getDebugRepository());
            }
        });
    }
