...
public class UpdaterState {
    ...
    static {
        ...
        TRANSITIONS = ImmutableMap.builder().put(0, ImmutableSet.of(0, 1, 2)).put(1, ImmutableSet.of(0)).put(2, ImmutableSet.of(0, 1, 3, 5, 4)).put(3, ImmutableSet.of(1, 2, 0)).put(4, ImmutableSet.of(1, 5, 0)).put(5, ImmutableSet.of(0)).build();
    }
