...
public abstract class ByteSource {
    ...
    public class AsCharSource extends CharSource {
        ...
        @Override // com.google.common.p006io.CharSource
    ...
    public final class SlicedByteSource extends ByteSource {
        ...
        @Override // com.google.common.p006io.ByteSource
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (sizeIfKnown.isPresent()) {
                ...
                return Optional.m241of(Long.valueOf(Math.min(this.length, longValue - Math.min(this.offset, longValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        @Override // com.google.common.p006io.ByteSource
        public Optional<Long> sizeIfKnown() {
            return Optional.m241of(Long.valueOf(this.length));
        }
    ...
    public static final class EmptyByteSource extends ByteArrayByteSource {
        ...
        @Override // com.google.common.p006io.ByteSource.ByteArrayByteSource
        public String toString() {
            return "ByteSource.empty()";
        }
        ...
        @Override // com.google.common.p006io.ByteSource.ByteArrayByteSource, com.google.common.p006io.ByteSource
        public byte[] read() {
            return this.bytes;
        }
    }
    ...
    public static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            for (ByteSource byteSource : iterable) {
                ...
                if (j < 0) {
                    return Optional.m241of(Long.MAX_VALUE);
                }
            }
            return Optional.m241of(Long.valueOf(j));
        }
