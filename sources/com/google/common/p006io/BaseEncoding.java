...
public abstract class BaseEncoding {
    ...
    public final ByteSink encodingSink(final CharSink charSink) {
        ...
        return new ByteSink() { // from class: com.google.common.io.BaseEncoding.1
            @Override // com.google.common.p006io.ByteSink
    ...
    public static class StandardBaseEncoding extends BaseEncoding {
        ...
        @Override // com.google.common.p006io.BaseEncoding
    ...
    static final class Base16Encoding extends StandardBaseEncoding {
        ...
        @Override // com.google.common.p006io.BaseEncoding.StandardBaseEncoding, com.google.common.p006io.BaseEncoding
        void encodeTo(Appendable appendable, byte[] bArr, int i, int i2) throws IOException {
            Preconditions.checkNotNull(appendable);
            Preconditions.checkPositionIndexes(i, i + i2, bArr.length);
        ...
        @Override // com.google.common.p006io.BaseEncoding.StandardBaseEncoding
        BaseEncoding newInstance(Alphabet alphabet, @CheckForNull Character ch) {
