...
public final class CipherSuite {
    ...
    public final String m6965deprecated_javaName() {
        return this.javaName;
    }
    ...
    static {
        ...
        TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", R.styleable.AppCompatTheme_textAppearanceListItem);
        TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", R.styleable.AppCompatTheme_textAppearancePopupMenuHeader);
        TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle);
