...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m6582getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }

    /* renamed from: getFirst-pVg5ArA  reason: not valid java name */
    public final int m6596getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m6597getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) UInt.m5514toStringimpl(this.first)).append("..").append((Object) UInt.m5514toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            append = new StringBuilder().append((Object) UInt.m5514toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m5514toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m6598fromClosedRangeNkh28Cs(int i, int i2, int i3) {
