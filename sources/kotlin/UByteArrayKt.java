...
public final class UByteArrayKt {
    ...
    private static final byte[] m5460ubyteArrayOfGBYM_sE(byte... elements) {
    ...
    private static final byte[] UByteArray(int i, Function1<? super Integer, UByte> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            bArr[i2] = init.invoke(Integer.valueOf(i2)).m5441unboximpl();
        }
        return UByteArray.m5444constructorimpl(bArr);
    }
}
