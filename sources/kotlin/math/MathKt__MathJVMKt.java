...
public class MathKt__MathJVMKt extends MathH {
    ...
    /* renamed from: ln */
    private static final double m20ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m19ln(float f) {
