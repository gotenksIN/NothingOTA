...
public final class UMathKt {
    ...
    private static final int m6585minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6567minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m6586mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m6575minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m6583maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6555maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m6584maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m6563maxOfeb3DHEI(j, j2);
    }
}
