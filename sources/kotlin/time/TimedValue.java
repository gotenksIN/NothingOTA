...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m6856copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m6858copyRFiDyg4(obj, j);
    }
    ...
    public final long m6857component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m6858copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimedValue) {
            ...
            return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m6703equalsimpl0(this.duration, timedValue.duration);
        }
        return false;
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m6726hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m6747toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m6859getDurationUwyO8pc() {
        return this.duration;
    }
