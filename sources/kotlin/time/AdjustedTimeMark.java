...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m6692getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo6689minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m6835minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo6688elapsedNowUwyO8pc() {
        return Duration.m6733minusLRDsOJo(this.mark.mo6688elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo6691plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m6734plusLRDsOJo(this.adjustment, j), null);
    }
}
