...
public interface TimeMark {
    ...
    TimeMark mo6689minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo6691plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m6836plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m6835minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo6691plusLRDsOJo(Duration.m6751unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m6731isNegativeimpl(timeMark.mo6688elapsedNowUwyO8pc());
        }
