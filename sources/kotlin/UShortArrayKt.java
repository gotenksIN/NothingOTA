...
public final class UShortArrayKt {
    ...
    private static final short[] m5723ushortArrayOfrL5Bavg(short... elements) {
    ...
    private static final short[] UShortArray(int i, Function1<? super Integer, UShort> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            sArr[i2] = init.invoke(Integer.valueOf(i2)).m5704unboximpl();
        }
        return UShortArray.m5707constructorimpl(sArr);
    }
}
