...
public final class SafePublicationLazyImpl<T> implements Lazy<T>, Serializable {
    ...
    public SafePublicationLazyImpl(Function0<? extends T> initializer) {
        ...
        this.f54final = UNINITIALIZED_VALUE.INSTANCE;
    }
    ...
    public T getValue() {
        ...
        if (function0 != null) {
            ...
            if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(valueUpdater, this, UNINITIALIZED_VALUE.INSTANCE, invoke)) {
