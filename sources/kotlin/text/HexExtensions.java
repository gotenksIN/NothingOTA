    ...
    */
    public static final java.lang.String toHexString(byte[] r17, int r18, int r19, kotlin.text.HexFormat r20) {
        ...
        Lb7:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.HexExtensions.toHexString(byte[], int, int, kotlin.text.HexFormat):java.lang.String");
    }
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m5869toStringimpl(ULong.m5823constructorimpl(j))));
    }
