...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m6854getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m5648boximpl(obj);
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result == null) {
                    ...
                    ResultKt.throwOnFailure(result.m5658unboximpl());
                }
            }
        }
    }
