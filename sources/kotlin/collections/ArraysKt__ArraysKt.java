        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m5942contentEqualskV0jMPg(((UByteArray) t).m5458unboximpl(), ((UByteArray) t2).m5458unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m5940contentEqualsFGO6Aew(((UShortArray) t).m5721unboximpl(), ((UShortArray) t2).m5721unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m5941contentEqualsKJPZfPQ(((UIntArray) t).m5537unboximpl(), ((UIntArray) t2).m5537unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m5943contentEqualslec5QzE(((ULongArray) t).m5616unboximpl(), ((ULongArray) t2).m5616unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m5948contentToString2csIQuQ(uByteArray != null ? uByteArray.m5458unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m5950contentToStringd6D3K8(uShortArray != null ? uShortArray.m5721unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m5949contentToStringXUkPCBk(uIntArray != null ? uIntArray.m5537unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m5951contentToStringuLth9ew(uLongArray != null ? uLongArray.m5616unboximpl() : null));
            } else {
