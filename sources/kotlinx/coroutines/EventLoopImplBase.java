...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo6927scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
    ...
    */
    ...
    public final void mo6926dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        enqueue(runnable);
    }
    ...
    private final void closeQueue() {
        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                symbol = EventLoop_commonKt.CLOSED_EMPTY;
                if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, (Object) null, symbol)) {
                    return;
                }
                ...
                if (obj != null) {
                    ...
                    if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore)) {
                        return;
                    }
                } else {
    ...
    private final int scheduleImpl(long j, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_delayed$FU, this, (Object) null, new DelayedTaskQueue(j));
    ...
    private final boolean enqueueImpl(Runnable runnable) {
        ...
        while (true) {
            ...
            if (obj == null) {
                if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, (Object) null, runnable)) {
                    return true;
                }
            } else if (!(obj instanceof LockFreeTaskQueueCore)) {
                symbol = EventLoop_commonKt.CLOSED_EMPTY;
                ...
                if (addLast == 1) {
                    MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore2.next());
                } else if (addLast == 2) {
                    return false;
                }
            } else {
    ...
    private final Runnable dequeue() {
        ...
        while (true) {
            ...
            if (!(obj instanceof LockFreeTaskQueueCore)) {
                ...
                if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, (Object) null)) {
                    if (obj != null) {
                        return (Runnable) obj;
                    }
                    throw new NullPointerException("null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
                ...
                MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore.next());
            } else {
                throw new NullPointerException("null cannot be cast to non-null type kotlinx.coroutines.internal.LockFreeTaskQueueCore<java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }>{ kotlinx.coroutines.EventLoop_commonKt.Queue<java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }> }");
            }
        }
