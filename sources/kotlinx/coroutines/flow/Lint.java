...
public final class Lint {
    ...
    private static final <T> Flow<T> m7187catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m7179catch(sharedFlow, function3);
    }
