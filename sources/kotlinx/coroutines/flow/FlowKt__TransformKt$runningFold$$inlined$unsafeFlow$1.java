...
public final class FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    @DebugMetadata(m31c = "kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1", m30f = "Transform.kt", m29i = {0, 0, 0}, m28l = {C0032R.styleable.AppCompatTheme_tooltipForegroundColor, C0032R.styleable.AppCompatTheme_tooltipFrameBackground}, m27m = "collect", m26n = {"this", "$this$runningFold_u24lambda_u2d8", "accumulator"}, m25s = {"L$0", "L$1", "L$2"})
    ...
    public static final class C17581 extends ContinuationImpl {
        ...
        public C17581(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super R> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1.C17581
            if (r0 == 0) goto L14
            r0 = r8
            kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1$1 r0 = (kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1.C17581) r0
            int r1 = r0.label
