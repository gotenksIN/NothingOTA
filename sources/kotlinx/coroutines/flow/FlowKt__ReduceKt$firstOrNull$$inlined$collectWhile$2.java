...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m31c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2", m30f = "Reduce.kt", m29i = {0, 0}, m28l = {142}, m27m = "emit", m26n = {"this", "it"}, m25s = {"L$0", "L$1"})
    ...
    public static final class C17351 extends ContinuationImpl {
        ...
        public C17351(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public java.lang.Object emit(T r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2.C17351
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2$1 r0 = (kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2.C17351) r0
            int r1 = r0.label
