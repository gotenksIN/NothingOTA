...
@DebugMetadata(m31c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", m30f = "Zip.kt", m29i = {}, m28l = {251}, m27m = "invokeSuspend", m26n = {}, m25s = {})
...
public final class FlowKt__ZipKt$combineTransform$6<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes2.dex */
    public static final class C17751<T> extends Lambda implements Functions<T[]> {
        final /* synthetic */ Flow<T>[] $flows;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C17751(Flow<? extends T>[] flowArr) {
            super(0);
            this.$flows = flowArr;
        }
    ...
    @DebugMetadata(m31c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", m30f = "Zip.kt", m29i = {}, m28l = {251}, m27m = "invokeSuspend", m26n = {}, m25s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* loaded from: classes2.dex */
    public static final class C17762<T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        final /* synthetic */ Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> $transform;
        private /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C17762(Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C17762> continuation) {
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C17762 c17762 = new C17762(this.$transform, continuation);
            c17762.L$0 = flowCollector;
            c17762.L$1 = tArr;
            return c17762.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Intrinsics.needClassReification();
            this.label = 1;
            if (Combine.combineInternal((FlowCollector) this.L$0, flowArr, new C17751(this.$flows), new C17762(this.$transform, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i != 1) {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        Combine.combineInternal((FlowCollector) this.L$0, flowArr, new C17751(this.$flows), new C17762(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
