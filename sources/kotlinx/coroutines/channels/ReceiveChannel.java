...
public interface ReceiveChannel<E> {
    ...
    Object mo6878receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo6879tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo6879tryReceivePtdJZtk = receiveChannel.mo6879tryReceivePtdJZtk();
            if (ChannelResult.m6895isSuccessimpl(mo6879tryReceivePtdJZtk)) {
                return (E) ChannelResult.m6891getOrThrowimpl(mo6879tryReceivePtdJZtk);
            }
            Throwable m6889exceptionOrNullimpl = ChannelResult.m6889exceptionOrNullimpl(mo6879tryReceivePtdJZtk);
            if (m6889exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m6889exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L19:
                ...
                java.lang.Object r4 = r5.m6897unboximpl()
                goto L44
            L30:
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo6878receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m6890getOrNullimpl(r4)
                return r4
            */
