...
public interface ReceiveChannel<E> {
    ...
    Object mo7154receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo7155tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo7155tryReceivePtdJZtk = receiveChannel.mo7155tryReceivePtdJZtk();
            if (ChannelResult.m7171isSuccessimpl(mo7155tryReceivePtdJZtk)) {
                return (E) ChannelResult.m7167getOrThrowimpl(mo7155tryReceivePtdJZtk);
            }
            Throwable m7165exceptionOrNullimpl = ChannelResult.m7165exceptionOrNullimpl(mo7155tryReceivePtdJZtk);
            if (m7165exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecovery.recoverStackTrace(m7165exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L19:
                ...
                java.lang.Object r4 = r5.m7173unboximpl()
                goto L44
            L30:
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo7154receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m7166getOrNullimpl(r4)
                return r4
            */
