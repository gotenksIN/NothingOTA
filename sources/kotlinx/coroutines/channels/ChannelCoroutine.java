...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo7154receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo7154receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo7155tryReceivePtdJZtk() {
        return this._channel.mo7155tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo7156trySendJP2dKIU(E e) {
        return this._channel.mo7156trySendJP2dKIU(e);
    }
