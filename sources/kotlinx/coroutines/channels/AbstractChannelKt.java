...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.Companion.m7174closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m7176successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m7174closedJP2dKIU(closed.closeCause);
    }
}
