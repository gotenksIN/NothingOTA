...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo6880trySendJP2dKIU = sendChannel.mo6880trySendJP2dKIU(e);
        if (mo6880trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m6897unboximpl();
        }
        Unit unit = (Unit) mo6880trySendJP2dKIU;
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m6895isSuccessimpl(sendChannel.mo6880trySendJP2dKIU(e))) {
            return;
        }
