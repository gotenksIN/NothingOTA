...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: ConflatedBroadcastChannel.kt */
    @Metadata(m41d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0007\b\u0002\u0018\u00002\u00020\u0001B\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004R\u0012\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007R\u0011\u0010\b\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\t\u0010\u0007¨\u0006\n"}, m40d2 = {"Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Closed;", "", "closeCause", "", "(Ljava/lang/Throwable;)V", "sendException", "getSendException", "()Ljava/lang/Throwable;", "valueException", "getValueException", "kotlinx-coroutines-core"}, m39k = 1, m38mv = {1, 6, 0}, m36xi = 48)
    /* loaded from: classes2.dex */
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m293m(_state$FU, this, obj, new State(state.value, addSubscriber(state.subscribers, subscriber))));
        return subscriber;
    }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if ((obj2 instanceof Closed) && MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m293m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo7156trySendJP2dKIU(E e) {
        Closed offerInternal = offerInternal(e);
        return offerInternal != null ? ChannelResult.Companion.m7174closedJP2dKIU(offerInternal.getSendException()) : ChannelResult.Companion.m7176successJP2dKIU(Unit.INSTANCE);
    }
    ...
    private final Closed offerInternal(E e) {
        ...
        if (_updating$FU.compareAndSet(this, 0, 1)) {
            ...
            } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m293m(_state$FU, this, obj, new State(e, ((State) obj).subscribers)));
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m293m(_state$FU, this, obj, new State(obj2, removeSubscriber(subscriberArr, subscriber))));
    }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m293m(_state$FU, this, obj, th == null ? CLOSED : new Closed(th)));
        Subscriber<E>[] subscriberArr = ((State) obj).subscribers;
        if (subscriberArr != null) {
            for (Subscriber<E> subscriber : subscriberArr) {
                subscriber.close(th);
