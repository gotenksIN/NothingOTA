...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(state.value, addSubscriber(state.subscribers, subscriber))));
        return subscriber;
    }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if ((obj2 instanceof Closed) && MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo6880trySendJP2dKIU(E e) {
        Closed offerInternal = offerInternal(e);
        return offerInternal != null ? ChannelResult.Companion.m6898closedJP2dKIU(offerInternal.getSendException()) : ChannelResult.Companion.m6900successJP2dKIU(Unit.INSTANCE);
    }
    ...
    private final Closed offerInternal(E e) {
        ...
        if (_updating$FU.compareAndSet(this, 0, 1)) {
            ...
            } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(e, ((State) obj).subscribers)));
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(obj2, removeSubscriber(subscriberArr, subscriber))));
    }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, th == null ? CLOSED : new Closed(th)));
        Subscriber<E>[] subscriberArr = ((State) obj).subscribers;
        if (subscriberArr != null) {
            for (Subscriber<E> subscriber : subscriberArr) {
                subscriber.close(th);
