...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo6878receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r5 = r0.m6898closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m6900successJP2dKIU(r5)
        L52:
            return r5
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            java.lang.Object r5 = r5.m6897unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo6878receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public final Object mo6879tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m6899failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m6898closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m6900successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        Object m6917constructorimpl$default = InlineList.m6917constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo6925remove()) {
                    prevNode.helpRemove();
                } else {
                    m6917constructorimpl$default = InlineList.m6922plusFjFbRPM(m6917constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo6877onCancelIdempotentListww6eGU(m6917constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            ...
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m6885boximpl(z ? companion.m6898closedJP2dKIU(((Closed) obj).closeCause) : companion.m6900successJP2dKIU(obj)), selectInstance.getCompletion());
        } else if (i == 0) {
            throw StackTraceRecoveryKt.recoverStackTrace(((Closed) obj).getReceiveException());
        } else {
            if (i == 1 && selectInstance.trySelect()) {
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m6885boximpl(ChannelResult.Companion.m6898closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m5373constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuationImpl.resumeWith(Result.m5373constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m6885boximpl(ChannelResult.Companion.m6900successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m5373constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            ChannelResult m6885boximpl = ChannelResult.m6885boximpl(ChannelResult.Companion.m6898closedJP2dKIU(closed.closeCause));
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m5373constructorimpl(m6885boximpl));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m6885boximpl(ChannelResult.Companion.m6900successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m6885boximpl(ChannelResult.Companion.m6898closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo6877onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
