...
@DebugMetadata(m31c = "kotlinx.coroutines.channels.BroadcastKt$broadcast$2", m30f = "Broadcast.kt", m29i = {0, 1}, m28l = {C0032R.styleable.AppCompatTheme_colorControlActivated, C0032R.styleable.AppCompatTheme_colorControlHighlight}, m27m = "invokeSuspend", m26n = {"$this$broadcast", "$this$broadcast"}, m25s = {"L$0", "L$0"})
