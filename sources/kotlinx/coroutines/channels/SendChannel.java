...
public interface SendChannel<E> {
    ...
    Object mo7156trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m7171isSuccessimpl(mo7156trySendJP2dKIU)) {
                return true;
            }
            Throwable m7165exceptionOrNullimpl = ChannelResult.m7165exceptionOrNullimpl(mo7156trySendJP2dKIU);
