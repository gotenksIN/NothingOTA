...
public interface SendChannel<E> {
    ...
    Object mo6880trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m6895isSuccessimpl(mo6880trySendJP2dKIU)) {
                return true;
            }
            Throwable m6889exceptionOrNullimpl = ChannelResult.m6889exceptionOrNullimpl(mo6880trySendJP2dKIU);
