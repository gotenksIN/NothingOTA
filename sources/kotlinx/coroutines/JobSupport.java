...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final Object finalizeFinishingState(Finishing finishing, Object obj) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || (!finishing.isSealed())) {
            if (!DebugKt.getASSERTIONS_ENABLED() || finishing.isCompleting()) {
                ...
                boolean m = MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, finishing, JobSupportKt.boxIncomplete(obj));
    ...
    private final boolean tryFinalizeSimpleState(Incomplete incomplete, Object obj) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(obj instanceof CompletedExceptionally))) {
            if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, incomplete, JobSupportKt.boxIncomplete(obj))) {
                onCancelling(null);
                onCompletionInternal(obj);
    ...
    private final int startInternal(Object obj) {
        ...
        if (obj instanceof Empty) {
            ...
            if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, obj, empty)) {
                onStart();
                return 1;
            }
            return -1;
        } else if (obj instanceof InactiveNodeList) {
            if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, ((InactiveNodeList) obj).getList())) {
                onStart();
                return 1;
            }
            return -1;
    ...
    public final DisposableHandle invokeOnCompletion(boolean z, boolean z2, Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                if (empty.isActive()) {
                    if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, state$kotlinx_coroutines_core, makeNode)) {
                        return makeNode;
                    }
                } else {
    ...
    private final void promoteEmptyToNodeList(Empty empty) {
        ...
        MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, empty, empty.isActive() ? nodeList : new InactiveNodeList(nodeList));
    }

    private final void promoteSingleToNodeList(JobNode jobNode) {
        jobNode.addOneIfEmpty(new NodeList());
        MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, jobNode, jobNode.getNextNode());
    }
    ...
    private final boolean tryMakeCancelling(Incomplete incomplete, Throwable th) {
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(incomplete instanceof Finishing))) {
            if (!DebugKt.getASSERTIONS_ENABLED() || incomplete.isActive()) {
                ...
                if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, incomplete, new Finishing(orPromoteCancellingList, false, th))) {
    ...
    private final Object tryMakeCompletingSlowPath(Incomplete incomplete, Object obj) {
        ...
        synchronized (finishing) {
            ...
            if (finishing != incomplete && !MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, incomplete, finishing)) {
                symbol = JobSupportKt.COMPLETING_RETRY;
                return symbol;
            }
            if (DebugKt.getASSERTIONS_ENABLED() && !(!finishing.isSealed())) {
    ...
    public final void removeNode$kotlinx_coroutines_core(JobNode jobNode) {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, state$kotlinx_coroutines_core, empty));
    }
