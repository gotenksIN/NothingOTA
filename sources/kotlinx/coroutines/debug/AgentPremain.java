...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m5373constructorimpl = Result.m5373constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5373constructorimpl = Result.m5373constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m5379isFailureimpl(m5373constructorimpl) ? null : m5373constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m6902installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m6902installSignalHandler$lambda1(Signal signal) {
