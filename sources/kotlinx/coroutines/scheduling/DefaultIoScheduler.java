...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f57default;
    ...
    static {
        ...
        f57default = unlimitedIoScheduler.limitedParallelism(systemProp$default);
    }
    ...
    public void execute(Runnable runnable) {
        mo6926dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo6926dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f57default.mo6926dispatch(coroutineContext, runnable);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        f57default.dispatchYield(coroutineContext, runnable);
    }
