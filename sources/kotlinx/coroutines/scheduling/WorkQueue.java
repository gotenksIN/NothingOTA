...
public final class WorkQueue {
    ...
    public final long tryStealBlockingFrom(WorkQueue workQueue) {
        ...
        for (int i2 = workQueue.consumerIndex; i2 != i; i2++) {
            ...
            if (task != null) {
                if ((task.taskContext.getTaskMode() == 1) && MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m294m(atomicReferenceArray, i3, task, (Object) null)) {
    ...
    private final long tryStealLastScheduled(WorkQueue workQueue, boolean z) {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m293m(lastScheduledTask$FU, workQueue, task, (Object) null));
        add$default(this, task, false, 2, null);
        return -1L;
    }
