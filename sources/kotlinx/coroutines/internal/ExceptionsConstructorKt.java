...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m5373constructorimpl = Result.m5373constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            try {
                                ...
                                Result.Companion companion2 = Result.Companion;
                                m5373constructorimpl = Result.m5373constructorimpl(ResultKt.createFailure(th2));
                            }
                            if (newInstance != null) {
                                m5373constructorimpl = Result.m5373constructorimpl((Throwable) newInstance);
                                if (Result.m5379isFailureimpl(m5373constructorimpl)) {
                                    m5373constructorimpl = null;
                                }
                                return (Throwable) m5373constructorimpl;
                            }
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            if (newInstance != null) {
                                ...
                                th3.initCause(th);
                                m5373constructorimpl = Result.m5373constructorimpl(th3);
                                if (Result.m5379isFailureimpl(m5373constructorimpl)) {
                                    m5373constructorimpl = null;
                                }
                                return (Throwable) m5373constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    m5373constructorimpl = Result.m5373constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.Companion;
                    m5373constructorimpl = Result.m5373constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m5373constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m5373constructorimpl = Result.m5373constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5373constructorimpl = Result.m5373constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5379isFailureimpl(m5373constructorimpl)) {
            m5373constructorimpl = valueOf;
        }
        return ((Number) m5373constructorimpl).intValue();
    }
