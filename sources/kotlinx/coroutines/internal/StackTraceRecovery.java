...
public final class StackTraceRecovery {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m5649constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m5649constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5652exceptionOrNullimpl(obj) == null) {
            obj4 = obj;
        }
        baseContinuationImplClassName = (String) obj4;
        try {
            Result.Companion companion3 = Result.Companion;
            obj2 = Result.m5649constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m5649constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m5652exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
    ...
    private static final <E extends Throwable> Tuples<E, StackTraceElement[]> causeAndStacktrace(E e) {
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            if (z) {
                return TuplesKt.m33to(cause, stackTrace);
            }
            return TuplesKt.m33to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m33to(e, new StackTraceElement[0]);
    }
