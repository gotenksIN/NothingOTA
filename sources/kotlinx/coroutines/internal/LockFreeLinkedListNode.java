...
public class LockFreeLinkedListNode {
    ...
    public static abstract class CondAddOp extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void complete(LockFreeLinkedListNode lockFreeLinkedListNode, Object obj) {
            ...
            if (lockFreeLinkedListNode2 != null && MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, lockFreeLinkedListNode2) && z) {
    ...
    public final boolean addOneIfEmpty(LockFreeLinkedListNode lockFreeLinkedListNode) {
        ...
        while (getNext() == this) {
            if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_next$FU, this, this, lockFreeLinkedListNode)) {
    ...
    public final boolean addNext(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2) {
        ...
        if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, lockFreeLinkedListNode2, lockFreeLinkedListNode)) {
    ...
    public final int tryCondAddNext(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2, CondAddOp condAddOp) {
        ...
        if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, lockFreeLinkedListNode2, condAddOp)) {
    ...
    public final LockFreeLinkedListNode removeOrNext() {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_next$FU, this, next, lockFreeLinkedListNode.removed()));
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo6925remove()) {
                return lockFreeLinkedListNode;
            }
    ...
    public static class AddLastDesc<T extends LockFreeLinkedListNode> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_affectedNode$FU, this, (Object) null, prepareOp.affected);
        }

        @Override // kotlinx.coroutines.internal.LockFreeLinkedListNode.AbstractAtomicDesc
        public Object updatedNext(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2) {
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._prev$FU, this.node, this.node, lockFreeLinkedListNode);
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, this.node, this.node, this.queue);
            return this.node;
        }
    ...
    public static class RemoveFirstDesc<T> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_affectedNode$FU, this, (Object) null, prepareOp.affected);
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_originalNext$FU, this, (Object) null, prepareOp.next);
        }
        ...
        public Object perform(Object obj) {
            ...
            if (obj != null) {
                ...
                if (onPrepare == LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                    ...
                    if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, lockFreeLinkedListNode2.removed())) {
                ...
                MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, obj2);
                return null;
            }
        ...
        */
        public final java.lang.Object prepare(kotlinx.coroutines.internal.AtomicOp<?> r7) {
            ...
            L33:
                ...
                boolean r4 = androidx.compose.animation.core.MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(r4, r0, r1, r3)
                if (r4 == 0) goto L0
            ...
            L66:
                ...
                androidx.compose.animation.core.MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(r2, r0, r3, r1)
                throw r7
            */
        ...
        public final void complete(AtomicOp<?> atomicOp, Object obj) {
            ...
            if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, affectedNode, atomicOp, z ? updatedNext(affectedNode, originalNext) : originalNext) && z) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x0048, code lost:
        if (androidx.compose.animation.core.MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(kotlinx.coroutines.internal.LockFreeLinkedListNode._next$FU, r3, r2, ((kotlinx.coroutines.internal.Removed) r4).ref) != false) goto L23;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final kotlinx.coroutines.internal.LockFreeLinkedListNode correctPrev(kotlinx.coroutines.internal.OpDescriptor r8) {
        ...
        Le:
            ...
            boolean r0 = androidx.compose.animation.core.MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(r1, r7, r0, r2)
            if (r0 != 0) goto L17
            goto L0
        L17:
            return r2
        ...
        L38:
            ...
            boolean r2 = androidx.compose.animation.core.MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(r5, r3, r2, r4)
            if (r2 != 0) goto L4b
            goto L0
        L4b:
            r2 = r3
    ...
    public final void finishAdd(LockFreeLinkedListNode lockFreeLinkedListNode) {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_prev$FU, lockFreeLinkedListNode, lockFreeLinkedListNode2, this));
        if (isRemoved()) {
            lockFreeLinkedListNode.correctPrev(null);
        }
    }
