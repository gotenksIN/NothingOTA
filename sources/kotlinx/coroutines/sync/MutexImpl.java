...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    public <R> void registerSelectClause2(SelectInstance<? super R> selectInstance, Object obj, Function2<? super Mutex, ? super Continuation<? super R>, ? extends Object> function2) {
        ...
        while (!selectInstance.isSelected()) {
            ...
            if (obj2 instanceof Empty) {
                ...
                if (obj3 != symbol) {
                    MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj2, new LockedQueue(empty.locked));
                } else {
    ...
    private static final class TryLockDesc extends AtomicDesc {
        ...
        private final class PrepareOp extends OpDescriptor {
            ...
            public Object perform(Object obj) {
                ...
                if (obj != null) {
                    MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(MutexImpl._state$FU, (MutexImpl) obj, this, atomicOp);
                    return null;
                }
        ...
        public Object prepare(AtomicOp<?> atomicOp) {
            ...
            if (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, mutexImpl, empty, prepareOp)) {
        ...
        public void complete(AtomicOp<?> atomicOp, Object obj) {
            ...
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(MutexImpl._state$FU, this.mutex, atomicOp, empty);
        }
    }
    ...
    private static final class UnlockOp extends AtomicOp<MutexImpl> {
        ...
        public void complete(MutexImpl mutexImpl, Object obj) {
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(MutexImpl._state$FU, mutexImpl, this, obj == null ? MutexKt.EMPTY_UNLOCKED : this.queue);
        }
    }
    ...
    public boolean tryLock(Object obj) {
        ...
        while (true) {
            ...
            if (obj2 instanceof Empty) {
                ...
                if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj2, obj == null ? MutexKt.EMPTY_LOCKED : new Empty(obj))) {
                    return true;
                }
            } else if (obj2 instanceof LockedQueue) {
    ...
    public void unlock(Object obj) {
        ...
        while (true) {
            ...
            if (obj2 instanceof Empty) {
                ...
                empty = MutexKt.EMPTY_UNLOCKED;
                if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, obj2, empty)) {
                    return;
                }
            } else if (obj2 instanceof OpDescriptor) {
                ((OpDescriptor) obj2).perform(this);
                ...
                if (removeFirstOrNull == null) {
                    ...
                    if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj2, unlockOp) && unlockOp.perform(this) == null) {
                        return;
                    }
                } else {
