...
public final class ViewKt {
    ...
    public static final Runnable postOnAnimationDelayed(View view, long j, final Functions<Unit> action) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.core.view.ViewKt$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ViewKt.postOnAnimationDelayed$lambda$1(Functions.this);
            }
        };
    ...
    public static final void postOnAnimationDelayed$lambda$1(Functions action) {
        Intrinsics.checkNotNullParameter(action, "$action");
        action.invoke();
    }
