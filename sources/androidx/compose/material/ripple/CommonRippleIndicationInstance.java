...
public final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        ...
        m889drawRipples4WTKRHQ(contentDrawScope2, m2566unboximpl);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(this.bounded ? Offset.m2307boximpl(interaction.m334getPressPositionF1C5BW0()) : null, this.radius, this.bounded, null);
    ...
    private final void m889drawRipples4WTKRHQ(DrawScope drawScope, long j) {
        for (Map.Entry<PressInteraction.Press, RippleAnimation> entry : this.ripples.entrySet()) {
            RippleAnimation value = entry.getValue();
            float pressedAlpha = this.rippleAlpha.getValue().getPressedAlpha();
            if (!(pressedAlpha == 0.0f)) {
                value.m891draw4WTKRHQ(drawScope, Color.m2555copywmQWz5c$default(j, pressedAlpha, 0.0f, 0.0f, 0.0f, 14, null));
            }
        }
    }
