...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5050constructorimpl(10);
    ...
    public static final float m893getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m2387getWidthimpl(j), Size.m2384getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA  reason: not valid java name */
    public static final float m892getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean z, long j) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float m2316getDistanceimpl = Offset.m2316getDistanceimpl(OffsetKt.Offset(Size.m2387getWidthimpl(j), Size.m2384getHeightimpl(j))) / 2.0f;
        return z ? m2316getDistanceimpl + getRippleEndRadius.mo302toPx0680j_4(BoundedRippleExtraRadius) : m2316getDistanceimpl;
    }
}
