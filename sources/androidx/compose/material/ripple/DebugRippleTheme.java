...
public final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo890defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m900defaultRippleColor5vOe2sY = RippleTheme.Companion.m900defaultRippleColor5vOe2sY(Color.Companion.m2582getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m900defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m899defaultRippleAlphaDxMtmZc = RippleTheme.Companion.m899defaultRippleAlphaDxMtmZc(Color.Companion.m2582getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m899defaultRippleAlphaDxMtmZc;
    }
}
