...
public final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m903setColorDxMtmZc(long j, float f) {
        long m902calculateRippleColor5vOe2sY = m902calculateRippleColor5vOe2sY(j, f);
        Color color = this.rippleColor;
        if (color == null ? false : Color.m2557equalsimpl0(color.m2566unboximpl(), m902calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m2546boximpl(m902calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m2610toArgb8_81llA(m902calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m902calculateRippleColor5vOe2sY(long j, float f) {
        if (Build.VERSION.SDK_INT < 28) {
            f *= 2;
        }
        return Color.m2555copywmQWz5c$default(j, RangesKt.coerceAtMost(f, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
