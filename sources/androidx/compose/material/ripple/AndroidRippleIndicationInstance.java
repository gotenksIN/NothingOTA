...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean z, float f, State<Color> state, State<RippleAlpha> state2, RippleContainer rippleContainer) {
        ...
        this.rippleSize = Size.Companion.m2697getZeroNHjbRc();
        this.rippleRadius = -1;
        this.onInvalidateRipple = new Functions<Unit>() { // from class: androidx.compose.material.ripple.AndroidRippleIndicationInstance$onInvalidateRipple$1
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        ...
        this.rippleSize = contentDrawScope.mo3397getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            i = MathKt.roundToInt(RippleAnimationKt.m1193getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo3397getSizeNHjbRc()));
        } else {
            i = contentDrawScope.mo597roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = i;
        ...
        if (rippleHostView != null) {
            rippleHostView.m1197updateRipplePropertiesbiQXAtU(contentDrawScope.mo3397getSizeNHjbRc(), this.rippleRadius, m2867unboximpl, pressedAlpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        rippleHostView.m1196addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m2867unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
