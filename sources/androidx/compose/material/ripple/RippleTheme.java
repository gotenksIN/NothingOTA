...
public interface RippleTheme {
    ...
    long mo890defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m900defaultRippleColor5vOe2sY(long j, boolean z) {
            return (z || ((double) ColorKt.m2608luminance8_81llA(j)) >= 0.5d) ? j : Color.Companion.m2593getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m899defaultRippleAlphaDxMtmZc(long j, boolean z) {
            ...
            if (!z) {
                ...
                return rippleAlpha;
            } else if (ColorKt.m2608luminance8_81llA(j) > 0.5d) {
