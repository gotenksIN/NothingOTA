...
public final class FocusTargetModifierNode extends Modifier.Node implements ObserverNode, ModifierLocalNode {
    ...
    @Override // androidx.compose.p002ui.node.ObserverNode
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int m4578constructorimpl = NodeKind.m4578constructorimpl(2048) | NodeKind.m4578constructorimpl(1024);
    ...
    public final void m2569fetchCustomEnteraToIllA$ui_release(int i, Function1<? super FocusRequester, Unit> block) {
        ...
        try {
            FocusRequester invoke = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2540boximpl(i));
    ...
    public final void m2570fetchCustomExitaToIllA$ui_release(int i, Function1<? super FocusRequester, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        ...
        try {
            FocusRequester invoke = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2540boximpl(i));
            if (invoke != FocusRequester.Companion.getDefault()) {
                block.invoke(invoke);
            }
        } finally {
    ...
    public final void invalidateFocus$ui_release() {
        ...
        if (focusState == FocusStateImpl.Active || focusState == FocusStateImpl.Captured) {
            ...
            ObserverNodeKt.observeReads(this, new Functions<Unit>() { // from class: androidx.compose.ui.focus.FocusTargetModifierNode$invalidateFocus$1
