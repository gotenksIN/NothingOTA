...
public final class TwoDimensionalFocusSearch {
    ...
    public static final Boolean m2584twoDimensionalFocusSearchOMvw8(FocusTargetModifierNode twoDimensionalFocusSearch, int i, Function1<? super FocusTargetModifierNode, Boolean> onFound) {
        ...
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m2580findChildCorrespondingToFocusEnterOMvw8(twoDimensionalFocusSearch, i, onFound));
            }
            if (i2 == 4) {
        ...
        FocusTargetModifierNode activeChild = FocusTraversal.getActiveChild(twoDimensionalFocusSearch);
        if (activeChild == null) {
        ...
        if (i3 != 1) {
            if (i3 == 2 || i3 == 3) {
                return Boolean.valueOf(m2581generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeChild, i, onFound));
            }
            if (i3 == 4) {
                throw new IllegalStateException(NoActiveChild.toString());
            }
        ...
        Boolean m2584twoDimensionalFocusSearchOMvw8 = m2584twoDimensionalFocusSearchOMvw8(activeChild, i, onFound);
        if (Intrinsics.areEqual((Object) m2584twoDimensionalFocusSearchOMvw8, (Object) false)) {
            FocusRequester invoke = activeChild.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2540boximpl(i));
            ...
            return Boolean.valueOf(m2581generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeNode(activeChild), i, onFound));
        }
        return m2584twoDimensionalFocusSearchOMvw8;
    }
    ...
    public static final boolean m2580findChildCorrespondingToFocusEnterOMvw8(FocusTargetModifierNode findChildCorrespondingToFocusEnter, int i, Function1<? super FocusTargetModifierNode, Boolean> onFound) {
        Rect bottomRight;
        Intrinsics.checkNotNullParameter(findChildCorrespondingToFocusEnter, "$this$findChildCorrespondingToFocusEnter");
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        FocusRequester invoke = findChildCorrespondingToFocusEnter.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2540boximpl(i));
        if (Intrinsics.areEqual(invoke, FocusRequester.Companion.getDefault())) {
            invoke = null;
        }
        FocusRequester focusRequester = invoke;
        ...
        if (mutableVector.getSize() > 1) {
            if (FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2552getEnterdhqQ8s())) {
                i = FocusDirection.Companion.m2559getRightdhqQ8s();
            }
            if (FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2559getRightdhqQ8s()) ? true : FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2551getDowndhqQ8s())) {
                bottomRight = topLeft(FocusTraversal.focusRect(findChildCorrespondingToFocusEnter));
            } else {
                if (!(FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2555getLeftdhqQ8s()) ? true : FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2560getUpdhqQ8s()))) {
                    throw new IllegalStateException(InvalidFocusDirection.toString());
                }
                bottomRight = bottomRight(FocusTraversal.focusRect(findChildCorrespondingToFocusEnter));
            }
            FocusTargetModifierNode m2579findBestCandidate4WY_MpI = m2579findBestCandidate4WY_MpI(mutableVector, bottomRight, i);
            if (m2579findBestCandidate4WY_MpI != null) {
                return onFound.invoke(m2579findBestCandidate4WY_MpI).booleanValue();
            }
            return false;
        }
    ...
    private static final boolean m2581generateAndSearchChildren4C6V_qg(final FocusTargetModifierNode focusTargetModifierNode, final FocusTargetModifierNode focusTargetModifierNode2, final int i, final Function1<? super FocusTargetModifierNode, Boolean> function1) {
        if (m2583searchChildren4C6V_qg(focusTargetModifierNode, focusTargetModifierNode2, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayout.m2539searchBeyondBoundsOMvw8(focusTargetModifierNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
                boolean m2583searchChildren4C6V_qg;
                Intrinsics.checkNotNullParameter(searchBeyondBounds, "$this$searchBeyondBounds");
                m2583searchChildren4C6V_qg = TwoDimensionalFocusSearch.m2583searchChildren4C6V_qg(FocusTargetModifierNode.this, focusTargetModifierNode2, i, function1);
                Boolean valueOf = Boolean.valueOf(m2583searchChildren4C6V_qg);
    ...
    private static final FocusTargetModifierNode m2579findBestCandidate4WY_MpI(MutableVector<FocusTargetModifierNode> mutableVector, Rect rect, int i) {
        Rect translate;
        if (FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2555getLeftdhqQ8s())) {
            ...
            translate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2560getUpdhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversal.isEligibleForFocusSearch(focusTargetModifierNode2)) {
                    Rect focusRect = FocusTraversal.focusRect(focusTargetModifierNode2);
                    if (m2582isBetterCandidateI7lrPNg(focusRect, translate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float f;
        if (!FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2555getLeftdhqQ8s())) {
            if (FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2559getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float left2;
        float width;
        if (FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2555getLeftdhqQ8s()) ? true : FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2559getRightdhqQ8s())) {
            f = 2;
            left = rect2.getTop() + (rect2.getHeight() / f);
            left2 = rect.getTop();
            width = rect.getHeight();
        } else {
            if (!(FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2560getUpdhqQ8s()) ? true : FocusDirection.m2543equalsimpl0(i, FocusDirection.Companion.m2551getDowndhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m2582isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m2578beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m2578beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    private static final FocusTargetModifierNode activeNode(FocusTargetModifierNode focusTargetModifierNode) {
        ...
        FocusTargetModifierNode findActiveFocusNode = FocusTraversal.findActiveFocusNode(focusTargetModifierNode);
    ...
    public static final boolean m2583searchChildren4C6V_qg(FocusTargetModifierNode focusTargetModifierNode, FocusTargetModifierNode focusTargetModifierNode2, int i, Function1<? super FocusTargetModifierNode, Boolean> function1) {
        FocusTargetModifierNode m2579findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetModifierNode[16], 0);
        ...
        while (mutableVector.isNotEmpty() && (m2579findBestCandidate4WY_MpI = m2579findBestCandidate4WY_MpI(mutableVector, FocusTraversal.focusRect(focusTargetModifierNode2), i)) != null) {
            if (m2579findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(m2579findBestCandidate4WY_MpI).booleanValue();
            }
            FocusRequester invoke = m2579findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2540boximpl(i));
            if (Intrinsics.areEqual(invoke, FocusRequester.Companion.getDefault())) {
                invoke = null;
            }
            FocusRequester focusRequester = invoke;
            ...
            } else if (m2581generateAndSearchChildren4C6V_qg(m2579findBestCandidate4WY_MpI, focusTargetModifierNode2, i, function1)) {
                return true;
            } else {
                mutableVector.remove(m2579findBestCandidate4WY_MpI);
            }
        }
        return false;
    }
    ...
    */
    private static final void collectAccessibleChildren(androidx.compose.p002ui.node.DelegatableNode r9, androidx.compose.runtime.collection.MutableVector<androidx.compose.p002ui.focus.FocusTargetModifierNode> r10) {
        /*
            ...
            androidx.compose.p002ui.node.DelegatableNodeKt.access$addLayoutNodeChildren(r1, r9)
            goto L2f
        L2c:
            r1.add(r2)
        L2f:
        ...
        L6f:
            ...
            int r6 = r6.m2552getEnterdhqQ8s()
            androidx.compose.ui.focus.FocusDirection r6 = androidx.compose.p002ui.focus.FocusDirection.m2540boximpl(r6)
        ...
        L96:
            ...
            if (r5 == 0) goto Lc2
            androidx.compose.ui.focus.FocusRequester$Companion r6 = androidx.compose.p002ui.focus.FocusRequester.Companion
        ...
        Lb5:
            ...
            androidx.compose.ui.node.DelegatableNode r8 = (androidx.compose.p002ui.node.DelegatableNode) r8
        ...
        Ld1:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.focus.TwoDimensionalFocusSearch.collectAccessibleChildren(androidx.compose.ui.node.DelegatableNode, androidx.compose.runtime.collection.MutableVector):void");
    }
}
