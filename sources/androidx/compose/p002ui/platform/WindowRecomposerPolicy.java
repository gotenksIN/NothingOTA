...
public final class WindowRecomposerPolicy {
    ...
    public final boolean compareAndSetFactory(WindowRecomposerFactory expected, WindowRecomposerFactory factory2) {
        ...
        Intrinsics.checkNotNullParameter(factory2, "factory");
        return MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m295m(factory, expected, factory2);
    }
    ...
    public final <R> R withFactory(WindowRecomposerFactory factory2, Functions<? extends R> block) {
        Intrinsics.checkNotNullParameter(factory2, "factory");
        ...
        try {
            ...
            try {
                ...
                Exceptions.addSuppressed(th, new IllegalStateException("WindowRecomposerFactory was set to unexpected value; cannot safely restore old state"));
                throw th;
            }
        }
    }
    ...
    public final Recomposer createAndInstallWindowRecomposer$ui_release(View rootView) {
        ...
        launch$default = BuildersKt__Builders_commonKt.launch$default(globalScope, HandlerDispatcherKt.from(handler, "windowRecomposer cleanup").getImmediate(), null, new C0761xbfd085b3(createRecomposer, rootView, null), 2, null);
