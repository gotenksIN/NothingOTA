...
public final class WrappedComposition implements Composition, LifecycleEventObserver {
    ...
    public WrappedComposition(AndroidComposeView owner, Composition original) {
        ...
        this.lastContent = ComposableSingletons$Wrapper_androidKt.INSTANCE.m4661getLambda1$ui_release();
    }
                    ...
                    original.setContent(ComposableLambdaKt.composableLambdaInstance(-2000640158, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition$setContent$1.1
                        ...
                        public final void invoke(Composer composer, int i) {
                            ...
                            if ((i & 11) != 2 || !composer.getSkipping()) {
                                ...
                                Object tag = WrappedComposition.this.getOwner().getTag(C0684R.C0685id.inspection_slot_table_set);
                                ...
                                if (set == null) {
                                    ...
                                    Object tag2 = view != null ? view.getTag(C0684R.C0685id.inspection_slot_table_set) : null;
                                ...
                                EffectsKt.LaunchedEffect(WrappedComposition.this.getOwner(), new C07691(WrappedComposition.this, null), composer, 72);
                                ProvidedValue[] providedValueArr = {InspectionTables.getLocalInspectionTables().provides(set)};
                        ...
                        @DebugMetadata(m31c = "androidx.compose.ui.platform.WrappedComposition$setContent$1$1$1", m30f = "Wrapper.android.kt", m29i = {}, m28l = {153}, m27m = "invokeSuspend", m26n = {}, m25s = {})
                        ...
                        public static final class C07691 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            C07691(WrappedComposition wrappedComposition, Continuation<? super C07691> continuation) {
                            ...
                            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                return new C07691(this.this$0, continuation);
                            }
    ...
    public void dispose() {
        if (!this.disposed) {
            this.disposed = true;
            this.owner.getView().setTag(C0684R.C0685id.wrapped_composition_tag, null);
