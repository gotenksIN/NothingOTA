...
public final class CollectionInfo {
    public static final void setCollectionInfo(SemanticsNode node, AccessibilityNodeInfoCompat info) {
        ...
        androidx.compose.p002ui.semantics.CollectionInfo collectionInfo = (androidx.compose.p002ui.semantics.CollectionInfo) SemanticsConfigurationKt.getOrNull(node.getConfig(), SemanticsProperties.INSTANCE.getCollectionInfo());
    ...
    public static final void setCollectionItemInfo(SemanticsNode node, AccessibilityNodeInfoCompat info) {
        ...
        androidx.compose.p002ui.semantics.CollectionInfo collectionInfo = (androidx.compose.p002ui.semantics.CollectionInfo) SemanticsConfigurationKt.getOrNull(parent.getConfig(), SemanticsProperties.INSTANCE.getCollectionInfo());
    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                emptyList.add(Offset.m2608boximpl(OffsetKt.Offset(Math.abs(Offset.m2619getXimpl(semanticsNode4.getBoundsInRoot().m2649getCenterF1C5BW0()) - Offset.m2619getXimpl(semanticsNode3.getBoundsInRoot().m2649getCenterF1C5BW0())), Math.abs(Offset.m2620getYimpl(semanticsNode4.getBoundsInRoot().m2649getCenterF1C5BW0()) - Offset.m2620getYimpl(semanticsNode3.getBoundsInRoot().m2649getCenterF1C5BW0())))));
                semanticsNode = semanticsNode2;
            }
        }
        if (emptyList.size() == 1) {
            m2629unboximpl = ((Offset) CollectionsKt.first((List<? extends Object>) emptyList)).m2629unboximpl();
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m2608boximpl(Offset.m2624plusMKHz9U(((Offset) first).m2629unboximpl(), ((Offset) emptyList.get(i2)).m2629unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
            ...
            m2629unboximpl = ((Offset) first).m2629unboximpl();
        }
        return Offset.m2610component2impl(m2629unboximpl) < Offset.m2609component1impl(m2629unboximpl);
    }

    private static final boolean isLazyCollection(androidx.compose.p002ui.semantics.CollectionInfo collectionInfo) {
        return collectionInfo.getRowCount() < 0 || collectionInfo.getColumnCount() < 0;
    }

    private static final AccessibilityNodeInfoCompat.CollectionInfoCompat toAccessibilityCollectionInfo(androidx.compose.p002ui.semantics.CollectionInfo collectionInfo) {
