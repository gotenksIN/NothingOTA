...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> drawBlock, Functions<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m3238getCenterSzJe1aQ();
    ...
    /* compiled from: ViewLayer.android.kt */
    @Metadata(m41d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\u0007"}, m40d2 = {"Landroidx/compose/ui/platform/ViewLayer$UniqueDrawingIdApi29;", "", "()V", "getUniqueDrawingId", "", "view", "Landroid/view/View;", "ui_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
    ...
    public void mo4625updateLayerPropertiesdDxrwY(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, LayoutDirection layoutDirection, Density density) {
        ...
        setRotationX(f7);
        setRotationY(f8);
        setPivotX(TransformOrigin.m3233getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
        setPivotY(TransformOrigin.m3234getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        setCameraDistancePx(f10);
        boolean z2 = true;
        this.clipToBounds = z && shape == RectangleShape.getRectangleShape();
        resetClipBounds();
        boolean z3 = getManualClipPath() != null;
        setClipToOutline(z && shape != RectangleShape.getRectangleShape());
        ...
        if (!this.drawnWithZ && getElevation() > 0.0f && (functions = this.invalidateParentLayer) != null) {
            functions.invoke();
        }
        this.matrixCache.invalidate();
        if (Build.VERSION.SDK_INT >= 28) {
            ViewLayer viewLayer = this;
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(viewLayer, ColorKt.m2911toArgb8_81llA(j2));
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(viewLayer, ColorKt.m2911toArgb8_81llA(j3));
        }
        if (Build.VERSION.SDK_INT >= 31) {
            ViewLayerVerificationHelper31.INSTANCE.setRenderEffect(this, renderEffect);
        }
        if (CompositingStrategy.m2937equalsimpl0(i, CompositingStrategy.Companion.m2943getOffscreenNrFUSI())) {
            setLayerType(2, null);
        } else if (CompositingStrategy.m2937equalsimpl0(i, CompositingStrategy.Companion.m2942getModulateAlphaNrFUSI())) {
            setLayerType(0, null);
            z2 = false;
        } else {
            setLayerType(0, null);
    ...
    public boolean mo4620isInLayerk4lQ0M(long j) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= m2619getXimpl && m2619getXimpl < ((float) getWidth()) && 0.0f <= m2620getYimpl && m2620getYimpl < ((float) getHeight());
    ...
    public void mo4623resizeozmzZPI(long j) {
        ...
        if (m5511getWidthimpl == getWidth() && m5510getHeightimpl == getHeight()) {
            return;
        }
        float f = m5511getWidthimpl;
        setPivotX(TransformOrigin.m3233getPivotFractionXimpl(this.mTransformOrigin) * f);
        float f2 = m5510getHeightimpl;
        setPivotY(TransformOrigin.m3234getPivotFractionYimpl(this.mTransformOrigin) * f2);
        this.outlineResolver.m4707updateuvyYCjk(SizeKt.Size(f, f2));
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + m5511getWidthimpl, getTop() + m5510getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo4622movegyyYBs(long j) {
        ...
        if (m5469getXimpl != getLeft()) {
            offsetLeftAndRight(m5469getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m5470getYimpl = IntOffset.m5470getYimpl(j);
        if (m5470getYimpl != getTop()) {
            offsetTopAndBottom(m5470getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    @Override // android.view.View, androidx.compose.p002ui.node.OwnedLayer
    ...
    public long mo4621mapOffset8S9VItk(long j, boolean z) {
        ...
        return androidx.compose.p002ui.graphics.Matrix.m3087mapMKHz9U(this.matrixCache.m4684calculateMatrixGrdbGEg(this), j);
    }
    ...
    public void mapBounds(MutableRect rect, boolean z) {
        ...
        androidx.compose.p002ui.graphics.Matrix.m3089mapimpl(this.matrixCache.m4684calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4624transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.p002ui.graphics.Matrix.m3098timesAssign58bKbWc(matrix, this.matrixCache.m4684calculateMatrixGrdbGEg(this));
    }
    ...
    /* compiled from: ViewLayer.android.kt */
    @Metadata(m41d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0019\u001a\u00020\u000b2\u0006\u0010\u001a\u001a\u00020\tH\u0007R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006R \u0010\u0007\u001a\u0014\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\u000b0\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u001e\u0010\u000e\u001a\u00020\r2\u0006\u0010\f\u001a\u00020\r@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0010R\u0010\u0010\u0011\u001a\u0004\u0018\u00010\u0012X\u0082\u000e¢\u0006\u0002\n\u0000R$\u0010\u0013\u001a\u00020\r2\u0006\u0010\f\u001a\u00020\r@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0014\u0010\u0010\"\u0004\b\u0015\u0010\u0016R\u0010\u0010\u0017\u001a\u0004\u0018\u00010\u0018X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001b"}, m40d2 = {"Landroidx/compose/ui/platform/ViewLayer$Companion;", "", "()V", "OutlineProvider", "Landroid/view/ViewOutlineProvider;", "getOutlineProvider", "()Landroid/view/ViewOutlineProvider;", "getMatrix", "Lkotlin/Function2;", "Landroid/view/View;", "Landroid/graphics/Matrix;", "", "<set-?>", "", "hasRetrievedMethod", "getHasRetrievedMethod", "()Z", "recreateDisplayList", "Ljava/lang/reflect/Field;", "shouldUseDispatchDraw", "getShouldUseDispatchDraw", "setShouldUseDispatchDraw$ui_release", "(Z)V", "updateDisplayListIfDirtyMethod", "Ljava/lang/reflect/Method;", "updateDisplayList", "view", "ui_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
