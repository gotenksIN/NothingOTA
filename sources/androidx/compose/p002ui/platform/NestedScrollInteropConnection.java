...
public final class NestedScrollInteropConnection implements NestedScrollModifier {
    ...
    public long mo611onPreScrollOzD1aCk(long j, int i) {
        int m4702getScrollAxesk4lQ0M;
        int m4704toViewTypeGyEprt8;
        int m4704toViewTypeGyEprt82;
        long m4703toOffsetUv8p0NA;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        m4702getScrollAxesk4lQ0M = NestedScrollInteropConnectionKt.m4702getScrollAxesk4lQ0M(j);
        m4704toViewTypeGyEprt8 = NestedScrollInteropConnectionKt.m4704toViewTypeGyEprt8(i);
        if (nestedScrollingChildHelper.startNestedScroll(m4702getScrollAxesk4lQ0M, m4704toViewTypeGyEprt8)) {
            ...
            int composeToViewOffset = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2619getXimpl(j));
            int composeToViewOffset2 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2620getYimpl(j));
            int[] iArr = this.consumedScrollCache;
            m4704toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m4704toViewTypeGyEprt8(i);
            nestedScrollingChildHelper2.dispatchNestedPreScroll(composeToViewOffset, composeToViewOffset2, iArr, null, m4704toViewTypeGyEprt82);
            m4703toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m4703toOffsetUv8p0NA(this.consumedScrollCache, j);
            return m4703toOffsetUv8p0NA;
        }
    ...
    public long mo610onPostScrollDzOQY0M(long j, long j2, int i) {
        ...
        long m4703toOffsetUv8p0NA;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        m4702getScrollAxesk4lQ0M = NestedScrollInteropConnectionKt.m4702getScrollAxesk4lQ0M(j2);
        m4704toViewTypeGyEprt8 = NestedScrollInteropConnectionKt.m4704toViewTypeGyEprt8(i);
        if (nestedScrollingChildHelper.startNestedScroll(m4702getScrollAxesk4lQ0M, m4704toViewTypeGyEprt8)) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            NestedScrollingChildHelper nestedScrollingChildHelper2 = this.nestedScrollChildHelper;
            int composeToViewOffset = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2619getXimpl(j));
            int composeToViewOffset2 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2620getYimpl(j));
            int composeToViewOffset3 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2619getXimpl(j2));
            int composeToViewOffset4 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2620getYimpl(j2));
            m4704toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m4704toViewTypeGyEprt8(i);
            nestedScrollingChildHelper2.dispatchNestedScroll(composeToViewOffset, composeToViewOffset2, composeToViewOffset3, composeToViewOffset4, null, m4704toViewTypeGyEprt82, this.consumedScrollCache);
            m4703toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m4703toOffsetUv8p0NA(this.consumedScrollCache, j2);
            return m4703toOffsetUv8p0NA;
        }
        return Offset.Companion.m2635getZeroF1C5BW0();
    }
    ...
    public Object mo780onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        ...
        float viewVelocity2;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        viewVelocity = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5576getXimpl(j));
        viewVelocity2 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5577getYimpl(j));
    ...
    public Object mo609onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        float viewVelocity2;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        viewVelocity = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5576getXimpl(j2));
        viewVelocity2 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5577getYimpl(j2));
        if (!nestedScrollingChildHelper.dispatchNestedFling(viewVelocity, viewVelocity2, true)) {
            j2 = Velocity.Companion.m5587getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
