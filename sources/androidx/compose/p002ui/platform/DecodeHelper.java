...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte != 1) {
                ...
                if (decodeByte == 2) {
                    ...
                    mutableSpanStyle.m4695setFontSizeR2X_6o(m4667decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m4696setFontStylemLjRB2g(FontStyle.m4970boximpl(m4665decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (decodeByte != 8) {
                                if (decodeByte != 9) {
                                    if (decodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m4692setBackground8_81llA(m4664decodeColor0d7_KjU());
                                    }
                                } else if (dataAvailable() < 8) {
                                    break;
                                } else {
                                ...
                                mutableSpanStyle.m4693setBaselineShift_isdbwI(BaselineShift.m5134boximpl(m4662decodeBaselineShifty9eOQZs()));
                            }
                        } else if (dataAvailable() < 5) {
                            break;
                        } else {
                            mutableSpanStyle.m4698setLetterSpacingR2X_6o(m4667decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m4697setFontSynthesistDdu0R4(FontSynthesis.m4979boximpl(m4666decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else if (dataAvailable() < 8) {
                break;
            } else {
                mutableSpanStyle2.m4694setColor8_81llA(m4664decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m4664decodeColor0d7_KjU() {
        return Color.m2853constructorimpl(m4663decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE  reason: not valid java name */
    public final long m4667decodeTextUnitXSAIIZE() {
        long m5566getUnspecifiedUIouoOA;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            m5566getUnspecifiedUIouoOA = TextUnitType.Companion.m5565getSpUIouoOA();
        } else if (decodeByte == 2) {
            m5566getUnspecifiedUIouoOA = TextUnitType.Companion.m5564getEmUIouoOA();
        } else {
            m5566getUnspecifiedUIouoOA = TextUnitType.Companion.m5566getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m5560equalsimpl0(m5566getUnspecifiedUIouoOA, TextUnitType.Companion.m5566getUnspecifiedUIouoOA())) {
            return TextUnit.Companion.m5543getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m5544TextUnitanM5pPY(decodeFloat(), m5566getUnspecifiedUIouoOA);
    }
    ...
    public final int m4665decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.Companion.m4978getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.Companion.m4977getItalic_LCdwA();
        }
        return FontStyle.Companion.m4978getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m4666decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.Companion.m4989getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.Companion.m4988getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.Companion.m4990getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.Companion.m4991getWeightGVVA2EU();
        }
        return FontSynthesis.Companion.m4989getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs  reason: not valid java name */
    private final float m4662decodeBaselineShifty9eOQZs() {
        return BaselineShift.m5135constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m4664decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m4663decodeULongsVKNKU() {
        return ULong.m5823constructorimpl(this.parcel.readLong());
    }
