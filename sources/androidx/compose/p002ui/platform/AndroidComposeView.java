...
import androidx.compose.p002ui.input.pointer.InternalPointerInput;
...
import androidx.compose.p002ui.input.rotary.RotaryInputModifier;
...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    private final MutableVector<Functions<Unit>> endApplyChangesListeners;
    private final FocusOwner focusOwner;
    private final SnapshotState fontFamilyResolver$delegate;
    ...
    private final SnapshotState layoutDirection$delegate;
    ...
    private final Functions<Unit> resendMotionEventOnLayout;
    ...
    private final SnapshotState viewTreeOwners$delegate;
    ...
    @Override // androidx.compose.p002ui.node.Owner
    ...
    public AndroidComposeView(Context context) {
        ...
        this.lastDownPointerPosition = Offset.Companion.m2634getUnspecifiedF1C5BW0();
        ...
        this.focusOwner = new FocusOwnerImpl(new Function1<Functions<? extends Unit>, Unit>() { // from class: androidx.compose.ui.platform.AndroidComposeView$focusOwner$1
            ...
            /* renamed from: invoke  reason: avoid collision after fix types in other method */
            public final void invoke2(Functions<Unit> it) {
                Intrinsics.checkNotNullParameter(it, "it");
                AndroidComposeView.this.registerOnEndApplyChangesListener(it);
            }
        });
        this._windowInfo = new WindowInfoImpl();
        Modifier onKeyEvent = KeyInputModifier.onKeyEvent(Modifier.Companion, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m4650invokeZmokQxo(keyEvent.m4114unboximpl());
            }

            /* renamed from: invoke-ZmokQxo  reason: not valid java name */
            public final Boolean m4650invokeZmokQxo(android.view.KeyEvent it) {
                Intrinsics.checkNotNullParameter(it, "it");
                FocusDirection mo4628getFocusDirectionP8AzH3I = AndroidComposeView.this.mo4628getFocusDirectionP8AzH3I(it);
                if (mo4628getFocusDirectionP8AzH3I == null || !KeyEventType.m4118equalsimpl0(KeyEvent_androidKt.m4126getTypeZmokQxo(it), KeyEventType.Companion.m4122getKeyDownCS__XNY())) {
                    return false;
                }
                return Boolean.valueOf(AndroidComposeView.this.getFocusOwner().mo2561moveFocus3ESFkO8(mo4628getFocusDirectionP8AzH3I.m2546unboximpl()));
            }
        });
        this.keyInputModifier = onKeyEvent;
        Modifier onRotaryScrollEvent = RotaryInputModifier.onRotaryScrollEvent(Modifier.Companion, new Function1<RotaryScrollEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$rotaryInputModifier$1
            @Override // kotlin.jvm.functions.Function1
        ...
        this.viewToWindowMatrix = Matrix.m3081constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m3081constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.Companion.m2633getInfiniteF1C5BW0();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.Companion.m3523getTouchaOaMEAU() : InputMode.Companion.m3522getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m4649invokeiuPiT84(inputMode.m3521unboximpl());
            }

            /* renamed from: invoke-iuPiT84  reason: not valid java name */
            public final Boolean m4649invokeiuPiT84(int i) {
                boolean requestFocusFromTouch;
                if (InputMode.m3518equalsimpl0(i, InputMode.Companion.m3523getTouchaOaMEAU())) {
                    requestFocusFromTouch = AndroidComposeView.this.isInTouchMode();
                } else {
                    requestFocusFromTouch = InputMode.m3518equalsimpl0(i, InputMode.Companion.m3522getKeyboardaOaMEAU()) ? AndroidComposeView.this.isInTouchMode() ? AndroidComposeView.this.requestFocusFromTouch() : true : false;
                }
        ...
        this.endApplyChangesListeners = new MutableVector<>(new Functions[16], 0);
        ...
        this.resendMotionEventOnLayout = new Functions<Unit>() { // from class: androidx.compose.ui.platform.AndroidComposeView$resendMotionEventOnLayout$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        this.pointerIconService = new PointerIconService() { // from class: androidx.compose.ui.platform.AndroidComposeView$pointerIconService$1
            @Override // androidx.compose.p002ui.input.pointer.PointerIconService
    ...
    @Override // androidx.compose.p002ui.platform.ViewRootForTest
    public View getView() {
        return this;
    }

    @Override // androidx.compose.p002ui.node.Owner, androidx.compose.p002ui.node.RootForTest
    ...
    @Override // androidx.compose.p002ui.node.RootForTest
    ...
    public static final void touchModeChangeListener$lambda$3(AndroidComposeView this$0, boolean z) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0._inputModeManager.m3526setInputModeiuPiT84(z ? InputMode.Companion.m3523getTouchaOaMEAU() : InputMode.Companion.m3522getKeyboardaOaMEAU());
    }
    ...
    @Override // android.view.View, android.view.ViewParent, androidx.compose.p002ui.node.Owner
    ...
    public static final void sendHoverExitEvent$lambda$5(AndroidComposeView this$0) {
        ...
        this$0.m4648sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public boolean mo4630sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return getFocusOwner().mo2562dispatchKeyEventZmokQxo(keyEvent);
    }
    ...
    public boolean dispatchKeyEvent(android.view.KeyEvent event) {
        ...
        if (isFocused()) {
            this._windowInfo.m4714setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4320constructorimpl(event.getMetaState()));
            return mo4630sendKeyEventZmokQxo(KeyEvent.m4109constructorimpl(event));
        }
    ...
    public void onEndApplyChanges() {
        ...
        while (this.endApplyChangesListeners.isNotEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                Functions<Unit> functions = this.endApplyChangesListeners.getContent()[i];
    ...
    @Override // androidx.compose.p002ui.node.Owner
    public void registerOnEndApplyChangesListener(Functions<Unit> listener) {
            ...
            */
            public void onInitializeAccessibilityNodeInfo(android.view.View r3, androidx.core.view.accessibility.AccessibilityNodeInfoCompat r4) {
                /*
                    ...
                    androidx.compose.ui.node.LayoutNode r3 = androidx.compose.p002ui.node.LayoutNode.this
                    androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1 r0 = new kotlin.jvm.functions.Function1<androidx.compose.p002ui.node.LayoutNode, java.lang.Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1
                        static {
                            /*
                                ...
                                return
                            */
                            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.platform.C0716x60998eaf.<clinit>():void");
                        }

                        {
                            /*
                                ...
                                return
                            */
                            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.platform.C0716x60998eaf.<init>():void");
                        }
                        ...
                        public final java.lang.Boolean invoke(androidx.compose.p002ui.node.LayoutNode r2) {
                            ...
                            Le:
                                ...
                                return r2
                            */
                            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.platform.C0716x60998eaf.invoke(androidx.compose.ui.node.LayoutNode):java.lang.Boolean");
                        }
                        ...
                        public /* bridge */ /* synthetic */ java.lang.Boolean invoke(androidx.compose.p002ui.node.LayoutNode r1) {
                            /*
                                ...
                                return r1
                            */
                            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.platform.C0716x60998eaf.invoke(java.lang.Object):java.lang.Object");
                        }
                    }
                    kotlin.jvm.functions.Function1 r0 = (kotlin.jvm.functions.Function1) r0
                    androidx.compose.ui.node.LayoutNode r3 = androidx.compose.p002ui.semantics.SemanticsNodeKt.findClosestParentNode(r3, r0)
                    if (r3 == 0) goto L22
                ...
                L3e:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.platform.AndroidComposeView$addAndroidView$1.onInitializeAccessibilityNodeInfo(android.view.View, androidx.core.view.accessibility.AccessibilityNodeInfoCompat):void");
            }
        });
    }
    ...
    public final void removeAndroidView(final AndroidViewHolder view) {
        Intrinsics.checkNotNullParameter(view, "view");
        registerOnEndApplyChangesListener(new Functions<Unit>() { // from class: androidx.compose.ui.platform.AndroidComposeView$removeAndroidView$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
    ...
    private final Tuples<Integer, Integer> convertMeasureSpec(int i) {
        int mode = View.MeasureSpec.getMode(i);
        int size = View.MeasureSpec.getSize(i);
        if (mode != Integer.MIN_VALUE) {
            if (mode != 0) {
                if (mode == 1073741824) {
                    return TuplesKt.m33to(Integer.valueOf(size), Integer.valueOf(size));
                }
                throw new IllegalStateException();
            }
            return TuplesKt.m33to(0, Integer.MAX_VALUE);
        }
        return TuplesKt.m33to(0, Integer.valueOf(size));
    }
    ...
    private final void updatePositionCacheAndDispatch() {
        ...
        int m5461component1impl = IntOffset.m5461component1impl(j);
        int m5462component2impl = IntOffset.m5462component2impl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (m5461component1impl != i || m5462component2impl != iArr[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(i, iArr[1]);
            if (m5461component1impl != Integer.MAX_VALUE && m5462component2impl != Integer.MAX_VALUE) {
    ...
    @Override // androidx.compose.p002ui.node.Owner
    public OwnedLayer createLayer(Function1<? super androidx.compose.p002ui.graphics.Canvas, Unit> drawBlock, Functions<Unit> invalidateParentLayer) {
    ...
    public FocusDirection mo4628getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        long m4125getKeyZmokQxo = KeyEvent_androidKt.m4125getKeyZmokQxo(keyEvent);
        if (Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m4053getTabEK5gGoQ())) {
            return FocusDirection.m2540boximpl(KeyEvent_androidKt.m4131isShiftPressedZmokQxo(keyEvent) ? FocusDirection.Companion.m2558getPreviousdhqQ8s() : FocusDirection.Companion.m2556getNextdhqQ8s());
        } else if (Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m3894getDirectionRightEK5gGoQ())) {
            return FocusDirection.m2540boximpl(FocusDirection.Companion.m2559getRightdhqQ8s());
        } else {
            if (Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m3893getDirectionLeftEK5gGoQ())) {
                return FocusDirection.m2540boximpl(FocusDirection.Companion.m2555getLeftdhqQ8s());
            }
            if (Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m3895getDirectionUpEK5gGoQ())) {
                return FocusDirection.m2540boximpl(FocusDirection.Companion.m2560getUpdhqQ8s());
            }
            if (Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m3890getDirectionDownEK5gGoQ())) {
                return FocusDirection.m2540boximpl(FocusDirection.Companion.m2551getDowndhqQ8s());
            }
            if (Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m3889getDirectionCenterEK5gGoQ()) ? true : Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m3903getEnterEK5gGoQ()) ? true : Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m3995getNumPadEnterEK5gGoQ())) {
                return FocusDirection.m2540boximpl(FocusDirection.Companion.m2552getEnterdhqQ8s());
            }
            if (Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m3832getBackEK5gGoQ()) ? true : Key.m3530equalsimpl0(m4125getKeyZmokQxo, Key.Companion.m3906getEscapeEK5gGoQ())) {
                return FocusDirection.m2540boximpl(FocusDirection.Companion.m2553getExitdhqQ8s());
            }
            return null;
        }
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m3526setInputModeiuPiT84(isInTouchMode() ? InputMode.Companion.m3523getTouchaOaMEAU() : InputMode.Companion.m3522getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent event) {
        ...
        if (event.getActionMasked() == 8) {
            ...
            return ProcessResult.m4345getDispatchedToAPointerInputModifierimpl(m4647handleMotionEvent8iAsVTc(event));
        }
        return super.dispatchGenericMotionEvent(event);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() != 2 || isPositionChanged(motionEvent)) {
            int m4647handleMotionEvent8iAsVTc = m4647handleMotionEvent8iAsVTc(motionEvent);
            if (ProcessResult.m4344getAnyMovementConsumedimpl(m4647handleMotionEvent8iAsVTc)) {
                getParent().requestDisallowInterceptTouchEvent(true);
            }
            return ProcessResult.m4345getDispatchedToAPointerInputModifierimpl(m4647handleMotionEvent8iAsVTc);
        }
        return false;
    }
    ...
    private final int m4647handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        try {
            ...
            int m4648sendMotionEvent8iAsVTc = m4648sendMotionEvent8iAsVTc(motionEvent);
            Trace.endSection();
            AndroidComposeViewVerificationHelperMethodsN.INSTANCE.setPointerIcon(this, this.desiredPointerIcon);
            return m4648sendMotionEvent8iAsVTc;
        } finally {
    ...
    private final int m4648sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        InternalPointerInput internalPointerInput;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m4714setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4320constructorimpl(motionEvent.getMetaState()));
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (convertToPointerInputEvent$ui_release != null) {
            List<InternalPointerInput> pointers = convertToPointerInputEvent$ui_release.getPointers();
            ListIterator<InternalPointerInput> listIterator = pointers.listIterator(pointers.size());
            while (true) {
                if (!listIterator.hasPrevious()) {
                    internalPointerInput = null;
                    break;
                }
                internalPointerInput = listIterator.previous();
            ...
            if (internalPointerInput2 != null) {
                this.lastDownPointerPosition = internalPointerInput2.m4272getPositionF1C5BW0();
            }
            int m4277processBIzXfog = this.pointerInputEventProcessor.m4277processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, isInBounds(motionEvent));
            int actionMasked = motionEvent.getActionMasked();
            if ((actionMasked == 0 || actionMasked == 5) && !ProcessResult.m4345getDispatchedToAPointerInputModifierimpl(m4277processBIzXfog)) {
                this.motionEventAdapter.endStream(motionEvent.getPointerId(motionEvent.getActionIndex()));
                return m4277processBIzXfog;
            }
            return m4277processBIzXfog;
        }
        this.pointerInputEventProcessor.processCancel();
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int i, long j, boolean z) {
        ...
        while (i5 < pointerCount) {
            ...
            long mo4338localToScreenMKHz9U = mo4338localToScreenMKHz9U(OffsetKt.Offset(pointerCoords.x, pointerCoords.y));
            pointerCoords.x = Offset.m2619getXimpl(mo4338localToScreenMKHz9U);
            pointerCoords.y = Offset.m2620getYimpl(mo4338localToScreenMKHz9U);
            i5++;
        }
        ...
        this.pointerInputEventProcessor.m4277processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, true);
        event.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int i) {
        return this.accessibilityDelegate.m4652canScroll0AR0LA0$ui_release(false, i, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int i) {
        return this.accessibilityDelegate.m4652canScroll0AR0LA0$ui_release(true, i, this.lastDownPointerPosition);
    }
    ...
    @Override // androidx.compose.p002ui.input.pointer.PositionCalculator
    /* renamed from: localToScreen-MK-Hz9U */
    public long mo4338localToScreenMKHz9U(long j) {
        recalculateWindowPosition();
        long m3087mapMKHz9U = Matrix.m3087mapMKHz9U(this.viewToWindowMatrix, j);
        return OffsetKt.Offset(Offset.m2619getXimpl(m3087mapMKHz9U) + Offset.m2619getXimpl(this.windowPosition), Offset.m2620getYimpl(m3087mapMKHz9U) + Offset.m2620getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.p002ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo4339screenToLocalMKHz9U(long j) {
        recalculateWindowPosition();
        return Matrix.m3087mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(Offset.m2619getXimpl(j) - Offset.m2619getXimpl(this.windowPosition), Offset.m2620getYimpl(j) - Offset.m2620getYimpl(this.windowPosition)));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long m3087mapMKHz9U = Matrix.m3087mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m2619getXimpl(m3087mapMKHz9U), motionEvent.getRawY() - Offset.m2620getYimpl(m3087mapMKHz9U));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo4657calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrix.m4681invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public long mo4626calculateLocalPositionMKHz9U(long j) {
        recalculateWindowPosition();
        return Matrix.m3087mapMKHz9U(this.windowToViewMatrix, j);
    }

    @Override // androidx.compose.p002ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo4627calculatePositionInWindowMKHz9U(long j) {
        recalculateWindowPosition();
        return Matrix.m3087mapMKHz9U(this.viewToWindowMatrix, j);
    }
    ...
    /* compiled from: AndroidComposeView.android.kt */
    @Metadata(m41d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u000b\u001a\u00020\fH\u0003R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u0004\u0018\u00010\bX\u0082\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\t\u001a\b\u0012\u0002\b\u0003\u0018\u00010\nX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\r"}, m40d2 = {"Landroidx/compose/ui/platform/AndroidComposeView$Companion;", "", "()V", "FocusTag", "", "MaximumLayerCacheSize", "", "getBooleanMethod", "Ljava/lang/reflect/Method;", "systemPropertiesClass", "Ljava/lang/Class;", "getIsShowingLayoutBounds", "", "ui_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
    ...
    public void measureAndLayout(boolean z) {
        ...
        if (z) {
            try {
                functions = this.resendMotionEventOnLayout;
            } catch (Throwable th) {
                Trace.endSection();
                throw th;
            }
        ...
        if (this.measureAndLayoutDelegate.measureAndLayout(functions)) {
            requestLayout();
        }
    ...
    public void mo4629measureAndLayout0kLqBqw(LayoutNode layoutNode, long j) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m4534measureAndLayout0kLqBqw(layoutNode, j);
            MeasureAndLayoutDelegate.dispatchOnPositionedCallbacks$default(this.measureAndLayoutDelegate, false, 1, null);
            Unit unit = Unit.INSTANCE;
        } finally {
            Trace.endSection();
    ...
    protected void onMeasure(int i, int i2) {
        ...
        try {
            ...
            Tuples<Integer, Integer> convertMeasureSpec = convertMeasureSpec(i);
            int intValue = convertMeasureSpec.component1().intValue();
            int intValue2 = convertMeasureSpec.component2().intValue();
            Tuples<Integer, Integer> convertMeasureSpec2 = convertMeasureSpec(i2);
            ...
            boolean z = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m5295boximpl(Constraints);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    z = Constraints.m5300equalsimpl0(constraints.m5313unboximpl(), Constraints);
                }
                if (!z) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m4535updateRootConstraintsBRTryo0(Constraints);
