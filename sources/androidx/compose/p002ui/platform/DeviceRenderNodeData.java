...
public final class DeviceRenderNodeData {
    ...
    public final int m4671component25NrFUSI() {
    ...
    public final DeviceRenderNodeData m4672copyfuCbV5c(long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect, int i9) {
    ...
    public int hashCode() {
        ...
        return ((hashCode2 + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + CompositingStrategy.m2938hashCodeimpl(this.compositingStrategy);
    }
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", compositingStrategy=").append((Object) CompositingStrategy.m2939toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public final int m4673getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE  reason: not valid java name */
    public final void m4674setCompositingStrategyaDBOjCE(int i) {
