...
import androidx.compose.p002ui.text.platform.AndroidMultiParagraphDraw;
...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, boolean z) {
        ...
        this.maxLines = i;
        int i2 = 0;
        if (!(Constraints.m5309getMinWidthimpl(j) == 0 && Constraints.m5308getMinHeightimpl(j) == 0)) {
        ...
        while (i4 < size) {
            ...
            if (Constraints.m5302getHasBoundedHeightimpl(j)) {
                m5306getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m5306getMaxHeightimpl(j) - ParagraphKt.ceilToInt(f), i2);
            } else {
                m5306getMaxHeightimpl = Constraints.m5306getMaxHeightimpl(j);
            }
            Paragraph m4790Paragraph_EkL_Y = ParagraphKt.m4790Paragraph_EkL_Y(intrinsics, ConstraintsKt.Constraints$default(0, m5307getMaxWidthimpl, 0, m5306getMaxHeightimpl, 5, null), this.maxLines - i3, z);
            float height = f + m4790Paragraph_EkL_Y.getHeight();
            int lineCount = i3 + m4790Paragraph_EkL_Y.getLineCount();
            arrayList.add(new ParagraphInfo(m4790Paragraph_EkL_Y, paragraphIntrinsicInfo.getStartIndex(), paragraphIntrinsicInfo.getEndIndex(), i3, lineCount, f, height));
            if (m4790Paragraph_EkL_Y.getDidExceedMaxLines() || (lineCount == this.maxLines && i4 != CollectionsKt.getLastIndex(this.intrinsics.getInfoList$ui_text_release()))) {
                i3 = lineCount;
                f = height;
                z2 = true;
                break;
        ...
        this.width = Constraints.m5307getMaxWidthimpl(j);
    ...
    public static /* synthetic */ void m4776paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        if ((i & 2) != 0) {
            j = Color.Companion.m2893getUnspecified0d7_KjU();
        }
        multiParagraph.m4781paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
    }

    /* renamed from: paint-RPmYEkk  reason: not valid java name */
    public final void m4781paintRPmYEkk(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            paragraphInfo.getParagraph().mo4753paintRPmYEkk(canvas, j, shadow, textDecoration);
    ...
    public final void m4780paintLG529CI(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i2 = 0; i2 < size; i2++) {
            ...
            paragraphInfo.getParagraph().mo4752paintLG529CI(canvas, j, shadow, textDecoration, drawStyle, i);
            canvas.translate(0.0f, paragraphInfo.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m4782painthn5TExg(Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        AndroidMultiParagraphDraw.m5102drawMultiParagraph7AXcY_I(this, canvas, brush, f, shadow, textDecoration, drawStyle, i);
    }
        ...
        if ((!(i >= 0 && i <= i2) || i2 > getAnnotatedString().getText().length()) ? false : false) {
            ...
            for (int findParagraphByIndex = MultiParagraphKt.findParagraphByIndex(this.paragraphInfoList, i); findParagraphByIndex < size; findParagraphByIndex++) {
                ...
                if (paragraphInfo.getStartIndex() != paragraphInfo.getEndIndex()) {
                    Path.m3119addPathUv8p0NA$default(Path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(i), paragraphInfo.toLocalIndex(i2))), 0L, 2, null);
                }
            }
            return Path;
        }
    ...
    public final int m4778getOffsetForPositionk4lQ0M(long j) {
        int lastIndex;
        if (Offset.m2620getYimpl(j) <= 0.0f) {
            lastIndex = 0;
        } else {
            lastIndex = Offset.m2620getYimpl(j) >= this.height ? CollectionsKt.getLastIndex(this.paragraphInfoList) : MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m2620getYimpl(j));
        }
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(lastIndex);
        if (paragraphInfo.getLength() == 0) {
            return Math.max(0, paragraphInfo.getStartIndex() - 1);
        }
        return paragraphInfo.toGlobalIndex(paragraphInfo.getParagraph().mo4750getOffsetForPositionk4lQ0M(paragraphInfo.m4787toLocalMKHz9U(j)));
    }
    ...
    public final long m4779getWordBoundaryjx7JFs(int i) {
        int findParagraphByIndex;
        requireIndexInRangeInclusiveEnd(i);
        if (i == getAnnotatedString().length()) {
            findParagraphByIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(findParagraphByIndex);
        return paragraphInfo.m4786toGlobalGEjPoXI(paragraphInfo.getParagraph().mo4751getWordBoundaryjx7JFs(paragraphInfo.toLocalIndex(i)));
    }
