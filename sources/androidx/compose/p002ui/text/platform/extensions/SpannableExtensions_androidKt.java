...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float m5532getValueimpl;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        Intrinsics.checkNotNullParameter(density, "density");
        if (textIndent != null) {
            if ((TextUnit.m5529equalsimpl0(textIndent.m5267getFirstLineXSAIIZE(), TextUnitKt.getSp(0)) && TextUnit.m5529equalsimpl0(textIndent.m5268getRestLineXSAIIZE(), TextUnitKt.getSp(0))) || TextUnitKt.m5550isUnspecifiedR2X_6o(textIndent.m5267getFirstLineXSAIIZE()) || TextUnitKt.m5550isUnspecifiedR2X_6o(textIndent.m5268getRestLineXSAIIZE())) {
                return;
            }
            long m5531getTypeUIouoOA = TextUnit.m5531getTypeUIouoOA(textIndent.m5267getFirstLineXSAIIZE());
            float f2 = 0.0f;
            if (TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA, TextUnitType.Companion.m5565getSpUIouoOA())) {
                m5532getValueimpl = density.mo602toPxR2X_6o(textIndent.m5267getFirstLineXSAIIZE());
            } else {
                m5532getValueimpl = TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA, TextUnitType.Companion.m5564getEmUIouoOA()) ? TextUnit.m5532getValueimpl(textIndent.m5267getFirstLineXSAIIZE()) * f : 0.0f;
            }
            long m5531getTypeUIouoOA2 = TextUnit.m5531getTypeUIouoOA(textIndent.m5268getRestLineXSAIIZE());
            if (TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA2, TextUnitType.Companion.m5565getSpUIouoOA())) {
                f2 = density.mo602toPxR2X_6o(textIndent.m5268getRestLineXSAIIZE());
            } else if (TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA2, TextUnitType.Companion.m5564getEmUIouoOA())) {
                f2 = TextUnit.m5532getValueimpl(textIndent.m5268getRestLineXSAIIZE()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(m5532getValueimpl), (int) Math.ceil(f2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE  reason: not valid java name */
    public static final void m5127setLineHeightKmRG4DE(Spannable setLineHeight, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float m5122resolveLineHeightInPxo2QH7mI = m5122resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m5122resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable = setLineHeight;
        setSpan(setLineHeight, new LineHeightStyleSpan(m5122resolveLineHeightInPxo2QH7mI, 0, ((spannable.length() == 0) || StringsKt.last(spannable) == '\n') ? setLineHeight.length() + 1 : setLineHeight.length(), LineHeightStyle.Trim.m5230isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.m5209getTrimEVpEnUU()), LineHeightStyle.Trim.m5231isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.m5209getTrimEVpEnUU()), lineHeightStyle.m5208getAlignmentPIaL0Z0()), 0, setLineHeight.length());
    }

    /* renamed from: setLineHeight-r9BaKPg  reason: not valid java name */
    public static final void m5128setLineHeightr9BaKPg(Spannable setLineHeight, long j, float f, Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float m5122resolveLineHeightInPxo2QH7mI = m5122resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m5122resolveLineHeightInPxo2QH7mI)) {
        ...
        setSpan(setLineHeight, new LineHeightSpan(m5122resolveLineHeightInPxo2QH7mI), 0, setLineHeight.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI  reason: not valid java name */
    private static final float m5122resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        long m5531getTypeUIouoOA = TextUnit.m5531getTypeUIouoOA(j);
        if (TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA, TextUnitType.Companion.m5565getSpUIouoOA())) {
            return density.mo602toPxR2X_6o(j);
        }
        if (TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA, TextUnitType.Companion.m5564getEmUIouoOA())) {
            return TextUnit.m5532getValueimpl(j) * f;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        MetricAffectingSpan m5121createLetterSpacingSpaneAf_CNQ;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (m5121createLetterSpacingSpaneAf_CNQ = m5121createLetterSpacingSpaneAf_CNQ(item.m4852getLetterSpacingXSAIIZE(), density)) != null) {
                    setSpan(spannable, m5121createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m5124setBaselineShift0ocSgnM(spannable, item.m4847getBaselineShift5SSeXJ0(), start, end);
        m5125setColorRPmYEkk(spannable, item.m4848getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m5126setFontSizeKmRG4DE(spannable, item.m4849getFontSizeXSAIIZE(), density, start, end);
        ...
        m5123setBackgroundRPmYEkk(spannable, item.m4846getBackground0d7_KjU(), start, end);
    ...
    private static final MetricAffectingSpan m5121createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long m5531getTypeUIouoOA = TextUnit.m5531getTypeUIouoOA(j);
        if (TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA, TextUnitType.Companion.m5565getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo602toPxR2X_6o(j));
        }
        if (TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA, TextUnitType.Companion.m5564getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m5532getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m5560equalsimpl0(TextUnit.m5531getTypeUIouoOA(spanStyle.m4852getLetterSpacingXSAIIZE()), TextUnitType.Companion.m5565getSpUIouoOA()) || TextUnitType.m5560equalsimpl0(TextUnit.m5531getTypeUIouoOA(spanStyle.m4852getLetterSpacingXSAIIZE()), TextUnitType.Companion.m5564getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m2911toArgb8_81llA(shadow.m3172getColor0d7_KjU()), Offset.m2619getXimpl(shadow.m3173getOffsetF1C5BW0()), Offset.m2620getYimpl(shadow.m3173getOffsetF1C5BW0()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m5126setFontSizeKmRG4DE(Spannable setFontSize, long j, Density density, int i, int i2) {
        Intrinsics.checkNotNullParameter(setFontSize, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long m5531getTypeUIouoOA = TextUnit.m5531getTypeUIouoOA(j);
        if (TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA, TextUnitType.Companion.m5565getSpUIouoOA())) {
            setSpan(setFontSize, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo602toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m5560equalsimpl0(m5531getTypeUIouoOA, TextUnitType.Companion.m5564getEmUIouoOA())) {
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m5532getValueimpl(j)), i, i2);
        }
    }
    ...
    private static final void m5124setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m5140unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m5125setColorRPmYEkk(spannable, ((SolidColor) brush).m3182getValue0d7_KjU(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m4911getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (TextPaintExtensions_androidKt.hasFontAttributes(range2.getItem()) || range2.getItem().m4851getFontSynthesisZQGJjVo() != null) {
                arrayList.add(range);
            }
        }
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m4910getFontStyle4Lr2A7w(), textStyle.m4911getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, 16323, (DefaultConstructorMarker) null) : null, arrayList, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt$setFontAttributes$1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, m4970boximpl, FontSynthesis.m4979boximpl(m4851getFontSynthesisZQGJjVo != null ? m4851getFontSynthesisZQGJjVo.m4987unboximpl() : FontSynthesis.Companion.m4988getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }

    /* renamed from: setBackground-RPmYEkk  reason: not valid java name */
    public static final void m5123setBackgroundRPmYEkk(Spannable setBackground, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setBackground, "$this$setBackground");
        if (j != Color.Companion.m2893getUnspecified0d7_KjU()) {
            setSpan(setBackground, new BackgroundColorSpan(ColorKt.m2911toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setColor-RPmYEkk  reason: not valid java name */
    public static final void m5125setColorRPmYEkk(Spannable setColor, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setColor, "$this$setColor");
        if (j != Color.Companion.m2893getUnspecified0d7_KjU()) {
            setSpan(setColor, new ForegroundColorSpan(ColorKt.m2911toArgb8_81llA(j)), i, i2);
        }
    }
}
