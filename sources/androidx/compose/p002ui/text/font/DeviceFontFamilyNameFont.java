...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    private DeviceFontFamilyNameFont(String str, FontWeight fontWeight, int i, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m4966getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, settings, null);
        this.familyName = str;
    ...
    public final Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().mo5000optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), mo4928getStyle_LCdwA(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeviceFontFamilyNameFont) {
            ...
            return DeviceFontFamilyName.m4941equalsimpl0(this.familyName, deviceFontFamilyNameFont.familyName) && Intrinsics.areEqual(getWeight(), deviceFontFamilyNameFont.getWeight()) && FontStyle.m4973equalsimpl0(mo4928getStyle_LCdwA(), deviceFontFamilyNameFont.mo4928getStyle_LCdwA()) && Intrinsics.areEqual(getVariationSettings(), deviceFontFamilyNameFont.getVariationSettings());
        }
        return false;
    }

    public int hashCode() {
        return (((((DeviceFontFamilyName.m4942hashCodeimpl(this.familyName) * 31) + getWeight().hashCode()) * 31) + FontStyle.m4974hashCodeimpl(mo4928getStyle_LCdwA())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m4943toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4975toStringimpl(mo4928getStyle_LCdwA())) + ')';
    }
}
