...
public final class FontFamilyResolver implements FontFamily.Resolver {
    ...
    public FontFamilyResolver(PlatformFontLoader platformFontLoader, PlatformResolveInterceptor platformResolveInterceptor, TypefaceRequestCache typefaceRequestCache, FontListFontFamilyTypefaceAdapter fontListFontFamilyTypefaceAdapter, PlatformFontFamilyTypefaceAdapter platformFamilyTypefaceAdapter) {
        ...
        this.createDefaultTypeface = new Function1<TypefaceRequest, Object>() { // from class: androidx.compose.ui.text.font.FontFamilyResolverImpl$createDefaultTypeface$1
            ...
            public final Object invoke(TypefaceRequest it) {
                ...
                resolve = FontFamilyResolver.this.resolve(TypefaceRequest.m5012copye1PVR60$default(it, null, null, 0, 0, null, 30, null));
    ...
    @Override // androidx.compose.p002ui.text.font.FontFamily.Resolver
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public java.lang.Object preload(androidx.compose.p002ui.text.font.FontFamily r17, kotlin.coroutines.Continuation<? super kotlin.Unit> r18) {
        /*
            r16 = this;
            r0 = r16
            r1 = r17
            r2 = r18
            boolean r3 = r2 instanceof androidx.compose.p002ui.text.font.FontFamilyResolverImpl$preload$1
            if (r3 == 0) goto L1a
            r3 = r2
            androidx.compose.ui.text.font.FontFamilyResolverImpl$preload$1 r3 = (androidx.compose.p002ui.text.font.FontFamilyResolverImpl$preload$1) r3
            int r4 = r3.label
        ...
        L1f:
            ...
            androidx.compose.ui.text.font.FontFamily r1 = (androidx.compose.p002ui.text.font.FontFamily) r1
            java.lang.Object r3 = r3.L$0
            androidx.compose.ui.text.font.FontFamilyResolverImpl r3 = (androidx.compose.p002ui.text.font.FontFamilyResolver) r3
        ...
        L40:
            kotlin.ResultKt.throwOnFailure(r2)
            boolean r2 = r1 instanceof androidx.compose.p002ui.text.font.FontListFontFamily
            if (r2 != 0) goto L4a
        ...
        L5c:
            r2 = r1
            androidx.compose.ui.text.font.FontListFontFamily r2 = (androidx.compose.p002ui.text.font.FontListFontFamily) r2
        ...
        L71:
            ...
            androidx.compose.ui.text.font.PlatformResolveInterceptor r9 = r3.platformResolveInterceptor
            int r7 = r7.mo4928getStyle_LCdwA()
            int r12 = r9.m4996interceptFontStyleT2F_aPo(r7)
            androidx.compose.ui.text.font.FontSynthesis$Companion r7 = androidx.compose.p002ui.text.font.FontSynthesis.Companion
            int r13 = r7.m4988getAllGVVA2EU()
        ...
        Lb3:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.text.font.FontFamilyResolver.preload(androidx.compose.ui.text.font.FontFamily, kotlin.coroutines.Continuation):java.lang.Object");
    }

    @Override // androidx.compose.p002ui.text.font.FontFamily.Resolver
    /* renamed from: resolve-DPcqOEQ */
    public State<Object> mo4948resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m4996interceptFontStyleT2F_aPo(i), this.platformResolveInterceptor.m4997interceptFontSynthesisMscr08Y(i2), this.platformFontLoader.getCacheKey(), null));
    }
    ...
    public final State<Object> resolve(final TypefaceRequest typefaceRequest) {
        return this.typefaceRequestCache.runCached(typefaceRequest, new Function1<Function1<? super TypefaceResult, ? extends Unit>, TypefaceResult>() { // from class: androidx.compose.ui.text.font.FontFamilyResolverImpl$resolve$result$1
            ...
            public final TypefaceResult invoke2(Function1<? super TypefaceResult, Unit> onAsyncCompletion) {
                ...
                fontListFontFamilyTypefaceAdapter = FontFamilyResolver.this.fontListFontFamilyTypefaceAdapter;
                TypefaceRequest typefaceRequest2 = typefaceRequest;
                PlatformFontLoader platformFontLoader$ui_text_release = FontFamilyResolver.this.getPlatformFontLoader$ui_text_release();
                function1 = FontFamilyResolver.this.createDefaultTypeface;
                ...
                if (resolve == null) {
                    platformFontFamilyTypefaceAdapter = FontFamilyResolver.this.platformFamilyTypefaceAdapter;
                    TypefaceRequest typefaceRequest3 = typefaceRequest;
                    PlatformFontLoader platformFontLoader$ui_text_release2 = FontFamilyResolver.this.getPlatformFontLoader$ui_text_release();
                    function12 = FontFamilyResolver.this.createDefaultTypeface;
