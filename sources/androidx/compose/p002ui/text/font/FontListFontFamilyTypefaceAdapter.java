...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    private static final CoroutineExceptionHandler DropExceptionHandler = new CoroutineExceptionHandler(CoroutineExceptionHandler.Key);
    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        if (fontFamily instanceof FontListFontFamily) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (FontLoadingStrategy.m4960equalsimpl0(font.mo4920getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m4964getAsyncPKNRLFQ())) {
                    arrayList.add(font);
                }
            }
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                arrayList3.add(TuplesKt.m33to(font2.getWeight(), FontStyle.m4970boximpl(font2.mo4928getStyle_LCdwA())));
            }
            ...
            for (int i4 = 0; i4 < size4; i4++) {
                Tuples tuples = (Tuples) arrayList6.get(i4);
                FontWeight fontWeight = (FontWeight) tuples.component1();
                int m4976unboximpl = ((FontStyle) tuples.component2()).m4976unboximpl();
                List list = (List) FontListFontFamilyTypefaceAdapterKt.access$firstImmediatelyAvailable(fontMatcher.m4969matchFontRetOiIg(fonts, fontWeight, m4976unboximpl), new TypefaceRequest(fontFamily, fontWeight, m4976unboximpl, FontSynthesis.Companion.m4988getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (typefaceRequest.getFontFamily() instanceof FontListFontFamily) {
            Tuples access$firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.access$firstImmediatelyAvailable(fontMatcher.m4969matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m5016getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, createDefaultTypeface);
    ...
    /* compiled from: FontListFontFamilyTypefaceAdapter.kt */
    @Metadata(m41d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006R\u0011\u0010\u0007\u001a\u00020\b¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, m40d2 = {"Landroidx/compose/ui/text/font/FontListFontFamilyTypefaceAdapter$Companion;", "", "()V", "DropExceptionHandler", "Lkotlinx/coroutines/CoroutineExceptionHandler;", "getDropExceptionHandler", "()Lkotlinx/coroutines/CoroutineExceptionHandler;", "fontMatcher", "Landroidx/compose/ui/text/font/FontMatcher;", "getFontMatcher", "()Landroidx/compose/ui/text/font/FontMatcher;", "ui-text_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
