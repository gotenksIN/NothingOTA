...
public final class RecordingInputConnection implements InputConnection {
    ...
    private final boolean ensureActive(Functions<Unit> functions) {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            TextRange m5096getCompositionMzsxiRA = state.m5096getCompositionMzsxiRA();
            int m4886getMinimpl = m5096getCompositionMzsxiRA != null ? TextRange.m4886getMinimpl(m5096getCompositionMzsxiRA.m4892unboximpl()) : -1;
            TextRange m5096getCompositionMzsxiRA2 = state.m5096getCompositionMzsxiRA();
            inputMethodManager.updateSelection(TextRange.m4886getMinimpl(state.m5097getSelectiond9O1mEE()), TextRange.m4885getMaximpl(state.m5097getSelectiond9O1mEE()), m4886getMinimpl, m5096getCompositionMzsxiRA2 != null ? TextRange.m4885getMaximpl(m5096getCompositionMzsxiRA2.m4892unboximpl()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m4882getCollapsedimpl(this.mTextFieldValue.m5097getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4886getMinimpl(this.mTextFieldValue.m5097getSelectiond9O1mEE()), i);
    }
    ...
    public boolean performEditorAction(int i) {
        int m5036getDefaulteUduSuo;
        boolean z = this.isActive;
        if (z) {
            if (i == 0) {
                m5036getDefaulteUduSuo = ImeAction.Companion.m5036getDefaulteUduSuo();
            } else {
                switch (i) {
                    case 2:
                        m5036getDefaulteUduSuo = ImeAction.Companion.m5038getGoeUduSuo();
                        break;
                    case 3:
                        m5036getDefaulteUduSuo = ImeAction.Companion.m5042getSearcheUduSuo();
                        break;
                    case 4:
                        m5036getDefaulteUduSuo = ImeAction.Companion.m5043getSendeUduSuo();
                        break;
                    case 5:
                        m5036getDefaulteUduSuo = ImeAction.Companion.m5039getNexteUduSuo();
                        break;
                    case 6:
                        m5036getDefaulteUduSuo = ImeAction.Companion.m5037getDoneeUduSuo();
                        break;
                    case 7:
                        m5036getDefaulteUduSuo = ImeAction.Companion.m5041getPreviouseUduSuo();
                        break;
                    default:
            ...
            this.eventCallback.mo5051onImeActionKlQnJC8(m5036getDefaulteUduSuo);
            return true;
        }
        return z;
    }
