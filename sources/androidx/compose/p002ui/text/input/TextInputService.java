...
public class TextInputService {
    ...
    public void stopInput(TextInputSession session) {
        ...
        if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m295m(this._currentInputSession, session, null)) {
