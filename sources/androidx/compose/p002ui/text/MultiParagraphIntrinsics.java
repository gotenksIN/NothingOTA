...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> placeholders, Density density, FontFamily.Resolver fontFamilyResolver) {
        ...
        this.minIntrinsicWidth$delegate = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Functions) new Functions<Float>() { // from class: androidx.compose.ui.text.MultiParagraphIntrinsics$minIntrinsicWidth$2
        ...
        this.maxIntrinsicWidth$delegate = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Functions) new Functions<Float>() { // from class: androidx.compose.ui.text.MultiParagraphIntrinsics$maxIntrinsicWidth$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle paragraphStyle, ParagraphStyle paragraphStyle2) {
        ParagraphStyle m4798copyciSxzs0;
        TextDirection m4807getTextDirectionmmuk1to = paragraphStyle.m4807getTextDirectionmmuk1to();
        if (m4807getTextDirectionmmuk1to != null) {
            m4807getTextDirectionmmuk1to.m5257unboximpl();
            if (paragraphStyle != null) {
                return paragraphStyle;
            }
        }
        m4798copyciSxzs0 = paragraphStyle.m4798copyciSxzs0((r20 & 1) != 0 ? paragraphStyle.textAlign : null, (r20 & 2) != 0 ? paragraphStyle.textDirection : paragraphStyle2.m4807getTextDirectionmmuk1to(), (r20 & 4) != 0 ? paragraphStyle.lineHeight : 0L, (r20 & 8) != 0 ? paragraphStyle.textIndent : null, (r20 & 16) != 0 ? paragraphStyle.platformStyle : null, (r20 & 32) != 0 ? paragraphStyle.lineHeightStyle : null, (r20 & 64) != 0 ? paragraphStyle.lineBreak : null, (r20 & 128) != 0 ? paragraphStyle.hyphens : null);
        return m4798copyciSxzs0;
    }
}
