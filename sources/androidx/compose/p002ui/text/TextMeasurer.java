...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m4864measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        return textMeasurer.m4866measurexDpz5zY(annotatedString, (i3 & 2) != 0 ? TextStyle.Companion.getDefault() : textStyle, (i3 & 4) != 0 ? TextOverflow.Companion.m5292getClipgIe3tQ8() : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 128) != 0 ? textMeasurer.fallbackLayoutDirection : layoutDirection, (i3 & 256) != 0 ? textMeasurer.fallbackDensity : density, (i3 & 512) != 0 ? textMeasurer.fallbackFontFamilyResolver : resolver, (i3 & 1024) != 0 ? false : z2);
    }

    /* renamed from: measure-xDpz5zY  reason: not valid java name */
    public final TextLayoutResult m4866measurexDpz5zY(AnnotatedString text, TextStyle style, int i, boolean z, int i2, List<AnnotatedString.Range<Placeholder>> placeholders, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean z2) {
        ...
        if (textLayoutResult != null) {
            return textLayoutResult.m4859copyO0kMr_c(textLayoutInput, ConstraintsKt.m5318constrain4WqzIAM(j, IntSizeKt.IntSize(ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getHeight()))));
        }
    ...
    public final TextLayoutResult m4865measurewNUYSr0(String text, TextStyle style, int i, boolean z, int i2, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean z2) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        return m4864measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, i, z, i2, null, j, layoutDirection, density, fontFamilyResolver, z2, 32, null);
    }

    /* compiled from: TextMeasurer.kt */
    @Metadata(m41d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0002¨\u0006\u0007"}, m40d2 = {"Landroidx/compose/ui/text/TextMeasurer$Companion;", "", "()V", "layout", "Landroidx/compose/ui/text/TextLayoutResult;", "textLayoutInput", "Landroidx/compose/ui/text/TextLayoutInput;", "ui-text_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int m5309getMinWidthimpl = Constraints.m5309getMinWidthimpl(textLayoutInput.m4856getConstraintsmsEJaDk());
            boolean z = false;
            int m5307getMaxWidthimpl = ((textLayoutInput.getSoftWrap() || TextOverflow.m5285equalsimpl0(textLayoutInput.m4857getOverflowgIe3tQ8(), TextOverflow.Companion.m5293getEllipsisgIe3tQ8())) && Constraints.m5303getHasBoundedWidthimpl(textLayoutInput.m4856getConstraintsmsEJaDk())) ? Constraints.m5307getMaxWidthimpl(textLayoutInput.m4856getConstraintsmsEJaDk()) : Integer.MAX_VALUE;
            if (!textLayoutInput.getSoftWrap() && TextOverflow.m5285equalsimpl0(textLayoutInput.m4857getOverflowgIe3tQ8(), TextOverflow.Companion.m5293getEllipsisgIe3tQ8())) {
                z = true;
            }
            int maxLines = z ? 1 : textLayoutInput.getMaxLines();
            if (m5309getMinWidthimpl != m5307getMaxWidthimpl) {
                m5307getMaxWidthimpl = RangesKt.coerceIn(ParagraphKt.ceilToInt(multiParagraphIntrinsics.getMaxIntrinsicWidth()), m5309getMinWidthimpl, m5307getMaxWidthimpl);
            }
            return new TextLayoutResult(textLayoutInput, new MultiParagraph(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, m5307getMaxWidthimpl, 0, Constraints.m5306getMaxHeightimpl(textLayoutInput.m4856getConstraintsmsEJaDk()), 5, null), maxLines, TextOverflow.m5285equalsimpl0(textLayoutInput.m4857getOverflowgIe3tQ8(), TextOverflow.Companion.m5293getEllipsisgIe3tQ8()), null), ConstraintsKt.m5318constrain4WqzIAM(textLayoutInput.m4856getConstraintsmsEJaDk(), IntSizeKt.IntSize((int) Math.ceil(multiParagraph.getWidth()), (int) Math.ceil(multiParagraph.getHeight()))), null);
        }
    }
}
