...
public final class ParagraphInfo {
    ...
    public final long m4787toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2619getXimpl(j), Offset.m2620getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m2656translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo2754translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI  reason: not valid java name */
    public final long m4786toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4888getStartimpl(j)), toGlobalIndex(TextRange.m4883getEndimpl(j)));
    }
}
