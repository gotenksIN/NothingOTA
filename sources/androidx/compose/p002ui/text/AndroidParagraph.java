...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i, boolean z, long j) {
        ...
        this.ellipsis = z;
        this.constraints = j;
        if ((Constraints.m5308getMinHeightimpl(j) == 0 && Constraints.m5309getMinWidthimpl(j) == 0) != true) {
        ...
        int m4755access$toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m4755access$toLayoutAlignAMY3VfE(style.m4916getTextAlignbuA522U());
        TextAlign m4916getTextAlignbuA522U = style.m4916getTextAlignbuA522U();
        int i2 = m4916getTextAlignbuA522U == null ? 0 : TextAlign.m5241equalsimpl0(m4916getTextAlignbuA522U.m5244unboximpl(), TextAlign.Companion.m5247getJustifye0LSkKk()) ? 1 : 0;
        int m4757access$toLayoutHyphenationFrequency0_XeFpE = AndroidParagraph_androidKt.m4757access$toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle$ui_text_release().m4800getHyphensEaSxIns());
        LineBreak m4914getLineBreakLgCVezo = style.m4914getLineBreakLgCVezo();
        int m4756access$toLayoutBreakStrategyu6PBz3U = AndroidParagraph_androidKt.m4756access$toLayoutBreakStrategyu6PBz3U(m4914getLineBreakLgCVezo != null ? LineBreak.Strategy.m5178boximpl(LineBreak.m5169getStrategyfcGXIks(m4914getLineBreakLgCVezo.m5174unboximpl())) : null);
        LineBreak m4914getLineBreakLgCVezo2 = style.m4914getLineBreakLgCVezo();
        int m4758access$toLayoutLineBreakStyle4a2g8L8 = AndroidParagraph_androidKt.m4758access$toLayoutLineBreakStyle4a2g8L8(m4914getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m5188boximpl(LineBreak.m5170getStrictnessusljTpc(m4914getLineBreakLgCVezo2.m5174unboximpl())) : null);
        LineBreak m4914getLineBreakLgCVezo3 = style.m4914getLineBreakLgCVezo();
        int m4759access$toLayoutLineBreakWordStylegvcdTPQ = AndroidParagraph_androidKt.m4759access$toLayoutLineBreakWordStylegvcdTPQ(m4914getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m5199boximpl(LineBreak.m5171getWordBreakjp8hJ3c(m4914getLineBreakLgCVezo3.m5174unboximpl())) : null);
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout constructTextLayout = constructTextLayout(m4755access$toLayoutAlignAMY3VfE, i2, truncateAt, i, m4757access$toLayoutHyphenationFrequency0_XeFpE, m4756access$toLayoutBreakStrategyu6PBz3U, m4758access$toLayoutLineBreakStyle4a2g8L8, m4759access$toLayoutLineBreakWordStylegvcdTPQ);
        if (z && constructTextLayout.getHeight() > Constraints.m5306getMaxHeightimpl(j) && i > 1) {
            int access$numberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.access$numberOfLinesThatFitMaxHeight(constructTextLayout, Constraints.m5306getMaxHeightimpl(j));
            if (access$numberOfLinesThatFitMaxHeight >= 0 && access$numberOfLinesThatFitMaxHeight != i) {
                constructTextLayout = constructTextLayout(m4755access$toLayoutAlignAMY3VfE, i2, truncateAt, RangesKt.coerceAtLeast(access$numberOfLinesThatFitMaxHeight, 1), m4757access$toLayoutHyphenationFrequency0_XeFpE, m4756access$toLayoutBreakStrategyu6PBz3U, m4758access$toLayoutLineBreakStyle4a2g8L8, m4759access$toLayoutLineBreakWordStylegvcdTPQ);
            }
            this.layout = constructTextLayout;
        } else {
            this.layout = constructTextLayout;
        }
        getTextPaint$ui_text_release().m5114setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
            shaderBrushSpan.m5133setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
        ...
        this.wordBoundary$delegate = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Functions) new Functions<WordBoundary>() { // from class: androidx.compose.ui.text.AndroidParagraph$wordBoundary$2
    ...
    public final long m4749getConstraintsmsEJaDk() {
    ...
    @Override // androidx.compose.p002ui.text.Paragraph
    public float getWidth() {
        return Constraints.m5307getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo4750getOffsetForPositionk4lQ0M(long j) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m2620getYimpl(j)), Offset.m2619getXimpl(j));
    }
    ...
    public final void m4748fillBoundingBoxes8ffj60Q(long j, float[] array, int i) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m4886getMinimpl(j), TextRange.m4885getMaximpl(j), array, i);
    }
    ...
    public long mo4751getWordBoundaryjx7JFs(int i) {
    ...
    public void mo4753paintRPmYEkk(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5115setColor8_81llA(j);
    ...
    public void mo4752paintLG529CI(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int m5112getBlendMode0nO6VwU = getTextPaint$ui_text_release().m5112getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5115setColor8_81llA(j);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m5113setBlendModes9anfk8(i);
        paint(canvas);
        getTextPaint$ui_text_release().m5113setBlendModes9anfk8(m5112getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.p002ui.text.Paragraph
    /* renamed from: paint-hn5TExg  reason: not valid java name */
    public void mo4754painthn5TExg(Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int m5112getBlendMode0nO6VwU = getTextPaint$ui_text_release().m5112getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5114setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), f);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m5113setBlendModes9anfk8(i);
