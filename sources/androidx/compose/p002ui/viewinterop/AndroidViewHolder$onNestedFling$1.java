...
@DebugMetadata(m31c = "androidx.compose.ui.viewinterop.AndroidViewHolder$onNestedFling$1", m30f = "AndroidViewHolder.android.kt", m29i = {}, m28l = {523, 528}, m27m = "invokeSuspend", m26n = {}, m25s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!this.$consumed) {
                ...
                this.label = 1;
                if (nestedScrollDispatcher2.m4145dispatchPostFlingRZ2iAVY(Velocity.Companion.m5587getZero9UxMQ8M(), this.$viewVelocity, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                nestedScrollDispatcher = this.this$0.dispatcher;
                this.label = 2;
                if (nestedScrollDispatcher.m4145dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.Companion.m5587getZero9UxMQ8M(), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else if (i != 1 && i != 2) {
