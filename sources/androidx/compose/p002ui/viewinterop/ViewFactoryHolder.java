...
public final class ViewFactoryHolder<T extends View> extends AndroidViewHolder implements ViewRootForInspector {
    ...
    public final void setUpdateBlock(Function1<? super T, Unit> value) {
        ...
        setUpdate(new Functions<Unit>(this) { // from class: androidx.compose.ui.viewinterop.ViewFactoryHolder$updateBlock$1
    ...
    public final void setResetBlock(Function1<? super T, Unit> value) {
        ...
        setReset(new Functions<Unit>(this) { // from class: androidx.compose.ui.viewinterop.ViewFactoryHolder$resetBlock$1
            final /* synthetic */ ViewFactoryHolder<T> this$0;
    ...
    public final void setReleaseBlock(Function1<? super T, Unit> value) {
        ...
        setRelease(new Functions<Unit>(this) { // from class: androidx.compose.ui.viewinterop.ViewFactoryHolder$releaseBlock$1
            final /* synthetic */ ViewFactoryHolder<T> this$0;
    ...
    private final void registerSaveStateProvider() {
        ...
        if (saveableStateRegistry != null) {
            setSaveableRegistryEntry(saveableStateRegistry.registerProvider(this.saveStateKey, new Functions<Object>(this) { // from class: androidx.compose.ui.viewinterop.ViewFactoryHolder$registerSaveStateProvider$1
                final /* synthetic */ ViewFactoryHolder<T> this$0;
