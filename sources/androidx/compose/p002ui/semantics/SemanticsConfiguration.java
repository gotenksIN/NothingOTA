...
public final class SemanticsConfiguration implements SemanticsPropertyReceiver, Iterable<Map.Entry<? extends SemanticsPropertyKey<?>, ? extends Object>>, KMarkers {
    ...
    public final <T> T getOrElse(SemanticsPropertyKey<T> key, Functions<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(key, "key");
    ...
    public final <T> T getOrElseNullable(SemanticsPropertyKey<T> key, Functions<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(key, "key");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        T t = (T) this.props.get(key);
        return t == null ? defaultValue.invoke() : t;
    ...
    @Override // androidx.compose.p002ui.semantics.SemanticsPropertyReceiver
