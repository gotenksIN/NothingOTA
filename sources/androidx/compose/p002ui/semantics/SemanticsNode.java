...
public final class SemanticsNode {
    ...
    public SemanticsNode(SemanticsModifierNode outerSemanticsNode, boolean z, LayoutNode layoutNode) {
        ...
        this.f150id = layoutNode.getSemanticsId();
    }
    ...
    public final long m4742getSizeYbymL2g() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        return findCoordinatorToGetBounds$ui_release != null ? findCoordinatorToGetBounds$ui_release.mo4381getSizeYbymL2g() : IntSize.Companion.m5516getZeroYbymL2g();
    }
    ...
    public final long m4740getPositionInRootF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        if (findCoordinatorToGetBounds$ui_release != null) {
            if (!findCoordinatorToGetBounds$ui_release.isAttached()) {
                findCoordinatorToGetBounds$ui_release = null;
    ...
    public final long m4741getPositionInWindowF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        if (findCoordinatorToGetBounds$ui_release != null) {
            if (!findCoordinatorToGetBounds$ui_release.isAttached()) {
                findCoordinatorToGetBounds$ui_release = null;
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        ...
        return DelegatableNodeKt.m4482requireCoordinator64DMado(outerMergingSemantics, NodeKind.m4578constructorimpl(8));
    }
    ...
    private final void emitFakeNodes(List<SemanticsNode> list) {
        ...
        if (role != null && this.unmergedConfig.isMergingSemanticsOfDescendants() && (!list.isEmpty())) {
            list.add(m4739fakeSemanticsNodeypyhhiA(role, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                ...
                public final void invoke2(SemanticsPropertyReceiver fakeSemanticsNode) {
                    ...
                    SemanticsPropertiesKt.m4746setRolekuIjeqM(fakeSemanticsNode, Role.this.m4731unboximpl());
                }
            }));
        }
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && (!list.isEmpty()) && this.unmergedConfig.isMergingSemanticsOfDescendants()) {
            ...
            if (str != null) {
                list.add(0, m4739fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
                    /* JADX INFO: Access modifiers changed from: package-private */
    ...
    private final SemanticsNode m4739fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> function1) {
