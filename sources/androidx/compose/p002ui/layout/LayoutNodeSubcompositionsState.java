...
public final class LayoutNodeSubcompositionsState {
    ...
    private final void subcompose(LayoutNode layoutNode, Object obj, Function2<? super Composer, ? super Integer, Unit> function2) {
        ...
        if (nodeState == null) {
            nodeState = new NodeState(obj, SubcomposeLayout.INSTANCE.m4366getLambda1$ui_release(), null, 4, null);
    ...
    public final MeasurePolicy createMeasurePolicy(final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> block) {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(str) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$createMeasurePolicy$1
            ...
            public MeasureResult mo313measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                final MeasureResult invoke = function2.invoke(scope4, Constraints.m5295boximpl(j));
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object obj, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$precompose$1
            @Override // androidx.compose.p002ui.layout.SubcomposeLayoutState.PrecomposedSlotHandle
            public void dispose() {
                Map map2;
                int i;
            ...
            public void mo4389premeasure0kLqBqw(int i, long j) {
                Map map2;
                LayoutNode layoutNode2;
                map2 = LayoutNodeSubcompositionsState.this.precomposeMap;
                ...
                if (!layoutNode3.isPlaced()) {
                    layoutNode2 = LayoutNodeSubcompositionsState.this.root;
                    layoutNode2.ignoreRemeasureRequests = true;
                    LayoutNodeKt.requireOwner(layoutNode3).mo4629measureAndLayout0kLqBqw(layoutNode3.getChildren$ui_release().get(i), j);
                    layoutNode2.ignoreRemeasureRequests = false;
                    return;
                }
    ...
    private final void ignoreRemeasureRequests(Functions<Unit> functions) {
