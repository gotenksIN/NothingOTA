...
@Metadata(m41d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\bg\u0018\u0000 \t2\u00020\u0001:\u0001\tJ%\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0005H&ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u0007\u0010\bø\u0001\u0002\u0082\u0002\u0011\n\u0005\b¡\u001e0\u0001\n\u0002\b\u0019\n\u0004\b!0\u0001¨\u0006\nÀ\u0006\u0001"}, m40d2 = {"Landroidx/compose/ui/layout/ContentScale;", "", "computeScaleFactor", "Landroidx/compose/ui/layout/ScaleFactor;", "srcSize", "Landroidx/compose/ui/geometry/Size;", "dstSize", "computeScaleFactor-H7hwNQA", "(JJ)J", "Companion", "ui_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
...
public interface ContentScale {
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo4367computeScaleFactorH7hwNQA(long j, long j2) {
                float m4369access$computeFillMaxDimensioniLBOSCw = ContentScaleKt.m4369access$computeFillMaxDimensioniLBOSCw(j, j2);
                return ScaleFactorKt.ScaleFactor(m4369access$computeFillMaxDimensioniLBOSCw, m4369access$computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4367computeScaleFactorH7hwNQA(long j, long j2) {
                float m4370access$computeFillMinDimensioniLBOSCw = ContentScaleKt.m4370access$computeFillMinDimensioniLBOSCw(j, j2);
                return ScaleFactorKt.ScaleFactor(m4370access$computeFillMinDimensioniLBOSCw, m4370access$computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4367computeScaleFactorH7hwNQA(long j, long j2) {
                float m4368access$computeFillHeightiLBOSCw = ContentScaleKt.m4368access$computeFillHeightiLBOSCw(j, j2);
                return ScaleFactorKt.ScaleFactor(m4368access$computeFillHeightiLBOSCw, m4368access$computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4367computeScaleFactorH7hwNQA(long j, long j2) {
                float m4371access$computeFillWidthiLBOSCw = ContentScaleKt.m4371access$computeFillWidthiLBOSCw(j, j2);
                return ScaleFactorKt.ScaleFactor(m4371access$computeFillWidthiLBOSCw, m4371access$computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4367computeScaleFactorH7hwNQA(long j, long j2) {
                if (Size.m2688getWidthimpl(j) <= Size.m2688getWidthimpl(j2) && Size.m2685getHeightimpl(j) <= Size.m2685getHeightimpl(j2)) {
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4367computeScaleFactorH7hwNQA(long j, long j2) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m4371access$computeFillWidthiLBOSCw(j, j2), ContentScaleKt.m4368access$computeFillHeightiLBOSCw(j, j2));
            }
        };
