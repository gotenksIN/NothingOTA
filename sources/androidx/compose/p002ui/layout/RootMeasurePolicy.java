...
public final class RootMeasurePolicy extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult mo313measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        if (measurables.isEmpty()) {
            return MeasureScope.layout$default(measure, Constraints.m5309getMinWidthimpl(j), Constraints.m5308getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$1
        ...
        if (measurables.size() == 1) {
            final Placeable mo4376measureBRTryo0 = measurables.get(0).mo4376measureBRTryo0(j);
            return MeasureScope.layout$default(measure, ConstraintsKt.m5321constrainWidthK40F9xA(j, mo4376measureBRTryo0.getWidth()), ConstraintsKt.m5320constrainHeightK40F9xA(j, mo4376measureBRTryo0.getHeight()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$2
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(measurables.get(i).mo4376measureBRTryo0(j));
        }
        ...
        return MeasureScope.layout$default(measure, ConstraintsKt.m5321constrainWidthK40F9xA(j, i2), ConstraintsKt.m5320constrainHeightK40F9xA(j, i3), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$4
            /* JADX INFO: Access modifiers changed from: package-private */
