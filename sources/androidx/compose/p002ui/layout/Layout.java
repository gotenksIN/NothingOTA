...
public final class Layout implements Measurable {
    ...
    public Layout(IntrinsicMeasurable measurable, IntrinsicMinMax minMax, IntrinsicWidthHeight widthHeight) {
    ...
    public Placeable mo4376measureBRTryo0(long j) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(minIntrinsicWidth, Constraints.m5306getMaxHeightimpl(j));
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m5307getMaxWidthimpl(j), minIntrinsicHeight);
    }
