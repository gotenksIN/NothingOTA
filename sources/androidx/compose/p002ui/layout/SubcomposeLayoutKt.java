...
public final class SubcomposeLayoutKt {
    public static final void SubcomposeLayout(final Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> measurePolicy, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            int i5 = i3 << 3;
            SubcomposeLayout((SubcomposeLayoutState) rememberedValue, modifier, measurePolicy, startRestartGroup, (i5 & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 8 | (i5 & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState state, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> measurePolicy, Composer composer, final int i, final int i2) {
        ...
        if (startRestartGroup.getInserting()) {
            startRestartGroup.createNode(new Functions<LayoutNode>() { // from class: androidx.compose.ui.layout.SubcomposeLayoutKt$SubcomposeLayout$$inlined$ComposeNode$1
                {
                    super(0);
                }
        ...
        Updater.m2503setimpl(m2496constructorimpl, state, state.getSetRoot$ui_release());
        Updater.m2503setimpl(m2496constructorimpl, rememberCompositionContext, state.getSetCompositionContext$ui_release());
        Updater.m2503setimpl(m2496constructorimpl, measurePolicy, state.getSetMeasurePolicy$ui_release());
        ...
        if (!startRestartGroup.getSkipping()) {
            EffectsKt.SideEffect(new Functions<Unit>() { // from class: androidx.compose.ui.layout.SubcomposeLayoutKt$SubcomposeLayout$4
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
