...
@Metadata(m41d1 = {"\u0000\u001e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u001a\u001a\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004H\u0001\u001a\u0014\u0010\u0006\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0007\u001a\u00020\bH\u0001¨\u0006\t"}, m40d2 = {"performAutofill", "", "Landroidx/compose/ui/autofill/AndroidAutofill;", "values", "Landroid/util/SparseArray;", "Landroid/view/autofill/AutofillValue;", "populateViewStructure", "root", "Landroid/view/ViewStructure;", "ui_release"}, m39k = 2, m38mv = {1, 8, 0}, m36xi = 48)
    ...
    public static final void performAutofill(AndroidAutofill androidAutofill, SparseArray<AutofillValue> values) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (autofillApi26Helper.isText(value)) {
                ...
                throw new Standard("An operation is not implemented: b/138604541: Add onFill() callback for date");
            } else {
                if (AutofillApi26Helper.INSTANCE.isList(value)) {
                    throw new Standard("An operation is not implemented: b/138604541: Add onFill() callback for list");
                }
                if (AutofillApi26Helper.INSTANCE.isToggle(value)) {
                    throw new Standard("An operation is not implemented: b/138604541:  Add onFill() callback for toggle");
                }
            }
        }
    }
