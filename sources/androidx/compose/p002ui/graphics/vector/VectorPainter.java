...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter() {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2676boximpl(Size.Companion.m2697getZeroNHjbRc()), null, 2, null);
        this.size$delegate = mutableStateOf$default;
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(false, null, 2, null);
        this.autoMirror$delegate = mutableStateOf$default2;
        VectorComponent vectorComponent = new VectorComponent();
        vectorComponent.setInvalidateCallback$ui_release(new Functions<Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainter$vector$1$1
    ...
    public final long m3492getSizeNHjbRc$ui_release() {
        return ((Size) this.size$delegate.getValue()).m2693unboximpl();
    }

    /* renamed from: setSize-uvyYCjk$ui_release  reason: not valid java name */
    public final void m3493setSizeuvyYCjk$ui_release(long j) {
        this.size$delegate.setValue(Size.m2676boximpl(j));
    }
    ...
    public long mo3466getIntrinsicSizeNHjbRc() {
        return m3492getSizeNHjbRc$ui_release();
    }
