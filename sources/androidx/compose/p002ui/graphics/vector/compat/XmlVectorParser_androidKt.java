...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3500getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m3200getButtKaPHkGw();
        }
        return m3499getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m3499getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeCap.Companion.m3202getSquareKaPHkGw();
            }
    ...
    static /* synthetic */ int m3502getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m3211getMiterLxFBmk8();
        }
        return m3501getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m3501getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeJoin.Companion.m3210getBevelLxFBmk8();
            }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs) {
        long m2893getUnspecified0d7_KjU;
        int m2799getSrcIn0nO6VwU;
        Intrinsics.checkNotNullParameter(androidVectorParser, "<this>");
        Intrinsics.checkNotNullParameter(res, "res");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        ...
        if (namedFloat > 0.0f) {
            ...
            if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
                ...
                if (typedValue.type == 2) {
                    m2893getUnspecified0d7_KjU = Color.Companion.m2893getUnspecified0d7_KjU();
                } else {
                    ...
                    if (namedColorStateList != null) {
                        m2893getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                    } else {
                        m2893getUnspecified0d7_KjU = Color.Companion.m2893getUnspecified0d7_KjU();
                    }
                }
            ...
            long j = m2893getUnspecified0d7_KjU;
            ...
            if (i == -1) {
                m2799getSrcIn0nO6VwU = BlendMode.Companion.m2799getSrcIn0nO6VwU();
            } else if (i == 3) {
                m2799getSrcIn0nO6VwU = BlendMode.Companion.m2801getSrcOver0nO6VwU();
            } else if (i == 5) {
                m2799getSrcIn0nO6VwU = BlendMode.Companion.m2799getSrcIn0nO6VwU();
            } else if (i == 9) {
                m2799getSrcIn0nO6VwU = BlendMode.Companion.m2798getSrcAtop0nO6VwU();
            } else {
                switch (i) {
                    case 14:
                        m2799getSrcIn0nO6VwU = BlendMode.Companion.m2790getModulate0nO6VwU();
                        break;
                    case 15:
                        m2799getSrcIn0nO6VwU = BlendMode.Companion.m2795getScreen0nO6VwU();
                        break;
                    case 16:
                        m2799getSrcIn0nO6VwU = BlendMode.Companion.m2793getPlus0nO6VwU();
                        break;
                    default:
                        m2799getSrcIn0nO6VwU = BlendMode.Companion.m2799getSrcIn0nO6VwU();
                        break;
            ...
            int i2 = m2799getSrcIn0nO6VwU;
            float m5351constructorimpl = C0780Dp.m5351constructorimpl(dimension / res.getDisplayMetrics().density);
            float m5351constructorimpl2 = C0780Dp.m5351constructorimpl(dimension2 / res.getDisplayMetrics().density);
            obtainAttributes.recycle();
            return new ImageVector.Builder(null, m5351constructorimpl, m5351constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
        }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m3499getStrokeLineCapCSYIeUk = m3499getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m3200getButtKaPHkGw());
        int m3501getStrokeLineJoinkLtJ_vA = m3501getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m3210getBevelLxFBmk8());
        ...
        builder.m3479addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m3131getNonZeroRgk1Os() : companion.m3130getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m3499getStrokeLineCapCSYIeUk, m3501getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
