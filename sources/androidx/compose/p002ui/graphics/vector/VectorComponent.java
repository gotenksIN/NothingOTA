...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        vector.setInvalidateListener$ui_release(new Functions<Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$root$1$1
        ...
        this.invalidateCallback = new Functions<Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$invalidateCallback$1
            /* renamed from: invoke  reason: avoid collision after fix types in other method */
            public final void invoke2() {
            }
        ...
        this.previousDrawSize = Size.Companion.m2696getUnspecifiedNHjbRc();
    ...
    public final void setInvalidateCallback$ui_release(Functions<Unit> functions) {
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m2684equalsimpl0(this.previousDrawSize, drawScope.mo3397getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2688getWidthimpl(drawScope.mo3397getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2685getHeightimpl(drawScope.mo3397getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3473drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m2688getWidthimpl(drawScope.mo3397getSizeNHjbRc())), (int) Math.ceil(Size.m2685getHeightimpl(drawScope.mo3397getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo3397getSizeNHjbRc();
        }
