...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo2826createShaderuvyYCjk(long j) {
        ...
        if (OffsetKt.m2640isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m2698getCenteruvyYCjk(j);
        } else {
            Offset = OffsetKt.Offset((Offset.m2619getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m2619getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m2688getWidthimpl(j) : Offset.m2619getXimpl(this.center), Offset.m2620getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2685getHeightimpl(j) : Offset.m2620getYimpl(this.center));
        }
        return Shader.m3166SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SweepGradient) {
            ...
            return Offset.m2616equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
        }
        return false;
    }

    public int hashCode() {
        int m2621hashCodeimpl = ((Offset.m2621hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m2621hashCodeimpl + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m2638isSpecifiedk4lQ0M(this.center) ? "center=" + ((Object) Offset.m2627toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}
