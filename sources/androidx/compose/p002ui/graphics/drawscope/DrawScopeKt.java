...
import androidx.compose.p002ui.graphics.Degrees;
...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m3439rotateRg1IO4c$default(DrawScope rotate, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotate.mo3396getCenterF1C5BW0();
        }
        ...
        drawContext.getTransform().mo3328rotateUv8p0NA(f, j);
        block.invoke(rotate);
    ...
    public static /* synthetic */ void m3441rotateRadRg1IO4c$default(DrawScope rotateRad, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotateRad.mo3396getCenterF1C5BW0();
        }
        ...
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3328rotateUv8p0NA(Degrees.degrees(f), j);
    ...
    public static /* synthetic */ void m3443scaleFgt4K4Q$default(DrawScope scale, float f, float f2, long j, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            j = scale.mo3396getCenterF1C5BW0();
        }
        ...
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3329scale0AR0LA0(f, f2, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo3323setSizeuvyYCjk(mo3322getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m3445scaleRg1IO4c$default(DrawScope scale, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = scale.mo3396getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        ...
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3329scale0AR0LA0(f, f, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo3323setSizeuvyYCjk(mo3322getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m3437clipRectrOu3jXo$default(DrawScope clipRect, float f, float f2, float f3, float f4, int i, Function1 block, int i2, Object obj) {
        float f5 = (i2 & 1) != 0 ? 0.0f : f;
        float f6 = (i2 & 2) != 0 ? 0.0f : f2;
        if ((i2 & 4) != 0) {
            f3 = Size.m2688getWidthimpl(clipRect.mo3397getSizeNHjbRc());
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Size.m2685getHeightimpl(clipRect.mo3397getSizeNHjbRc());
        }
        float f8 = f4;
        if ((i2 & 16) != 0) {
            i = ClipOp.Companion.m2846getIntersectrtfAjoo();
        }
        ...
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3325clipRectN_I0leg(f5, f6, f7, f8, i);
    ...
    public static /* synthetic */ void m3435clipPathKD09W0M$default(DrawScope clipPath, Path path, int i, Function1 block, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = ClipOp.Companion.m2846getIntersectrtfAjoo();
        }
        ...
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3324clipPathmtrdDE(path, i);
    ...
    public static final void m3438rotateRg1IO4c(DrawScope rotate, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotate.getDrawContext();
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
    ...
    public static final void m3440rotateRadRg1IO4c(DrawScope rotateRad, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotateRad.getDrawContext();
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
    ...
    public static final void m3442scaleFgt4K4Q(DrawScope scale, float f, float f2, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
    ...
    public static final void m3444scaleRg1IO4c(DrawScope scale, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
    ...
    public static final void m3436clipRectrOu3jXo(DrawScope clipRect, float f, float f2, float f3, float f4, int i, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipRect, "$this$clipRect");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipRect.getDrawContext();
        long mo3322getSizeNHjbRc = drawContext.mo3322getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3325clipRectN_I0leg(f, f2, f3, f4, i);
        block.invoke(clipRect);
        drawContext.getCanvas().restore();
        drawContext.mo3323setSizeuvyYCjk(mo3322getSizeNHjbRc);
    }
    ...
    public static final void m3434clipPathKD09W0M(DrawScope clipPath, Path path, int i, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipPath, "$this$clipPath");
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipPath.getDrawContext();
