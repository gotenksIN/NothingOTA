...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo2715concat58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        if (MatrixKt.m3105isIdentity58bKbWc(matrix)) {
            return;
        }
        Matrix matrix2 = new Matrix();
        AndroidMatrixConversions_androidKt.m2730setFromEL8BTi8(matrix2, matrix);
        this.internalCanvas.concat(matrix2);
    }

    @Override // androidx.compose.p002ui.graphics.Canvas
    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    public void mo2714clipRectN_I0leg(float f, float f2, float f3, float f4, int i) {
        this.internalCanvas.clipRect(f, f2, f3, f4, m2723toRegionOp7u2Bmg(i));
    }

    @Override // androidx.compose.p002ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void mo2713clipPathmtrdDE(Path path, int i) {
        Intrinsics.checkNotNullParameter(path, "path");
        Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m2723toRegionOp7u2Bmg(i));
            return;
        }
    ...
    public final Region.Op m2723toRegionOp7u2Bmg(int i) {
        return ClipOp.m2841equalsimpl0(i, ClipOp.Companion.m2845getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.p002ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    public void mo2719drawLineWko1d7g(long j, long j2, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawLine(Offset.m2619getXimpl(j), Offset.m2620getYimpl(j), Offset.m2619getXimpl(j2), Offset.m2620getYimpl(j2), paint.asFrameworkPaint());
    }
    ...
    public void mo2716drawCircle9KIMszo(long j, float f, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawCircle(Offset.m2619getXimpl(j), Offset.m2620getYimpl(j), f, paint.asFrameworkPaint());
    }
    ...
    public void mo2717drawImaged4ec7I(ImageBitmap image, long j, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m2619getXimpl(j), Offset.m2620getYimpl(j), paint.asFrameworkPaint());
    }

    @Override // androidx.compose.p002ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0  reason: not valid java name */
    public void mo2718drawImageRectHPBpro0(ImageBitmap image, long j, long j2, long j3, long j4, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        Canvas canvas = this.internalCanvas;
        Bitmap asAndroidBitmap = AndroidImageBitmap_androidKt.asAndroidBitmap(image);
        Rect rect = this.srcRect;
        rect.left = IntOffset.m5469getXimpl(j);
        rect.top = IntOffset.m5470getYimpl(j);
        rect.right = IntOffset.m5469getXimpl(j) + IntSize.m5511getWidthimpl(j2);
        rect.bottom = IntOffset.m5470getYimpl(j) + IntSize.m5510getHeightimpl(j2);
        Unit unit = Unit.INSTANCE;
        Rect rect2 = this.dstRect;
        rect2.left = IntOffset.m5469getXimpl(j3);
        rect2.top = IntOffset.m5470getYimpl(j3);
        rect2.right = IntOffset.m5469getXimpl(j3) + IntSize.m5511getWidthimpl(j4);
        rect2.bottom = IntOffset.m5470getYimpl(j3) + IntSize.m5510getHeightimpl(j4);
    ...
    public void mo2720drawPointsO7TthRY(int i, List<Offset> points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        if (PointMode.m3148equalsimpl0(i, PointMode.Companion.m3152getLinesr_lszbg())) {
            drawLines(points, paint, 2);
        } else if (PointMode.m3148equalsimpl0(i, PointMode.Companion.m3154getPolygonr_lszbg())) {
            drawLines(points, paint, 1);
        } else if (PointMode.m3148equalsimpl0(i, PointMode.Companion.m3153getPointsr_lszbg())) {
    ...
    private final void drawLines(List<Offset> list, Paint paint, int i) {
        ...
        while (true) {
            long m2629unboximpl = list.get(first).m2629unboximpl();
            long m2629unboximpl2 = list.get(first + 1).m2629unboximpl();
            this.internalCanvas.drawLine(Offset.m2619getXimpl(m2629unboximpl), Offset.m2620getYimpl(m2629unboximpl), Offset.m2619getXimpl(m2629unboximpl2), Offset.m2620getYimpl(m2629unboximpl2), paint.asFrameworkPaint());
            if (first == last) {
                return;
            }
            first += step2;
    ...
    public void mo2721drawRawPointsO7TthRY(int i, float[] points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
    ...
    public void mo2722drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint) {
        Intrinsics.checkNotNullParameter(vertices, "vertices");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m2765toAndroidVertexModeJOOmi9M(vertices.m3249getVertexModec2xauaI()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.asFrameworkPaint());
    }

    private final void drawPoints(List<Offset> list, Paint paint) {
        int size = list.size();
        for (int i = 0; i < size; i++) {
            long m2629unboximpl = list.get(i).m2629unboximpl();
            this.internalCanvas.drawPoint(Offset.m2619getXimpl(m2629unboximpl), Offset.m2620getYimpl(m2629unboximpl), paint.asFrameworkPaint());
        }
    }
}
