...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(Paint internalPaint) {
        ...
        this._blendMode = BlendMode.Companion.m2801getSrcOver0nO6VwU();
    }
    ...
    public long mo2733getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.p002ui.graphics.Paint
    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public void mo2739setColor8_81llA(long j) {
        AndroidPaint_androidKt.m2745setNativeColor4WTKRHQ(this.internalPaint, j);
    }

    @Override // androidx.compose.p002ui.graphics.Paint
    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public int mo2732getBlendMode0nO6VwU() {
        return this._blendMode;
    }

    @Override // androidx.compose.p002ui.graphics.Paint
    /* renamed from: setBlendMode-s9anfk8  reason: not valid java name */
    public void mo2738setBlendModes9anfk8(int i) {
        if (BlendMode.m2770equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m2744setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.p002ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo  reason: not valid java name */
    public int mo2737getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.p002ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s  reason: not valid java name */
    public void mo2743setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m2749setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo2735getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.p002ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE  reason: not valid java name */
    public void mo2741setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m2747setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.p002ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8  reason: not valid java name */
    public int mo2736getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.p002ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ  reason: not valid java name */
    public void mo2742setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m2748setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo2734getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.p002ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo  reason: not valid java name */
    public void mo2740setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m2746setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
