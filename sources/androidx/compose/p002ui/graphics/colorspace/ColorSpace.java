...
public abstract class ColorSpace {
    ...
    public final long m3263getModelxdoWZVw() {
        return this.model;
    }
    ...
    public final int getComponentCount() {
        return ColorModel.m3255getComponentCountimpl(this.model);
    }
    ...
    public final float[] fromXyz(float f, float f2, float f3) {
        float[] fArr = new float[ColorModel.m3255getComponentCountimpl(this.model)];
        fArr[0] = f;
        fArr[1] = f2;
        fArr[2] = f3;
        return fromXyz(fArr);
    ...
    public String toString() {
        return this.name + " (id=" + this.f55id + ", model=" + ((Object) ColorModel.m3257toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f55id == colorSpace.f55id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m3254equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m3256hashCodeimpl(this.model)) * 31) + this.f55id;
    }

    /* compiled from: ColorSpace.kt */
    @Metadata(m41d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m40d2 = {"Landroidx/compose/ui/graphics/colorspace/ColorSpace$Companion;", "", "()V", "MaxId", "", "MinId", "ui-graphics_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
