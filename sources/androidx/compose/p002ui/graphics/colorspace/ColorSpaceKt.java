...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m3266connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m3280getPerceptualuksYyKA();
        }
        return m3265connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m3265connectYBCOT_4(ColorSpace connect, ColorSpace destination, int i) {
        ...
        if (connect == ColorSpaces.INSTANCE.getSrgb()) {
            ...
            if (destination == ColorSpaces.INSTANCE.getOklab() && RenderIntent.m3275equalsimpl0(i, RenderIntent.Companion.m3280getPerceptualuksYyKA())) {
                return Connector.Companion.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (connect == ColorSpaces.INSTANCE.getOklab() && destination == ColorSpaces.INSTANCE.getSrgb() && RenderIntent.m3275equalsimpl0(i, RenderIntent.Companion.m3280getPerceptualuksYyKA())) {
        ...
        if (ColorModel.m3254equalsimpl0(connect.m3263getModelxdoWZVw(), ColorModel.Companion.m3261getRgbxdoWZVw()) && ColorModel.m3254equalsimpl0(destination.m3263getModelxdoWZVw(), ColorModel.Companion.m3261getRgbxdoWZVw())) {
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        ...
        if (ColorModel.m3254equalsimpl0(colorSpace.m3263getModelxdoWZVw(), ColorModel.Companion.m3261getRgbxdoWZVw())) {
