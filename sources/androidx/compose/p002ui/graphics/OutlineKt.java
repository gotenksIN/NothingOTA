...
public final class OutlineKt {
    public static final void addOutline(Path path, Outline outline) {
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            Path.m3119addPathUv8p0NA$default(path, ((Outline.Generic) outline).getPath(), 0L, 2, null);
        }
    }

    /* renamed from: drawOutline-hn5TExg$default */
    public static /* synthetic */ void m3107drawOutlinehn5TExg$default(DrawScope drawScope, Outline outline, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = 1.0f;
        }
        float f2 = f;
        ...
        if ((i2 & 32) != 0) {
            i = DrawScope.Companion.m3398getDefaultBlendMode0nO6VwU();
        }
        m3106drawOutlinehn5TExg(drawScope, outline, brush, f2, drawStyle2, colorFilter2, i);
    }
    ...
    public static final void drawOutline(Canvas canvas, Outline outline, Paint paint) {
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            if (roundRectPath$ui_graphics_release != null) {
                ...
                canvas.drawRoundRect(rounded.getRoundRect().getLeft(), rounded.getRoundRect().getTop(), rounded.getRoundRect().getRight(), rounded.getRoundRect().getBottom(), CornerRadius.m2594getXimpl(rounded.getRoundRect().m2667getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m2595getYimpl(rounded.getRoundRect().m2667getBottomLeftCornerRadiuskKHJgLs()), paint);
            }
        } else if (!(outline instanceof Outline.Generic)) {
            throw new NoWhenBranchMatchedException();
        } else {
    ...
    */
    public static final boolean hasSameCornerRadius(androidx.compose.p002ui.geometry.RoundRect r6) {
        /*
            long r0 = r6.m2667getBottomLeftCornerRadiuskKHJgLs()
            float r0 = androidx.compose.p002ui.geometry.CornerRadius.m2594getXimpl(r0)
            long r1 = r6.m2668getBottomRightCornerRadiuskKHJgLs()
            float r1 = androidx.compose.p002ui.geometry.CornerRadius.m2594getXimpl(r1)
        ...
        L19:
            if (r0 == 0) goto L4f
            long r3 = r6.m2668getBottomRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.p002ui.geometry.CornerRadius.m2594getXimpl(r3)
            long r3 = r6.m2670getTopRightCornerRadiuskKHJgLs()
            float r3 = androidx.compose.p002ui.geometry.CornerRadius.m2594getXimpl(r3)
        ...
        L32:
            ...
            long r3 = r6.m2670getTopRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.p002ui.geometry.CornerRadius.m2594getXimpl(r3)
            long r3 = r6.m2669getTopLeftCornerRadiuskKHJgLs()
            float r3 = androidx.compose.p002ui.geometry.CornerRadius.m2594getXimpl(r3)
            int r0 = (r0 > r3 ? 1 : (r0 == r3 ? 0 : -1))
            if (r0 != 0) goto L4a
            r0 = r1
        ...
        L4f:
            r0 = r2
        L50:
            long r3 = r6.m2667getBottomLeftCornerRadiuskKHJgLs()
            float r3 = androidx.compose.p002ui.geometry.CornerRadius.m2595getYimpl(r3)
            long r4 = r6.m2668getBottomRightCornerRadiuskKHJgLs()
            float r4 = androidx.compose.p002ui.geometry.CornerRadius.m2595getYimpl(r4)
    ...
    public static final void m3108drawOutlinewDX37Ww(DrawScope drawOutline, Outline outline, long j, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            drawOutline.mo3314drawRectnJ9OG0(j, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            ...
            if (path == null) {
                ...
                drawOutline.mo3316drawRoundRectuAw5IA(j, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m2594getXimpl(roundRect.m2667getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), style, f, colorFilter, i);
                return;
            }
        } else if (!(outline instanceof Outline.Generic)) {
            throw new NoWhenBranchMatchedException();
        ...
        drawOutline.mo3310drawPathLG529CI(path, j, f, style, colorFilter, i);
    }

    /* renamed from: drawOutline-hn5TExg */
    public static final void m3106drawOutlinehn5TExg(DrawScope drawOutline, Outline outline, Brush brush, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        ...
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo3313drawRectAsUm42w(brush, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                RoundRect roundRect = rounded.getRoundRect();
                drawOutline.mo3315drawRoundRectZuiqVtQ(brush, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m2594getXimpl(roundRect.m2667getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), f, style, colorFilter, i);
                return;
            }
        } else if (!(outline instanceof Outline.Generic)) {
            throw new NoWhenBranchMatchedException();
        ...
        drawOutline.mo3309drawPathGBMwjPU(path, brush, f, style, colorFilter, i);
    }
}
