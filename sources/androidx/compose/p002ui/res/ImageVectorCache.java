    ...
    public static final class Key {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Key) {
                Key key = (Key) obj;
                return Intrinsics.areEqual(this.theme, key.theme) && this.f149id == key.f149id;
            }
            return false;
        }

        public int hashCode() {
            return (this.theme.hashCode() * 31) + Integer.hashCode(this.f149id);
        }

        public String toString() {
            return "Key(theme=" + this.theme + ", id=" + this.f149id + ')';
        }
