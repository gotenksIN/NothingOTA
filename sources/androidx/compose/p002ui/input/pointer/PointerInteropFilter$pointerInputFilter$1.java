...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    */
    public void mo4279onPointerEventH0pRuoY(androidx.compose.p002ui.input.pointer.PointerEvent r6, androidx.compose.p002ui.input.pointer.PointerEventPass r7, long r8) {
        /*
            r5 = this;
        ...
        L7c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.input.pointer.PointerInteropFilter$pointerInputFilter$1.mo4279onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent, androidx.compose.ui.input.pointer.PointerEventPass, long):void");
    }
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
        ...
        if (z) {
            if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                ...
                if (layoutCoordinates$ui_release != null) {
                    long mo4383localToRootMKHz9U = layoutCoordinates$ui_release.mo4383localToRootMKHz9U(Offset.Companion.m2635getZeroF1C5BW0());
                    final PointerInteropFilter pointerInteropFilter = this.this$0;
                    PointerInteropUtils_androidKt.m4316toCancelMotionEventScoped4ec7I(pointerEvent, mo4383localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                        /* JADX INFO: Access modifiers changed from: package-private */
                        {
                            super(1);
                        }
        ...
        if (layoutCoordinates$ui_release2 != null) {
            long mo4383localToRootMKHz9U2 = layoutCoordinates$ui_release2.mo4383localToRootMKHz9U(Offset.Companion.m2635getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m4317toMotionEventScoped4ec7I(pointerEvent, mo4383localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
                /* JADX INFO: Access modifiers changed from: package-private */
