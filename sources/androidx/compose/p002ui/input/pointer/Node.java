...
public final class Node extends NodeParent {
    ...
    public boolean buildCache(Map<PointerId, PointerInputChange> changes, LayoutCoordinates parentCoordinates, InternalPointerEvent internalPointerEvent, boolean z) {
        ...
        int m4215getExit7fucELk;
        PointerInputChange m4255copyOHpmEuE;
        ...
        if (PointerInputModifierNodeKt.isAttached(this.pointerInputNode)) {
            ...
            while (true) {
                ...
                long m4246unboximpl = next.getKey().m4246unboximpl();
                PointerInputChange value = next.getValue();
                if (this.pointerIds.contains(PointerId.m4240boximpl(m4246unboximpl))) {
                    ...
                    for (int size = historical.size(); i < size; size = size) {
                        ...
                        arrayList.add(new HistoricalChange(uptimeMillis, layoutCoordinates2.mo4382localPositionOfR5De75A(parentCoordinates, historicalChange.m4188getPositionF1C5BW0()), null));
                        i++;
                        historical = historical;
                    }
                    Map<PointerId, PointerInputChange> map = this.relevantChanges;
                    PointerId m4240boximpl = PointerId.m4240boximpl(m4246unboximpl);
                    LayoutCoordinates layoutCoordinates3 = this.coordinates;
                    Intrinsics.checkNotNull(layoutCoordinates3);
                    long mo4382localPositionOfR5De75A = layoutCoordinates3.mo4382localPositionOfR5De75A(parentCoordinates, value.m4259getPreviousPositionF1C5BW0());
                    LayoutCoordinates layoutCoordinates4 = this.coordinates;
                    Intrinsics.checkNotNull(layoutCoordinates4);
                    m4255copyOHpmEuE = value.m4255copyOHpmEuE((r34 & 1) != 0 ? value.f145id : 0L, (r34 & 2) != 0 ? value.uptimeMillis : 0L, (r34 & 4) != 0 ? value.position : layoutCoordinates4.mo4382localPositionOfR5De75A(parentCoordinates, value.m4258getPositionF1C5BW0()), (r34 & 8) != 0 ? value.pressed : false, (r34 & 16) != 0 ? value.previousUptimeMillis : 0L, (r34 & 32) != 0 ? value.previousPosition : mo4382localPositionOfR5De75A, (r34 & 64) != 0 ? value.previousPressed : false, (r34 & 128) != 0 ? value.type : 0, arrayList, (r34 & 512) != 0 ? value.scrollDelta : 0L);
                    map.put(m4240boximpl, m4255copyOHpmEuE);
                }
            }
            ...
            for (int size2 = this.pointerIds.getSize() - 1; -1 < size2; size2--) {
                if (!changes.containsKey(PointerId.m4240boximpl(this.pointerIds.getContent()[size2].m4246unboximpl()))) {
            ...
            while (true) {
                ...
                if (internalPointerEvent.m4190issuesEnterExitEvent0FcD4WY(pointerInputChange.m4257getIdJ3iCeTQ())) {
                    break;
                }
                i2++;
            }
            ...
            if (pointerInputChange2 != null) {
                if (!z) {
                    ...
                    z2 = true;
                    this.isIn = !PointerEventKt.m4205isOutOfBoundsO0kMr_c(pointerInputChange2, layoutCoordinates.mo4381getSizeYbymL2g());
                    if (this.isIn == this.wasIn && (PointerEventType.m4210equalsimpl0(pointerEvent.m4203getType7fucELk(), PointerEventType.Companion.m4216getMove7fucELk()) || PointerEventType.m4210equalsimpl0(pointerEvent.m4203getType7fucELk(), PointerEventType.Companion.m4214getEnter7fucELk()) || PointerEventType.m4210equalsimpl0(pointerEvent.m4203getType7fucELk(), PointerEventType.Companion.m4215getExit7fucELk()))) {
                        if (this.isIn) {
                            m4215getExit7fucELk = PointerEventType.Companion.m4214getEnter7fucELk();
                        } else {
                            m4215getExit7fucELk = PointerEventType.Companion.m4215getExit7fucELk();
                        }
                        pointerEvent.m4204setTypeEhbLWgg$ui_release(m4215getExit7fucELk);
                    } else if (!PointerEventType.m4210equalsimpl0(pointerEvent.m4203getType7fucELk(), PointerEventType.Companion.m4214getEnter7fucELk()) && this.wasIn && !this.hasExited) {
                        pointerEvent.m4204setTypeEhbLWgg$ui_release(PointerEventType.Companion.m4216getMove7fucELk());
                    } else if (PointerEventType.m4210equalsimpl0(pointerEvent.m4203getType7fucELk(), PointerEventType.Companion.m4215getExit7fucELk()) && this.isIn && pointerInputChange2.getPressed()) {
                        pointerEvent.m4204setTypeEhbLWgg$ui_release(PointerEventType.Companion.m4216getMove7fucELk());
                    }
                }
                z2 = true;
                ...
                if (!PointerEventType.m4210equalsimpl0(pointerEvent.m4203getType7fucELk(), PointerEventType.Companion.m4214getEnter7fucELk())) {
                }
                if (PointerEventType.m4210equalsimpl0(pointerEvent.m4203getType7fucELk(), PointerEventType.Companion.m4215getExit7fucELk())) {
                    pointerEvent.m4204setTypeEhbLWgg$ui_release(PointerEventType.Companion.m4216getMove7fucELk());
                }
            } else {
                z2 = true;
            }
            boolean z3 = (buildCache || !PointerEventType.m4210equalsimpl0(pointerEvent.m4203getType7fucELk(), PointerEventType.Companion.m4216getMove7fucELk()) || hasPositionChanged(this.pointerEvent, pointerEvent)) ? z2 : false;
    ...
    private final boolean hasPositionChanged(PointerEvent pointerEvent, PointerEvent pointerEvent2) {
        ...
        for (int i = 0; i < size; i++) {
            if (!Offset.m2616equalsimpl0(pointerEvent.getChanges().get(i).m4258getPositionF1C5BW0(), pointerEvent2.getChanges().get(i).m4258getPositionF1C5BW0())) {
                return true;
            }
        }
        return false;
    ...
    private final boolean dispatchIfNeeded(Functions<Unit> functions) {
    ...
    public void cleanUpHits(InternalPointerEvent internalPointerEvent) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((pointerInputChange.getPressed() || (internalPointerEvent.m4190issuesEnterExitEvent0FcD4WY(pointerInputChange.m4257getIdJ3iCeTQ()) && this.isIn)) ? false : true) {
                this.pointerIds.remove(PointerId.m4240boximpl(pointerInputChange.m4257getIdJ3iCeTQ()));
            }
        }
        this.isIn = false;
        this.hasExited = PointerEventType.m4210equalsimpl0(pointerEvent.m4203getType7fucELk(), PointerEventType.Companion.m4215getExit7fucELk());
    }
    ...
    */
    public boolean dispatchMainEventPass(java.util.Map<androidx.compose.p002ui.input.pointer.PointerId, androidx.compose.p002ui.input.pointer.PointerInputChange> r9, androidx.compose.p002ui.layout.LayoutCoordinates r10, androidx.compose.p002ui.input.pointer.InternalPointerEvent r11, boolean r12) {
        ...
        L22:
            ...
            long r0 = r0.mo4381getSizeYbymL2g()
            ...
            r2.mo4463onPointerEventH0pRuoY(r9, r3, r0)
            androidx.compose.ui.node.PointerInputModifierNode r2 = r8.pointerInputNode
        ...
        L5f:
            ...
            r10.mo4463onPointerEventH0pRuoY(r9, r11, r0)
        L6e:
            r10 = r3
        L6f:
            return r10
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (!this.relevantChanges.isEmpty() && PointerInputModifierNodeKt.isAttached(this.pointerInputNode)) {
            ...
            this.pointerInputNode.mo4463onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Final, layoutCoordinates.mo4381getSizeYbymL2g());
