...
public final class InternalPointerEvent {
    ...
    public final boolean m4190issuesEnterExitEvent0FcD4WY(long j) {
        ...
        while (true) {
            ...
            if (PointerId.m4243equalsimpl0(internalPointerInput.m4271getIdJ3iCeTQ(), j)) {
                break;
            }
            i++;
        }
