...
public final class HitPathTracker {
    ...
    public final void m4189addHitPathKNwqfcY(long j, List<? extends PointerInputModifierNode> pointerInputNodes) {
        Node node;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (z) {
                ...
                if (node3 != null) {
                    node3.markIsIn();
                    if (!node3.getPointerIds().contains(PointerId.m4240boximpl(j))) {
                        node3.getPointerIds().add(PointerId.m4240boximpl(j));
                    }
                    node2 = node3;
                } else {
                    z = false;
            ...
            node4.getPointerIds().add(PointerId.m4240boximpl(j));
