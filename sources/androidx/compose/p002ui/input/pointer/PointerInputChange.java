...
public final class PointerInputChange {
    ...
    public final long m4257getIdJ3iCeTQ() {
        return this.f145id;
    }
    ...
    public final long m4258getPositionF1C5BW0() {
    ...
    public final long m4259getPreviousPositionF1C5BW0() {
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, boolean z3, int i, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, j4, j5, z2, z3, (i2 & 256) != 0 ? PointerType.Companion.m4336getTouchT8wyACA() : i, (i2 & 512) != 0 ? Offset.Companion.m2635getZeroF1C5BW0() : j6, (DefaultConstructorMarker) null);
    }

    /* renamed from: getType-T8wyACA  reason: not valid java name */
    public final int m4261getTypeT8wyACA() {
        return this.type;
    }

    /* renamed from: getScrollDelta-F1C5BW0  reason: not valid java name */
    public final long m4260getScrollDeltaF1C5BW0() {
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumedData, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, j4, j5, z2, consumedData, (i2 & 256) != 0 ? PointerType.Companion.m4336getTouchT8wyACA() : i, (DefaultConstructorMarker) null);
    }

    private PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumedData, int i) {
        this(j, j2, j3, z, 1.0f, j4, j5, z2, consumedData.getDownChange() || consumedData.getPositionChange(), i, Offset.Companion.m2635getZeroF1C5BW0(), (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, float f, long j4, long j5, boolean z2, boolean z3, int i, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, f, j4, j5, z2, z3, (i2 & 512) != 0 ? PointerType.Companion.m4336getTouchT8wyACA() : i, (i2 & 1024) != 0 ? Offset.Companion.m2635getZeroF1C5BW0() : j6, (DefaultConstructorMarker) null);
    }
    ...
    public final /* synthetic */ PointerInputChange m4253copyEzrO64(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumed, int i) {
        Intrinsics.checkNotNullParameter(consumed, "consumed");
        PointerInputChange pointerInputChange = new PointerInputChange(j, j2, j3, z, getPressure(), j4, j5, z2, consumed.getDownChange() || consumed.getPositionChange(), i, getHistorical(), this.scrollDelta, (DefaultConstructorMarker) null);
        this.consumed = consumed;
        return pointerInputChange;
    }

    /* renamed from: copy-JKmWfYY  reason: not valid java name */
    public final PointerInputChange m4254copyJKmWfYY(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, int i, long j6) {
    ...
    public final PointerInputChange m4252copy0GkPj7c(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumed, int i, long j6) {
        Intrinsics.checkNotNullParameter(consumed, "consumed");
        PointerInputChange pointerInputChange = new PointerInputChange(j, j2, j3, z, getPressure(), j4, j5, z2, consumed.getDownChange() || consumed.getPositionChange(), i, getHistorical(), j6, (DefaultConstructorMarker) null);
        this.consumed = consumed;
        return pointerInputChange;
    }

    /* renamed from: copy-OHpmEuE  reason: not valid java name */
    public final PointerInputChange m4255copyOHpmEuE(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, int i, List<HistoricalChange> historical, long j6) {
        Intrinsics.checkNotNullParameter(historical, "historical");
        PointerInputChange pointerInputChange = new PointerInputChange(j, j2, j3, z, getPressure(), j4, j5, z2, false, i, (List) historical, j6, (DefaultConstructorMarker) null);
        pointerInputChange.consumed = this.consumed;
        return pointerInputChange;
    }

    /* renamed from: copy-wbzehF4  reason: not valid java name */
    public final PointerInputChange m4256copywbzehF4(long j, long j2, long j3, boolean z, float f, long j4, long j5, boolean z2, int i, List<HistoricalChange> historical, long j6) {
        Intrinsics.checkNotNullParameter(historical, "historical");
    ...
    public String toString() {
        ...
        sb.append((Object) PointerId.m4245toStringimpl(this.f145id)).append(", uptimeMillis=").append(this.uptimeMillis).append(", position=").append((Object) Offset.m2627toStringimpl(this.position)).append(", pressed=").append(this.pressed).append(", pressure=").append(getPressure()).append(", previousUptimeMillis=").append(this.previousUptimeMillis).append(", previousPosition=").append((Object) Offset.m2627toStringimpl(this.previousPosition)).append(", previousPressed=").append(this.previousPressed).append(", isConsumed=").append(isConsumed()).append(", type=").append((Object) PointerType.m4331toStringimpl(this.type)).append(", historical=").append(getHistorical()).append(",scrollDelta=");
        sb.append((Object) Offset.m2627toStringimpl(this.scrollDelta)).append(')');
        return sb.toString();
    }
}
