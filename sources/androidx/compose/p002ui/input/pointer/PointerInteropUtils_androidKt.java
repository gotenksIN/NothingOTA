...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m4317toMotionEventScoped4ec7I(PointerEvent toMotionEventScope, long j, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toMotionEventScope, "$this$toMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m4318toMotionEventScopeubNVwUQ(toMotionEventScope, j, block, false);
    }

    /* renamed from: toCancelMotionEventScope-d-4ec7I  reason: not valid java name */
    public static final void m4316toCancelMotionEventScoped4ec7I(PointerEvent toCancelMotionEventScope, long j, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toCancelMotionEventScope, "$this$toCancelMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m4318toMotionEventScopeubNVwUQ(toCancelMotionEventScope, j, block, true);
    }
    ...
    private static final void m4318toMotionEventScopeubNVwUQ(PointerEvent pointerEvent, long j, Function1<? super MotionEvent, Unit> function1, boolean z) {
        ...
        motionEvent$ui_release.offsetLocation(-Offset.m2619getXimpl(j), -Offset.m2620getYimpl(j));
