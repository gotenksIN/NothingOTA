    ...
    public final MeasureResult mo313measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
        ...
        if (size != 0) {
            ...
            if (size == 1) {
                ...
                return MeasureScope.layout$default(Layout, mo4376measureBRTryo0.getWidth(), mo4376measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$2
                    {
                        super(1);
                    }
