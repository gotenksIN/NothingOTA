...
public final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    @Override // androidx.compose.p002ui.window.DialogWindowProvider
    ...
    public DialogLayout(Context context, Window window) {
        ...
        this.window = window;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m5594getLambda1$ui_release(), null, 2, null);
    ...
    public void Content(Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(Content)267@10417L9:AndroidDialog.android.kt#2oxthz");
