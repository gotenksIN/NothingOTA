...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void mo3298drawArcillE91I(Brush brush, float f, float f2, boolean z, long j, long j2, float f3, DrawStyle style, ColorFilter colorFilter, int i) {
        ...
        this.canvasDrawScope.mo3298drawArcillE91I(brush, f, f2, z, j, j2, f3, style, colorFilter, i);
    }
    ...
    public void mo3299drawArcyD3GUKo(long j, float f, float f2, boolean z, long j2, long j3, float f3, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3299drawArcyD3GUKo(j, f, f2, z, j2, j3, f3, style, colorFilter, i);
    }
    ...
    public void mo3300drawCircleV9BoPsw(Brush brush, float f, long j, float f2, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3300drawCircleV9BoPsw(brush, f, j, f2, style, colorFilter, i);
    }
    ...
    public void mo3301drawCircleVaOC9Bg(long j, float f, long j2, float f2, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3301drawCircleVaOC9Bg(j, f, j2, f2, style, colorFilter, i);
    }
    ...
    public /* synthetic */ void mo3302drawImage9jGpkUE(ImageBitmap image, long j, long j2, long j3, long j4, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        ...
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3302drawImage9jGpkUE(image, j, j2, j3, j4, f, style, colorFilter, i);
    }
    ...
    public void mo3303drawImageAZ2fEMs(ImageBitmap image, long j, long j2, long j3, long j4, float f, DrawStyle style, ColorFilter colorFilter, int i, int i2) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3303drawImageAZ2fEMs(image, j, j2, j3, j4, f, style, colorFilter, i, i2);
    }
    ...
    public void mo3304drawImagegbVJVH8(ImageBitmap image, long j, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3304drawImagegbVJVH8(image, j, f, style, colorFilter, i);
    }
    ...
    public void mo3305drawLine1RTmtNc(Brush brush, long j, long j2, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        this.canvasDrawScope.mo3305drawLine1RTmtNc(brush, j, j2, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo3306drawLineNGM6Ib0(long j, long j2, long j3, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.canvasDrawScope.mo3306drawLineNGM6Ib0(j, j2, j3, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo3307drawOvalAsUm42w(Brush brush, long j, long j2, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3307drawOvalAsUm42w(brush, j, j2, f, style, colorFilter, i);
    }
    ...
    public void mo3308drawOvalnJ9OG0(long j, long j2, long j3, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3308drawOvalnJ9OG0(j, j2, j3, f, style, colorFilter, i);
    }
    ...
    public void mo3309drawPathGBMwjPU(Path path, Brush brush, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        ...
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3309drawPathGBMwjPU(path, brush, f, style, colorFilter, i);
    }
    ...
    public void mo3310drawPathLG529CI(Path path, long j, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3310drawPathLG529CI(path, j, f, style, colorFilter, i);
    }
    ...
    public void mo3311drawPointsF8ZwMP8(List<Offset> points, int i, long j, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        ...
        this.canvasDrawScope.mo3311drawPointsF8ZwMP8(points, i, j, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo3312drawPointsGsft0Ws(List<Offset> points, int i, Brush brush, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(brush, "brush");
        this.canvasDrawScope.mo3312drawPointsGsft0Ws(points, i, brush, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo3313drawRectAsUm42w(Brush brush, long j, long j2, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3313drawRectAsUm42w(brush, j, j2, f, style, colorFilter, i);
    }
    ...
    public void mo3314drawRectnJ9OG0(long j, long j2, long j3, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3314drawRectnJ9OG0(j, j2, j3, f, style, colorFilter, i);
    }
    ...
    public void mo3315drawRoundRectZuiqVtQ(Brush brush, long j, long j2, long j3, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3315drawRoundRectZuiqVtQ(brush, j, j2, j3, f, style, colorFilter, i);
    }
    ...
    public void mo3316drawRoundRectuAw5IA(long j, long j2, long j3, long j4, DrawStyle style, float f, ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.canvasDrawScope.mo3316drawRoundRectuAw5IA(j, j2, j3, j4, style, f, colorFilter, i);
    }

    @Override // androidx.compose.p002ui.graphics.drawscope.DrawScope
    /* renamed from: getCenter-F1C5BW0 */
    public long mo3396getCenterF1C5BW0() {
        return this.canvasDrawScope.mo3396getCenterF1C5BW0();
    }
    ...
    public long mo3397getSizeNHjbRc() {
        return this.canvasDrawScope.mo3397getSizeNHjbRc();
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo596roundToPxR2X_6o(long j) {
        return this.canvasDrawScope.mo596roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo597roundToPx0680j_4(float f) {
        return this.canvasDrawScope.mo597roundToPx0680j_4(f);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: toDp-GaN1DYA */
    public float mo598toDpGaN1DYA(long j) {
        return this.canvasDrawScope.mo598toDpGaN1DYA(j);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo599toDpu2uoSUM(float f) {
        return this.canvasDrawScope.mo599toDpu2uoSUM(f);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo600toDpu2uoSUM(int i) {
        return this.canvasDrawScope.mo600toDpu2uoSUM(i);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo601toDpSizekrfVVM(long j) {
        return this.canvasDrawScope.mo601toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo602toPxR2X_6o(long j) {
        return this.canvasDrawScope.mo602toPxR2X_6o(j);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo603toPx0680j_4(float f) {
        return this.canvasDrawScope.mo603toPx0680j_4(f);
    }
    ...
    public long mo604toSizeXkaWNTQ(long j) {
        return this.canvasDrawScope.mo604toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: toSp-0xMU5do */
    public long mo605toSp0xMU5do(float f) {
        return this.canvasDrawScope.mo605toSp0xMU5do(f);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo606toSpkPz2Gy4(float f) {
        return this.canvasDrawScope.mo606toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.p002ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo607toSpkPz2Gy4(int i) {
        return this.canvasDrawScope.mo607toSpkPz2Gy4(i);
    }
    ...
    @Override // androidx.compose.p002ui.graphics.drawscope.ContentDrawScope
    public void drawContent() {
        ...
        NodeCoordinator m4482requireCoordinator64DMado = DelegatableNodeKt.m4482requireCoordinator64DMado(drawModifierNode2, NodeKind.m4578constructorimpl(4));
        if (m4482requireCoordinator64DMado.getTail() == drawModifierNode) {
            m4482requireCoordinator64DMado = m4482requireCoordinator64DMado.getWrapped$ui_release();
            Intrinsics.checkNotNull(m4482requireCoordinator64DMado);
        }
        m4482requireCoordinator64DMado.performDraw(canvas);
    }
    ...
    public final void performDraw(DrawModifierNode drawModifierNode, Canvas canvas) {
        ...
        NodeCoordinator m4482requireCoordinator64DMado = DelegatableNodeKt.m4482requireCoordinator64DMado(drawModifierNode, NodeKind.m4578constructorimpl(4));
        m4482requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui_release().m4515drawx_KDEd0$ui_release(canvas, IntSizeKt.m5521toSizeozmzZPI(m4482requireCoordinator64DMado.mo4381getSizeYbymL2g()), m4482requireCoordinator64DMado, drawModifierNode);
    }

    /* renamed from: draw-x_KDEd0$ui_release  reason: not valid java name */
    public final void m4515drawx_KDEd0$ui_release(Canvas canvas, long j, NodeCoordinator coordinator, DrawModifierNode drawNode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
