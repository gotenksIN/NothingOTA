...
public abstract class AlignmentLines {
    ...
    protected abstract long mo4461calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int i, NodeCoordinator nodeCoordinator) {
        ...
        while (true) {
            Offset = mo4461calculatePositionInParentR5De75A(nodeCoordinator, Offset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            roundToInt = MathKt.roundToInt(Offset.m2620getYimpl(Offset));
        } else {
            roundToInt = MathKt.roundToInt(Offset.m2619getXimpl(Offset));
        }
