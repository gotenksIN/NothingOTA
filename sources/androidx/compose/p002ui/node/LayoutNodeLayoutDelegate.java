...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m4520getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m4525getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw  reason: not valid java name */
    public final Constraints m4521getLastLookaheadConstraintsDWUhwKw() {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            return lookaheadPassDelegate.m4522getLastConstraintsDWUhwKw();
        }
        return null;
    }
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        private long lastPosition = IntOffset.Companion.m5479getZeronOccac();
        ...
        /* renamed from: getLastConstraints-DWUhwKw  reason: not valid java name */
        public final Constraints m4525getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m5295boximpl(m4421getMeasurementConstraintsmsEJaDk());
            }
            return null;
        }
        ...
        @Override // androidx.compose.p002ui.node.AlignmentLinesOwner
        ...
        public void layoutChildren() {
            ...
            if (LayoutNodeLayoutDelegate.this.layoutPendingForAlignment || (!this.duringAlignmentLinesQuery && !getInnerCoordinator().isPlacingForAlignment$ui_release() && LayoutNodeLayoutDelegate.this.getLayoutPending$ui_release())) {
                ...
                LayoutNodeKt.requireOwner(layoutNode).getSnapshotObserver().observeLayoutSnapshotReads$ui_release(layoutNode, false, new Functions<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$layoutChildren$1$1
        ...
        public Placeable mo4376measureBRTryo0(long j) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                lookaheadPassDelegate$ui_release.mo4376measureBRTryo0(j);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m4526remeasureBRTryo0(j);
            return this;
        }

        /* renamed from: remeasure-BRTryo0  reason: not valid java name */
        public final boolean m4526remeasureBRTryo0(long j) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m5300equalsimpl0(m4421getMeasurementConstraintsmsEJaDk(), j)) {
            ...
            this.measuredOnce = true;
            long mo4381getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4381getSizeYbymL2g();
            m4423setMeasurementConstraintsBRTryo0(j);
            LayoutNodeLayoutDelegate.this.m4519performMeasureBRTryo0(j);
            if (IntSize.m5509equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4381getSizeYbymL2g(), mo4381getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m4422setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        @Override // androidx.compose.p002ui.layout.Placeable, androidx.compose.p002ui.layout.Measured
        ...
        public void mo4377placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            if (!IntOffset.m5468equalsimpl0(j, this.lastPosition)) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                LookaheadPassDelegate lookaheadPassDelegate$ui_release = LayoutNodeLayoutDelegate.this.getLookaheadPassDelegate$ui_release();
                Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
                Placeable.PlacementScope.place$default(companion, lookaheadPassDelegate$ui_release, IntOffset.m5469getXimpl(j), IntOffset.m5470getYimpl(j), 0.0f, 4, null);
            }
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LayingOut;
            m4524placeOuterCoordinatorf8xVGno(j, f, function1);
        ...
        private final void m4524placeOuterCoordinatorf8xVGno(final long j, final float f, final Function1<? super GraphicsLayerScope, Unit> function1) {
            this.lastPosition = j;
            this.lastZIndex = f;
            ...
            final LayoutNodeLayoutDelegate layoutNodeLayoutDelegate = LayoutNodeLayoutDelegate.this;
            snapshotObserver.observeLayoutModifierSnapshotReads$ui_release(layoutNode, false, new Functions<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinator$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke2() {
                    ...
                    float f2 = f;
                    if (function12 == null) {
                        companion.m4428place70tqf50(layoutNodeLayoutDelegate2.getOuterCoordinator(), j2, f2);
                    } else {
                        companion.m4433placeWithLayeraW9wM(layoutNodeLayoutDelegate2.getOuterCoordinator(), j2, f2, function12);
                    }
                }
            });
        }
        ...
        public final void replace() {
            ...
            m4524placeOuterCoordinatorf8xVGno(this.lastPosition, this.lastZIndex, this.lastLayerBlock);
        }
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m4504remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        public LookaheadPassDelegate(LayoutNodeLayoutDelegate layoutNodeLayoutDelegate, LookaheadScope lookaheadScope) {
            ...
            this.lastPosition = IntOffset.Companion.m5479getZeronOccac();
            this.isPlaced = true;
        ...
        /* renamed from: getLastConstraints-DWUhwKw  reason: not valid java name */
        public final Constraints m4522getLastConstraintsDWUhwKw() {
        ...
        public void layoutChildren() {
            ...
            if (this.this$0.lookaheadLayoutPendingForAlignment || (!this.duringAlignmentLinesQuery && !lookaheadDelegate$ui_release.isPlacingForAlignment$ui_release() && this.this$0.getLookaheadLayoutPending$ui_release())) {
                ...
                OwnerSnapshotObserver.observeLayoutSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Functions<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    ...
                    */
                    public final void invoke2() {
                        /*
                            r7 = this;
                            androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate r0 = androidx.compose.p002ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.this
                            androidx.compose.ui.node.LayoutNodeLayoutDelegate r0 = r0.this$0
                            androidx.compose.ui.node.LayoutNode r0 = androidx.compose.p002ui.node.LayoutNodeLayoutDelegate.access$getLayoutNode$p(r0)
                        ...
                        L18:
                            r4 = r0[r3]
                            androidx.compose.ui.node.LayoutNode r4 = (androidx.compose.p002ui.node.LayoutNode) r4
                            ...
                            androidx.compose.p002ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.access$setPreviouslyPlaced$p(r4, r5)
                            r4.setPlaced(r2)
                            int r3 = r3 + 1
                            if (r3 < r1) goto L18
                        L35:
                        ...
                        L4a:
                            ...
                            androidx.compose.ui.node.LayoutNode$UsageByParent r6 = androidx.compose.p002ui.node.LayoutNode.UsageByParent.InLayoutBlock
                            if (r5 != r6) goto L5b
                            androidx.compose.ui.node.LayoutNode$UsageByParent r5 = androidx.compose.p002ui.node.LayoutNode.UsageByParent.NotUsed
                        ...
                        L5f:
                            androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate r0 = androidx.compose.p002ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.this
                            androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1$3 r1 = new kotlin.jvm.functions.Function1<androidx.compose.p002ui.node.AlignmentLinesOwner, kotlin.Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.3
                                static {
                                    /*
                                        ...
                                        return
                                    */
                                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.C07103.<clinit>():void");
                                }

                                {
                                    /*
                                        ...
                                        return
                                    */
                                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.C07103.<init>():void");
                                }

                                @Override // kotlin.jvm.functions.Function1
                                public /* bridge */ /* synthetic */ kotlin.Unit invoke(androidx.compose.p002ui.node.AlignmentLinesOwner r1) {
                                    /*
                                        r0 = this;
                                        androidx.compose.ui.node.AlignmentLinesOwner r1 = (androidx.compose.p002ui.node.AlignmentLinesOwner) r1
                                        r0.invoke2(r1)
                                        kotlin.Unit r1 = kotlin.Unit.INSTANCE
                                        return r1
                                    */
                                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.C07103.invoke(java.lang.Object):java.lang.Object");
                                }

                                /* renamed from: invoke  reason: avoid collision after fix types in other method */
                                public final void invoke2(androidx.compose.p002ui.node.AlignmentLinesOwner r2) {
                                    /*
                                        r1 = this;
                                        ...
                                        return
                                    */
                                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.C07103.invoke2(androidx.compose.ui.node.AlignmentLinesOwner):void");
                                }
                            }
                            ...
                            r0.placeChildren()
                            androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate r0 = androidx.compose.p002ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.this
                            androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1$4 r1 = new kotlin.jvm.functions.Function1<androidx.compose.p002ui.node.AlignmentLinesOwner, kotlin.Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.4
                                static {
                                    /*
                                        ...
                                        return
                                    */
                                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.C07114.<clinit>():void");
                                }

                                {
                                    /*
                                        ...
                                        return
                                    */
                                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.C07114.<init>():void");
                                }
                                ...
                                public /* bridge */ /* synthetic */ kotlin.Unit invoke(androidx.compose.p002ui.node.AlignmentLinesOwner r1) {
                                    /*
                                        ...
                                        return r1
                                    */
                                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.C07114.invoke(java.lang.Object):java.lang.Object");
                                }
                                ...
                                public final void invoke2(androidx.compose.p002ui.node.AlignmentLinesOwner r2) {
                                    /*
                                        ...
                                        return
                                    */
                                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.C07114.invoke2(androidx.compose.ui.node.AlignmentLinesOwner):void");
                                }
                            }
                            kotlin.jvm.functions.Function1 r1 = (kotlin.jvm.functions.Function1) r1
                            r0.forEachChildAlignmentLinesOwner(r1)
                        ...
                        L90:
                            ...
                            if (r4 != 0) goto La8
                            androidx.compose.p002ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.access$markSubtreeNotPlaced(r3)
                        La8:
                            int r2 = r2 + 1
                            if (r2 < r1) goto L90
                        Lac:
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$layoutChildren$1.invoke2():void");
                    }
                }, 2, null);
        ...
        /* renamed from: remeasure-BRTryo0  reason: not valid java name */
        public final boolean m4523remeasureBRTryo0(long j) {
            LayoutNode parent$ui_release = this.this$0.layoutNode.getParent$ui_release();
            ...
            this.lookaheadConstraints = Constraints.m5295boximpl(j);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            this.this$0.m4518performLookaheadMeasureBRTryo0(j);
            m4422setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate$ui_release.getWidth(), lookaheadDelegate$ui_release.getHeight()));
            return (IntSize.m5511getWidthimpl(IntSize) == lookaheadDelegate$ui_release.getWidth() && IntSize.m5510getHeightimpl(IntSize) == lookaheadDelegate$ui_release.getHeight()) ? false : true;
        }

        /* JADX INFO: Access modifiers changed from: protected */
        @Override // androidx.compose.p002ui.layout.Placeable
        /* renamed from: placeAt-f8xVGno */
        public void mo4377placeAtf8xVGno(final long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            this.this$0.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            if (!IntOffset.m5468equalsimpl0(j, this.lastPosition)) {
                notifyChildrenUsingCoordinatesWhilePlacing();
            ...
            LayoutNode layoutNode = this.this$0.layoutNode;
            final LayoutNodeLayoutDelegate layoutNodeLayoutDelegate = this.this$0;
            OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Functions<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeAt$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                ...
                public final void invoke2() {
                    ...
                    Intrinsics.checkNotNull(lookaheadDelegate$ui_release);
                    Placeable.PlacementScope.m4424place70tqf50$default(companion2, lookaheadDelegate$ui_release, j2, 0.0f, 2, null);
                }
            }, 2, null);
            this.lastPosition = j;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        ...
                        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
                        Constraints m4522getLastConstraintsDWUhwKw = m4522getLastConstraintsDWUhwKw();
                        Intrinsics.checkNotNull(m4522getLastConstraintsDWUhwKw);
                        if (lookaheadPassDelegate$ui_release.m4523remeasureBRTryo0(m4522getLastConstraintsDWUhwKw.m5313unboximpl())) {
        ...
        public final void replace() {
            ...
            mo4377placeAtf8xVGno(this.lastPosition, 0.0f, null);
        }
    }
    ...
    public final void m4519performMeasureBRTryo0(final long j) {
        if (!(this.layoutState == LayoutNode.LayoutState.Idle)) {
            throw new IllegalStateException("layout state is not idle before measure starts".toString());
        }
        this.layoutState = LayoutNode.LayoutState.Measuring;
        this.measurePending = false;
        LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver().observeMeasureSnapshotReads$ui_release(this.layoutNode, false, new Functions<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasure$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            ...
            /* renamed from: invoke  reason: avoid collision after fix types in other method */
            public final void invoke2() {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4376measureBRTryo0(j);
            }
        });
    ...
    public final void m4518performLookaheadMeasureBRTryo0(final long j) {
        this.layoutState = LayoutNode.LayoutState.LookaheadMeasuring;
        this.lookaheadMeasurePending = false;
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Functions<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
