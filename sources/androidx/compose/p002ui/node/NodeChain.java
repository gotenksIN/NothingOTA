    ...
    */
    ...
    private final void syncCoordinators() {
        ...
        for (Modifier.Node parent$ui_release = this.tail.getParent$ui_release(); parent$ui_release != null; parent$ui_release = parent$ui_release.getParent$ui_release()) {
            if (((NodeKind.m4578constructorimpl(2) & parent$ui_release.getKindSet$ui_release()) != 0) && (parent$ui_release instanceof LayoutModifierNode)) {
    ...
    public final class Differ implements DiffCallback {
        ...
        @Override // androidx.compose.p002ui.node.DiffCallback
    ...
    public final boolean m4541hasH91voCI$ui_release(int i) {
    ...
    public final /* synthetic */ <T> T m4540firstFromHeadaLcG6gQ$ui_release(int i, Function1<? super T, Boolean> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if ((getAggregateChildKindSet() & i) != 0) {
            for (Modifier.Node head$ui_release = getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
    ...
    public final /* synthetic */ <T> void m4543headToTailaLcG6gQ$ui_release(int i, Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if ((getAggregateChildKindSet() & i) != 0) {
            for (Modifier.Node head$ui_release = getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if ((head$ui_release.getKindSet$ui_release() & i) != 0) {
    ...
    public final /* synthetic */ <T> void m4545tailToHeadaLcG6gQ$ui_release(int i, Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if ((getAggregateChildKindSet() & i) != 0) {
            for (Modifier.Node tail$ui_release = getTail$ui_release(); tail$ui_release != null; tail$ui_release = tail$ui_release.getParent$ui_release()) {
                if ((tail$ui_release.getKindSet$ui_release() & i) != 0) {
    ...
    public final /* synthetic */ <T> T m4544tailH91voCI$ui_release(int i) {
        if ((getAggregateChildKindSet() & i) != 0) {
    ...
    public final /* synthetic */ <T> T m4542headH91voCI$ui_release(int i) {
        if ((getAggregateChildKindSet() & i) != 0) {
