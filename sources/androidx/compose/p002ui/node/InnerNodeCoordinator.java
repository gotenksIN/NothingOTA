...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo4376measureBRTryo0(long j) {
            ...
            LookaheadDelegate.m4528access$setMeasurementConstraintsBRTryo0(lookaheadDelegateImpl, j);
            MutableVector<LayoutNode> mutableVector = getLayoutNode().get_children$ui_release();
            int size = mutableVector.getSize();
            if (size <= 0) {
                LookaheadDelegate.access$set_measureResult(lookaheadDelegateImpl, getLayoutNode().getMeasurePolicy().mo313measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), j));
        ...
        @Override // androidx.compose.p002ui.node.LookaheadDelegate
    ...
    public Placeable mo4376measureBRTryo0(long j) {
        ...
        int size = mutableVector.getSize();
        if (size <= 0) {
            setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo313measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), j));
            onMeasured();
            return this;
        }
        LayoutNode[] content = mutableVector.getContent();
    ...
    */
    public void performDraw(androidx.compose.p002ui.graphics.Canvas r7) {
        /*
            r6 = this;
            java.lang.String r0 = "canvas"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r7, r0)
            androidx.compose.ui.node.LayoutNode r0 = r6.getLayoutNode()
            androidx.compose.ui.node.Owner r0 = androidx.compose.p002ui.node.LayoutNodeKt.requireOwner(r0)
        ...
        L31:
            ...
            if (r0 == 0) goto L3c
            androidx.compose.ui.graphics.Paint r0 = androidx.compose.p002ui.node.InnerNodeCoordinator.innerBoundsPaint
            r6.drawBorder(r7, r0)
        L3c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.InnerNodeCoordinator.performDraw(androidx.compose.ui.graphics.Canvas):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public <T extends androidx.compose.p002ui.node.DelegatableNode> void mo4500hitTestChildYqVAtuI(androidx.compose.p002ui.node.NodeCoordinator.HitTestSource<T> r20, long r21, androidx.compose.p002ui.node.HitTestResult<T> r23, boolean r24, boolean r25) {
        /*
            r19 = this;
            r0 = r19
            r8 = r20
            ...
            r13 = 0
            if (r1 == 0) goto L46
            boolean r1 = r0.m4572withinLayerBoundsk4lQ0M(r9)
            if (r1 == 0) goto L28
            r14 = r25
            r1 = r12
            goto L49
        L28:
            if (r24 == 0) goto L46
            long r1 = r19.m4562getMinimumTouchTargetSizeNHjbRc()
            float r1 = r0.m4559distanceInMinimumTouchTargettz77jQw(r9, r1)
        ...
        L49:
            if (r1 == 0) goto La3
            int r15 = androidx.compose.p002ui.node.HitTestResult.access$getHitDepth$p(r23)
            androidx.compose.ui.node.LayoutNode r1 = r19.getLayoutNode()
            androidx.compose.runtime.collection.MutableVector r1 = r1.getZSortedChildren()
            int r2 = r1.getSize()
            if (r2 <= 0) goto La0
        ...
        L64:
            ...
            r6 = r24
            r7 = r14
            r1.mo4573childHitTestYqVAtuI(r2, r3, r5, r6, r7)
        ...
        L9a:
            ...
            if (r17 >= 0) goto L64
        La0:
            androidx.compose.p002ui.node.HitTestResult.access$setHitDepth$p(r11, r15)
        La3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p002ui.node.InnerNodeCoordinator.mo4500hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator$HitTestSource, long, androidx.compose.ui.node.HitTestResult, boolean, boolean):void");
    }

    /* compiled from: InnerNodeCoordinator.kt */
    @Metadata(m41d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, m40d2 = {"Landroidx/compose/ui/node/InnerNodeCoordinator$Companion;", "", "()V", "innerBoundsPaint", "Landroidx/compose/ui/graphics/Paint;", "getInnerBoundsPaint", "()Landroidx/compose/ui/graphics/Paint;", "ui_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
    ...
    static {
        ...
        Paint.mo2739setColor8_81llA(Color.Companion.m2891getRed0d7_KjU());
