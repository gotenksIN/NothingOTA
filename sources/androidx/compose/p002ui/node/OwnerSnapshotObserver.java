...
public final class OwnerSnapshotObserver {
    ...
    public OwnerSnapshotObserver(Function1<? super Functions<Unit>, Unit> onChangedExecutor) {
    ...
    public static /* synthetic */ void observeLayoutSnapshotReads$ui_release$default(OwnerSnapshotObserver ownerSnapshotObserver, LayoutNode layoutNode, boolean z, Functions functions, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        ownerSnapshotObserver.observeLayoutSnapshotReads$ui_release(layoutNode, z, functions);
    }

    public final void observeLayoutSnapshotReads$ui_release(LayoutNode node, boolean z, Functions<Unit> block) {
    ...
    public static /* synthetic */ void observeLayoutModifierSnapshotReads$ui_release$default(OwnerSnapshotObserver ownerSnapshotObserver, LayoutNode layoutNode, boolean z, Functions functions, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        ownerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release(layoutNode, z, functions);
    }

    public final void observeLayoutModifierSnapshotReads$ui_release(LayoutNode node, boolean z, Functions<Unit> block) {
        Intrinsics.checkNotNullParameter(node, "node");
        Intrinsics.checkNotNullParameter(block, "block");
        if (z && node.getMLookaheadScope$ui_release() != null) {
    ...
    public static /* synthetic */ void observeMeasureSnapshotReads$ui_release$default(OwnerSnapshotObserver ownerSnapshotObserver, LayoutNode layoutNode, boolean z, Functions functions, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        ownerSnapshotObserver.observeMeasureSnapshotReads$ui_release(layoutNode, z, functions);
    }

    public final void observeMeasureSnapshotReads$ui_release(LayoutNode node, boolean z, Functions<Unit> block) {
        Intrinsics.checkNotNullParameter(node, "node");
        Intrinsics.checkNotNullParameter(block, "block");
        if (z && node.getMLookaheadScope$ui_release() != null) {
    ...
    public final <T extends OwnerScope> void observeReads$ui_release(T target, Function1<? super T, Unit> onChanged, Functions<Unit> block) {
