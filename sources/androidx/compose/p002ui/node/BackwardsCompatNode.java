...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, IntermediateLayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((NodeKind.m4578constructorimpl(32) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
        ...
        if ((backwardsCompatNode.getKindSet$ui_release() & NodeKind.m4578constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean z) {
        ...
        if ((NodeKind.m4578constructorimpl(32) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
            ...
            if (element instanceof ModifierLocalConsumer) {
                if (z) {
                    ...
                    sideEffect(new Functions<Unit>() { // from class: androidx.compose.ui.node.BackwardsCompatNode$initializeModifier$1
        ...
        if ((NodeKind.m4578constructorimpl(4) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
        ...
        if ((NodeKind.m4578constructorimpl(2) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
        ...
        if ((NodeKind.m4578constructorimpl(128) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(backwardsCompatNode4).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode$initializeModifier$2
                        ...
                        public void onLayoutComplete() {
                            ...
                            if (layoutCoordinates == null) {
                                ...
                                backwardsCompatNode5.onPlaced(DelegatableNodeKt.m4482requireCoordinator64DMado(backwardsCompatNode5, NodeKind.m4578constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if (((NodeKind.m4578constructorimpl(256) & backwardsCompatNode.getKindSet$ui_release()) != 0) && (element instanceof OnGloballyPositionedModifier)) {
        ...
        if (((NodeKind.m4578constructorimpl(16) & backwardsCompatNode.getKindSet$ui_release()) != 0) && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator$ui_release());
        }
        if ((NodeKind.m4578constructorimpl(8) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo2528getSizeNHjbRc() {
        return IntSizeKt.m5521toSizeozmzZPI(DelegatableNodeKt.m4482requireCoordinator64DMado(this, NodeKind.m4578constructorimpl(128)).mo4381getSizeYbymL2g());
    }
    ...
    private final void updateDrawCache() {
        ...
        if (element instanceof DrawCacheModifier) {
            ...
            DelegatableNodeKt.requireOwner(this).getSnapshotObserver().observeReads$ui_release(this, function1, new Functions<Unit>() { // from class: androidx.compose.ui.node.BackwardsCompatNode$updateDrawCache$1
                /* JADX INFO: Access modifiers changed from: package-private */
    ...
    @Override // androidx.compose.p002ui.modifier.ModifierLocalNode
    ...
    @Override // androidx.compose.p002ui.modifier.ModifierLocalNode, androidx.compose.p002ui.modifier.ModifierLocalReadScope
    ...
    public final void updateModifierLocalConsumer() {
        ...
        if (isAttached()) {
            ...
            DelegatableNodeKt.requireOwner(this).getSnapshotObserver().observeReads$ui_release(this, function1, new Functions<Unit>() { // from class: androidx.compose.ui.node.BackwardsCompatNode$updateModifierLocalConsumer$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
    ...
    @Override // androidx.compose.p002ui.node.IntermediateLayoutModifierNode
    /* renamed from: getTargetSize-YbymL2g  reason: not valid java name */
    public long mo4462getTargetSizeYbymL2g() {
        Modifier.Element element = this.element;
        ...
        return ((IntermediateLayoutModifier) element).mo4378getTargetSizeYbymL2g();
    }

    @Override // androidx.compose.p002ui.node.IntermediateLayoutModifierNode
    /* renamed from: setTargetSize-ozmzZPI  reason: not valid java name */
    public void mo4465setTargetSizeozmzZPI(long j) {
        Modifier.Element element = this.element;
        Intrinsics.checkNotNull(element, "null cannot be cast to non-null type androidx.compose.ui.layout.IntermediateLayoutModifier");
        ((IntermediateLayoutModifier) element).mo4379setTargetSizeozmzZPI(j);
    }
    ...
    public MeasureResult mo2534measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return ((LayoutModifier) element).mo326measure3p2s80s(measure, measurable, j);
    }
    ...
    @Override // androidx.compose.p002ui.node.PointerInputModifierNode
    /* renamed from: onPointerEvent-H0pRuoY  reason: not valid java name */
    public void mo4463onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long j) {
        ...
        ((PointerInputModifier) element).getPointerInputFilter().mo4279onPointerEventH0pRuoY(pointerEvent, pass, j);
    }
    ...
    @Override // androidx.compose.p002ui.node.GlobalPositionAwareModifierNode
    ...
    public void mo4464onRemeasuredozmzZPI(long j) {
        Modifier.Element element = this.element;
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).mo526onRemeasuredozmzZPI(j);
        }
    }
