...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i, boolean z, long j) {
        ...
        this.ellipsis = z;
        this.constraints = j;
        if ((Constraints.m5007getMinHeightimpl(j) == 0 && Constraints.m5008getMinWidthimpl(j) == 0) != true) {
        ...
        int m4454access$toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m4454access$toLayoutAlignAMY3VfE(style.m4615getTextAlignbuA522U());
        TextAlign m4615getTextAlignbuA522U = style.m4615getTextAlignbuA522U();
        int i2 = m4615getTextAlignbuA522U == null ? 0 : TextAlign.m4940equalsimpl0(m4615getTextAlignbuA522U.m4943unboximpl(), TextAlign.Companion.m4946getJustifye0LSkKk()) ? 1 : 0;
        int m4456access$toLayoutHyphenationFrequency0_XeFpE = AndroidParagraph_androidKt.m4456access$toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle$ui_text_release().m4499getHyphensEaSxIns());
        LineBreak m4613getLineBreakLgCVezo = style.m4613getLineBreakLgCVezo();
        int m4455access$toLayoutBreakStrategyu6PBz3U = AndroidParagraph_androidKt.m4455access$toLayoutBreakStrategyu6PBz3U(m4613getLineBreakLgCVezo != null ? LineBreak.Strategy.m4877boximpl(LineBreak.m4868getStrategyfcGXIks(m4613getLineBreakLgCVezo.m4873unboximpl())) : null);
        LineBreak m4613getLineBreakLgCVezo2 = style.m4613getLineBreakLgCVezo();
        int m4457access$toLayoutLineBreakStyle4a2g8L8 = AndroidParagraph_androidKt.m4457access$toLayoutLineBreakStyle4a2g8L8(m4613getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m4887boximpl(LineBreak.m4869getStrictnessusljTpc(m4613getLineBreakLgCVezo2.m4873unboximpl())) : null);
        LineBreak m4613getLineBreakLgCVezo3 = style.m4613getLineBreakLgCVezo();
        int m4458access$toLayoutLineBreakWordStylegvcdTPQ = AndroidParagraph_androidKt.m4458access$toLayoutLineBreakWordStylegvcdTPQ(m4613getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m4898boximpl(LineBreak.m4870getWordBreakjp8hJ3c(m4613getLineBreakLgCVezo3.m4873unboximpl())) : null);
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout constructTextLayout = constructTextLayout(m4454access$toLayoutAlignAMY3VfE, i2, truncateAt, i, m4456access$toLayoutHyphenationFrequency0_XeFpE, m4455access$toLayoutBreakStrategyu6PBz3U, m4457access$toLayoutLineBreakStyle4a2g8L8, m4458access$toLayoutLineBreakWordStylegvcdTPQ);
        if (z && constructTextLayout.getHeight() > Constraints.m5005getMaxHeightimpl(j) && i > 1) {
            int access$numberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.access$numberOfLinesThatFitMaxHeight(constructTextLayout, Constraints.m5005getMaxHeightimpl(j));
            if (access$numberOfLinesThatFitMaxHeight >= 0 && access$numberOfLinesThatFitMaxHeight != i) {
                constructTextLayout = constructTextLayout(m4454access$toLayoutAlignAMY3VfE, i2, truncateAt, RangesKt.coerceAtLeast(access$numberOfLinesThatFitMaxHeight, 1), m4456access$toLayoutHyphenationFrequency0_XeFpE, m4455access$toLayoutBreakStrategyu6PBz3U, m4457access$toLayoutLineBreakStyle4a2g8L8, m4458access$toLayoutLineBreakWordStylegvcdTPQ);
            }
            this.layout = constructTextLayout;
        } else {
            this.layout = constructTextLayout;
        }
        getTextPaint$ui_text_release().m4813setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
            shaderBrushSpan.m4832setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public final long m4448getConstraintsmsEJaDk() {
    ...
    public float getWidth() {
        return Constraints.m5006getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo4449getOffsetForPositionk4lQ0M(long j) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m2319getYimpl(j)), Offset.m2318getXimpl(j));
    }
    ...
    public final void m4447fillBoundingBoxes8ffj60Q(long j, float[] array, int i) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m4585getMinimpl(j), TextRange.m4584getMaximpl(j), array, i);
    }
    ...
    public long mo4450getWordBoundaryjx7JFs(int i) {
    ...
    public void mo4452paintRPmYEkk(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4814setColor8_81llA(j);
    ...
    public void mo4451paintLG529CI(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int m4811getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4811getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4814setColor8_81llA(j);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4812setBlendModes9anfk8(i);
        paint(canvas);
        getTextPaint$ui_text_release().m4812setBlendModes9anfk8(m4811getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg  reason: not valid java name */
    public void mo4453painthn5TExg(Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int m4811getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4811getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4813setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), f);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4812setBlendModes9anfk8(i);
