...
public final class SaversKt {
    ...
    private static final Saver<ParagraphStyle, Object> ParagraphStyleSaver = SaverKt.Saver(new Function2<SaverScope, ParagraphStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$ParagraphStyleSaver$1
        ...
        public final Object invoke(SaverScope Saver, ParagraphStyle it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(it.m4504getTextAlignbuA522U()), SaversKt.save(it.m4506getTextDirectionmmuk1to()), SaversKt.save(TextUnit.m5221boximpl(it.m4503getLineHeightXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.getTextIndent(), SaversKt.getSaver(TextIndent.Companion), Saver));
        }
        ...
        public final ParagraphStyle invoke(Object it) {
            ...
            long m5240unboximpl = restore.m5240unboximpl();
            Object obj4 = list.get(3);
            return new ParagraphStyle(textAlign, textDirection, m5240unboximpl, (Intrinsics.areEqual(obj4, (Object) false) || obj4 == null) ? null : SaversKt.getSaver(TextIndent.Companion).restore(obj4), (PlatformParagraphStyle) null, (LineHeightStyle) null, (LineBreak) null, (Hyphens) null, 240, (DefaultConstructorMarker) null);
        }
    });
    private static final Saver<SpanStyle, Object> SpanStyleSaver = SaverKt.Saver(new Function2<SaverScope, SpanStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$1
        ...
        public final Object invoke(SaverScope Saver, SpanStyle it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m2546boximpl(it.m4547getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(TextUnit.m5221boximpl(it.m4548getFontSizeXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.getFontWeight(), SaversKt.getSaver(FontWeight.Companion), Saver), SaversKt.save(it.m4549getFontStyle4Lr2A7w()), SaversKt.save(it.m4550getFontSynthesisZQGJjVo()), SaversKt.save(-1), SaversKt.save(it.getFontFeatureSettings()), SaversKt.save(TextUnit.m5221boximpl(it.m4551getLetterSpacingXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.m4546getBaselineShift5SSeXJ0(), SaversKt.getSaver(BaselineShift.Companion), Saver), SaversKt.save(it.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.Companion), Saver), SaversKt.save(it.getLocaleList(), SaversKt.getSaver(LocaleList.Companion), Saver), SaversKt.save(Color.m2546boximpl(it.m4545getBackground0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(it.getTextDecoration(), SaversKt.getSaver(TextDecoration.Companion), Saver), SaversKt.save(it.getShadow(), SaversKt.getSaver(Shadow.Companion), Saver));
        }
        ...
        public final SpanStyle invoke(Object it) {
            ...
            Intrinsics.checkNotNull(restore);
            long m2566unboximpl = restore.m2566unboximpl();
            Object obj2 = list.get(1);
            ...
            long m5240unboximpl = restore2.m5240unboximpl();
            Object obj3 = list.get(2);
            ...
            long m5240unboximpl2 = restore4.m5240unboximpl();
            ...
            long m2566unboximpl2 = restore8.m2566unboximpl();
            ...
            return new SpanStyle(m2566unboximpl, m5240unboximpl, restore3, fontStyle, fontSynthesis, (FontFamily) null, str, m5240unboximpl2, restore5, restore6, restore7, m2566unboximpl2, restore9, (Intrinsics.areEqual(obj13, (Object) false) || obj13 == null) ? null : SaversKt.getSaver(Shadow.Companion).restore(obj13), 32, (DefaultConstructorMarker) null);
        }
    });
    ...
    private static final Saver<TextIndent, Object> TextIndentSaver = SaverKt.Saver(new Function2<SaverScope, TextIndent, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextIndentSaver$1
        ...
        public final Object invoke(SaverScope Saver, TextIndent it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m5221boximpl(it.m4966getFirstLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(TextUnit.m5221boximpl(it.m4967getRestLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver));
        }
        ...
        public final TextIndent invoke(Object it) {
            ...
            return new TextIndent(m5240unboximpl, textUnit.m5240unboximpl(), null);
        }
    });
    ...
    private static final Saver<BaselineShift, Object> BaselineShiftSaver = SaverKt.Saver(new Function2<SaverScope, BaselineShift, Object>() { // from class: androidx.compose.ui.text.SaversKt$BaselineShiftSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, BaselineShift baselineShift) {
            return m4527invoke8a2Sb4w(saverScope, baselineShift.m4839unboximpl());
        }

        /* renamed from: invoke-8a2Sb4w  reason: not valid java name */
        public final Object m4527invoke8a2Sb4w(SaverScope Saver, float f) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
        ...
        public final BaselineShift invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return BaselineShift.m4833boximpl(BaselineShift.m4834constructorimpl(((Float) it).floatValue()));
        }
    });
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2<SaverScope, TextRange, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextRange textRange) {
            return m4533invokeFDrldGo(saverScope, textRange.m4591unboximpl());
        }

        /* renamed from: invoke-FDrldGo  reason: not valid java name */
        public final Object m4533invokeFDrldGo(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf((Integer) SaversKt.save(Integer.valueOf(TextRange.m4587getStartimpl(j))), (Integer) SaversKt.save(Integer.valueOf(TextRange.m4582getEndimpl(j))));
        }
        ...
        public final TextRange invoke(Object it) {
            ...
            Intrinsics.checkNotNull(num2);
            return TextRange.m4575boximpl(TextRangeKt.TextRange(intValue, num2.intValue()));
        }
    });
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2<SaverScope, Shadow, Object>() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Object invoke(SaverScope Saver, Shadow it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m2546boximpl(it.m2871getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(Offset.m2307boximpl(it.m2872getOffsetF1C5BW0()), SaversKt.getSaver(Offset.Companion), Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
        }
        ...
        public final Shadow invoke(Object it) {
            ...
            Intrinsics.checkNotNull(restore2);
            long m2328unboximpl = restore2.m2328unboximpl();
            Object obj3 = list.get(2);
            Float f = obj3 != null ? (Float) obj3 : null;
            Intrinsics.checkNotNull(f);
            return new Shadow(m2566unboximpl, m2328unboximpl, f.floatValue(), null);
        }
    });
    private static final Saver<Color, Object> ColorSaver = SaverKt.Saver(new Function2<SaverScope, Color, Object>() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Color color) {
            return m4529invoke4WTKRHQ(saverScope, color.m2566unboximpl());
        }

        /* renamed from: invoke-4WTKRHQ  reason: not valid java name */
        public final Object m4529invoke4WTKRHQ(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return ULong.m5541boximpl(j);
        }
        ...
        public final Color invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return Color.m2546boximpl(Color.m2552constructorimpl(((ULong) it).m5599unboximpl()));
        }
    });
    private static final Saver<TextUnit, Object> TextUnitSaver = SaverKt.Saver(new Function2<SaverScope, TextUnit, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextUnit textUnit) {
            return m4535invokempE4wyQ(saverScope, textUnit.m5240unboximpl());
        }

        /* renamed from: invoke-mpE4wyQ  reason: not valid java name */
        public final Object m4535invokempE4wyQ(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(TextUnit.m5231getValueimpl(j))), SaversKt.save(TextUnitType.m5256boximpl(TextUnit.m5230getTypeUIouoOA(j))));
        }
        ...
        public final TextUnit invoke(Object it) {
            ...
            return TextUnit.m5221boximpl(TextUnitKt.m5243TextUnitanM5pPY(floatValue, textUnitType.m5262unboximpl()));
        }
    });
    private static final Saver<Offset, Object> OffsetSaver = SaverKt.Saver(new Function2<SaverScope, Offset, Object>() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Offset offset) {
            return m4531invokeUv8p0NA(saverScope, offset.m2328unboximpl());
        }

        /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
        public final Object m4531invokeUv8p0NA(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return Offset.m2315equalsimpl0(j, Offset.Companion.m2333getUnspecifiedF1C5BW0()) ? (Serializable) false : CollectionsKt.arrayListOf((Float) SaversKt.save(Float.valueOf(Offset.m2318getXimpl(j))), (Float) SaversKt.save(Float.valueOf(Offset.m2319getYimpl(j))));
        }
        ...
        public final Offset invoke(Object it) {
            ...
            if (Intrinsics.areEqual(it, (Object) false)) {
                return Offset.m2307boximpl(Offset.Companion.m2333getUnspecifiedF1C5BW0());
            }
            List list = (List) it;
            Object obj = list.get(0);
            Float f = obj != null ? (Float) obj : null;
            ...
            return Offset.m2307boximpl(OffsetKt.Offset(floatValue, f2.floatValue()));
        }
    });
