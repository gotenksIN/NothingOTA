...
public final class ParagraphStyle {
    ...
    private ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
        ...
        this.textAlignOrDefault = textAlign != null ? textAlign.m4943unboximpl() : TextAlign.Companion.m4949getStarte0LSkKk();
        this.lineBreakOrDefault = lineBreak != null ? lineBreak.m4873unboximpl() : LineBreak.Companion.m4876getSimplerAG3T2k();
        this.hyphensOrDefault = hyphens != null ? hyphens.m4858unboximpl() : Hyphens.Companion.m4860getNonevmbZdU8();
        if (TextUnit.m5228equalsimpl0(j, TextUnit.Companion.m5242getUnspecifiedXSAIIZE())) {
            return;
        }
        if (!(TextUnit.m5231getValueimpl(j) >= 0.0f)) {
            throw new IllegalStateException(("lineHeight can't be negative (" + TextUnit.m5231getValueimpl(j) + ')').toString());
        }
    }

    /* renamed from: getTextAlign-buA522U  reason: not valid java name */
    public final TextAlign m4504getTextAlignbuA522U() {
        return this.textAlign;
    }

    /* renamed from: getTextDirection-mmuk1to  reason: not valid java name */
    public final TextDirection m4506getTextDirectionmmuk1to() {
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.Companion.m5242getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, (i & 64) != 0 ? null : lineBreak, (i & 128) != 0 ? null : hyphens, (i & 256) == 0 ? textMotion : null, (DefaultConstructorMarker) null);
    }

    /* renamed from: getLineHeight-XSAIIZE  reason: not valid java name */
    public final long m4503getLineHeightXSAIIZE() {
    ...
    public final LineBreak m4501getLineBreakLgCVezo() {
        return this.lineBreak;
    }

    /* renamed from: getHyphens-EaSxIns  reason: not valid java name */
    public final Hyphens m4499getHyphensEaSxIns() {
        return this.hyphens;
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.Companion.m5242getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.Companion.m5242getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) == 0 ? lineHeightStyle : null, null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.Companion.m5242getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, (i & 64) != 0 ? null : lineBreak, (i & 128) == 0 ? hyphens : null, (DefaultConstructorMarker) null);
    }
    ...
    public final ParagraphStyle merge(ParagraphStyle paragraphStyle) {
        ...
        if (TextUnitKt.m5249isUnspecifiedR2X_6o(paragraphStyle.lineHeight)) {
            j = this.lineHeight;
        } else {
    ...
    public static /* synthetic */ ParagraphStyle m4491copyElsmlbk$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return paragraphStyle.m4495copyElsmlbk(textAlign, textDirection2, j2, textIndent);
    }
    ...
    public final /* synthetic */ ParagraphStyle m4495copyElsmlbk(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent) {
    ...
    public static /* synthetic */ ParagraphStyle m4494copyxPh5V4g$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i, Object obj) {
        if ((i & 1) != 0) {
            textAlign = paragraphStyle.textAlign;
        }
        if ((i & 2) != 0) {
        ...
        return paragraphStyle.m4498copyxPh5V4g(textAlign, textDirection2, j2, textIndent2, platformParagraphStyle2, lineHeightStyle);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "ParagraphStyle copy constructors that do not take new stable parameters like LineHeightStyle, LineBreak, Hyphens are deprecated. Please use the new stable copy constructor.")
    /* renamed from: copy-xPh5V4g  reason: not valid java name */
    public final /* synthetic */ ParagraphStyle m4498copyxPh5V4g(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle) {
    ...
    public final ParagraphStyle m4497copyciSxzs0(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens) {
    ...
    public final ParagraphStyle m4496copyNH1kkwU(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
    ...
    public int hashCode() {
        ...
        int m4941hashCodeimpl = (textAlign != null ? TextAlign.m4941hashCodeimpl(textAlign.m4943unboximpl()) : 0) * 31;
        TextDirection textDirection = this.textDirection;
        int m4954hashCodeimpl = (((m4941hashCodeimpl + (textDirection != null ? TextDirection.m4954hashCodeimpl(textDirection.m4956unboximpl()) : 0)) * 31) + TextUnit.m5232hashCodeimpl(this.lineHeight)) * 31;
        TextIndent textIndent = this.textIndent;
        int hashCode = (m4954hashCodeimpl + (textIndent != null ? textIndent.hashCode() : 0)) * 31;
        PlatformParagraphStyle platformParagraphStyle = this.platformStyle;
        int hashCode2 = (hashCode + (platformParagraphStyle != null ? platformParagraphStyle.hashCode() : 0)) * 31;
        LineHeightStyle lineHeightStyle = this.lineHeightStyle;
        int hashCode3 = (hashCode2 + (lineHeightStyle != null ? lineHeightStyle.hashCode() : 0)) * 31;
        LineBreak lineBreak = this.lineBreak;
        int m4871hashCodeimpl = (hashCode3 + (lineBreak != null ? LineBreak.m4871hashCodeimpl(lineBreak.m4873unboximpl()) : 0)) * 31;
        Hyphens hyphens = this.hyphens;
        int m4856hashCodeimpl = (m4871hashCodeimpl + (hyphens != null ? Hyphens.m4856hashCodeimpl(hyphens.m4858unboximpl()) : 0)) * 31;
        TextMotion textMotion = this.textMotion;
        return m4856hashCodeimpl + (textMotion != null ? textMotion.hashCode() : 0);
    }

    public String toString() {
        return "ParagraphStyle(textAlign=" + this.textAlign + ", textDirection=" + this.textDirection + ", lineHeight=" + ((Object) TextUnit.m5238toStringimpl(this.lineHeight)) + ", textIndent=" + this.textIndent + ", platformStyle=" + this.platformStyle + ", lineHeightStyle=" + this.lineHeightStyle + ", lineBreak=" + this.lineBreak + ", hyphens=" + this.hyphens + ", textMotion=" + this.textMotion + ')';
    }
}
