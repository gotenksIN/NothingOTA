...
public final class DeprecatedBridgeFontResourceLoader implements Font.ResourceLoader {
    ...
    public Object load(Font font) {
        ...
        return FontFamily.Resolver.m4646resolveDPcqOEQ$default(this.fontFamilyResolver, FontKt.toFontFamily(font), font.getWeight(), font.mo4627getStyle_LCdwA(), 0, 8, null).getValue();
    }
