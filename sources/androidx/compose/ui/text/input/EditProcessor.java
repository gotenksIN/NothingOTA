...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.Companion.m4592getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    private EditingBuffer mBuffer = new EditingBuffer(this.mBufferState.getAnnotatedString(), this.mBufferState.m4796getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        ...
        boolean z = true;
        boolean z2 = !Intrinsics.areEqual(value.m4795getCompositionMzsxiRA(), this.mBuffer.m4717getCompositionMzsxiRA$ui_text_release());
        boolean z3 = false;
        if (!Intrinsics.areEqual(this.mBufferState.getAnnotatedString(), value.getAnnotatedString())) {
            this.mBuffer = new EditingBuffer(value.getAnnotatedString(), value.m4796getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
        } else if (TextRange.m4580equalsimpl0(this.mBufferState.m4796getSelectiond9O1mEE(), value.m4796getSelectiond9O1mEE())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text_release(TextRange.m4585getMinimpl(value.m4796getSelectiond9O1mEE()), TextRange.m4584getMaximpl(value.m4796getSelectiond9O1mEE()));
            z3 = true;
            z = false;
        }
        if (value.m4795getCompositionMzsxiRA() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m4581getCollapsedimpl(value.m4795getCompositionMzsxiRA().m4591unboximpl())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m4585getMinimpl(value.m4795getCompositionMzsxiRA().m4591unboximpl()), TextRange.m4584getMaximpl(value.m4795getCompositionMzsxiRA().m4591unboximpl()));
        }
        if (z || (!z3 && z2)) {
            this.mBuffer.commitComposition$ui_text_release();
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> list, final EditCommand editCommand) {
        ...
        StringBuilder append = sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m4717getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m4590toStringimpl(this.mBuffer.m4718getSelectiond9O1mEE$ui_text_release())) + "):");
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            TextFieldValue textFieldValue = new TextFieldValue(this.mBuffer.toAnnotatedString$ui_text_release(), this.mBuffer.m4718getSelectiond9O1mEE$ui_text_release(), this.mBuffer.m4717getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
