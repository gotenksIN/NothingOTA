...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString annotatedString, long j) {
        ...
        this.selectionStart = TextRange.m4585getMinimpl(j);
        this.selectionEnd = TextRange.m4584getMaximpl(j);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int m4585getMinimpl = TextRange.m4585getMinimpl(j);
        int m4584getMaximpl = TextRange.m4584getMaximpl(j);
        if (m4585getMinimpl < 0 || m4585getMinimpl > annotatedString.length()) {
            throw new IndexOutOfBoundsException("start (" + m4585getMinimpl + ") offset is outside of text region " + annotatedString.length());
        }
        if (m4584getMaximpl < 0 || m4584getMaximpl > annotatedString.length()) {
            throw new IndexOutOfBoundsException("end (" + m4584getMaximpl + ") offset is outside of text region " + annotatedString.length());
        }
        if (m4585getMinimpl > m4584getMaximpl) {
            throw new IllegalArgumentException("Do not set reversed range: " + m4585getMinimpl + " > " + m4584getMaximpl);
        }
    }
    ...
    public final TextRange m4717getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m4575boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release  reason: not valid java name */
    public final long m4718getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int i, int i2) {
        ...
        long m4719updateRangeAfterDeletepWDy79M = EditingBufferKt.m4719updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), TextRange);
        setSelectionStart(TextRange.m4585getMinimpl(m4719updateRangeAfterDeletepWDy79M));
        setSelectionEnd(TextRange.m4584getMaximpl(m4719updateRangeAfterDeletepWDy79M));
        if (hasComposition$ui_text_release()) {
            long m4719updateRangeAfterDeletepWDy79M2 = EditingBufferKt.m4719updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), TextRange);
            if (TextRange.m4581getCollapsedimpl(m4719updateRangeAfterDeletepWDy79M2)) {
                commitComposition$ui_text_release();
                return;
            }
            this.compositionStart = TextRange.m4585getMinimpl(m4719updateRangeAfterDeletepWDy79M2);
            this.compositionEnd = TextRange.m4584getMaximpl(m4719updateRangeAfterDeletepWDy79M2);
        }
    }
