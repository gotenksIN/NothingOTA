...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    public TextInputServiceAndroid(View view, InputMethodManager inputMethodManager, PlatformTextInput platformTextInput, Executor inputCommandProcessorExecutor) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            ...
            public final void m4797invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m4797invokeKlQnJC8(imeAction.m4726unboximpl());
                return Unit.INSTANCE;
            }
        };
        this.state = new TextFieldValue("", TextRange.Companion.m4592getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    */
    ...
    public final InputConnection createInputConnection(EditorInfo outAttrs) {
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$createInputConnection$1
            ...
            public void mo4750onImeActionKlQnJC8(int i) {
                Function1 function1;
                function1 = TextInputServiceAndroid.this.onImeActionPerformed;
                function1.invoke(ImeAction.m4720boximpl(i));
            }
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$stopInput$2
            /* renamed from: invoke-KlQnJC8  reason: not valid java name */
            public final void m4798invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m4798invokeKlQnJC8(imeAction.m4726unboximpl());
                return Unit.INSTANCE;
            }
        };
    ...
    */
    ...
    public void updateState(TextFieldValue textFieldValue, TextFieldValue newValue) {
        ...
        boolean z = true;
        boolean z2 = (TextRange.m4580equalsimpl0(this.state.m4796getSelectiond9O1mEE(), newValue.m4796getSelectiond9O1mEE()) && Intrinsics.areEqual(this.state.m4795getCompositionMzsxiRA(), newValue.m4795getCompositionMzsxiRA())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(textFieldValue, newValue)) {
            if (z2) {
                ...
                int m4585getMinimpl = TextRange.m4585getMinimpl(newValue.m4796getSelectiond9O1mEE());
                int m4584getMaximpl = TextRange.m4584getMaximpl(newValue.m4796getSelectiond9O1mEE());
                TextRange m4795getCompositionMzsxiRA = this.state.m4795getCompositionMzsxiRA();
                ...
                TextRange m4795getCompositionMzsxiRA2 = this.state.m4795getCompositionMzsxiRA();
                inputMethodManager.updateSelection(m4585getMinimpl, m4584getMaximpl, m4585getMinimpl2, m4795getCompositionMzsxiRA2 != null ? TextRange.m4584getMaximpl(m4795getCompositionMzsxiRA2.m4591unboximpl()) : -1);
                return;
            }
            return;
        }
        if (textFieldValue == null || (Intrinsics.areEqual(textFieldValue.getText(), newValue.getText()) && (!TextRange.m4580equalsimpl0(textFieldValue.m4796getSelectiond9O1mEE(), newValue.m4796getSelectiond9O1mEE()) || Intrinsics.areEqual(textFieldValue.m4795getCompositionMzsxiRA(), newValue.m4795getCompositionMzsxiRA())))) {
            z = false;
        }
        if (z) {
