...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            TextRange m4795getCompositionMzsxiRA = state.m4795getCompositionMzsxiRA();
            int m4585getMinimpl = m4795getCompositionMzsxiRA != null ? TextRange.m4585getMinimpl(m4795getCompositionMzsxiRA.m4591unboximpl()) : -1;
            TextRange m4795getCompositionMzsxiRA2 = state.m4795getCompositionMzsxiRA();
            inputMethodManager.updateSelection(TextRange.m4585getMinimpl(state.m4796getSelectiond9O1mEE()), TextRange.m4584getMaximpl(state.m4796getSelectiond9O1mEE()), m4585getMinimpl, m4795getCompositionMzsxiRA2 != null ? TextRange.m4584getMaximpl(m4795getCompositionMzsxiRA2.m4591unboximpl()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m4581getCollapsedimpl(this.mTextFieldValue.m4796getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4585getMinimpl(this.mTextFieldValue.m4796getSelectiond9O1mEE()), i);
    }
    ...
    public boolean performEditorAction(int i) {
        int m4735getDefaulteUduSuo;
        boolean z = this.isActive;
        if (z) {
            if (i == 0) {
                m4735getDefaulteUduSuo = ImeAction.Companion.m4735getDefaulteUduSuo();
            } else {
                switch (i) {
                    case 2:
                        m4735getDefaulteUduSuo = ImeAction.Companion.m4737getGoeUduSuo();
                        break;
                    case 3:
                        m4735getDefaulteUduSuo = ImeAction.Companion.m4741getSearcheUduSuo();
                        break;
                    case 4:
                        m4735getDefaulteUduSuo = ImeAction.Companion.m4742getSendeUduSuo();
                        break;
                    case 5:
                        m4735getDefaulteUduSuo = ImeAction.Companion.m4738getNexteUduSuo();
                        break;
                    case 6:
                        m4735getDefaulteUduSuo = ImeAction.Companion.m4736getDoneeUduSuo();
                        break;
                    case 7:
                        m4735getDefaulteUduSuo = ImeAction.Companion.m4740getPreviouseUduSuo();
                        break;
                    default:
            ...
            this.eventCallback.mo4750onImeActionKlQnJC8(m4735getDefaulteUduSuo);
            return true;
        }
        return z;
    }
