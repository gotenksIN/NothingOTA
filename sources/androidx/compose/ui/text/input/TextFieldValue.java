...
public final class TextFieldValue {
    ...
    private static final Saver<TextFieldValue, Object> Saver = SaverKt.Saver(new Function2<SaverScope, TextFieldValue, Object>() { // from class: androidx.compose.ui.text.input.TextFieldValue$Companion$Saver$1
        ...
        public final Object invoke(SaverScope Saver2, TextFieldValue it) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(it.getAnnotatedString(), SaversKt.getAnnotatedStringSaver(), Saver2), SaversKt.save(TextRange.m4575boximpl(it.m4796getSelectiond9O1mEE()), SaversKt.getSaver(TextRange.Companion), Saver2));
        }
        ...
        public final TextFieldValue invoke(Object it) {
            ...
            return new TextFieldValue(restore, textRange.m4591unboximpl(), (TextRange) null, 4, (DefaultConstructorMarker) null);
        }
    });
    ...
    private TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange) {
        ...
        this.selection = TextRangeKt.m4593constrain8ffj60Q(j, 0, getText().length());
        this.composition = textRange != null ? TextRange.m4575boximpl(TextRangeKt.m4593constrain8ffj60Q(textRange.m4591unboximpl(), 0, getText().length())) : null;
    }
    ...
    public /* synthetic */ TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, (i & 2) != 0 ? TextRange.Companion.m4592getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.Companion.m4592getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public final long m4796getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: getComposition-MzsxiRA  reason: not valid java name */
    public final TextRange m4795getCompositionMzsxiRA() {
        return this.composition;
    }

    /* renamed from: copy-3r_uNRQ$default  reason: not valid java name */
    public static /* synthetic */ TextFieldValue m4791copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m4793copy3r_uNRQ(annotatedString, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ  reason: not valid java name */
    public final TextFieldValue m4793copy3r_uNRQ(AnnotatedString annotatedString, long j, TextRange textRange) {
        Intrinsics.checkNotNullParameter(annotatedString, "annotatedString");
        return new TextFieldValue(annotatedString, j, textRange, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-3r_uNRQ$default  reason: not valid java name */
    public static /* synthetic */ TextFieldValue m4792copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m4794copy3r_uNRQ(str, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ  reason: not valid java name */
    public final TextFieldValue m4794copy3r_uNRQ(String text, long j, TextRange textRange) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextFieldValue) {
            ...
            return TextRange.m4580equalsimpl0(this.selection, textFieldValue.selection) && Intrinsics.areEqual(this.composition, textFieldValue.composition) && Intrinsics.areEqual(this.annotatedString, textFieldValue.annotatedString);
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((this.annotatedString.hashCode() * 31) + TextRange.m4588hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return hashCode + (textRange != null ? TextRange.m4588hashCodeimpl(textRange.m4591unboximpl()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + ((Object) this.annotatedString) + "', selection=" + ((Object) TextRange.m4590toStringimpl(this.selection)) + ", composition=" + this.composition + ')';
    }
