...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m4563measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        return textMeasurer.m4565measurexDpz5zY(annotatedString, (i3 & 2) != 0 ? TextStyle.Companion.getDefault() : textStyle, (i3 & 4) != 0 ? TextOverflow.Companion.m4991getClipgIe3tQ8() : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 128) != 0 ? textMeasurer.fallbackLayoutDirection : layoutDirection, (i3 & 256) != 0 ? textMeasurer.fallbackDensity : density, (i3 & 512) != 0 ? textMeasurer.fallbackFontFamilyResolver : resolver, (i3 & 1024) != 0 ? false : z2);
    }

    /* renamed from: measure-xDpz5zY  reason: not valid java name */
    public final TextLayoutResult m4565measurexDpz5zY(AnnotatedString text, TextStyle style, int i, boolean z, int i2, List<AnnotatedString.Range<Placeholder>> placeholders, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean z2) {
        ...
        if (textLayoutResult != null) {
            return textLayoutResult.m4558copyO0kMr_c(textLayoutInput, ConstraintsKt.m5017constrain4WqzIAM(j, IntSizeKt.IntSize(ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getHeight()))));
        }
    ...
    public final TextLayoutResult m4564measurewNUYSr0(String text, TextStyle style, int i, boolean z, int i2, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean z2) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        return m4563measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, i, z, i2, null, j, layoutDirection, density, fontFamilyResolver, z2, 32, null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int m5008getMinWidthimpl = Constraints.m5008getMinWidthimpl(textLayoutInput.m4555getConstraintsmsEJaDk());
            boolean z = false;
            int m5006getMaxWidthimpl = ((textLayoutInput.getSoftWrap() || TextOverflow.m4984equalsimpl0(textLayoutInput.m4556getOverflowgIe3tQ8(), TextOverflow.Companion.m4992getEllipsisgIe3tQ8())) && Constraints.m5002getHasBoundedWidthimpl(textLayoutInput.m4555getConstraintsmsEJaDk())) ? Constraints.m5006getMaxWidthimpl(textLayoutInput.m4555getConstraintsmsEJaDk()) : Integer.MAX_VALUE;
            if (!textLayoutInput.getSoftWrap() && TextOverflow.m4984equalsimpl0(textLayoutInput.m4556getOverflowgIe3tQ8(), TextOverflow.Companion.m4992getEllipsisgIe3tQ8())) {
                z = true;
            }
            int maxLines = z ? 1 : textLayoutInput.getMaxLines();
            if (m5008getMinWidthimpl != m5006getMaxWidthimpl) {
                m5006getMaxWidthimpl = RangesKt.coerceIn(ParagraphKt.ceilToInt(multiParagraphIntrinsics.getMaxIntrinsicWidth()), m5008getMinWidthimpl, m5006getMaxWidthimpl);
            }
            return new TextLayoutResult(textLayoutInput, new MultiParagraph(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, m5006getMaxWidthimpl, 0, Constraints.m5005getMaxHeightimpl(textLayoutInput.m4555getConstraintsmsEJaDk()), 5, null), maxLines, TextOverflow.m4984equalsimpl0(textLayoutInput.m4556getOverflowgIe3tQ8(), TextOverflow.Companion.m4992getEllipsisgIe3tQ8()), null), ConstraintsKt.m5017constrain4WqzIAM(textLayoutInput.m4555getConstraintsmsEJaDk(), IntSizeKt.IntSize((int) Math.ceil(multiParagraph.getWidth()), (int) Math.ceil(multiParagraph.getHeight()))), null);
        }
    }
}
