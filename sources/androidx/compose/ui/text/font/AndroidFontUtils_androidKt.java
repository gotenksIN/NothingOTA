...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m4626getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m4672equalsimpl0(i, FontStyle.Companion.m4676getItalic_LCdwA()));
    }
}
