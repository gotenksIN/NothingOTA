...
public final class DeviceFontFamilyNameFontKt {
    ...
    public static /* synthetic */ Font m4645Fontvxs03AY$default(String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        return m4644Fontvxs03AY(str, fontWeight, i, settings);
    }

    /* renamed from: Font-vxs03AY  reason: not valid java name */
    public static final Font m4644Fontvxs03AY(String familyName, FontWeight weight, int i, FontVariation.Settings variationSettings) {
