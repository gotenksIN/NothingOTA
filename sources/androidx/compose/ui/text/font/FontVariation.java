...
public final class FontVariation {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        public float toVariationValue(Density density) {
            ...
            return TextUnit.m5231getValueimpl(this.value) * density.getFontScale();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof SettingTextUnit) {
                ...
                return Intrinsics.areEqual(getAxisName(), settingTextUnit.getAxisName()) && TextUnit.m5228equalsimpl0(this.value, settingTextUnit.value);
            }
            return false;
        }

        public int hashCode() {
            return (getAxisName().hashCode() * 31) + TextUnit.m5232hashCodeimpl(this.value);
        }

        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + ((Object) TextUnit.m5238toStringimpl(this.value)) + ')';
        }
    }
    ...
    public final Setting m4693opticalSizingR2X_6o(long j) {
        if (!TextUnit.m5234isSpimpl(j)) {
    ...
    public final Settings m4692Settings6EWAqTQ(FontWeight weight, int i, Setting... settings) {
