...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        if (font instanceof ResourceFont) {
            ...
            } else if (FontLoadingStrategy.m4659equalsimpl0(mo4619getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4665getOptionalLocalPKNRLFQ())) {
                try {
                    ...
                    m5373constructorimpl = Result.m5373constructorimpl(load);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.Companion;
                    m5373constructorimpl = Result.m5373constructorimpl(ResultKt.createFailure(th));
                }
                typeface = Result.m5379isFailureimpl(m5373constructorimpl) ? null : m5373constructorimpl;
            } else if (FontLoadingStrategy.m4659equalsimpl0(mo4619getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4663getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            } else {
                throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m4661toStringimpl(font.mo4619getLoadingStrategyPKNRLFQ())));
            }
