...
public final class FontMatcher {
    ...
    public final List<Font> m4666matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        if (!(fontFamily instanceof FontListFontFamily)) {
            throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
        }
        return m4667matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, i);
    }

    /* renamed from: matchFont-RetOiIg  reason: not valid java name */
    public final List<Font> m4667matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return m4668matchFontRetOiIg(fontFamily.getFonts(), fontWeight, i);
    }

    /* renamed from: matchFont-RetOiIg  reason: not valid java name */
    public final List<Font> m4668matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int i) {
        ...
        while (true) {
            ...
            Font font2 = font;
            if ((Intrinsics.areEqual(font2.getWeight(), fontWeight) && FontStyle.m4672equalsimpl0(font2.mo4627getStyle_LCdwA(), i)) ? false : false) {
                arrayList.add(font);
            }
            i3++;
        }
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (FontStyle.m4672equalsimpl0(font3.mo4627getStyle_LCdwA(), i)) {
