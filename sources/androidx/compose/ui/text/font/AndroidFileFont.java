...
public final class AndroidFileFont extends AndroidPreloadedFont {
    ...
    public /* synthetic */ AndroidFileFont(File file, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(file, (i2 & 2) != 0 ? FontWeight.Companion.getNormal() : fontWeight, (i2 & 4) != 0 ? FontStyle.Companion.m4677getNormal_LCdwA() : i, settings, null);
    }
    ...
    public String toString() {
        return "Font(file=" + this.file + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4674toStringimpl(mo4627getStyle_LCdwA())) + ')';
    }
}
