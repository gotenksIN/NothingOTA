...
public final class AndroidFontKt {
    ...
    public static /* synthetic */ Font m4625FontMuC2MFs$default(String str, AssetManager assetManager, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 4) != 0) {
        ...
        if ((i2 & 16) != 0) {
            settings = FontVariation.INSTANCE.m4692Settings6EWAqTQ(fontWeight, i, new FontVariation.Setting[0]);
        }
        return m4624FontMuC2MFs(str, assetManager, fontWeight, i, settings);
    }

    /* renamed from: Font-MuC2MFs  reason: not valid java name */
    public static final Font m4624FontMuC2MFs(String path, AssetManager assetManager, FontWeight weight, int i, FontVariation.Settings variationSettings) {
    ...
    public static /* synthetic */ Font m4623FontEj4NQ78$default(File file, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i2 & 4) != 0) {
        ...
        return m4621FontEj4NQ78(file, fontWeight, i, settings);
    }

    /* renamed from: Font-Ej4NQ78  reason: not valid java name */
    public static final Font m4621FontEj4NQ78(File file, FontWeight weight, int i, FontVariation.Settings variationSettings) {
    ...
    /* renamed from: Font-Ej4NQ78$default  reason: not valid java name */
    public static /* synthetic */ Font m4622FontEj4NQ78$default(ParcelFileDescriptor parcelFileDescriptor, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i2 & 4) != 0) {
        ...
        return m4620FontEj4NQ78(parcelFileDescriptor, fontWeight, i, settings);
    }

    /* renamed from: Font-Ej4NQ78  reason: not valid java name */
    public static final Font m4620FontEj4NQ78(ParcelFileDescriptor fileDescriptor, FontWeight weight, int i, FontVariation.Settings variationSettings) {
