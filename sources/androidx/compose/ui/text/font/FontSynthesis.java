...
public final class FontSynthesis {
    ...
    private static final int All = m4679constructorimpl(1);
    private static final int Weight = m4679constructorimpl(2);
    private static final int Style = m4679constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FontSynthesis m4678boximpl(int i) {
    ...
    public static boolean m4680equalsimpl(int i, Object obj) {
        return (obj instanceof FontSynthesis) && i == ((FontSynthesis) obj).m4686unboximpl();
    }
    ...
    public static String m4685toStringimpl(int i) {
        return m4681equalsimpl0(i, None) ? "None" : m4681equalsimpl0(i, All) ? "All" : m4681equalsimpl0(i, Weight) ? "Weight" : m4681equalsimpl0(i, Style) ? "Style" : "Invalid";
    }
    ...
    public static final boolean m4684isWeightOnimpl$ui_text_release(int i) {
        return m4681equalsimpl0(i, All) || m4681equalsimpl0(i, Weight);
    }

    /* renamed from: isStyleOn-impl$ui_text_release  reason: not valid java name */
    public static final boolean m4683isStyleOnimpl$ui_text_release(int i) {
        return m4681equalsimpl0(i, All) || m4681equalsimpl0(i, Style);
    }
}
