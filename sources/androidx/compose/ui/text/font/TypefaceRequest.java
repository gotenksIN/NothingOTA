...
public final class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m4711copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return typefaceRequest.m4714copye1PVR60(fontFamily, fontWeight2, i4, i5, obj);
    }
    ...
    public final TypefaceRequest m4714copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj) {
    ...
    public int hashCode() {
        ...
        int hashCode = (((((((fontFamily == null ? 0 : fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m4673hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m4682hashCodeimpl(this.fontSynthesis)) * 31;
        Object obj = this.resourceLoaderCacheKey;
        return hashCode + (obj != null ? obj.hashCode() : 0);
    }

    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m4674toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m4685toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
