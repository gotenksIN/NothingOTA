...
public abstract class FontFamily {
    ...
    public interface Resolver {
        ...
        State<Object> mo4647resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2);

        /* renamed from: resolve-DPcqOEQ$default  reason: not valid java name */
        static /* synthetic */ State m4646resolveDPcqOEQ$default(Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
            if (obj == null) {
                if ((i3 & 1) != 0) {
                    fontFamily = null;
                }
                ...
                return resolver.mo4647resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
            }
