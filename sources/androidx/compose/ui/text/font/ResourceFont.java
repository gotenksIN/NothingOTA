    ...
    */
    public /* synthetic */ ResourceFont(int r8, androidx.compose.ui.text.font.FontWeight r9, int r10, androidx.compose.ui.text.font.FontVariation.Settings r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        L23:
            ...
            int r12 = r9.m4663getAsyncPKNRLFQ()
        L2e:
            r5 = r12
            r6 = 0
            r0 = r7
    ...
    public int mo4627getStyle_LCdwA() {
        return this.style;
    }
    ...
    public static /* synthetic */ ResourceFont m4707copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        if ((i3 & 4) != 0) {
            i2 = resourceFont.mo4627getStyle_LCdwA();
        }
        return resourceFont.m4710copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m4710copyRetOiIg(int i, FontWeight weight, int i2) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return m4706copyF3nL8kk$default(this, i, weight, i2, mo4619getLoadingStrategyPKNRLFQ(), null, 16, null);
    }

    /* renamed from: copy-F3nL8kk$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m4706copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i2;
        if ((i4 & 8) != 0) {
            i3 = resourceFont.mo4619getLoadingStrategyPKNRLFQ();
        }
        int i6 = i3;
        if ((i4 & 16) != 0) {
            settings = resourceFont.variationSettings;
        }
        return resourceFont.m4709copyF3nL8kk(i, fontWeight2, i5, i6, settings);
    }

    /* renamed from: copy-F3nL8kk  reason: not valid java name */
    public final ResourceFont m4709copyF3nL8kk(int i, FontWeight weight, int i2, int i3, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(weight, "weight");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResourceFont) {
            ...
            return this.resId == resourceFont.resId && Intrinsics.areEqual(getWeight(), resourceFont.getWeight()) && FontStyle.m4672equalsimpl0(mo4627getStyle_LCdwA(), resourceFont.mo4627getStyle_LCdwA()) && Intrinsics.areEqual(this.variationSettings, resourceFont.variationSettings) && FontLoadingStrategy.m4659equalsimpl0(mo4619getLoadingStrategyPKNRLFQ(), resourceFont.mo4619getLoadingStrategyPKNRLFQ());
        }
        return false;
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m4673hashCodeimpl(mo4627getStyle_LCdwA())) * 31) + FontLoadingStrategy.m4660hashCodeimpl(mo4619getLoadingStrategyPKNRLFQ())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4674toStringimpl(mo4627getStyle_LCdwA())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m4661toStringimpl(mo4619getLoadingStrategyPKNRLFQ())) + ')';
    }
}
