...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    private DeviceFontFamilyNameFont(String str, FontWeight fontWeight, int i, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m4665getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, settings, null);
        this.familyName = str;
    ...
    public final android.graphics.Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().mo4699optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), mo4627getStyle_LCdwA(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeviceFontFamilyNameFont) {
            ...
            return DeviceFontFamilyName.m4640equalsimpl0(this.familyName, deviceFontFamilyNameFont.familyName) && Intrinsics.areEqual(getWeight(), deviceFontFamilyNameFont.getWeight()) && FontStyle.m4672equalsimpl0(mo4627getStyle_LCdwA(), deviceFontFamilyNameFont.mo4627getStyle_LCdwA()) && Intrinsics.areEqual(getVariationSettings(), deviceFontFamilyNameFont.getVariationSettings());
        }
        return false;
    }

    public int hashCode() {
        return (((((DeviceFontFamilyName.m4641hashCodeimpl(this.familyName) * 31) + getWeight().hashCode()) * 31) + FontStyle.m4673hashCodeimpl(mo4627getStyle_LCdwA())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m4642toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4674toStringimpl(mo4627getStyle_LCdwA())) + ')';
    }
}
