    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        if (fontFamily instanceof FontListFontFamily) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (FontLoadingStrategy.m4659equalsimpl0(font.mo4619getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m4663getAsyncPKNRLFQ())) {
                    arrayList.add(font);
                }
            }
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                arrayList3.add(TuplesKt.to(font2.getWeight(), FontStyle.m4669boximpl(font2.mo4627getStyle_LCdwA())));
            }
            ...
            for (int i4 = 0; i4 < size4; i4++) {
                ...
                int m4675unboximpl = ((FontStyle) pair.component2()).m4675unboximpl();
                List list = (List) FontListFontFamilyTypefaceAdapterKt.access$firstImmediatelyAvailable(fontMatcher.m4668matchFontRetOiIg(fonts, fontWeight, m4675unboximpl), new TypefaceRequest(fontFamily, fontWeight, m4675unboximpl, FontSynthesis.Companion.m4687getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
