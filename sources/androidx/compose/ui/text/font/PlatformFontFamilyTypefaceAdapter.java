...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface mo4799getNativeTypefacePYhJU0U;
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            mo4799getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo4697createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m4715getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            mo4799getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo4698createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m4715getFontStyle_LCdwA());
            ...
            mo4799getNativeTypefacePYhJU0U = ((AndroidTypeface) typeface).mo4799getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m4715getFontStyle_LCdwA(), typefaceRequest.m4716getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(mo4799getNativeTypefacePYhJU0U, false, 2, null);
    }
}
