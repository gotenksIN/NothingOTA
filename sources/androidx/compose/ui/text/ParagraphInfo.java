...
public final class ParagraphInfo {
    ...
    public final long m4486toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m2355translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo2453translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI  reason: not valid java name */
    public final long m4485toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4587getStartimpl(j)), toGlobalIndex(TextRange.m4582getEndimpl(j)));
    }
}
