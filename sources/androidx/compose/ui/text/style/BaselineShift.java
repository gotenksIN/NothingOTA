...
public final class BaselineShift {
    ...
    private static final float Superscript = m4834constructorimpl(0.5f);
    private static final float Subscript = m4834constructorimpl(-0.5f);
    private static final float None = m4834constructorimpl(0.0f);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ BaselineShift m4833boximpl(float f) {
        return new BaselineShift(f);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static float m4834constructorimpl(float f) {
        return f;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4835equalsimpl(float f, Object obj) {
        return (obj instanceof BaselineShift) && Float.compare(f, ((BaselineShift) obj).m4839unboximpl()) == 0;
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4836equalsimpl0(float f, float f2) {
        return Float.compare(f, f2) == 0;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4837hashCodeimpl(float f) {
        return Float.hashCode(f);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4838toStringimpl(float f) {
        return "BaselineShift(multiplier=" + f + ')';
    }

    public boolean equals(Object obj) {
        return m4835equalsimpl(this.multiplier, obj);
    }

    public int hashCode() {
        return m4837hashCodeimpl(this.multiplier);
    }

    public String toString() {
        return m4838toStringimpl(this.multiplier);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ float m4839unboximpl() {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4840getNoney9eOQZs$annotations() {
        }

        /* renamed from: getSubscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m4841getSubscripty9eOQZs$annotations() {
        }

        /* renamed from: getSuperscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m4842getSuperscripty9eOQZs$annotations() {
        }
