...
public final class TextMotion {
    ...
    private static final TextMotion Static = new TextMotion(Linearity.Companion.m4978getFontHinting4e0Vf04(), false, null);
    private static final TextMotion Animated = new TextMotion(Linearity.Companion.m4979getLinear4e0Vf04(), true, null);
    ...
    public final int m4970getLinearity4e0Vf04$ui_text_release() {
    ...
    public static /* synthetic */ TextMotion m4968copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m4969copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release  reason: not valid java name */
    public final TextMotion m4969copyJdDtMQo$ui_text_release(int i, boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextMotion) {
            ...
            return Linearity.m4974equalsimpl0(this.linearity, textMotion.linearity) && this.subpixelTextPositioning == textMotion.subpixelTextPositioning;
        }
        return false;
    }

    public int hashCode() {
        return (Linearity.m4975hashCodeimpl(this.linearity) * 31) + Boolean.hashCode(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        ...
        public static final Companion Companion = new Companion(null);
        private static final int Linear = m4972constructorimpl(1);
        private static final int FontHinting = m4972constructorimpl(2);
        private static final int None = m4972constructorimpl(3);

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Linearity m4971boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        private static int m4972constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m4973equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).m4977unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m4973equalsimpl(this.value, obj);
        }
        ...
        public final /* synthetic */ int m4977unboximpl() {
            return this.value;
        }
        ...
        public static final class Companion {
            ...
            public final int m4979getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04  reason: not valid java name */
            public final int m4978getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04  reason: not valid java name */
            public final int m4980getNone4e0Vf04() {
        ...
        public static String m4976toStringimpl(int i) {
            return m4974equalsimpl0(i, Linear) ? "Linearity.Linear" : m4974equalsimpl0(i, FontHinting) ? "Linearity.FontHinting" : m4974equalsimpl0(i, None) ? "Linearity.None" : "Invalid";
        }
    }
}
