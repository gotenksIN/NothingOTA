...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float f) {
        ...
        if (!z && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.Companion.m4963from8_81llA(ColorKt.m2607lerpjxsXWHM(start.mo4847getColor0d7_KjU(), stop.mo4847getColor0d7_KjU(), f));
        }
        if (z && (stop instanceof BrushStyle)) {
    ...
    public static final long m4962modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m2555copywmQWz5c$default(j, Color.m2558getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
