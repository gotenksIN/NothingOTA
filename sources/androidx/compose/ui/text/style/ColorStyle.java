...
public final class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m4848copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m4850copy8_81llA(j);
    }

    /* renamed from: component1-0d7_KjU  reason: not valid java name */
    public final long m4849component10d7_KjU() {
        return this.value;
    }

    /* renamed from: copy-8_81llA  reason: not valid java name */
    public final ColorStyle m4850copy8_81llA(long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ColorStyle) && Color.m2557equalsimpl0(this.value, ((ColorStyle) obj).value);
    }
    ...
    public int hashCode() {
        return Color.m2563hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m2564toStringimpl(this.value)) + ')';
    }
    ...
    public final long m4851getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    /* renamed from: getColor-0d7_KjU */
    public long mo4847getColor0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    public float getAlpha() {
        return Color.m2558getAlphaimpl(mo4847getColor0d7_KjU());
    }
}
