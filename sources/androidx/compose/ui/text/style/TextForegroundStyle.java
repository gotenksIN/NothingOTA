...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        public long mo4847getColor0d7_KjU() {
            return Color.Companion.m2592getUnspecified0d7_KjU();
        }
    }
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle from(Brush brush, float f) {
            ...
            if (brush instanceof SolidColor) {
                return m4963from8_81llA(TextDrawStyleKt.m4962modulateDxMtmZc(((SolidColor) brush).m2881getValue0d7_KjU(), f));
            }
        ...
        public final TextForegroundStyle m4963from8_81llA(long j) {
            return (j > Color.Companion.m2592getUnspecified0d7_KjU() ? 1 : (j == Color.Companion.m2592getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(j, null) : Unspecified.INSTANCE;
        }
    }
}
