...
public final class TextIndent {
    ...
    public final long m4966getFirstLineXSAIIZE() {
        return this.firstLine;
    }

    /* renamed from: getRestLine-XSAIIZE  reason: not valid java name */
    public final long m4967getRestLineXSAIIZE() {
    ...
    public static /* synthetic */ TextIndent m4964copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m4965copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo  reason: not valid java name */
    public final TextIndent m4965copyNB67dxo(long j, long j2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextIndent) {
            ...
            return TextUnit.m5228equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m5228equalsimpl0(this.restLine, textIndent.restLine);
        }
        return false;
    }

    public int hashCode() {
        return (TextUnit.m5232hashCodeimpl(this.firstLine) * 31) + TextUnit.m5232hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m5238toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m5238toStringimpl(this.restLine)) + ')';
    }
}
