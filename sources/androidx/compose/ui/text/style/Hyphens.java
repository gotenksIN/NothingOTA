...
public final class Hyphens {
    ...
    private static final int None = m4853constructorimpl(1);
    private static final int Auto = m4853constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Hyphens m4852boximpl(int i) {
        return new Hyphens(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m4853constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4854equalsimpl(int i, Object obj) {
        return (obj instanceof Hyphens) && i == ((Hyphens) obj).m4858unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4855equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4856hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4860getNonevmbZdU8() {
            return Hyphens.None;
        }

        /* renamed from: getAuto-vmbZdU8  reason: not valid java name */
        public final int m4859getAutovmbZdU8() {
            return Hyphens.Auto;
        }
    }
    ...
    public static String m4857toStringimpl(int i) {
        return m4855equalsimpl0(i, None) ? "Hyphens.None" : m4855equalsimpl0(i, Auto) ? "Hyphens.Auto" : "Invalid";
    }
}
