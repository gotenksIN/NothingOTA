...
public final class TextStyleKt {
    ...
    public static final int m4617resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (textDirection == null ? false : TextDirection.m4953equalsimpl0(textDirection.m4956unboximpl(), TextDirection.Companion.m4957getContents_7Xco())) {
            int i = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i != 1) {
                if (i == 2) {
                    return TextDirection.Companion.m4959getContentOrRtls_7Xco();
                }
                throw new NoWhenBranchMatchedException();
            }
            return TextDirection.Companion.m4958getContentOrLtrs_7Xco();
        } else if (textDirection == null) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 != 1) {
                if (i2 == 2) {
                    return TextDirection.Companion.m4961getRtls_7Xco();
                }
                throw new NoWhenBranchMatchedException();
            }
            return TextDirection.Companion.m4960getLtrs_7Xco();
        } else {
            return textDirection.m4956unboximpl();
        }
    }
