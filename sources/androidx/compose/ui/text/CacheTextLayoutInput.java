...
public final class CacheTextLayoutInput {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CacheTextLayoutInput) {
            ...
            return Intrinsics.areEqual(textLayoutInput.getText(), cacheTextLayoutInput.textLayoutInput.getText()) && textLayoutInput.getStyle().hasSameLayoutAffectingAttributes(cacheTextLayoutInput.textLayoutInput.getStyle()) && Intrinsics.areEqual(textLayoutInput.getPlaceholders(), cacheTextLayoutInput.textLayoutInput.getPlaceholders()) && textLayoutInput.getMaxLines() == cacheTextLayoutInput.textLayoutInput.getMaxLines() && textLayoutInput.getSoftWrap() == cacheTextLayoutInput.textLayoutInput.getSoftWrap() && TextOverflow.m4984equalsimpl0(textLayoutInput.m4556getOverflowgIe3tQ8(), cacheTextLayoutInput.textLayoutInput.m4556getOverflowgIe3tQ8()) && Intrinsics.areEqual(textLayoutInput.getDensity(), cacheTextLayoutInput.textLayoutInput.getDensity()) && textLayoutInput.getLayoutDirection() == cacheTextLayoutInput.textLayoutInput.getLayoutDirection() && textLayoutInput.getFontFamilyResolver() == cacheTextLayoutInput.textLayoutInput.getFontFamilyResolver() && Constraints.m5006getMaxWidthimpl(textLayoutInput.m4555getConstraintsmsEJaDk()) == Constraints.m5006getMaxWidthimpl(cacheTextLayoutInput.textLayoutInput.m4555getConstraintsmsEJaDk()) && Constraints.m5005getMaxHeightimpl(textLayoutInput.m4555getConstraintsmsEJaDk()) == Constraints.m5005getMaxHeightimpl(cacheTextLayoutInput.textLayoutInput.m4555getConstraintsmsEJaDk());
        }
        return false;
    }
}
