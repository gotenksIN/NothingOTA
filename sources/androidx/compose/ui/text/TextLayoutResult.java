...
public final class TextLayoutResult {
    ...
    public final long m4560getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m5209getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m5210getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m4559getOffsetForPositionk4lQ0M(long j) {
        return this.multiParagraph.m4477getOffsetForPositionk4lQ0M(j);
    }
    ...
    public final long m4561getWordBoundaryjx7JFs(int i) {
        return this.multiParagraph.m4478getWordBoundaryjx7JFs(i);
    }
    ...
    public static /* synthetic */ TextLayoutResult m4557copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m4558copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c  reason: not valid java name */
    public final TextLayoutResult m4558copyO0kMr_c(TextLayoutInput layoutInput, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextLayoutResult) {
            ...
            if (Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) && Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) && IntSize.m5208equalsimpl0(this.size, textLayoutResult.size)) {
    ...
    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m5211hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m5213toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
