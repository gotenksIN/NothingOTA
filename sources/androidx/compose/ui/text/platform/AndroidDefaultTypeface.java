...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo4799getNativeTypefacePYhJU0U(FontWeight fontWeight, int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface defaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m4626getAndroidTypefaceStyleFO1MlWM(fontWeight, i));
        ...
        return typefaceHelperMethodsApi28.create(DEFAULT, fontWeight.getWeight(), FontStyle.m4672equalsimpl0(i, FontStyle.Companion.m4676getItalic_LCdwA()));
    }
}
