...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public ShaderBrushSpan(ShaderBrush shaderBrush, float f) {
        ...
        this.alpha = f;
        this.size = Size.Companion.m2395getUnspecifiedNHjbRc();
    }

    /* renamed from: getSize-NH-jbRc  reason: not valid java name */
    public final long m4831getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public final void m4832setSizeuvyYCjk(long j) {
        this.size = j;
    }

    @Override // android.text.style.CharacterStyle
    public void updateDrawState(TextPaint textPaint) {
        Shader mo2525createShaderuvyYCjk;
        Intrinsics.checkNotNullParameter(textPaint, "textPaint");
        AndroidTextPaint_androidKt.setAlpha(textPaint, this.alpha);
        if (this.size == Size.Companion.m2395getUnspecifiedNHjbRc()) {
            return;
        }
        Pair<Size, ? extends Shader> pair = this.cachedShader;
        if (pair == null || !Size.m2383equalsimpl0(pair.getFirst().m2392unboximpl(), this.size)) {
            mo2525createShaderuvyYCjk = this.shaderBrush.mo2525createShaderuvyYCjk(this.size);
        } else {
            mo2525createShaderuvyYCjk = pair.getSecond();
        }
        textPaint.setShader(mo2525createShaderuvyYCjk);
        this.cachedShader = TuplesKt.to(Size.m2375boximpl(this.size), mo2525createShaderuvyYCjk);
    }
}
