...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                ...
                textPaint.setStrokeJoin(m4830toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).m3160getJoinLxFBmk8()));
                textPaint.setStrokeCap(m4829toAndroidCapBeK7IIE(((Stroke) this.drawStyle).m3159getCapKaPHkGw()));
    ...
    private final Paint.Join m4830toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m2905equalsimpl0(i, StrokeJoin.Companion.m2910getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m2905equalsimpl0(i, StrokeJoin.Companion.m2911getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m2905equalsimpl0(i, StrokeJoin.Companion.m2909getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE  reason: not valid java name */
    private final Paint.Cap m4829toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m2895equalsimpl0(i, StrokeCap.Companion.m2899getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m2895equalsimpl0(i, StrokeCap.Companion.m2900getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m2895equalsimpl0(i, StrokeCap.Companion.m2901getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
