...
public final class AndroidMultiParagraphDrawKt {
    ...
    public static final void m4801drawMultiParagraph7AXcY_I(MultiParagraph drawMultiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(drawMultiParagraph, "$this$drawMultiParagraph");
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        canvas.save();
        if (drawMultiParagraph.getParagraphInfoList$ui_text_release().size() <= 1) {
            m4803drawParagraphs7AXcY_I(drawMultiParagraph, canvas, brush, f, shadow, textDecoration, drawStyle, i);
            ...
            Shader mo2525createShaderuvyYCjk = ((ShaderBrush) brush).mo2525createShaderuvyYCjk(SizeKt.Size(f2, f3));
            Matrix matrix = new Matrix();
            mo2525createShaderuvyYCjk.getLocalMatrix(matrix);
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                paragraphInfo2.getParagraph().mo4453painthn5TExg(canvas, BrushKt.ShaderBrush(mo2525createShaderuvyYCjk), f, shadow, textDecoration, drawStyle, i);
                ...
                mo2525createShaderuvyYCjk.setLocalMatrix(matrix);
            }
        }
        canvas.restore();
    }
    ...
    private static final void m4803drawParagraphs7AXcY_I(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        List<ParagraphInfo> paragraphInfoList$ui_text_release = multiParagraph.getParagraphInfoList$ui_text_release();
        int size = paragraphInfoList$ui_text_release.size();
        for (int i2 = 0; i2 < size; i2++) {
            ParagraphInfo paragraphInfo = paragraphInfoList$ui_text_release.get(i2);
            paragraphInfo.getParagraph().mo4453painthn5TExg(canvas, brush, f, shadow, textDecoration, drawStyle, i);
