...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.Companion.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m2318getXimpl(this.shadow.m2872getOffsetF1C5BW0()), Offset.m2319getYimpl(this.shadow.m2872getOffsetF1C5BW0()), ColorKt.m2610toArgb8_81llA(this.shadow.m2871getColor0d7_KjU()));
        }
    }

    /* renamed from: setBrush-12SF9DM$default  reason: not valid java name */
    public static /* synthetic */ void m4810setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m4813setBrush12SF9DM(brush, j, f);
    }

    /* JADX WARN: Code restructure failed: missing block: B:15:0x002c, code lost:
        if ((r9 != androidx.compose.ui.geometry.Size.Companion.m2395getUnspecifiedNHjbRc()) != false) goto L7;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0044, code lost:
        r8.mo2503applyToPq9zytI(r9, r0, r11);
     */
    /* JADX WARN: Code restructure failed: missing block: B:24:?, code lost:
        return;
     */
    /* JADX WARN: Code restructure failed: missing block: B:8:0x001a, code lost:
        if ((((androidx.compose.ui.graphics.SolidColor) r8).m2881getValue0d7_KjU() != androidx.compose.ui.graphics.Color.Companion.m2592getUnspecified0d7_KjU()) == false) goto L15;
     */
    ...
    */
    public final void m4813setBrush12SF9DM(androidx.compose.ui.graphics.Brush r8, long r9, float r11) {
        /*
            r7 = this;
        ...
        L1c:
            ...
            long r3 = r0.m2395getUnspecifiedNHjbRc()
        ...
        L50:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.AndroidTextPaint.m4813setBrush12SF9DM(androidx.compose.ui.graphics.Brush, long, float):void");
    }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
            this.composePaint.mo2442setStylek9PVt8s(PaintingStyle.Companion.m2816getFillTiuSbCo());
        } else if (drawStyle instanceof Stroke) {
            this.composePaint.mo2442setStylek9PVt8s(PaintingStyle.Companion.m2817getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            this.composePaint.setStrokeWidth(stroke.getWidth());
            this.composePaint.setStrokeMiterLimit(stroke.getMiter());
            this.composePaint.mo2441setStrokeJoinWw9F2mQ(stroke.m3160getJoinLxFBmk8());
            this.composePaint.mo2440setStrokeCapBeK7IIE(stroke.m3159getCapKaPHkGw());
            this.composePaint.setPathEffect(stroke.getPathEffect());
        }
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public final int m4811getBlendMode0nO6VwU() {
        return this.composePaint.mo2431getBlendMode0nO6VwU();
    }

    /* renamed from: setBlendMode-s9anfk8  reason: not valid java name */
    public final void m4812setBlendModes9anfk8(int i) {
        this.composePaint.mo2437setBlendModes9anfk8(i);
    }

    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public final void m4814setColor8_81llA(long j) {
        if (j != Color.Companion.m2592getUnspecified0d7_KjU()) {
            this.composePaint.mo2438setColor8_81llA(j);
