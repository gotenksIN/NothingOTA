...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, FontFamily.Resolver fontFamilyResolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m4805resolveTextDirectionHeuristics9GRLPo0(style.m4616getTextDirectionmmuk1to(), style.getLocaleList());
        Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface> function4 = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public /* bridge */ /* synthetic */ Typeface invoke(FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
                return m4804invokeDPcqOEQ(fontFamily, fontWeight, fontStyle.m4675unboximpl(), fontSynthesis.m4686unboximpl());
            }

            /* renamed from: invoke-DPcqOEQ  reason: not valid java name */
            public final Typeface m4804invokeDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
                TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList;
                Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
                State<Object> mo4647resolveDPcqOEQ = AndroidParagraphIntrinsics.this.getFontFamilyResolver().mo4647resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
                if (!(mo4647resolveDPcqOEQ instanceof TypefaceResult.Immutable)) {
                    typefaceDirtyTrackerLinkedList = AndroidParagraphIntrinsics.this.resolvedTypefaces;
                    TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList2 = new TypefaceDirtyTrackerLinkedList(mo4647resolveDPcqOEQ, typefaceDirtyTrackerLinkedList);
                ...
                Object value = mo4647resolveDPcqOEQ.getValue();
