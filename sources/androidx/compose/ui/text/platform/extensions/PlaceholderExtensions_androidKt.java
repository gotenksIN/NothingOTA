...
public final class PlaceholderExtensions_androidKt {
    ...
    private static /* synthetic */ void m4817getSpanUnitR2X_6o$annotations(long j) {
    }

    /* renamed from: getSpanVerticalAlign-do9X-Gg$annotations  reason: not valid java name */
    private static /* synthetic */ void m4819getSpanVerticalAligndo9XGg$annotations(int i) {
    }
    ...
    private static final void setPlaceholder(Spannable spannable, Placeholder placeholder, int i, int i2, Density density) {
        ...
        SpannableExtensions_androidKt.setSpan(spannable, new PlaceholderSpan(TextUnit.m5231getValueimpl(placeholder.m4511getWidthXSAIIZE()), m4816getSpanUnitR2X_6o(placeholder.m4511getWidthXSAIIZE()), TextUnit.m5231getValueimpl(placeholder.m4509getHeightXSAIIZE()), m4816getSpanUnitR2X_6o(placeholder.m4509getHeightXSAIIZE()), density.getFontScale() * density.getDensity(), m4818getSpanVerticalAligndo9XGg(placeholder.m4510getPlaceholderVerticalAlignJ6kI3mc())), i, i2);
    }

    /* renamed from: getSpanUnit--R2X_6o  reason: not valid java name */
    private static final int m4816getSpanUnitR2X_6o(long j) {
        ...
        return TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA, TextUnitType.Companion.m5263getEmUIouoOA()) ? 1 : 2;
    }

    /* renamed from: getSpanVerticalAlign-do9X-Gg  reason: not valid java name */
    private static final int m4818getSpanVerticalAligndo9XGg(int i) {
        if (PlaceholderVerticalAlign.m4515equalsimpl0(i, PlaceholderVerticalAlign.Companion.m4519getAboveBaselineJ6kI3mc())) {
            return 0;
        }
        if (PlaceholderVerticalAlign.m4515equalsimpl0(i, PlaceholderVerticalAlign.Companion.m4525getTopJ6kI3mc())) {
            return 1;
        }
        if (PlaceholderVerticalAlign.m4515equalsimpl0(i, PlaceholderVerticalAlign.Companion.m4520getBottomJ6kI3mc())) {
            return 2;
        }
        if (PlaceholderVerticalAlign.m4515equalsimpl0(i, PlaceholderVerticalAlign.Companion.m4521getCenterJ6kI3mc())) {
            return 3;
        }
        if (PlaceholderVerticalAlign.m4515equalsimpl0(i, PlaceholderVerticalAlign.Companion.m4524getTextTopJ6kI3mc())) {
            return 4;
        }
        if (PlaceholderVerticalAlign.m4515equalsimpl0(i, PlaceholderVerticalAlign.Companion.m4522getTextBottomJ6kI3mc())) {
            return 5;
        }
        if (PlaceholderVerticalAlign.m4515equalsimpl0(i, PlaceholderVerticalAlign.Companion.m4523getTextCenterJ6kI3mc())) {
            return 6;
        }
