...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float m5231getValueimpl;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        Intrinsics.checkNotNullParameter(density, "density");
        if (textIndent != null) {
            if ((TextUnit.m5228equalsimpl0(textIndent.m4966getFirstLineXSAIIZE(), TextUnitKt.getSp(0)) && TextUnit.m5228equalsimpl0(textIndent.m4967getRestLineXSAIIZE(), TextUnitKt.getSp(0))) || TextUnitKt.m5249isUnspecifiedR2X_6o(textIndent.m4966getFirstLineXSAIIZE()) || TextUnitKt.m5249isUnspecifiedR2X_6o(textIndent.m4967getRestLineXSAIIZE())) {
                return;
            }
            long m5230getTypeUIouoOA = TextUnit.m5230getTypeUIouoOA(textIndent.m4966getFirstLineXSAIIZE());
            float f2 = 0.0f;
            if (TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA, TextUnitType.Companion.m5264getSpUIouoOA())) {
                m5231getValueimpl = density.mo301toPxR2X_6o(textIndent.m4966getFirstLineXSAIIZE());
            } else {
                m5231getValueimpl = TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA, TextUnitType.Companion.m5263getEmUIouoOA()) ? TextUnit.m5231getValueimpl(textIndent.m4966getFirstLineXSAIIZE()) * f : 0.0f;
            }
            long m5230getTypeUIouoOA2 = TextUnit.m5230getTypeUIouoOA(textIndent.m4967getRestLineXSAIIZE());
            if (TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA2, TextUnitType.Companion.m5264getSpUIouoOA())) {
                f2 = density.mo301toPxR2X_6o(textIndent.m4967getRestLineXSAIIZE());
            } else if (TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA2, TextUnitType.Companion.m5263getEmUIouoOA())) {
                f2 = TextUnit.m5231getValueimpl(textIndent.m4967getRestLineXSAIIZE()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(m5231getValueimpl), (int) Math.ceil(f2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE  reason: not valid java name */
    public static final void m4826setLineHeightKmRG4DE(Spannable setLineHeight, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float m4821resolveLineHeightInPxo2QH7mI = m4821resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m4821resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable = setLineHeight;
        setSpan(setLineHeight, new LineHeightStyleSpan(m4821resolveLineHeightInPxo2QH7mI, 0, ((spannable.length() == 0) || StringsKt.last(spannable) == '\n') ? setLineHeight.length() + 1 : setLineHeight.length(), LineHeightStyle.Trim.m4929isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.m4908getTrimEVpEnUU()), LineHeightStyle.Trim.m4930isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.m4908getTrimEVpEnUU()), lineHeightStyle.m4907getAlignmentPIaL0Z0()), 0, setLineHeight.length());
    }

    /* renamed from: setLineHeight-r9BaKPg  reason: not valid java name */
    public static final void m4827setLineHeightr9BaKPg(Spannable setLineHeight, long j, float f, Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float m4821resolveLineHeightInPxo2QH7mI = m4821resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m4821resolveLineHeightInPxo2QH7mI)) {
        ...
        setSpan(setLineHeight, new LineHeightSpan(m4821resolveLineHeightInPxo2QH7mI), 0, setLineHeight.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI  reason: not valid java name */
    private static final float m4821resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        long m5230getTypeUIouoOA = TextUnit.m5230getTypeUIouoOA(j);
        if (TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA, TextUnitType.Companion.m5264getSpUIouoOA())) {
            return density.mo301toPxR2X_6o(j);
        }
        if (TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA, TextUnitType.Companion.m5263getEmUIouoOA())) {
            return TextUnit.m5231getValueimpl(j) * f;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        MetricAffectingSpan m4820createLetterSpacingSpaneAf_CNQ;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (m4820createLetterSpacingSpaneAf_CNQ = m4820createLetterSpacingSpaneAf_CNQ(item.m4551getLetterSpacingXSAIIZE(), density)) != null) {
                    setSpan(spannable, m4820createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m4823setBaselineShift0ocSgnM(spannable, item.m4546getBaselineShift5SSeXJ0(), start, end);
        m4824setColorRPmYEkk(spannable, item.m4547getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m4825setFontSizeKmRG4DE(spannable, item.m4548getFontSizeXSAIIZE(), density, start, end);
        ...
        m4822setBackgroundRPmYEkk(spannable, item.m4545getBackground0d7_KjU(), start, end);
    ...
    private static final MetricAffectingSpan m4820createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long m5230getTypeUIouoOA = TextUnit.m5230getTypeUIouoOA(j);
        if (TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA, TextUnitType.Companion.m5264getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo301toPxR2X_6o(j));
        }
        if (TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA, TextUnitType.Companion.m5263getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m5231getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m5259equalsimpl0(TextUnit.m5230getTypeUIouoOA(spanStyle.m4551getLetterSpacingXSAIIZE()), TextUnitType.Companion.m5264getSpUIouoOA()) || TextUnitType.m5259equalsimpl0(TextUnit.m5230getTypeUIouoOA(spanStyle.m4551getLetterSpacingXSAIIZE()), TextUnitType.Companion.m5263getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m2610toArgb8_81llA(shadow.m2871getColor0d7_KjU()), Offset.m2318getXimpl(shadow.m2872getOffsetF1C5BW0()), Offset.m2319getYimpl(shadow.m2872getOffsetF1C5BW0()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m4825setFontSizeKmRG4DE(Spannable setFontSize, long j, Density density, int i, int i2) {
        Intrinsics.checkNotNullParameter(setFontSize, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long m5230getTypeUIouoOA = TextUnit.m5230getTypeUIouoOA(j);
        if (TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA, TextUnitType.Companion.m5264getSpUIouoOA())) {
            setSpan(setFontSize, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo301toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m5259equalsimpl0(m5230getTypeUIouoOA, TextUnitType.Companion.m5263getEmUIouoOA())) {
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m5231getValueimpl(j)), i, i2);
        }
    }
    ...
    private static final void m4823setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m4839unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m4824setColorRPmYEkk(spannable, ((SolidColor) brush).m2881getValue0d7_KjU(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m4610getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (TextPaintExtensions_androidKt.hasFontAttributes(range2.getItem()) || range2.getItem().m4550getFontSynthesisZQGJjVo() != null) {
                arrayList.add(range);
            }
        }
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m4609getFontStyle4Lr2A7w(), textStyle.m4610getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, 16323, (DefaultConstructorMarker) null) : null, arrayList, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt$setFontAttributes$1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, m4669boximpl, FontSynthesis.m4678boximpl(m4550getFontSynthesisZQGJjVo != null ? m4550getFontSynthesisZQGJjVo.m4686unboximpl() : FontSynthesis.Companion.m4687getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }

    /* renamed from: setBackground-RPmYEkk  reason: not valid java name */
    public static final void m4822setBackgroundRPmYEkk(Spannable setBackground, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setBackground, "$this$setBackground");
        if (j != Color.Companion.m2592getUnspecified0d7_KjU()) {
            setSpan(setBackground, new BackgroundColorSpan(ColorKt.m2610toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setColor-RPmYEkk  reason: not valid java name */
    public static final void m4824setColorRPmYEkk(Spannable setColor, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setColor, "$this$setColor");
        if (j != Color.Companion.m2592getUnspecified0d7_KjU()) {
            setSpan(setColor, new ForegroundColorSpan(ColorKt.m2610toArgb8_81llA(j)), i, i2);
        }
    }
}
