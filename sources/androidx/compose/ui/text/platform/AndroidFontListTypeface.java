...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    */
    ...
    public Typeface mo4799getNativeTypefacePYhJU0U(FontWeight fontWeight, int i, int i2) {
        ...
        Font font = (Font) CollectionsKt.firstOrNull((List<? extends Object>) this.fontMatcher$1.m4668matchFontRetOiIg(new ArrayList(this.loadedTypefaces.keySet()), fontWeight, i));
        if (font == null) {
        ...
        Object m4691synthesizeTypefaceFxwP2eA = FontSynthesis_androidKt.m4691synthesizeTypefaceFxwP2eA(i2, typeface, font, fontWeight, i);
        Intrinsics.checkNotNull(m4691synthesizeTypefaceFxwP2eA, "null cannot be cast to non-null type android.graphics.Typeface");
