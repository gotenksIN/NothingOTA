...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, boolean z) {
        ...
        this.maxLines = i;
        int i2 = 0;
        if (!(Constraints.m5008getMinWidthimpl(j) == 0 && Constraints.m5007getMinHeightimpl(j) == 0)) {
        ...
        while (i4 < size) {
            ...
            if (Constraints.m5001getHasBoundedHeightimpl(j)) {
                m5005getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m5005getMaxHeightimpl(j) - ParagraphKt.ceilToInt(f), i2);
            } else {
                m5005getMaxHeightimpl = Constraints.m5005getMaxHeightimpl(j);
            }
            Paragraph m4489Paragraph_EkL_Y = ParagraphKt.m4489Paragraph_EkL_Y(intrinsics, ConstraintsKt.Constraints$default(0, m5006getMaxWidthimpl, 0, m5005getMaxHeightimpl, 5, null), this.maxLines - i3, z);
            float height = f + m4489Paragraph_EkL_Y.getHeight();
            int lineCount = i3 + m4489Paragraph_EkL_Y.getLineCount();
            arrayList.add(new ParagraphInfo(m4489Paragraph_EkL_Y, paragraphIntrinsicInfo.getStartIndex(), paragraphIntrinsicInfo.getEndIndex(), i3, lineCount, f, height));
            if (m4489Paragraph_EkL_Y.getDidExceedMaxLines() || (lineCount == this.maxLines && i4 != CollectionsKt.getLastIndex(this.intrinsics.getInfoList$ui_text_release()))) {
                i3 = lineCount;
                f = height;
                z2 = true;
                break;
        ...
        this.width = Constraints.m5006getMaxWidthimpl(j);
    ...
    public static /* synthetic */ void m4475paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        if ((i & 2) != 0) {
            j = Color.Companion.m2592getUnspecified0d7_KjU();
        }
        multiParagraph.m4480paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
    }

    /* renamed from: paint-RPmYEkk  reason: not valid java name */
    public final void m4480paintRPmYEkk(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            paragraphInfo.getParagraph().mo4452paintRPmYEkk(canvas, j, shadow, textDecoration);
    ...
    public final void m4479paintLG529CI(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i2 = 0; i2 < size; i2++) {
            ...
            paragraphInfo.getParagraph().mo4451paintLG529CI(canvas, j, shadow, textDecoration, drawStyle, i);
            canvas.translate(0.0f, paragraphInfo.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m4481painthn5TExg(Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        AndroidMultiParagraphDrawKt.m4801drawMultiParagraph7AXcY_I(this, canvas, brush, f, shadow, textDecoration, drawStyle, i);
    }
        ...
        if ((!(i >= 0 && i <= i2) || i2 > getAnnotatedString().getText().length()) ? false : false) {
            ...
            for (int findParagraphByIndex = MultiParagraphKt.findParagraphByIndex(this.paragraphInfoList, i); findParagraphByIndex < size; findParagraphByIndex++) {
                ...
                if (paragraphInfo.getStartIndex() != paragraphInfo.getEndIndex()) {
                    Path.m2818addPathUv8p0NA$default(Path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(i), paragraphInfo.toLocalIndex(i2))), 0L, 2, null);
                }
            }
            return Path;
        }
    ...
    public final int m4477getOffsetForPositionk4lQ0M(long j) {
        int lastIndex;
        if (Offset.m2319getYimpl(j) <= 0.0f) {
            lastIndex = 0;
        } else {
            lastIndex = Offset.m2319getYimpl(j) >= this.height ? CollectionsKt.getLastIndex(this.paragraphInfoList) : MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m2319getYimpl(j));
        }
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(lastIndex);
        if (paragraphInfo.getLength() == 0) {
            return Math.max(0, paragraphInfo.getStartIndex() - 1);
        }
        return paragraphInfo.toGlobalIndex(paragraphInfo.getParagraph().mo4449getOffsetForPositionk4lQ0M(paragraphInfo.m4486toLocalMKHz9U(j)));
    }
    ...
    public final long m4478getWordBoundaryjx7JFs(int i) {
        int findParagraphByIndex;
        requireIndexInRangeInclusiveEnd(i);
        if (i == getAnnotatedString().length()) {
            findParagraphByIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(findParagraphByIndex);
        return paragraphInfo.m4485toGlobalGEjPoXI(paragraphInfo.getParagraph().mo4450getWordBoundaryjx7JFs(paragraphInfo.toLocalIndex(i)));
    }
