...
public final class AndroidTextStyle_androidKt {
    ...
    public static final PlatformParagraphStyle lerp(PlatformParagraphStyle start, PlatformParagraphStyle stop, float f) {
        Intrinsics.checkNotNullParameter(start, "start");
        Intrinsics.checkNotNullParameter(stop, "stop");
        return start.getIncludeFontPadding() == stop.getIncludeFontPadding() ? start : new PlatformParagraphStyle(((EmojiSupportMatch) SpanStyleKt.lerpDiscrete(EmojiSupportMatch.m4465boximpl(start.m4526getEmojiSupportMatch_3YsG6Y()), EmojiSupportMatch.m4465boximpl(stop.m4526getEmojiSupportMatch_3YsG6Y()), f)).m4471unboximpl(), ((Boolean) SpanStyleKt.lerpDiscrete(Boolean.valueOf(start.getIncludeFontPadding()), Boolean.valueOf(stop.getIncludeFontPadding()), f)).booleanValue(), (DefaultConstructorMarker) null);
    }
}
