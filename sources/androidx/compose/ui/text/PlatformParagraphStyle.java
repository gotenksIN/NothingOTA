...
public final class PlatformParagraphStyle {
    ...
    public final int m4526getEmojiSupportMatch_3YsG6Y() {
    ...
    public PlatformParagraphStyle(boolean z) {
        ...
        this.emojiSupportMatch = EmojiSupportMatch.Companion.m4472getDefault_3YsG6Y();
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.Companion.m4472getDefault_3YsG6Y() : i, (i2 & 2) != 0 ? true : z, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.Companion.m4472getDefault_3YsG6Y() : i, (DefaultConstructorMarker) null);
    }

    public PlatformParagraphStyle() {
        this(EmojiSupportMatch.Companion.m4472getDefault_3YsG6Y(), true, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PlatformParagraphStyle) {
            ...
            return this.includeFontPadding == platformParagraphStyle.includeFontPadding && EmojiSupportMatch.m4468equalsimpl0(this.emojiSupportMatch, platformParagraphStyle.emojiSupportMatch);
        }
        return false;
    }

    public int hashCode() {
        return (Boolean.hashCode(this.includeFontPadding) * 31) + EmojiSupportMatch.m4469hashCodeimpl(this.emojiSupportMatch);
    }

    public String toString() {
        return "PlatformParagraphStyle(includeFontPadding=" + this.includeFontPadding + ", emojiSupportMatch=" + ((Object) EmojiSupportMatch.m4470toStringimpl(this.emojiSupportMatch)) + ')';
    }
}
