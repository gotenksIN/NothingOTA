...
public final class IntRectKt {
    ...
    public static final IntRect m5200IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m5168getXimpl(j), IntOffset.m5169getYimpl(j), IntOffset.m5168getXimpl(j) + IntSize.m5210getWidthimpl(j2), IntOffset.m5169getYimpl(j) + IntSize.m5209getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY  reason: not valid java name */
    public static final IntRect m5199IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m5168getXimpl(j), IntOffset.m5169getYimpl(j), IntOffset.m5168getXimpl(j2), IntOffset.m5169getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso  reason: not valid java name */
    public static final IntRect m5201IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m5168getXimpl(j) - i, IntOffset.m5169getYimpl(j) - i, IntOffset.m5168getXimpl(j) + i, IntOffset.m5169getYimpl(j) + i);
    }
