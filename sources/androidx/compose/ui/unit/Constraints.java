...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m4994boximpl(long j) {
    ...
    public static boolean m4998equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).m5012unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4999equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getFocusIndex-impl  reason: not valid java name */
    private static final int m5000getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }
    ...
    public static int m5009hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m5009hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m5012unboximpl() {
        return this.value;
    }
    ...
    public static final int m5008getMinWidthimpl(long j) {
        return ((int) (j >> MinFocusHeight)) & WidthMask[m5000getFocusIndeximpl(j)];
    }

    /* renamed from: getMaxWidth-impl  reason: not valid java name */
    public static final int m5006getMaxWidthimpl(long j) {
        int i = ((int) (j >> 33)) & WidthMask[m5000getFocusIndeximpl(j)];
        if (i == 0) {
    ...
    public static final int m5007getMinHeightimpl(long j) {
        int m5000getFocusIndeximpl = m5000getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[m5000getFocusIndeximpl])) & HeightMask[m5000getFocusIndeximpl];
    }

    /* renamed from: getMaxHeight-impl  reason: not valid java name */
    public static final int m5005getMaxHeightimpl(long j) {
        int m5000getFocusIndeximpl = m5000getFocusIndeximpl(j);
        int i = ((int) (j >> (MinHeightOffsets[m5000getFocusIndeximpl] + 31))) & HeightMask[m5000getFocusIndeximpl];
        if (i == 0) {
            return Integer.MAX_VALUE;
        }
        return i - 1;
    ...
    public static final boolean m5002getHasBoundedWidthimpl(long j) {
        return (((int) (j >> 33)) & WidthMask[m5000getFocusIndeximpl(j)]) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl  reason: not valid java name */
    public static final boolean m5001getHasBoundedHeightimpl(long j) {
        int m5000getFocusIndeximpl = m5000getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[m5000getFocusIndeximpl] + 31))) & HeightMask[m5000getFocusIndeximpl]) != 0;
    }

    /* renamed from: getHasFixedWidth-impl  reason: not valid java name */
    public static final boolean m5004getHasFixedWidthimpl(long j) {
        return m5006getMaxWidthimpl(j) == m5008getMinWidthimpl(j);
    }

    /* renamed from: getHasFixedHeight-impl  reason: not valid java name */
    public static final boolean m5003getHasFixedHeightimpl(long j) {
        return m5005getMaxHeightimpl(j) == m5007getMinHeightimpl(j);
    }

    /* renamed from: isZero-impl  reason: not valid java name */
    public static final boolean m5010isZeroimpl(long j) {
        return m5006getMaxWidthimpl(j) == 0 || m5005getMaxHeightimpl(j) == 0;
    }

    /* renamed from: copy-Zbe2FdA$default  reason: not valid java name */
    public static /* synthetic */ long m4997copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m5008getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m5006getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m5007getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m5005getMaxHeightimpl(j);
        }
        return m4996copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA  reason: not valid java name */
    public static final long m4996copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        boolean z = true;
        if (i3 >= 0 && i >= 0) {
            if (i2 >= i || i2 == Integer.MAX_VALUE) {
                ...
                return Companion.m5013createConstraintsZbe2FdA$ui_unit_release(i, i2, i3, i4);
            }
    ...
    public static String m5011toStringimpl(long j) {
        int m5006getMaxWidthimpl = m5006getMaxWidthimpl(j);
        String valueOf = m5006getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(m5006getMaxWidthimpl);
        int m5005getMaxHeightimpl = m5005getMaxHeightimpl(j);
        return "Constraints(minWidth = " + m5008getMinWidthimpl(j) + ", maxWidth = " + valueOf + ", minHeight = " + m5007getMinHeightimpl(j) + ", maxHeight = " + (m5005getMaxHeightimpl != Integer.MAX_VALUE ? String.valueOf(m5005getMaxHeightimpl) : "Infinity") + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m5014fixedJhjzzOo(int i, int i2) {
            if (!(i >= 0 && i2 >= 0)) {
                throw new IllegalArgumentException(("width(" + i + ") and height(" + i2 + ") must be >= 0").toString());
            }
            return m5013createConstraintsZbe2FdA$ui_unit_release(i, i, i2, i2);
        }

        /* renamed from: fixedWidth-OenEA2s  reason: not valid java name */
        public final long m5016fixedWidthOenEA2s(int i) {
            if (!(i >= 0)) {
                throw new IllegalArgumentException(("width(" + i + ") must be >= 0").toString());
            }
            return m5013createConstraintsZbe2FdA$ui_unit_release(i, i, 0, Integer.MAX_VALUE);
        }

        /* renamed from: fixedHeight-OenEA2s  reason: not valid java name */
        public final long m5015fixedHeightOenEA2s(int i) {
            if (!(i >= 0)) {
                throw new IllegalArgumentException(("height(" + i + ") must be >= 0").toString());
            }
            return m5013createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, i, i);
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release  reason: not valid java name */
        public final long m5013createConstraintsZbe2FdA$ui_unit_release(int i, int i2, int i3, int i4) {
            long j;
            ...
            if (bitsNeedForSize + bitsNeedForSize2 <= 31) {
                ...
                return Constraints.m4995constructorimpl((i7 << 33) | j | (i << Constraints.MinFocusHeight) | (i3 << i9) | (i8 << (i9 + 31)));
            }
