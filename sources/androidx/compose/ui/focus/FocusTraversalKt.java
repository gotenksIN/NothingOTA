...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m2270customFocusSearchOMvw8(FocusTargetModifierNode customFocusSearch, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2255getNextdhqQ8s())) {
            return fetchFocusProperties$ui_release.getNext();
        }
        if (FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2257getPreviousdhqQ8s())) {
        ...
        if (FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2250getDowndhqQ8s())) {
        ...
        } else if (FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2251getEnterdhqQ8s())) {
            return fetchFocusProperties$ui_release.getEnter().invoke(FocusDirection.m2239boximpl(i));
        } else {
            if (FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2252getExitdhqQ8s())) {
                return fetchFocusProperties$ui_release.getExit().invoke(FocusDirection.m2239boximpl(i));
            }
    ...
    public static final boolean m2271focusSearchsMXa3k8(FocusTargetModifierNode focusSearch, int i, LayoutDirection layoutDirection, Function1<? super FocusTargetModifierNode, Boolean> onFound) {
        int m2258getRightdhqQ8s;
        Boolean m2283twoDimensionalFocusSearchOMvw8;
        ...
        if (FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2255getNextdhqQ8s()) ? true : FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2257getPreviousdhqQ8s())) {
            return OneDimensionalFocusSearchKt.m2274oneDimensionalFocusSearchOMvw8(focusSearch, i, onFound);
        }
        if (FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2254getLeftdhqQ8s()) ? true : FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2258getRightdhqQ8s()) ? true : FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2259getUpdhqQ8s()) ? true : FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2250getDowndhqQ8s())) {
            Boolean m2283twoDimensionalFocusSearchOMvw82 = TwoDimensionalFocusSearchKt.m2283twoDimensionalFocusSearchOMvw8(focusSearch, i, onFound);
            if (m2283twoDimensionalFocusSearchOMvw82 != null) {
                return m2283twoDimensionalFocusSearchOMvw82.booleanValue();
            }
        } else if (FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2251getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                m2258getRightdhqQ8s = FocusDirection.Companion.m2258getRightdhqQ8s();
            } else if (i2 != 2) {
                throw new NoWhenBranchMatchedException();
            } else {
                m2258getRightdhqQ8s = FocusDirection.Companion.m2254getLeftdhqQ8s();
            }
            FocusTargetModifierNode findActiveFocusNode = findActiveFocusNode(focusSearch);
            if (findActiveFocusNode != null && (m2283twoDimensionalFocusSearchOMvw8 = TwoDimensionalFocusSearchKt.m2283twoDimensionalFocusSearchOMvw8(findActiveFocusNode, m2258getRightdhqQ8s, onFound)) != null) {
                return m2283twoDimensionalFocusSearchOMvw8.booleanValue();
            }
        } else if (FocusDirection.m2242equalsimpl0(i, FocusDirection.Companion.m2252getExitdhqQ8s())) {
            ...
            throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m2244toStringimpl(i))).toString());
        }
        return false;
    }
        ...
        while (requireLayoutNode != null) {
            if ((requireLayoutNode.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m4277constructorimpl) != 0) {
                while (parent$ui_release != null) {
                    if ((parent$ui_release.getKindSet$ui_release() & m4277constructorimpl) != 0 && (parent$ui_release instanceof FocusTargetModifierNode)) {
