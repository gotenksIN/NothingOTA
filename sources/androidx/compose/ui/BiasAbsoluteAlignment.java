...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2212alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m5210getWidthimpl(j2) - IntSize.m5210getWidthimpl(j), IntSize.m5209getHeightimpl(j2) - IntSize.m5209getHeightimpl(j));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m5210getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m5209getHeightimpl(IntSize) / 2.0f) * (f + this.verticalBias)));
    }
