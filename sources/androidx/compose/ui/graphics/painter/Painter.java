...
public abstract class Painter {
    ...
    public abstract long mo3165getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3170drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m3171drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0  reason: not valid java name */
    public final void m3171drawx_KDEd0(DrawScope draw, long j, float f, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float m2387getWidthimpl = Size.m2387getWidthimpl(draw.mo3096getSizeNHjbRc()) - Size.m2387getWidthimpl(j);
        float m2384getHeightimpl = Size.m2384getHeightimpl(draw.mo3096getSizeNHjbRc()) - Size.m2384getHeightimpl(j);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, m2387getWidthimpl, m2384getHeightimpl);
        if (f > 0.0f && Size.m2387getWidthimpl(j) > 0.0f && Size.m2384getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect m2358Recttz77jQw = RectKt.m2358Recttz77jQw(Offset.Companion.m2334getZeroF1C5BW0(), SizeKt.Size(Size.m2387getWidthimpl(j), Size.m2384getHeightimpl(j)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(m2358Recttz77jQw, obtainPaint());
                    onDraw(draw);
                } finally {
                    canvas.restore();
                }
