...
public final class ColorPainter extends Painter {
    ...
    public final long m3169getColor0d7_KjU() {
        return this.color;
    }
    ...
    public void onDraw(DrawScope drawScope) {
        ...
        DrawScope.m3091drawRectnJ9OG0$default(drawScope, this.color, 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ColorPainter) && Color.m2557equalsimpl0(this.color, ((ColorPainter) obj).color);
    }

    public int hashCode() {
        return Color.m2563hashCodeimpl(this.color);
    }

    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m2564toStringimpl(this.color)) + ')';
    }
