...
public final class AndroidShader_androidKt {
    ...
    public static final Shader m2459ActualLinearGradientShaderVjE6UOU(long j, long j2, List<Color> colors, List<Float> list, int i) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, list);
        int countTransparentColors = countTransparentColors(colors);
        return new android.graphics.LinearGradient(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j), Offset.m2318getXimpl(j2), Offset.m2319getYimpl(j2), makeTransparentColors(colors, countTransparentColors), makeTransparentStops(list, colors, countTransparentColors), AndroidTileMode_androidKt.m2463toAndroidTileMode0vamqd0(i));
    }

    /* renamed from: ActualRadialGradientShader-8uybcMk  reason: not valid java name */
    public static final Shader m2460ActualRadialGradientShader8uybcMk(long j, float f, List<Color> colors, List<Float> list, int i) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, list);
        int countTransparentColors = countTransparentColors(colors);
        return new android.graphics.RadialGradient(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j), f, makeTransparentColors(colors, countTransparentColors), makeTransparentStops(list, colors, countTransparentColors), AndroidTileMode_androidKt.m2463toAndroidTileMode0vamqd0(i));
    }

    /* renamed from: ActualSweepGradientShader-9KIMszo  reason: not valid java name */
    public static final Shader m2461ActualSweepGradientShader9KIMszo(long j, List<Color> colors, List<Float> list) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, list);
        int countTransparentColors = countTransparentColors(colors);
        return new android.graphics.SweepGradient(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j), makeTransparentColors(colors, countTransparentColors), makeTransparentStops(list, colors, countTransparentColors));
    }

    /* renamed from: ActualImageShader-F49vj9s  reason: not valid java name */
    public static final Shader m2458ActualImageShaderF49vj9s(ImageBitmap image, int i, int i2) {
        Intrinsics.checkNotNullParameter(image, "image");
        return new BitmapShader(AndroidImageBitmap_androidKt.asAndroidBitmap(image), AndroidTileMode_androidKt.m2463toAndroidTileMode0vamqd0(i), AndroidTileMode_androidKt.m2463toAndroidTileMode0vamqd0(i2));
    }
    ...
    public static final int[] makeTransparentColors(List<Color> colors, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            iArr[i2] = ColorKt.m2610toArgb8_81llA(colors.get(i2).m2566unboximpl());
        }
        return iArr;
    }
    ...
    public static final float[] makeTransparentStops(List<Float> list, List<Color> colors, int i) {
        ...
        for (int i3 = 1; i3 < lastIndex; i3++) {
            long m2566unboximpl = colors.get(i3).m2566unboximpl();
            float floatValue = list != null ? list.get(i3).floatValue() : i3 / CollectionsKt.getLastIndex(colors);
            int i4 = i2 + 1;
            fArr[i2] = floatValue;
            if (Color.m2558getAlphaimpl(m2566unboximpl) == 0.0f) {
                i2 = i4 + 1;
                fArr[i4] = floatValue;
            } else {
                i2 = i4;
