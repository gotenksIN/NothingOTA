...
public final class StrokeJoin {
    ...
    private static final int Miter = m2903constructorimpl(0);
    private static final int Round = m2903constructorimpl(1);
    private static final int Bevel = m2903constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m2902boximpl(int i) {
    ...
    public static boolean m2904equalsimpl(int i, Object obj) {
        return (obj instanceof StrokeJoin) && i == ((StrokeJoin) obj).m2908unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m2904equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2906hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2910getMiterLxFBmk8() {
            return StrokeJoin.Miter;
        }

        /* renamed from: getRound-LxFBmk8  reason: not valid java name */
        public final int m2911getRoundLxFBmk8() {
            return StrokeJoin.Round;
        }

        /* renamed from: getBevel-LxFBmk8  reason: not valid java name */
        public final int m2909getBevelLxFBmk8() {
    ...
    public String toString() {
        return m2907toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2907toStringimpl(int i) {
        return m2905equalsimpl0(i, Miter) ? "Miter" : m2905equalsimpl0(i, Round) ? "Round" : m2905equalsimpl0(i, Bevel) ? "Bevel" : "Unknown";
    }
}
