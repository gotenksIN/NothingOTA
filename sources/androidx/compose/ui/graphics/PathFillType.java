...
public final class PathFillType {
    ...
    private static final int NonZero = m2823constructorimpl(0);
    private static final int EvenOdd = m2823constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PathFillType m2822boximpl(int i) {
    ...
    public static boolean m2824equalsimpl(int i, Object obj) {
        return (obj instanceof PathFillType) && i == ((PathFillType) obj).m2828unboximpl();
    }
    ...
    public static int m2826hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2830getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os  reason: not valid java name */
        public final int m2829getEvenOddRgk1Os() {
    ...
    public static String m2827toStringimpl(int i) {
        return m2825equalsimpl0(i, NonZero) ? "NonZero" : m2825equalsimpl0(i, EvenOdd) ? "EvenOdd" : "Unknown";
    }
}
