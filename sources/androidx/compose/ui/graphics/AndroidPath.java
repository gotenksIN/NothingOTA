...
public final class AndroidPath implements Path {
    ...
    public int mo2450getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.Companion.m2829getEvenOddRgk1Os();
        }
        return PathFillType.Companion.m2830getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U  reason: not valid java name */
    public void mo2452setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m2825equalsimpl0(i, PathFillType.Companion.m2829getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m2293getXimpl(roundRect.m2368getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m2294getYimpl(roundRect.m2368getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m2293getXimpl(roundRect.m2369getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m2294getYimpl(roundRect.m2369getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m2293getXimpl(roundRect.m2367getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m2294getYimpl(roundRect.m2367getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m2293getXimpl(roundRect.m2366getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m2294getYimpl(roundRect.m2366getBottomLeftCornerRadiuskKHJgLs());
        this.internalPath.addRoundRect(this.rectF, this.radii, Path.Direction.CCW);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: addPath-Uv8p0NA  reason: not valid java name */
    public void mo2449addPathUv8p0NA(Path path, long j) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m2318getXimpl(j), Offset.m2319getYimpl(j));
            return;
        }
    ...
    public void mo2453translatek4lQ0M(long j) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j));
    ...
    public boolean mo2451opN5in7k0(Path path1, Path path2, int i) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m2834equalsimpl0(i, PathOperation.Companion.m2838getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m2834equalsimpl0(i, PathOperation.Companion.m2839getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m2834equalsimpl0(i, PathOperation.Companion.m2840getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m2834equalsimpl0(i, PathOperation.Companion.m2841getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
