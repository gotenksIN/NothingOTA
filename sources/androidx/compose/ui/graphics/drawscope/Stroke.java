...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.Companion.m2899getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.Companion.m2910getMiterLxFBmk8();
    ...
    public final int m3159getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m3160getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        public final int m3161getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m3162getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Stroke) {
            ...
            if (this.width == stroke.width) {
                return ((this.miter > stroke.miter ? 1 : (this.miter == stroke.miter ? 0 : -1)) == 0) && StrokeCap.m2895equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m2905equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        int hashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m2896hashCodeimpl(this.cap)) * 31) + StrokeJoin.m2906hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return hashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m2897toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m2907toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
