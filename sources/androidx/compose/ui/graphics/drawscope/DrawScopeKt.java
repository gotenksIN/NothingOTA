...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m3138rotateRg1IO4c$default(DrawScope rotate, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotate.mo3095getCenterF1C5BW0();
        }
        ...
        drawContext.getTransform().mo3027rotateUv8p0NA(f, j);
        block.invoke(rotate);
    ...
    public static /* synthetic */ void m3140rotateRadRg1IO4c$default(DrawScope rotateRad, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotateRad.mo3095getCenterF1C5BW0();
        }
        ...
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3027rotateUv8p0NA(DegreesKt.degrees(f), j);
    ...
    public static /* synthetic */ void m3142scaleFgt4K4Q$default(DrawScope scale, float f, float f2, long j, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            j = scale.mo3095getCenterF1C5BW0();
        }
        ...
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3028scale0AR0LA0(f, f2, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo3022setSizeuvyYCjk(mo3021getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m3144scaleRg1IO4c$default(DrawScope scale, float f, long j, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = scale.mo3095getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        ...
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3028scale0AR0LA0(f, f, j);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo3022setSizeuvyYCjk(mo3021getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m3136clipRectrOu3jXo$default(DrawScope clipRect, float f, float f2, float f3, float f4, int i, Function1 block, int i2, Object obj) {
        float f5 = (i2 & 1) != 0 ? 0.0f : f;
        float f6 = (i2 & 2) != 0 ? 0.0f : f2;
        if ((i2 & 4) != 0) {
            f3 = Size.m2387getWidthimpl(clipRect.mo3096getSizeNHjbRc());
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Size.m2384getHeightimpl(clipRect.mo3096getSizeNHjbRc());
        }
        float f8 = f4;
        if ((i2 & 16) != 0) {
            i = ClipOp.Companion.m2545getIntersectrtfAjoo();
        }
        ...
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3024clipRectN_I0leg(f5, f6, f7, f8, i);
    ...
    public static /* synthetic */ void m3134clipPathKD09W0M$default(DrawScope clipPath, Path path, int i, Function1 block, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = ClipOp.Companion.m2545getIntersectrtfAjoo();
        }
        ...
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3023clipPathmtrdDE(path, i);
    ...
    public static final void m3137rotateRg1IO4c(DrawScope rotate, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotate.getDrawContext();
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
    ...
    public static final void m3139rotateRadRg1IO4c(DrawScope rotateRad, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotateRad.getDrawContext();
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
    ...
    public static final void m3141scaleFgt4K4Q(DrawScope scale, float f, float f2, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
    ...
    public static final void m3143scaleRg1IO4c(DrawScope scale, float f, long j, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
    ...
    public static final void m3135clipRectrOu3jXo(DrawScope clipRect, float f, float f2, float f3, float f4, int i, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipRect, "$this$clipRect");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipRect.getDrawContext();
        long mo3021getSizeNHjbRc = drawContext.mo3021getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3024clipRectN_I0leg(f, f2, f3, f4, i);
        block.invoke(clipRect);
        drawContext.getCanvas().restore();
        drawContext.mo3022setSizeuvyYCjk(mo3021getSizeNHjbRc);
    }
    ...
    public static final void m3133clipPathKD09W0M(DrawScope clipPath, Path path, int i, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipPath, "$this$clipPath");
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipPath.getDrawContext();
