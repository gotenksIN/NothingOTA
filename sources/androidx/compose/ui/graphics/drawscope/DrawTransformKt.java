...
public final class DrawTransformKt {
    ...
    public static /* synthetic */ void m3156rotateRad0AR0LA0$default(DrawTransform rotateRad, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotateRad.mo3025getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo3027rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* renamed from: rotateRad-0AR0LA0  reason: not valid java name */
    public static final void m3155rotateRad0AR0LA0(DrawTransform rotateRad, float f, long j) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo3027rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* renamed from: scale-0AR0LA0$default  reason: not valid java name */
    public static /* synthetic */ void m3158scale0AR0LA0$default(DrawTransform scale, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = scale.mo3025getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo3028scale0AR0LA0(f, f, j);
    }

    /* renamed from: scale-0AR0LA0  reason: not valid java name */
    public static final void m3157scale0AR0LA0(DrawTransform scale, float f, long j) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo3028scale0AR0LA0(f, f, j);
    }
