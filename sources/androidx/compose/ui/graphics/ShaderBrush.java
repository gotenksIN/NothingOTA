...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo2525createShaderuvyYCjk(long j);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.Companion.m2395getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo2503applyToPq9zytI(long j, Paint p, float f) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m2383equalsimpl0(this.createdSize, j)) {
            shader = mo2525createShaderuvyYCjk(j);
            this.internalShader = shader;
            this.createdSize = j;
        }
        if (!Color.m2557equalsimpl0(p.mo2432getColor0d7_KjU(), Color.Companion.m2582getBlack0d7_KjU())) {
            p.mo2438setColor8_81llA(Color.Companion.m2582getBlack0d7_KjU());
        }
