...
final class RenderEffectVerificationHelper {
    ...
    public final android.graphics.RenderEffect m2856createBlurEffect8A3gB4(RenderEffect renderEffect, float f, float f2, int i) {
        if (renderEffect == null) {
            android.graphics.RenderEffect createBlurEffect = android.graphics.RenderEffect.createBlurEffect(f, f2, AndroidTileMode_androidKt.m2463toAndroidTileMode0vamqd0(i));
            Intrinsics.checkNotNullExpressionValue(createBlurEffect, "{\n            android.gr…)\n            )\n        }");
            return createBlurEffect;
        }
        android.graphics.RenderEffect createBlurEffect2 = android.graphics.RenderEffect.createBlurEffect(f, f2, renderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m2463toAndroidTileMode0vamqd0(i));
    ...
    public final android.graphics.RenderEffect m2857createOffsetEffectUv8p0NA(RenderEffect renderEffect, long j) {
        if (renderEffect == null) {
            android.graphics.RenderEffect createOffsetEffect = android.graphics.RenderEffect.createOffsetEffect(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j));
            Intrinsics.checkNotNullExpressionValue(createOffsetEffect, "{\n            android.gr…et.x, offset.y)\n        }");
            return createOffsetEffect;
        }
        android.graphics.RenderEffect createOffsetEffect2 = android.graphics.RenderEffect.createOffsetEffect(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j), renderEffect.asAndroidRenderEffect());
