...
public final class Vertices {
    ...
    public final int m2948getVertexModec2xauaI() {
    ...
    private final int[] encodeColorList(List<Color> list) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = ColorKt.m2610toArgb8_81llA(list.get(i).m2566unboximpl());
        }
        return iArr;
    }
    ...
    private final float[] encodePointList(List<Offset> list) {
        ...
        for (int i = 0; i < size; i++) {
            long m2328unboximpl = list.get(i / 2).m2328unboximpl();
            if (i % 2 == 0) {
                m2319getYimpl = Offset.m2318getXimpl(m2328unboximpl);
            } else {
                m2319getYimpl = Offset.m2319getYimpl(m2328unboximpl);
            }
            fArr[i] = m2319getYimpl;
        }
        return fArr;
    }
}
