...
public final class OffsetEffect extends RenderEffect {
    ...
    protected android.graphics.RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m2857createOffsetEffectUv8p0NA(this.renderEffect, this.offset);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OffsetEffect) {
            ...
            return Intrinsics.areEqual(this.renderEffect, offsetEffect.renderEffect) && Offset.m2315equalsimpl0(this.offset, offsetEffect.offset);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((renderEffect != null ? renderEffect.hashCode() : 0) * 31) + Offset.m2320hashCodeimpl(this.offset);
    }

    public String toString() {
        return "OffsetEffect(renderEffect=" + this.renderEffect + ", offset=" + ((Object) Offset.m2326toStringimpl(this.offset)) + ')';
    }
}
