...
public class Connector {
    ...
    public final int m2966getRenderIntentuksYyKA() {
        return this.renderIntent;
    }

    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        this(colorSpace, colorSpace2, ColorModel.m2953equalsimpl0(colorSpace.m2962getModelxdoWZVw(), ColorModel.Companion.m2960getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace, ColorModel.m2953equalsimpl0(colorSpace2.m2962getModelxdoWZVw(), ColorModel.Companion.m2960getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace2, i, Companion.m2969computeTransformYBCOT_4(colorSpace, colorSpace2, i), null);
    }
    ...
    public long mo2967transformToColorwmQWz5c$ui_graphics_release(float f, float f2, float f3, float f4) {
        ...
        return this.transformDestination.mo2963xyzaToColorJlNiLsg$ui_graphics_release(f6, f5, z$ui_graphics_release, f4, this.destination);
    }
        ...
        */
        private RgbConnector(androidx.compose.ui.graphics.colorspace.Rgb r9, androidx.compose.ui.graphics.colorspace.Rgb r10, int r11) {
            /*
                ...
                r8.mSource = r9
                r8.mDestination = r10
                float[] r9 = r8.m2970computeTransformYBCOT_4(r9, r10, r11)
                r8.mTransform = r9
                return
            */
        ...
        private final float[] m2970computeTransformYBCOT_4(Rgb rgb, Rgb rgb2, int i) {
            ...
            if (RenderIntent.m2974equalsimpl0(i, RenderIntent.Companion.m2978getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4  reason: not valid java name */
        public final float[] m2969computeTransformYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
            if (RenderIntent.m2974equalsimpl0(i, RenderIntent.Companion.m2978getAbsoluteuksYyKA())) {
                boolean m2953equalsimpl0 = ColorModel.m2953equalsimpl0(colorSpace.m2962getModelxdoWZVw(), ColorModel.Companion.m2960getRgbxdoWZVw());
                boolean m2953equalsimpl02 = ColorModel.m2953equalsimpl0(colorSpace2.m2962getModelxdoWZVw(), ColorModel.Companion.m2960getRgbxdoWZVw());
                if (m2953equalsimpl0 && m2953equalsimpl02) {
                    return null;
                }
                if (m2953equalsimpl0 || m2953equalsimpl02) {
                    if (!m2953equalsimpl0) {
                    ...
                    float[] xyz$ui_graphics_release = m2953equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
                    float[] xyz$ui_graphics_release2 = m2953equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            ...
            final int m2980getRelativeuksYyKA = RenderIntent.Companion.m2980getRelativeuksYyKA();
            return new Connector(source, m2980getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    Intrinsics.checkNotNullParameter(v, "v");
                    return v;
                ...
                {
                    super(source, source, m2980getRelativeuksYyKA, null);
                }
    ...
    static {
        ...
        SrgbToOklabPerceptual = new Connector(ColorSpaces.INSTANCE.getSrgb(), ColorSpaces.INSTANCE.getOklab(), RenderIntent.Companion.m2979getPerceptualuksYyKA(), null);
        OklabToSrgbPerceptual = new Connector(ColorSpaces.INSTANCE.getOklab(), ColorSpaces.INSTANCE.getSrgb(), RenderIntent.Companion.m2979getPerceptualuksYyKA(), null);
    }
}
