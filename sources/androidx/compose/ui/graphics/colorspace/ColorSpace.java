...
public abstract class ColorSpace {
    ...
    public final long m2962getModelxdoWZVw() {
        return this.model;
    }
    ...
    public final int getComponentCount() {
        return ColorModel.m2954getComponentCountimpl(this.model);
    }
    ...
    public long mo2963xyzaToColorJlNiLsg$ui_graphics_release(float f, float f2, float f3, float f4, ColorSpace colorSpace) {
    ...
    public final float[] fromXyz(float f, float f2, float f3) {
        float[] fArr = new float[ColorModel.m2954getComponentCountimpl(this.model)];
        fArr[0] = f;
        fArr[1] = f2;
        fArr[2] = f3;
        return fromXyz(fArr);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m2956toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m2953equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m2955hashCodeimpl(this.model)) * 31) + this.id;
    }
