...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m2965connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m2979getPerceptualuksYyKA();
        }
        return m2964connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m2964connectYBCOT_4(ColorSpace connect, ColorSpace destination, int i) {
        ...
        if (connect == ColorSpaces.INSTANCE.getSrgb()) {
            ...
            if (destination == ColorSpaces.INSTANCE.getOklab() && RenderIntent.m2974equalsimpl0(i, RenderIntent.Companion.m2979getPerceptualuksYyKA())) {
                return Connector.Companion.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (connect == ColorSpaces.INSTANCE.getOklab() && destination == ColorSpaces.INSTANCE.getSrgb() && RenderIntent.m2974equalsimpl0(i, RenderIntent.Companion.m2979getPerceptualuksYyKA())) {
        ...
        if (ColorModel.m2953equalsimpl0(connect.m2962getModelxdoWZVw(), ColorModel.Companion.m2960getRgbxdoWZVw()) && ColorModel.m2953equalsimpl0(destination.m2962getModelxdoWZVw(), ColorModel.Companion.m2960getRgbxdoWZVw())) {
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        ...
        if (ColorModel.m2953equalsimpl0(colorSpace.m2962getModelxdoWZVw(), ColorModel.Companion.m2960getRgbxdoWZVw())) {
