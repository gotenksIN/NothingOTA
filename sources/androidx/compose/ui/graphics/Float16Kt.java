...
public final class Float16Kt {
    ...
    public static final short m2698minAoSsdG0(short s, short s2) {
        if (Float16.m2670isNaNimpl(s) || Float16.m2670isNaNimpl(s2)) {
            return Float16.Companion.m2692getNaNslo4al4();
        }
        return Float16.m2657compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* renamed from: max-AoSsdG0  reason: not valid java name */
    public static final short m2697maxAoSsdG0(short s, short s2) {
        if (Float16.m2670isNaNimpl(s) || Float16.m2670isNaNimpl(s2)) {
            return Float16.Companion.m2692getNaNslo4al4();
        }
        return Float16.m2657compareTo41bOqos(s, s2) >= 0 ? s : s2;
