...
public interface Canvas {
    ...
    void mo2412clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg */
    void mo2413clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: concat-58bKbWc */
    void mo2414concat58bKbWc(float[] fArr);
    ...
    void mo2415drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo2416drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo2417drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo2418drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void mo2419drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo2420drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void mo2421drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m2534clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Canvas.super.m2531clipRectmtrdDE(rect, i);
        }
    ...
    static /* synthetic */ void m2529clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.m2531clipRectmtrdDE(rect, i);
    }

    /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
    default void m2531clipRectmtrdDE(Rect rect, int i) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        mo2413clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
    }

    /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
    static /* synthetic */ void m2528clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo2413clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* renamed from: clipPath-mtrdD-E$default  reason: not valid java name */
    static /* synthetic */ void m2527clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo2412clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m2530drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long m5178getZeronOccac = (i & 2) != 0 ? IntOffset.Companion.m5178getZeronOccac() : j;
        long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
        canvas.mo2417drawImageRectHPBpro0(imageBitmap, m5178getZeronOccac, IntSize, (i & 8) != 0 ? IntOffset.Companion.m5178getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
    }
}
