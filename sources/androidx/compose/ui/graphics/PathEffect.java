...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m2821stampedPathEffect7aD1DOk(Path shape, float f, float f2, int i) {
            Intrinsics.checkNotNullParameter(shape, "shape");
            return AndroidPathEffect_androidKt.m2454actualStampedPathEffect7aD1DOk(shape, f, f2, i);
        }
    }
}
