...
public final class Shadow {
    ...
    public static /* synthetic */ void m2868getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations  reason: not valid java name */
    public static /* synthetic */ void m2869getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.Companion.m2334getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public final long m2871getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: getOffset-F1C5BW0  reason: not valid java name */
    public final long m2872getOffsetF1C5BW0() {
        return this.offset;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Shadow) {
            ...
            if (Color.m2557equalsimpl0(this.color, shadow.color) && Offset.m2315equalsimpl0(this.offset, shadow.offset)) {
    ...
    public int hashCode() {
        return (((Color.m2563hashCodeimpl(this.color) * 31) + Offset.m2320hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m2564toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m2326toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM$default  reason: not valid java name */
    public static /* synthetic */ Shadow m2867copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.color;
        }
        long j3 = j;
        ...
        return shadow.m2870copyqcb84PM(j3, j4, f);
    }

    /* renamed from: copy-qcb84PM  reason: not valid java name */
    public final Shadow m2870copyqcb84PM(long j, long j2, float f) {
