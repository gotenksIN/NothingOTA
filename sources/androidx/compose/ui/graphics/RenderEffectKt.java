...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m2855BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.Companion.m2919getClamp3opZhB0();
        }
        return m2854BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs  reason: not valid java name */
    public static final BlurEffect m2854BlurEffect3YTHUZs(float f, float f2, int i) {
