...
public final class DrawCache {
    ...
    private long size = IntSize.Companion.m5215getZeroYbymL2g();
    ...
    public final void m3172drawCachedImageCJJARo(long j, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m5210getWidthimpl(j) > imageBitmap.getWidth() || IntSize.m5209getHeightimpl(j) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m2777ImageBitmapx__hDU$default(IntSize.m5210getWidthimpl(j), IntSize.m5209getHeightimpl(j), 0, false, null, 28, null);
        ...
        drawParams2.m3020setSizeuvyYCjk(m5220toSizeozmzZPI);
        canvas.save();
    ...
    public final void drawInto(DrawScope target, float f, ColorFilter colorFilter) {
        ...
        DrawScope.m3080drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, f, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.m3091drawRectnJ9OG0$default(drawScope, Color.Companion.m2582getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.Companion.m2473getClear0nO6VwU(), 62, null);
    }
}
