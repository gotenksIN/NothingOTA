...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.Companion.m2395getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m2383equalsimpl0(this.previousDrawSize, drawScope.mo3096getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2387getWidthimpl(drawScope.mo3096getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2384getHeightimpl(drawScope.mo3096getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3172drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m2387getWidthimpl(drawScope.mo3096getSizeNHjbRc())), (int) Math.ceil(Size.m2384getHeightimpl(drawScope.mo3096getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo3096getSizeNHjbRc();
        }
