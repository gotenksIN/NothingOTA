...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m3193rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        long m2592getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.Companion.m2592getUnspecified0d7_KjU() : j;
        int m2498getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.Companion.m2498getSrcIn0nO6VwU() : i;
        ...
        VectorPainter m3194rememberVectorPaintervIP8VLU = m3194rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, m2592getUnspecified0d7_KjU, m2498getSrcIn0nO6VwU, false, content, composer, (i2 & 14) | 12582912 | (i2 & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m3194rememberVectorPaintervIP8VLU;
    }

    /* renamed from: rememberVectorPainter-vIP8VLU  reason: not valid java name */
    public static final VectorPainter m3194rememberVectorPaintervIP8VLU(float f, float f2, float f3, float f4, String str, long j, int i, boolean z, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        float mo302toPx0680j_42 = density.mo302toPx0680j_4(f2);
        if (Float.isNaN(f5)) {
            f5 = mo302toPx0680j_4;
        }
        if (Float.isNaN(f6)) {
            f6 = mo302toPx0680j_42;
        }
        Color m2546boximpl = Color.m2546boximpl(m2592getUnspecified0d7_KjU);
        BlendMode m2466boximpl = BlendMode.m2466boximpl(m2498getSrcIn0nO6VwU);
        int i4 = i2 >> 15;
        composer.startReplaceableGroup(511388516);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1,2):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2546boximpl) | composer.changed(m2466boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = !Color.m2557equalsimpl0(m2592getUnspecified0d7_KjU, Color.Companion.m2592getUnspecified0d7_KjU()) ? ColorFilter.Companion.m2600tintxETnrds(m2592getUnspecified0d7_KjU, m2498getSrcIn0nO6VwU) : null;
        ...
        vectorPainter.m3192setSizeuvyYCjk$ui_release(SizeKt.Size(mo302toPx0680j_4, mo302toPx0680j_42));
    ...
    public static final VectorPainter rememberVectorPainter(final ImageVector image, Composer composer, int i) {
        ...
        VectorPainter m3194rememberVectorPaintervIP8VLU = m3194rememberVectorPaintervIP8VLU(image.m3174getDefaultWidthD9Ej5fM(), image.m3173getDefaultHeightD9Ej5fM(), image.getViewportWidth(), image.getViewportHeight(), image.getName(), image.m3176getTintColor0d7_KjU(), image.m3175getTintBlendMode0nO6VwU(), image.getAutoMirror(), ComposableLambdaKt.composableLambda(composer, 1873274766, true, new Function4<Float, Float, Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainterKt$rememberVectorPainter$3
    ...
    private static final void mirror(DrawScope drawScope, Function1<? super DrawScope, Unit> function1) {
        long mo3095getCenterF1C5BW0 = drawScope.mo3095getCenterF1C5BW0();
