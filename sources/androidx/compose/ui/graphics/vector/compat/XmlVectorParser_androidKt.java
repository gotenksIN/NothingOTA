...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3199getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m2899getButtKaPHkGw();
        }
        return m3198getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m3198getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeCap.Companion.m2901getSquareKaPHkGw();
            }
            return StrokeCap.Companion.m2900getRoundKaPHkGw();
        }
        return StrokeCap.Companion.m2899getButtKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default  reason: not valid java name */
    static /* synthetic */ int m3201getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m2910getMiterLxFBmk8();
        }
        return m3200getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m3200getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeJoin.Companion.m2909getBevelLxFBmk8();
            }
            return StrokeJoin.Companion.m2911getRoundLxFBmk8();
        }
        return StrokeJoin.Companion.m2910getMiterLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs) {
        long m2592getUnspecified0d7_KjU;
        int m2498getSrcIn0nO6VwU;
        Intrinsics.checkNotNullParameter(androidVectorParser, "<this>");
        Intrinsics.checkNotNullParameter(res, "res");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        ...
        if (namedFloat > 0.0f) {
            ...
            if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
                ...
                if (typedValue.type == 2) {
                    m2592getUnspecified0d7_KjU = Color.Companion.m2592getUnspecified0d7_KjU();
                } else {
                    ...
                    if (namedColorStateList != null) {
                        m2592getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                    } else {
                        m2592getUnspecified0d7_KjU = Color.Companion.m2592getUnspecified0d7_KjU();
                    }
                }
            ...
            long j = m2592getUnspecified0d7_KjU;
            ...
            if (i == -1) {
                m2498getSrcIn0nO6VwU = BlendMode.Companion.m2498getSrcIn0nO6VwU();
            } else if (i == 3) {
                m2498getSrcIn0nO6VwU = BlendMode.Companion.m2500getSrcOver0nO6VwU();
            } else if (i == 5) {
                m2498getSrcIn0nO6VwU = BlendMode.Companion.m2498getSrcIn0nO6VwU();
            } else if (i == 9) {
                m2498getSrcIn0nO6VwU = BlendMode.Companion.m2497getSrcAtop0nO6VwU();
            } else {
                switch (i) {
                    case 14:
                        m2498getSrcIn0nO6VwU = BlendMode.Companion.m2489getModulate0nO6VwU();
                        break;
                    case 15:
                        m2498getSrcIn0nO6VwU = BlendMode.Companion.m2494getScreen0nO6VwU();
                        break;
                    case 16:
                        m2498getSrcIn0nO6VwU = BlendMode.Companion.m2492getPlus0nO6VwU();
                        break;
                    default:
                        m2498getSrcIn0nO6VwU = BlendMode.Companion.m2498getSrcIn0nO6VwU();
                        break;
            ...
            int i2 = m2498getSrcIn0nO6VwU;
            float m5050constructorimpl = Dp.m5050constructorimpl(dimension / res.getDisplayMetrics().density);
            float m5050constructorimpl2 = Dp.m5050constructorimpl(dimension2 / res.getDisplayMetrics().density);
            obtainAttributes.recycle();
            return new ImageVector.Builder(null, m5050constructorimpl, m5050constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
        }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m3198getStrokeLineCapCSYIeUk = m3198getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m2899getButtKaPHkGw());
        int m3200getStrokeLineJoinkLtJ_vA = m3200getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m2909getBevelLxFBmk8());
        ...
        builder.m3178addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m2830getNonZeroRgk1Os() : companion.m2829getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m3198getStrokeLineCapCSYIeUk, m3200getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
