...
public final class VectorPath extends VectorNode {
    ...
    public final int m3195getPathFillTypeRgk1Os() {
    ...
    public final int m3196getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8  reason: not valid java name */
    public final int m3197getStrokeLineJoinLxFBmk8() {
        ...
        if (Intrinsics.areEqual(this.name, vectorPath.name) && Intrinsics.areEqual(this.fill, vectorPath.fill)) {
            if ((this.fillAlpha == vectorPath.fillAlpha) && Intrinsics.areEqual(this.stroke, vectorPath.stroke)) {
                if (this.strokeAlpha == vectorPath.strokeAlpha) {
                    if ((this.strokeLineWidth == vectorPath.strokeLineWidth) && StrokeCap.m2895equalsimpl0(this.strokeLineCap, vectorPath.strokeLineCap) && StrokeJoin.m2905equalsimpl0(this.strokeLineJoin, vectorPath.strokeLineJoin)) {
                        if (this.strokeLineMiter == vectorPath.strokeLineMiter) {
                            if (this.trimPathStart == vectorPath.trimPathStart) {
                                if (this.trimPathEnd == vectorPath.trimPathEnd) {
                                    return ((this.trimPathOffset > vectorPath.trimPathOffset ? 1 : (this.trimPathOffset == vectorPath.trimPathOffset ? 0 : -1)) == 0) && PathFillType.m2825equalsimpl0(this.pathFillType, vectorPath.pathFillType) && Intrinsics.areEqual(this.pathData, vectorPath.pathData);
                                }
                                return false;
                            }
                            return false;
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((hashCode2 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.hashCode(this.strokeAlpha)) * 31) + Float.hashCode(this.strokeLineWidth)) * 31) + StrokeCap.m2896hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m2906hashCodeimpl(this.strokeLineJoin)) * 31) + Float.hashCode(this.strokeLineMiter)) * 31) + Float.hashCode(this.trimPathStart)) * 31) + Float.hashCode(this.trimPathEnd)) * 31) + Float.hashCode(this.trimPathOffset)) * 31) + PathFillType.m2826hashCodeimpl(this.pathFillType);
    }
}
