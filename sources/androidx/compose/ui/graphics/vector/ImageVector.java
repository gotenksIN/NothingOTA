...
public final class ImageVector {
    ...
    public final float m3174getDefaultWidthD9Ej5fM() {
        return this.defaultWidth;
    }

    /* renamed from: getDefaultHeight-D9Ej5fM  reason: not valid java name */
    public final float m3173getDefaultHeightD9Ej5fM() {
    ...
    public final long m3176getTintColor0d7_KjU() {
        return this.tintColor;
    }

    /* renamed from: getTintBlendMode-0nO6VwU  reason: not valid java name */
    public final int m3175getTintBlendMode0nO6VwU() {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m2592getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m2498getSrcIn0nO6VwU() : i, (i2 & 128) != 0 ? false : z, (DefaultConstructorMarker) null);
        }
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m2592getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m2498getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
        ...
        public final Builder m3178addPathoIyEayM(List<? extends PathNode> pathData, int i, String name, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImageVector) {
            ...
            if (Intrinsics.areEqual(this.name, imageVector.name) && Dp.m5055equalsimpl0(this.defaultWidth, imageVector.defaultWidth) && Dp.m5055equalsimpl0(this.defaultHeight, imageVector.defaultHeight)) {
                if (this.viewportWidth == imageVector.viewportWidth) {
                    return ((this.viewportHeight > imageVector.viewportHeight ? 1 : (this.viewportHeight == imageVector.viewportHeight ? 0 : -1)) == 0) && Intrinsics.areEqual(this.root, imageVector.root) && Color.m2557equalsimpl0(this.tintColor, imageVector.tintColor) && BlendMode.m2469equalsimpl0(this.tintBlendMode, imageVector.tintBlendMode) && this.autoMirror == imageVector.autoMirror;
                }
                return false;
            }
            return false;
    ...
    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + Dp.m5056hashCodeimpl(this.defaultWidth)) * 31) + Dp.m5056hashCodeimpl(this.defaultHeight)) * 31) + Float.hashCode(this.viewportWidth)) * 31) + Float.hashCode(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m2563hashCodeimpl(this.tintColor)) * 31) + BlendMode.m2470hashCodeimpl(this.tintBlendMode)) * 31) + Boolean.hashCode(this.autoMirror);
    }
}
