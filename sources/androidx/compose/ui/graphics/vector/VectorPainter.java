...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter() {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2375boximpl(Size.Companion.m2396getZeroNHjbRc()), null, 2, null);
    ...
    public final long m3191getSizeNHjbRc$ui_release() {
        return ((Size) this.size$delegate.getValue()).m2392unboximpl();
    }

    /* renamed from: setSize-uvyYCjk$ui_release  reason: not valid java name */
    public final void m3192setSizeuvyYCjk$ui_release(long j) {
        this.size$delegate.setValue(Size.m2375boximpl(j));
    }
    ...
    public long mo3165getIntrinsicSizeNHjbRc() {
        return m3191getSizeNHjbRc$ui_release();
    }
