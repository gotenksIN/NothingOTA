...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (fArr == null) {
            fArr = Matrix.m2780constructorimpl$default(null, 1, null);
            this.groupMatrix = fArr;
        } else {
            Matrix.m2789resetimpl(fArr);
        }
        Matrix.m2800translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m2792rotateZimpl(fArr, this.rotation);
        Matrix.m2793scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m2800translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        float[] fArr = this.groupMatrix;
        if (fArr != null) {
            transform.mo3029transform58bKbWc((fArr != null ? Matrix.m2778boximpl(fArr) : null).m2801unboximpl());
        }
        Path path = this.clipPath;
        if (getWillClipPath() && path != null) {
            DrawTransform.m3146clipPathmtrdDE$default(transform, path, 0, 2, null);
        }
        List<VNode> list = this.children;
        int size = list.size();
        for (int i = 0; i < size; i++) {
