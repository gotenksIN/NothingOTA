...
public final class SolidColor extends Brush {
    ...
    public final long m2881getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public void mo2503applyToPq9zytI(long j, Paint p, float f) {
        long j2;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (!(f == 1.0f)) {
            long j3 = this.value;
            j2 = Color.m2555copywmQWz5c$default(j3, Color.m2558getAlphaimpl(j3) * f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j2 = this.value;
        }
        p.mo2438setColor8_81llA(j2);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SolidColor) && Color.m2557equalsimpl0(this.value, ((SolidColor) obj).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m2564toStringimpl(this.value)) + ')';
    }
}
