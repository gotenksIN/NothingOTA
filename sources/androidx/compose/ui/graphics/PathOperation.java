...
public final class PathOperation {
    ...
    private static final int Difference = m2832constructorimpl(0);
    private static final int Intersect = m2832constructorimpl(1);
    private static final int Union = m2832constructorimpl(2);
    private static final int Xor = m2832constructorimpl(3);
    private static final int ReverseDifference = m2832constructorimpl(4);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PathOperation m2831boximpl(int i) {
        return new PathOperation(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2832constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2833equalsimpl(int i, Object obj) {
        return (obj instanceof PathOperation) && i == ((PathOperation) obj).m2837unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m2838getDifferenceb3I0S0c() {
            return PathOperation.Difference;
        }

        /* renamed from: getIntersect-b3I0S0c  reason: not valid java name */
        public final int m2839getIntersectb3I0S0c() {
            return PathOperation.Intersect;
        }

        /* renamed from: getUnion-b3I0S0c  reason: not valid java name */
        public final int m2841getUnionb3I0S0c() {
            return PathOperation.Union;
        }

        /* renamed from: getXor-b3I0S0c  reason: not valid java name */
        public final int m2842getXorb3I0S0c() {
            return PathOperation.Xor;
        }

        /* renamed from: getReverseDifference-b3I0S0c  reason: not valid java name */
        public final int m2840getReverseDifferenceb3I0S0c() {
    ...
    public static String m2836toStringimpl(int i) {
        return m2834equalsimpl0(i, Difference) ? "Difference" : m2834equalsimpl0(i, Intersect) ? "Intersect" : m2834equalsimpl0(i, Union) ? "Union" : m2834equalsimpl0(i, Xor) ? "Xor" : m2834equalsimpl0(i, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }
}
