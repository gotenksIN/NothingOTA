...
public final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public final long m2876getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    /* renamed from: setTransformOrigin-__ExYCQ  reason: not valid java name */
    public final void m2880setTransformOrigin__ExYCQ(long j) {
    ...
    public final long m2873getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: setAmbientShadowColor-8_81llA  reason: not valid java name */
    public final void m2877setAmbientShadowColor8_81llA(long j) {
        this.ambientShadowColor = j;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU  reason: not valid java name */
    public final long m2875getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: setSpotShadowColor-8_81llA  reason: not valid java name */
    public final void m2879setSpotShadowColor8_81llA(long j) {
    ...
    public /* synthetic */ SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, f2, f3, f4, f5, f6, f7, f8, f9, f10, j, shape, z, renderEffect, j2, j3, (i2 & 65536) != 0 ? CompositingStrategy.Companion.m2640getAutoNrFUSI() : i, null);
    }

    /* renamed from: getCompositingStrategy--NrFUSI  reason: not valid java name */
    public final int m2874getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE  reason: not valid java name */
    public final void m2878setCompositingStrategyaDBOjCE(int i) {
    ...
    private SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                ...
                graphicsLayerScope.mo2744setTransformOrigin__ExYCQ(SimpleGraphicsLayerModifier.this.m2876getTransformOriginSzJe1aQ());
                ...
                graphicsLayerScope.mo2741setAmbientShadowColor8_81llA(SimpleGraphicsLayerModifier.this.m2873getAmbientShadowColor0d7_KjU());
                graphicsLayerScope.mo2743setSpotShadowColor8_81llA(SimpleGraphicsLayerModifier.this.m2875getSpotShadowColor0d7_KjU());
                graphicsLayerScope.mo2742setCompositingStrategyaDBOjCE(SimpleGraphicsLayerModifier.this.m2874getCompositingStrategyNrFUSI());
            }
        };
    }

    public final void invalidateLayerBlock() {
        NodeCoordinator wrapped$ui_release = DelegatableNodeKt.m4181requireCoordinator64DMado(this, NodeKind.m4277constructorimpl(2)).getWrapped$ui_release();
    ...
    public MeasureResult mo2233measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, mo4075measureBRTryo0.getWidth(), mo4075measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
