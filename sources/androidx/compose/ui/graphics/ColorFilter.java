...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m2597tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m2498getSrcIn0nO6VwU();
            }
            return companion.m2600tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m2600tintxETnrds(long j, int i) {
            return AndroidColorFilter_androidKt.m2425actualTintColorFilterxETnrds(j, i);
        }

        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m2598colorMatrixjHGOpc(float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m2423actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m2599lightingOWjLjI(long j, long j2) {
            return AndroidColorFilter_androidKt.m2424actualLightingColorFilterOWjLjI(j, j2);
        }
    }
