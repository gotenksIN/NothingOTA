...
public final class BiasAlignment implements Alignment {
    ...
    public long mo2212alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        ...
        float m5210getWidthimpl = (IntSize.m5210getWidthimpl(j2) - IntSize.m5210getWidthimpl(j)) / 2.0f;
        float m5209getHeightimpl = (IntSize.m5209getHeightimpl(j2) - IntSize.m5209getHeightimpl(j)) / 2.0f;
        ...
        float f2 = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(m5210getWidthimpl * (f + f2)), MathKt.roundToInt(m5209getHeightimpl * (f2 + this.verticalBias)));
    }
