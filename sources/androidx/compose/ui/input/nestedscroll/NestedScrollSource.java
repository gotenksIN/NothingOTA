...
public final class NestedScrollSource {
    ...
    private static final int Drag = m3849constructorimpl(1);
    private static final int Fling = m3849constructorimpl(2);
    private static final int Relocate = m3849constructorimpl(3);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m3848boximpl(int i) {
    ...
    public static boolean m3850equalsimpl(int i, Object obj) {
        return (obj instanceof NestedScrollSource) && i == ((NestedScrollSource) obj).m3854unboximpl();
    }
    ...
    public static String m3853toStringimpl(int i) {
        return m3851equalsimpl0(i, Drag) ? "Drag" : m3851equalsimpl0(i, Fling) ? "Fling" : m3851equalsimpl0(i, Relocate) ? "Relocate" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m3855getRelocateWNlRxjI$annotations() {
        }
        ...
        public final int m3856getDragWNlRxjI() {
            return NestedScrollSource.Drag;
        }

        /* renamed from: getFling-WNlRxjI  reason: not valid java name */
        public final int m3857getFlingWNlRxjI() {
            return NestedScrollSource.Fling;
        }

        /* renamed from: getRelocate-WNlRxjI  reason: not valid java name */
        public final int m3858getRelocateWNlRxjI() {
