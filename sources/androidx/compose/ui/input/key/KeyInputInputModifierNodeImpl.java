...
public final class KeyInputInputModifierNodeImpl extends Modifier.Node implements KeyInputModifierNode {
    ...
    public boolean mo3831onKeyEventZmokQxo(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        Function1<? super KeyEvent, Boolean> function1 = this.onEvent;
        if (function1 != null) {
            return function1.invoke(KeyEvent.m3807boximpl(event)).booleanValue();
        }
        return false;
    }
    ...
    public boolean mo3832onPreKeyEventZmokQxo(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
