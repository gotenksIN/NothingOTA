...
public final class SuspendingPointerInputFilter extends PointerInputFilter implements PointerInputModifier, PointerInputScope, Density {
    ...
    public SuspendingPointerInputFilter(ViewConfiguration viewConfiguration, Density density) {
        ...
        this.boundsSize = IntSize.Companion.m5215getZeroYbymL2g();
    ...
    public long mo3992getExtendedTouchPaddingNHjbRc() {
        long mo303toSizeXkaWNTQ = mo303toSizeXkaWNTQ(getViewConfiguration().mo4208getMinimumTouchTargetSizeMYxV2XQ());
        long j = m3977getSizeYbymL2g();
        return SizeKt.Size(Math.max(0.0f, Size.m2387getWidthimpl(mo303toSizeXkaWNTQ) - IntSize.m5210getWidthimpl(j)) / 2.0f, Math.max(0.0f, Size.m2384getHeightimpl(mo303toSizeXkaWNTQ) - IntSize.m5209getHeightimpl(j)) / 2.0f);
    }
    ...
    public void mo3978onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long j) {
    ...
    public void onCancel() {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            arrayList2.add(new PointerInputChange(pointerInputChange.m3956getIdJ3iCeTQ(), pointerInputChange.getUptimeMillis(), pointerInputChange.m3957getPositionF1C5BW0(), false, pointerInputChange.getPressure(), pointerInputChange.getUptimeMillis(), pointerInputChange.m3957getPositionF1C5BW0(), pointerInputChange.getPressed(), pointerInputChange.getPressed(), 0, 0L, 1536, (DefaultConstructorMarker) null));
        }
    ...
    public final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo3872getExtendedTouchPaddingNHjbRc() {
            return this.this$0.mo3992getExtendedTouchPaddingNHjbRc();
        }
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m5373constructorimpl(event));
        }
        ...
        */
        public <T> java.lang.Object withTimeout(long r12, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.AwaitPointerEventScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r14, kotlin.coroutines.Continuation<? super T> r15) {
            ...
            L39:
                ...
                java.lang.Object r2 = kotlin.Result.m5373constructorimpl(r2)
                r15.resumeWith(r2)
            L5c:
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Result.Companion companion = Result.Companion;
            createCoroutine.resumeWith(Result.m5373constructorimpl(Unit.INSTANCE));
            Unit unit = Unit.INSTANCE;
        }
