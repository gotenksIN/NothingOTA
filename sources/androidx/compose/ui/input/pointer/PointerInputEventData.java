...
public final class PointerInputEventData {
    ...
    public final long m3964component1J3iCeTQ() {
        return this.id;
    }

    /* renamed from: component10-F1C5BW0  reason: not valid java name */
    public final long m3965component10F1C5BW0() {
    ...
    public final long m3966component3F1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: component4-F1C5BW0  reason: not valid java name */
    public final long m3967component4F1C5BW0() {
    ...
    public final int m3968component7T8wyACA() {
        return this.type;
    }
    ...
    public final PointerInputEventData m3969copygYeeOSc(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List<HistoricalChange> historical, long j5) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PointerInputEventData) {
            ...
            return PointerId.m3942equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m2315equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m2315equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m4028equalsimpl0(this.type, pointerInputEventData.type) && this.issuesEnterExit == pointerInputEventData.issuesEnterExit && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m2315equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta);
        }
        return false;
    }
    ...
    public int hashCode() {
        int m3943hashCodeimpl = ((((((PointerId.m3943hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m2320hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m2320hashCodeimpl(this.position)) * 31;
        boolean z = this.down;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        int hashCode = (((((m3943hashCodeimpl + i) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m4029hashCodeimpl(this.type)) * 31;
        boolean z2 = this.issuesEnterExit;
        return ((((hashCode + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.historical.hashCode()) * 31) + Offset.m2320hashCodeimpl(this.scrollDelta);
    }

    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m3944toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m2326toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m2326toStringimpl(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) PointerType.m4030toStringimpl(this.type)) + ", issuesEnterExit=" + this.issuesEnterExit + ", historical=" + this.historical + ", scrollDelta=" + ((Object) Offset.m2326toStringimpl(this.scrollDelta)) + ')';
    }
    ...
    public final long m3970getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m3972getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: getPosition-F1C5BW0  reason: not valid java name */
    public final long m3971getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m3974getTypeT8wyACA() {
        return this.type;
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & 256) != 0 ? new ArrayList() : list, (i2 & 512) != 0 ? Offset.Companion.m2334getZeroF1C5BW0() : j5, null);
    }
    ...
    public final long m3973getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }
}
