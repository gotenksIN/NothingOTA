...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long j;
        boolean down;
        long mo4038screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m3939boximpl(pointerInputEventData.m3970getIdJ3iCeTQ()));
            if (pointerInputData == null) {
                j = pointerInputEventData.getUptime();
                mo4038screenToLocalMKHz9U = pointerInputEventData.m3971getPositionF1C5BW0();
                down = false;
            } else {
                long uptime = pointerInputData.getUptime();
                j = uptime;
                down = pointerInputData.getDown();
                mo4038screenToLocalMKHz9U = positionCalculator.mo4038screenToLocalMKHz9U(pointerInputData.m3961getPositionOnScreenF1C5BW0());
            }
            linkedHashMap.put(PointerId.m3939boximpl(pointerInputEventData.m3970getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m3970getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m3971getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), j, mo4038screenToLocalMKHz9U, down, false, pointerInputEventData.m3974getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m3973getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(PointerId.m3939boximpl(pointerInputEventData.m3970getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m3972getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m3974getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m3939boximpl(pointerInputEventData.m3970getIdJ3iCeTQ()));
            }
        }
    ...
    private static final class PointerInputData {
        ...
        public final long m3961getPositionOnScreenF1C5BW0() {
        ...
        public final int m3962getTypeT8wyACA() {
            return this.type;
        }
    }
}
