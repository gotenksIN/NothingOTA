...
public final class HitPathTracker {
    ...
    public final void m3888addHitPathKNwqfcY(long j, List<? extends PointerInputModifierNode> pointerInputNodes) {
        Node node;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (z) {
                ...
                if (node3 != null) {
                    node3.markIsIn();
                    if (!node3.getPointerIds().contains(PointerId.m3939boximpl(j))) {
                        node3.getPointerIds().add(PointerId.m3939boximpl(j));
                    }
                    node2 = node3;
                } else {
                    z = false;
            ...
            node4.getPointerIds().add(PointerId.m3939boximpl(j));
