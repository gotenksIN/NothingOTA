...
public final class HistoricalChange {
    ...
    public final long m3887getPositionF1C5BW0() {
        return this.position;
    }

    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m2326toStringimpl(this.position)) + ')';
    }
}
