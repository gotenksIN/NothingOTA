...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker velocityTracker, PointerInputChange event) {
        ...
        if (PointerEventKt.changedToDownIgnoreConsumed(event)) {
            velocityTracker.m4051setCurrentPointerPositionAccumulatork4lQ0M$ui_release(event.m3957getPositionF1C5BW0());
            velocityTracker.resetTracking();
        }
        long m3958getPreviousPositionF1C5BW0 = event.m3958getPreviousPositionF1C5BW0();
        List<HistoricalChange> historical = event.getHistorical();
        int size = historical.size();
        int i = 0;
        while (i < size) {
            HistoricalChange historicalChange = historical.get(i);
            long m2322minusMKHz9U = Offset.m2322minusMKHz9U(historicalChange.m3887getPositionF1C5BW0(), m3958getPreviousPositionF1C5BW0);
            long m3887getPositionF1C5BW0 = historicalChange.m3887getPositionF1C5BW0();
            velocityTracker.m4051setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2323plusMKHz9U(velocityTracker.m4050getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), m2322minusMKHz9U));
            velocityTracker.m4048addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.m4050getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
            i++;
            m3958getPreviousPositionF1C5BW0 = m3887getPositionF1C5BW0;
        }
        velocityTracker.m4051setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2323plusMKHz9U(velocityTracker.m4050getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), Offset.m2322minusMKHz9U(event.m3957getPositionF1C5BW0(), m3958getPreviousPositionF1C5BW0)));
        velocityTracker.m4048addPositionUv8p0NA(event.getUptimeMillis(), velocityTracker.m4050getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
    }
