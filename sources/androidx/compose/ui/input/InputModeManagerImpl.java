...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> function1) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m3214boximpl(i), null, 2, null);
        this.inputMode$delegate = mutableStateOf$default;
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: getInputMode-aOaMEAU */
    public int mo3223getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode$delegate.getValue()).m3220unboximpl();
    }

    /* renamed from: setInputMode-iuPiT84  reason: not valid java name */
    public void m3225setInputModeiuPiT84(int i) {
        this.inputMode$delegate.setValue(InputMode.m3214boximpl(i));
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: requestInputMode-iuPiT84 */
    public boolean mo3224requestInputModeiuPiT84(int i) {
        return this.onRequestInputModeChange.invoke(InputMode.m3214boximpl(i)).booleanValue();
    }
}
