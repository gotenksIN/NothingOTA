...
public final class PlatformHapticFeedbackType {
    ...
    private static final int LongPress = HapticFeedbackType.m3204constructorimpl(0);
    private static final int TextHandleMove = HapticFeedbackType.m3204constructorimpl(9);

    private PlatformHapticFeedbackType() {
    }

    /* renamed from: getLongPress-5zf0vsI  reason: not valid java name */
    public final int m3212getLongPress5zf0vsI() {
        return LongPress;
    }

    /* renamed from: getTextHandleMove-5zf0vsI  reason: not valid java name */
    public final int m3213getTextHandleMove5zf0vsI() {
