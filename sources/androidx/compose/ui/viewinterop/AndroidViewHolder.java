...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                if (AndroidViewHolder.this.getChildCount() == 0) {
                    return MeasureScope.layout$default(measure, Constraints.m5008getMinWidthimpl(j), Constraints.m5007getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        /* renamed from: invoke  reason: avoid collision after fix types in other method */
                ...
                if (Constraints.m5008getMinWidthimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m5008getMinWidthimpl(j));
                }
                if (Constraints.m5007getMinHeightimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m5007getMinHeightimpl(j));
                }
                AndroidViewHolder androidViewHolder = AndroidViewHolder.this;
                ...
                obtainMeasureSpec = androidViewHolder.obtainMeasureSpec(m5008getMinWidthimpl, m5006getMaxWidthimpl, layoutParams.width);
                ...
                obtainMeasureSpec2 = androidViewHolder2.obtainMeasureSpec(m5007getMinHeightimpl, m5005getMaxHeightimpl, layoutParams2.height);
    ...
    public void onNestedScroll(View target, int i, int i2, int i3, int i4, int i5, int[] consumed) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long m3845dispatchPostScrollDzOQY0M = nestedScrollDispatcher.m3845dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2318getXimpl(m3845dispatchPostScrollDzOQY0M));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2319getYimpl(m3845dispatchPostScrollDzOQY0M));
        }
    }
    ...
    public void onNestedScroll(View target, int i, int i2, int i3, int i4, int i5) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long Offset2 = OffsetKt.Offset(composeOffset3, composeOffset4);
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(i5);
            nestedScrollDispatcher.m3845dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
        }
    }
    ...
    public void onNestedPreScroll(View target, int i, int i2, int[] consumed, int i3) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long m3847dispatchPreScrollOzD1aCk = nestedScrollDispatcher.m3847dispatchPreScrollOzD1aCk(Offset, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2318getXimpl(m3847dispatchPreScrollOzD1aCk));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2319getYimpl(m3847dispatchPreScrollOzD1aCk));
        }
    }
