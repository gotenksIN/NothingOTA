...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int roundToInt = MathKt.roundToInt(Offset.m2318getXimpl(positionInRoot));
        int roundToInt2 = MathKt.roundToInt(Offset.m2319getYimpl(positionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.Companion.m3856getDragWNlRxjI();
        }
        return NestedScrollSource.Companion.m3857getFlingWNlRxjI();
    }
}
