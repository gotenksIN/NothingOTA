    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!this.$consumed) {
                ...
                this.label = 1;
                if (nestedScrollDispatcher2.m3844dispatchPostFlingRZ2iAVY(Velocity.Companion.m5286getZero9UxMQ8M(), this.$viewVelocity, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                nestedScrollDispatcher = this.this$0.dispatcher;
                this.label = 2;
                if (nestedScrollDispatcher.m3844dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.Companion.m5286getZero9UxMQ8M(), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else if (i != 1 && i != 2) {
