...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4234updateRootConstraintsBRTryo0(long j) {
        ...
        this.rootConstraints = Constraints.m4994boximpl(j);
    ...
    private final boolean m4231doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4202lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getMLookaheadScope$ui_release() == null) {
            return false;
        }
        if (constraints != null) {
            m4202lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m4206lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4202lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m4202lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4202lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4202lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA */
    private final boolean m4232doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4203remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m4203remeasure_Sx5XlM$ui_release$default = layoutNode.m4207remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4203remeasure_Sx5XlM$ui_release$default = LayoutNode.m4203remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4203remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4203remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m4233measureAndLayout0kLqBqw(LayoutNode layoutNode, long j) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean m4231doLookaheadRemeasuresdFAvZA = m4231doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m4994boximpl(j));
                m4232doRemeasuresdFAvZA(layoutNode, Constraints.m4994boximpl(j));
                if ((m4231doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode) {
        ...
        boolean m4231doLookaheadRemeasuresdFAvZA;
        boolean m4232doRemeasuresdFAvZA;
        int i = 0;
        if (layoutNode.isPlaced() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
                ...
                m4231doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui_release() ? m4231doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
                m4232doRemeasuresdFAvZA = m4232doRemeasuresdFAvZA(layoutNode, constraints);
            } else {
                m4232doRemeasuresdFAvZA = false;
                m4231doLookaheadRemeasuresdFAvZA = false;
            }
            if ((m4231doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                layoutNode.lookaheadReplace$ui_release();
            }
            ...
            return m4232doRemeasuresdFAvZA;
        }
        return false;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getMeasurePending$ui_release() || layoutNode.getLookaheadMeasurePending$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                m4231doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            }
            m4232doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
