...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public static final /* synthetic */ void m4227access$setMeasurementConstraintsBRTryo0(LookaheadDelegate lookaheadDelegate, long j) {
        lookaheadDelegate.m4122setMeasurementConstraintsBRTryo0(j);
    }
    ...
    public void m4230setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        Unit unit;
        if (measureResult != null) {
            m4121setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m4121setMeasuredSizeozmzZPI(IntSize.Companion.m5215getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo4076placeAtf8xVGno(mo4226getPositionnOccac(), 0.0f, null);
    }

    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo4076placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        if (!IntOffset.m5167equalsimpl0(mo4226getPositionnOccac(), j)) {
            m4230setPositiongyyYBs(j);
    ...
    public final Placeable m4228performingMeasureK40F9xA(long j, Function0<? extends MeasureResult> block) {
    ...
    public final long m4229positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long m5178getZeronOccac = IntOffset.Companion.m5178getZeronOccac();
        LookaheadDelegate lookaheadDelegate = this;
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            long mo4226getPositionnOccac = lookaheadDelegate.mo4226getPositionnOccac();
            m5178getZeronOccac = IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(m5178getZeronOccac) + IntOffset.m5168getXimpl(mo4226getPositionnOccac), IntOffset.m5169getYimpl(m5178getZeronOccac) + IntOffset.m5169getYimpl(mo4226getPositionnOccac));
