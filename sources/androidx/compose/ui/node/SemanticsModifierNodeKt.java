...
public final class SemanticsModifierNodeKt {
    ...
    public static final SemanticsConfiguration collapsedSemanticsConfiguration(SemanticsModifierNode semanticsModifierNode) {
        Intrinsics.checkNotNullParameter(semanticsModifierNode, "<this>");
        Modifier.Node localChild = DelegatableNodeKt.localChild(semanticsModifierNode, NodeKind.m4277constructorimpl(8));
    ...
    public static final Rect touchBoundsInRoot(SemanticsModifierNode semanticsModifierNode) {
        ...
        if (!getUseMinimumTouchTarget(semanticsModifierNode)) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m4181requireCoordinator64DMado(semanticsModifierNode, NodeKind.m4277constructorimpl(8)));
        }
        return DelegatableNodeKt.m4181requireCoordinator64DMado(semanticsModifierNode, NodeKind.m4277constructorimpl(8)).touchBoundsInRoot();
    }
}
