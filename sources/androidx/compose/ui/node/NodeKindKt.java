...
public final class NodeKindKt {
    ...
    public static /* synthetic */ void m4286getIncludeSelfInTraversalH91voCI$annotations(int i) {
    }

    /* renamed from: or-64DMado  reason: not valid java name */
    public static final int m4287or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    private static final void autoInvalidateNode(Modifier.Node node, int i) {
        ...
        if (((NodeKind.m4277constructorimpl(2) & node.getKindSet$ui_release()) != 0) && (node instanceof LayoutModifierNode)) {
            LayoutModifierNodeKt.invalidateMeasurements((LayoutModifierNode) node);
            if (i == 2) {
                DelegatableNodeKt.m4181requireCoordinator64DMado(node, NodeKind.m4277constructorimpl(2)).onRelease();
            }
        }
        if (((NodeKind.m4277constructorimpl(256) & node.getKindSet$ui_release()) != 0) && (node instanceof GlobalPositionAwareModifierNode)) {
            DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
        }
        if (((NodeKind.m4277constructorimpl(4) & node.getKindSet$ui_release()) != 0) && (node instanceof DrawModifierNode)) {
            DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
        }
        if (((NodeKind.m4277constructorimpl(8) & node.getKindSet$ui_release()) != 0) && (node instanceof SemanticsModifierNode)) {
            SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
        }
        if (((NodeKind.m4277constructorimpl(64) & node.getKindSet$ui_release()) != 0) && (node instanceof ParentDataModifierNode)) {
            ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
        }
        if (((NodeKind.m4277constructorimpl(1024) & node.getKindSet$ui_release()) != 0) && (node instanceof FocusTargetModifierNode)) {
            if (i == 2) {
                node.onReset();
            } else {
        ...
        if (((NodeKind.m4277constructorimpl(2048) & node.getKindSet$ui_release()) != 0) && (node instanceof FocusPropertiesModifierNode)) {
        ...
        if (((NodeKind.m4277constructorimpl(4096) & node.getKindSet$ui_release()) != 0) && (node instanceof FocusEventModifierNode) && i != 2) {
    ...
    public static final boolean m4285getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m4277constructorimpl(128)) != 0;
    }

    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        Intrinsics.checkNotNullParameter(element, "element");
        int m4277constructorimpl = NodeKind.m4277constructorimpl(1);
        if (element instanceof LayoutModifier) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(2);
        }
        if (element instanceof IntermediateLayoutModifier) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(512);
        }
        if (element instanceof DrawModifier) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(4);
        }
        if (element instanceof SemanticsModifier) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(8);
        }
        if (element instanceof PointerInputModifier) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(16);
        }
        if ((element instanceof ModifierLocalConsumer) || (element instanceof ModifierLocalProvider)) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(32);
        }
        if (element instanceof FocusEventModifier) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(4096);
        }
        if (element instanceof FocusOrderModifier) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(2048);
        }
        if (element instanceof OnGloballyPositionedModifier) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(256);
        }
        if (element instanceof ParentDataModifier) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(64);
        }
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier) || (element instanceof LookaheadOnPlacedModifier)) ? m4277constructorimpl | NodeKind.m4277constructorimpl(128) : m4277constructorimpl;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        if (node instanceof LayoutAwareModifierNode) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(128);
        }
        ...
        if (node instanceof FocusTargetModifierNode) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(1024);
        }
        ...
        if (node instanceof KeyInputModifierNode) {
            m4277constructorimpl |= NodeKind.m4277constructorimpl(8192);
        }
        return node instanceof RotaryInputModifierNode ? m4277constructorimpl | NodeKind.m4277constructorimpl(16384) : m4277constructorimpl;
    }
}
