...
public final class HitTestResult<T> implements List<T>, KMappedMarker {
    ...
    public final boolean hasHit() {
        long m4198findBestHitDistanceptXAw2c = m4198findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m4193getDistanceimpl(m4198findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m4195isInLayerimpl(m4198findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float f, boolean z) {
        ...
        return DistanceAndInLayer.m4189compareToS_HNhKs(m4198findBestHitDistanceptXAw2c(), DistanceAndInLayer) > 0;
    }

    /* renamed from: findBestHitDistance-ptXAw2c  reason: not valid java name */
    private final long m4198findBestHitDistanceptXAw2c() {
        long DistanceAndInLayer;
        ...
        if (i <= lastIndex) {
            while (true) {
                long m4190constructorimpl = DistanceAndInLayer.m4190constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m4189compareToS_HNhKs(m4190constructorimpl, DistanceAndInLayer) < 0) {
                    DistanceAndInLayer = m4190constructorimpl;
                }
                if (DistanceAndInLayer.m4193getDistanceimpl(DistanceAndInLayer) < 0.0f && DistanceAndInLayer.m4195isInLayerimpl(DistanceAndInLayer)) {
    ...
    public final void hit(T t, boolean z, Function0<Unit> childHitTest) {
        Intrinsics.checkNotNullParameter(childHitTest, "childHitTest");
        hitInMinimumTouchTarget(t, -1.0f, z, childHitTest);
    }

    public final void hitInMinimumTouchTarget(T t, float f, boolean z, Function0<Unit> childHitTest) {
        long DistanceAndInLayer;
        Intrinsics.checkNotNullParameter(childHitTest, "childHitTest");
        int i = this.hitDepth;
        this.hitDepth = i + 1;
    ...
    public final void speculativeHit(T t, float f, boolean z, Function0<Unit> childHitTest) {
        Intrinsics.checkNotNullParameter(childHitTest, "childHitTest");
        ...
        hitInMinimumTouchTarget(t, f, z, childHitTest);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndInLayer.m4189compareToS_HNhKs(m4198findBestHitDistanceptXAw2c, m4198findBestHitDistanceptXAw2c()) > 0) {
