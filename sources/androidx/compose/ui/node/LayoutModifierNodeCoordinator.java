...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode measureNode) {
        ...
        this.lookAheadTransientMeasureNode = (((measureNode.getNode().getKindSet$ui_release() & NodeKind.m4277constructorimpl(512)) != 0) && (measureNode instanceof IntermediateLayoutModifierNode)) ? (IntermediateLayoutModifierNode) measureNode : null;
    }
    ...
    public final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo4075measureBRTryo0(long j) {
            ...
            LookaheadDelegate.m4227access$setMeasurementConstraintsBRTryo0(lookaheadDelegateForLayoutModifierNode, j);
            ...
            LookaheadDelegate.access$set_measureResult(lookaheadDelegateForLayoutModifierNode, layoutModifierNodeCoordinator.getLayoutModifierNode().mo2233measure3p2s80s(this, lookaheadDelegate$ui_release, j));
    ...
    public final class LookaheadDelegateForIntermediateLayoutModifier extends LookaheadDelegate {
        ...
        public Placeable mo4075measureBRTryo0(long j) {
            ...
            LookaheadDelegate.m4227access$setMeasurementConstraintsBRTryo0(lookaheadDelegateForIntermediateLayoutModifier, j);
            LookaheadDelegate lookaheadDelegate$ui_release = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate$ui_release();
            Intrinsics.checkNotNull(lookaheadDelegate$ui_release);
            lookaheadDelegate$ui_release.mo4075measureBRTryo0(j);
            intermediateLayoutModifierNode.mo4164setTargetSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate$ui_release.getMeasureResult$ui_release().getWidth(), lookaheadDelegate$ui_release.getMeasureResult$ui_release().getHeight()));
    ...
    public Placeable mo4075measureBRTryo0(long j) {
        ...
        layoutModifierNodeCoordinator.m4122setMeasurementConstraintsBRTryo0(j);
        setMeasureResult$ui_release(this.layoutModifierNode.mo2233measure3p2s80s(this, getWrappedNonNull(), j));
        LayoutModifierNodeCoordinator layoutModifierNodeCoordinator2 = this;
        OwnedLayer layer = layoutModifierNodeCoordinator.getLayer();
        if (layer != null) {
            layer.mo4322resizeozmzZPI(layoutModifierNodeCoordinator.m4119getMeasuredSizeYbymL2g());
        }
        onMeasured();
    ...
    public void mo4076placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        ...
        onPlaced();
        Placeable.PlacementScope.Companion companion = Placeable.PlacementScope.Companion;
        int m5210getWidthimpl = IntSize.m5210getWidthimpl(m4119getMeasuredSizeYbymL2g());
        ...
        Placeable.PlacementScope.parentWidth = m5210getWidthimpl;
    ...
    public void onLayoutModifierNodeChanged() {
        ...
        if (((layoutModifierNode.getNode().getKindSet$ui_release() & NodeKind.m4277constructorimpl(512)) != 0) && (layoutModifierNode instanceof IntermediateLayoutModifierNode)) {
    ...
    static {
        ...
        Paint.mo2438setColor8_81llA(Color.Companion.m2583getBlue0d7_KjU());
