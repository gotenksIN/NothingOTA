...
public final class LayerPositionalProperties {
    ...
    public final void copyFrom(GraphicsLayerScope scope) {
        ...
        this.transformOrigin = scope.mo2740getTransformOriginSzJe1aQ();
    }
                        ...
                        if (this.rotationX == other.rotationX) {
                            if (this.rotationY == other.rotationY) {
                                if (this.rotationZ == other.rotationZ) {
                                    if ((this.cameraDistance == other.cameraDistance) && TransformOrigin.m2931equalsimpl0(this.transformOrigin, other.transformOrigin)) {
                                        return true;
                                    }
                                }
                            }
