...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m4103roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo295roundToPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4  reason: not valid java name */
        public static int m4104roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo296roundToPx0680j_4(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA  reason: not valid java name */
        public static float m4105toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo297toDpGaN1DYA(j);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM  reason: not valid java name */
        public static float m4106toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo298toDpu2uoSUM(f);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM  reason: not valid java name */
        public static float m4107toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo299toDpu2uoSUM(i);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM  reason: not valid java name */
        public static long m4108toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo300toDpSizekrfVVM(j);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o  reason: not valid java name */
        public static float m4109toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo301toPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4  reason: not valid java name */
        public static float m4110toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo302toPx0680j_4(f);
        }
        ...
        public static long m4111toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo303toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do  reason: not valid java name */
        public static long m4112toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo304toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
        public static long m4113toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo305toSpkPz2Gy4(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
        public static long m4114toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo306toSpkPz2Gy4(i);
        }
