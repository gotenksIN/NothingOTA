...
public final class LookaheadIntermediateLayoutModifierImpl extends InspectorValueInfo implements IntermediateLayoutModifier {
    ...
    public LookaheadIntermediateLayoutModifierImpl(Function4<? super MeasureScope, ? super Measurable, ? super Constraints, ? super IntSize, ? extends MeasureResult> measureBlock, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        this.targetSize = IntSize.Companion.m5215getZeroYbymL2g();
    }

    @Override // androidx.compose.ui.layout.IntermediateLayoutModifier
    /* renamed from: getTargetSize-YbymL2g */
    public long mo4077getTargetSizeYbymL2g() {
        return this.targetSize;
    }

    @Override // androidx.compose.ui.layout.IntermediateLayoutModifier
    /* renamed from: setTargetSize-ozmzZPI */
    public void mo4078setTargetSizeozmzZPI(long j) {
        this.targetSize = j;
    }
    ...
    public MeasureResult mo25measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return this.measureBlock.invoke(measure, measurable, Constraints.m4994boximpl(j), IntSize.m5202boximpl(mo4077getTargetSizeYbymL2g()));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LookaheadIntermediateLayoutModifierImpl) {
            ...
            return Intrinsics.areEqual(this.measureBlock, lookaheadIntermediateLayoutModifierImpl.measureBlock) && IntSize.m5208equalsimpl0(mo4077getTargetSizeYbymL2g(), lookaheadIntermediateLayoutModifierImpl.mo4077getTargetSizeYbymL2g());
        }
        return false;
    }

    public int hashCode() {
        return (this.measureBlock.hashCode() * 31) + IntSize.m5211hashCodeimpl(mo4077getTargetSizeYbymL2g());
    }
}
