...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo4075measureBRTryo0(long j) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(minIntrinsicWidth, Constraints.m5005getMaxHeightimpl(j));
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m5006getMaxWidthimpl(j), minIntrinsicHeight);
    }
