...
public interface LookaheadLayoutCoordinates extends LayoutCoordinates {
    ...
    long mo4090localLookaheadPositionOfR5De75A(LookaheadLayoutCoordinates lookaheadLayoutCoordinates, long j);

    /* renamed from: localLookaheadPositionOf-R5De75A$default  reason: not valid java name */
    static /* synthetic */ long m4089localLookaheadPositionOfR5De75A$default(LookaheadLayoutCoordinates lookaheadLayoutCoordinates, LookaheadLayoutCoordinates lookaheadLayoutCoordinates2, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Offset.Companion.m2334getZeroF1C5BW0();
            }
            return lookaheadLayoutCoordinates.mo4090localLookaheadPositionOfR5De75A(lookaheadLayoutCoordinates2, j);
        }
