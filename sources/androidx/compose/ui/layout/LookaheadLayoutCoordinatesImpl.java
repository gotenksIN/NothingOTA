...
public final class LookaheadLayoutCoordinatesImpl implements LookaheadLayoutCoordinates {
    ...
    public long mo4090localLookaheadPositionOfR5De75A(LookaheadLayoutCoordinates sourceCoordinates, long j) {
        ...
        if (lookaheadDelegate$ui_release != null) {
            long m4229positionInBjo55l4$ui_release = lookaheadDelegate.m4229positionInBjo55l4$ui_release(lookaheadDelegate$ui_release);
            long IntOffset = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2318getXimpl(j)), MathKt.roundToInt(Offset.m2319getYimpl(j)));
            long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(m4229positionInBjo55l4$ui_release) + IntOffset.m5168getXimpl(IntOffset), IntOffset.m5169getYimpl(m4229positionInBjo55l4$ui_release) + IntOffset.m5169getYimpl(IntOffset));
            long m4229positionInBjo55l4$ui_release2 = this.lookaheadDelegate.m4229positionInBjo55l4$ui_release(lookaheadDelegate$ui_release);
            long IntOffset3 = IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(IntOffset2) - IntOffset.m5168getXimpl(m4229positionInBjo55l4$ui_release2), IntOffset.m5169getYimpl(IntOffset2) - IntOffset.m5169getYimpl(m4229positionInBjo55l4$ui_release2));
            return OffsetKt.Offset(IntOffset.m5168getXimpl(IntOffset3), IntOffset.m5169getYimpl(IntOffset3));
        }
        ...
        long m4229positionInBjo55l4$ui_release3 = lookaheadDelegate.m4229positionInBjo55l4$ui_release(access$getRootLookaheadDelegate);
        long mo4226getPositionnOccac = access$getRootLookaheadDelegate.mo4226getPositionnOccac();
        long IntOffset4 = IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(m4229positionInBjo55l4$ui_release3) + IntOffset.m5168getXimpl(mo4226getPositionnOccac), IntOffset.m5169getYimpl(m4229positionInBjo55l4$ui_release3) + IntOffset.m5169getYimpl(mo4226getPositionnOccac));
        long IntOffset5 = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2318getXimpl(j)), MathKt.roundToInt(Offset.m2319getYimpl(j)));
        long IntOffset6 = IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(IntOffset4) + IntOffset.m5168getXimpl(IntOffset5), IntOffset.m5169getYimpl(IntOffset4) + IntOffset.m5169getYimpl(IntOffset5));
        LookaheadDelegate lookaheadDelegate2 = this.lookaheadDelegate;
        long m4229positionInBjo55l4$ui_release4 = lookaheadDelegate2.m4229positionInBjo55l4$ui_release(LookaheadLayoutCoordinatesKt.access$getRootLookaheadDelegate(lookaheadDelegate2));
        long mo4226getPositionnOccac2 = LookaheadLayoutCoordinatesKt.access$getRootLookaheadDelegate(lookaheadDelegate2).mo4226getPositionnOccac();
        long IntOffset7 = IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(m4229positionInBjo55l4$ui_release4) + IntOffset.m5168getXimpl(mo4226getPositionnOccac2), IntOffset.m5169getYimpl(m4229positionInBjo55l4$ui_release4) + IntOffset.m5169getYimpl(mo4226getPositionnOccac2));
        long IntOffset8 = IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(IntOffset6) - IntOffset.m5168getXimpl(IntOffset7), IntOffset.m5169getYimpl(IntOffset6) - IntOffset.m5169getYimpl(IntOffset7));
        ...
        return wrappedBy$ui_release.mo4081localPositionOfR5De75A(wrappedBy$ui_release2, OffsetKt.Offset(IntOffset.m5168getXimpl(IntOffset8), IntOffset.m5169getYimpl(IntOffset8)));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: getSize-YbymL2g */
    public long mo4080getSizeYbymL2g() {
        return getCoordinator().mo4080getSizeYbymL2g();
    }
    ...
    public long mo4085windowToLocalMKHz9U(long j) {
        return getCoordinator().mo4085windowToLocalMKHz9U(j);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo4083localToWindowMKHz9U(long j) {
        return getCoordinator().mo4083localToWindowMKHz9U(j);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToRoot-MK-Hz9U */
    public long mo4082localToRootMKHz9U(long j) {
        return getCoordinator().mo4082localToRootMKHz9U(j);
    }
    ...
    public long mo4081localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long j) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        return getCoordinator().mo4081localPositionOfR5De75A(sourceCoordinates, j);
    }
    ...
    public void mo4084transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        ...
        getCoordinator().mo4084transformFromEL8BTi8(sourceCoordinates, matrix);
    }
