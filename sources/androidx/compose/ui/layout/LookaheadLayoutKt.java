...
public final class LookaheadLayoutKt {
    public static final void LookaheadLayout(final Function3<? super LookaheadLayoutScope, ? super Composer, ? super Integer, Unit> content, Modifier modifier, final MeasurePolicy measurePolicy, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            Updater.m2202setimpl(m2195constructorimpl, materialize, ComposeUiNode.Companion.getSetModifier());
            ...
            Updater.m2202setimpl(m2195constructorimpl, lookaheadLayoutScopeImpl, new Function2<LayoutNode, LookaheadLayoutScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadLayoutKt$LookaheadLayout$1$1
            ...
            Updater.m2199initimpl(m2195constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadLayoutKt$LookaheadLayout$1$2
            ...
            content.invoke(lookaheadLayoutScopeImpl, startRestartGroup, Integer.valueOf(((i3 << 3) & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 8));
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
