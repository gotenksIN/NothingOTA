...
public final class RootMeasurePolicy extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        if (measurables.isEmpty()) {
            return MeasureScope.layout$default(measure, Constraints.m5008getMinWidthimpl(j), Constraints.m5007getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$1
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(measurables.get(i).mo4075measureBRTryo0(j));
        }
        ...
        return MeasureScope.layout$default(measure, ConstraintsKt.m5020constrainWidthK40F9xA(j, i2), ConstraintsKt.m5019constrainHeightK40F9xA(j, i3), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$4
            /* JADX INFO: Access modifiers changed from: package-private */
