...
public final class LiveRegionMode {
    ...
    private static final int Polite = m4416constructorimpl(0);
    private static final int Assertive = m4416constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m4415boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m4416constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4417equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).m4421unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4418equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4419hashCodeimpl(int i) {
    ...
    public static String m4420toStringimpl(int i) {
        return m4418equalsimpl0(i, Polite) ? "Polite" : m4418equalsimpl0(i, Assertive) ? "Assertive" : "Unknown";
    }
}
