...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4383calculateMatrixGrdbGEg(T t) {
        float[] fArr = this.matrixCache;
        if (fArr == null) {
            fArr = androidx.compose.ui.graphics.Matrix.m2780constructorimpl$default(null, 1, null);
        ...
        if (this.isDirty) {
            ...
            if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
                AndroidMatrixConversions_androidKt.m2430setFromtUYjHk(fArr, matrix);
    ...
    public final float[] m4382calculateInverseMatrixbWbORWo(T t) {
        ...
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m4380invertToJiSxe2E(m4383calculateMatrixGrdbGEg(t), fArr);
