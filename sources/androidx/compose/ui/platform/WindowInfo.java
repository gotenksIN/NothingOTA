...
public interface WindowInfo {
    ...
    static /* synthetic */ void m4410getKeyboardModifiersk7X9c1A$annotations() {
    }

    boolean isWindowFocused();

    /* renamed from: getKeyboardModifiers-k7X9c1A  reason: not valid java name */
    default int mo4411getKeyboardModifiersk7X9c1A() {
        return WindowInfoImpl.Companion.getGlobalKeyboardModifiers$ui_release().getValue().m4024unboximpl();
    }
}
