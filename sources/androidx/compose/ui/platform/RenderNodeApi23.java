...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.Companion.m2640getAutoNrFUSI();
    ...
    public int mo4367getCompositingStrategyNrFUSI() {
        return this.internalCompositingStrategy;
    }

    @Override // androidx.compose.ui.platform.DeviceRenderNode
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo4368setCompositingStrategyaDBOjCE(int i) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m2636equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m2642getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path path, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (path != null) {
            androidCanvas.save();
            Canvas.m2527clipPathmtrdDE$default(androidCanvas, path, 0, 2, null);
        }
