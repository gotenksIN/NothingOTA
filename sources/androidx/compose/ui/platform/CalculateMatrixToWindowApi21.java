...
final class CalculateMatrixToWindowApi21 implements CalculateMatrixToWindow {
    ...
    private final float[] tmpMatrix = Matrix.m2780constructorimpl$default(null, 1, null);

    @Override // androidx.compose.ui.platform.CalculateMatrixToWindow
    /* renamed from: calculateMatrixToWindow-EL8BTi8 */
    public void mo4356calculateMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Intrinsics.checkNotNullParameter(view, "view");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        Matrix.m2789resetimpl(matrix);
        m4359transformMatrixToWindowEL8BTi8(view, matrix);
    }

    /* renamed from: transformMatrixToWindow-EL8BTi8  reason: not valid java name */
    private final void m4359transformMatrixToWindowEL8BTi8(View view, float[] fArr) {
        ViewParent parent = view.getParent();
        if (parent instanceof View) {
            m4359transformMatrixToWindowEL8BTi8((View) parent, fArr);
            m4358preTranslate3XD1CNM(fArr, -view.getScrollX(), -view.getScrollY());
            m4358preTranslate3XD1CNM(fArr, view.getLeft(), view.getTop());
        } else {
            int[] iArr = this.tmpLocation;
            view.getLocationInWindow(iArr);
            m4358preTranslate3XD1CNM(fArr, -view.getScrollX(), -view.getScrollY());
            m4358preTranslate3XD1CNM(fArr, iArr[0], iArr[1]);
        }
        ...
        m4357preConcattUYjHk(fArr, viewMatrix);
    }

    /* renamed from: preConcat-tU-YjHk  reason: not valid java name */
    private final void m4357preConcattUYjHk(float[] fArr, android.graphics.Matrix matrix) {
        AndroidMatrixConversions_androidKt.m2430setFromtUYjHk(this.tmpMatrix, matrix);
        AndroidComposeView_androidKt.m4355preTransformJiSxe2E(fArr, this.tmpMatrix);
    }

    /* renamed from: preTranslate-3XD1CNM  reason: not valid java name */
    private final void m4358preTranslate3XD1CNM(float[] fArr, float f, float f2) {
        Matrix.m2789resetimpl(this.tmpMatrix);
        Matrix.m2800translateimpl$default(this.tmpMatrix, f, f2, 0.0f, 4, null);
        AndroidComposeView_androidKt.m4355preTransformJiSxe2E(fArr, this.tmpMatrix);
    }
}
