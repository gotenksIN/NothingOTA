    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                emptyList.add(Offset.m2307boximpl(OffsetKt.Offset(Math.abs(Offset.m2318getXimpl(semanticsNode4.getBoundsInRoot().m2348getCenterF1C5BW0()) - Offset.m2318getXimpl(semanticsNode3.getBoundsInRoot().m2348getCenterF1C5BW0())), Math.abs(Offset.m2319getYimpl(semanticsNode4.getBoundsInRoot().m2348getCenterF1C5BW0()) - Offset.m2319getYimpl(semanticsNode3.getBoundsInRoot().m2348getCenterF1C5BW0())))));
                semanticsNode = semanticsNode2;
            }
        }
        if (emptyList.size() == 1) {
            m2328unboximpl = ((Offset) CollectionsKt.first((List<? extends Object>) emptyList)).m2328unboximpl();
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m2307boximpl(Offset.m2323plusMKHz9U(((Offset) first).m2328unboximpl(), ((Offset) emptyList.get(i2)).m2328unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
            ...
            m2328unboximpl = ((Offset) first).m2328unboximpl();
        }
        return Offset.m2309component2impl(m2328unboximpl) < Offset.m2308component1impl(m2328unboximpl);
    }
