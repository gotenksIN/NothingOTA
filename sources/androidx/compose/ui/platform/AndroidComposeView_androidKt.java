...
public final class AndroidComposeView_androidKt {
    ...
    public static final void m4355preTransformJiSxe2E(float[] fArr, float[] fArr2) {
        float m4354dotp89u6pk = m4354dotp89u6pk(fArr2, 0, fArr, 0);
        float m4354dotp89u6pk2 = m4354dotp89u6pk(fArr2, 0, fArr, 1);
        float m4354dotp89u6pk3 = m4354dotp89u6pk(fArr2, 0, fArr, 2);
        float m4354dotp89u6pk4 = m4354dotp89u6pk(fArr2, 0, fArr, 3);
        float m4354dotp89u6pk5 = m4354dotp89u6pk(fArr2, 1, fArr, 0);
        float m4354dotp89u6pk6 = m4354dotp89u6pk(fArr2, 1, fArr, 1);
        float m4354dotp89u6pk7 = m4354dotp89u6pk(fArr2, 1, fArr, 2);
        float m4354dotp89u6pk8 = m4354dotp89u6pk(fArr2, 1, fArr, 3);
        float m4354dotp89u6pk9 = m4354dotp89u6pk(fArr2, 2, fArr, 0);
        float m4354dotp89u6pk10 = m4354dotp89u6pk(fArr2, 2, fArr, 1);
        float m4354dotp89u6pk11 = m4354dotp89u6pk(fArr2, 2, fArr, 2);
        float m4354dotp89u6pk12 = m4354dotp89u6pk(fArr2, 2, fArr, 3);
        float m4354dotp89u6pk13 = m4354dotp89u6pk(fArr2, 3, fArr, 0);
        float m4354dotp89u6pk14 = m4354dotp89u6pk(fArr2, 3, fArr, 1);
        float m4354dotp89u6pk15 = m4354dotp89u6pk(fArr2, 3, fArr, 2);
        float m4354dotp89u6pk16 = m4354dotp89u6pk(fArr2, 3, fArr, 3);
        fArr[0] = m4354dotp89u6pk;
        fArr[1] = m4354dotp89u6pk2;
        fArr[2] = m4354dotp89u6pk3;
        fArr[3] = m4354dotp89u6pk4;
        fArr[4] = m4354dotp89u6pk5;
        fArr[5] = m4354dotp89u6pk6;
        fArr[6] = m4354dotp89u6pk7;
        fArr[7] = m4354dotp89u6pk8;
        fArr[8] = m4354dotp89u6pk9;
        fArr[9] = m4354dotp89u6pk10;
        fArr[10] = m4354dotp89u6pk11;
        fArr[11] = m4354dotp89u6pk12;
        fArr[12] = m4354dotp89u6pk13;
        fArr[13] = m4354dotp89u6pk14;
        fArr[14] = m4354dotp89u6pk15;
        fArr[15] = m4354dotp89u6pk16;
    }

    /* renamed from: dot-p89u6pk  reason: not valid java name */
    private static final float m4354dotp89u6pk(float[] fArr, int i, float[] fArr2, int i2) {
        int i3 = i * 4;
