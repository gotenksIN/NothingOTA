...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m2937getCenterSzJe1aQ();
    ...
    public void mo4324updateLayerPropertiesdDxrwY(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, LayoutDirection layoutDirection, Density density) {
        ...
        setRotationX(f7);
        setRotationY(f8);
        setPivotX(TransformOrigin.m2932getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
        setPivotY(TransformOrigin.m2933getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(viewLayer, ColorKt.m2610toArgb8_81llA(j2));
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(viewLayer, ColorKt.m2610toArgb8_81llA(j3));
        }
        if (Build.VERSION.SDK_INT >= 31) {
            ViewLayerVerificationHelper31.INSTANCE.setRenderEffect(this, renderEffect);
        }
        if (CompositingStrategy.m2636equalsimpl0(i, CompositingStrategy.Companion.m2642getOffscreenNrFUSI())) {
            setLayerType(2, null);
        } else if (CompositingStrategy.m2636equalsimpl0(i, CompositingStrategy.Companion.m2641getModulateAlphaNrFUSI())) {
            setLayerType(0, null);
            z2 = false;
        } else {
            setLayerType(0, null);
    ...
    public boolean mo4319isInLayerk4lQ0M(long j) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= m2318getXimpl && m2318getXimpl < ((float) getWidth()) && 0.0f <= m2319getYimpl && m2319getYimpl < ((float) getHeight());
    ...
    public void mo4322resizeozmzZPI(long j) {
        ...
        if (m5210getWidthimpl == getWidth() && m5209getHeightimpl == getHeight()) {
            return;
        }
        float f = m5210getWidthimpl;
        setPivotX(TransformOrigin.m2932getPivotFractionXimpl(this.mTransformOrigin) * f);
        float f2 = m5209getHeightimpl;
        setPivotY(TransformOrigin.m2933getPivotFractionYimpl(this.mTransformOrigin) * f2);
        this.outlineResolver.m4406updateuvyYCjk(SizeKt.Size(f, f2));
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + m5210getWidthimpl, getTop() + m5209getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo4321movegyyYBs(long j) {
        ...
        if (m5168getXimpl != getLeft()) {
            offsetLeftAndRight(m5168getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m5169getYimpl = IntOffset.m5169getYimpl(j);
        if (m5169getYimpl != getTop()) {
            offsetTopAndBottom(m5169getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public long mo4320mapOffset8S9VItk(long j, boolean z) {
        if (z) {
            float[] m4382calculateInverseMatrixbWbORWo = this.matrixCache.m4382calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m2786mapMKHz9U(this.matrixCache.m4383calculateMatrixGrdbGEg(this), j);
    }
    ...
    public void mapBounds(MutableRect rect, boolean z) {
        ...
        androidx.compose.ui.graphics.Matrix.m2788mapimpl(this.matrixCache.m4383calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4323transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m2797timesAssign58bKbWc(matrix, this.matrixCache.m4383calculateMatrixGrdbGEg(this));
    }
