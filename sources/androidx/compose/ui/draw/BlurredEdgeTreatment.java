...
public final class BlurredEdgeTreatment {
    ...
    private static final Shape Rectangle = m2219constructorimpl(RectangleShapeKt.getRectangleShape());
    private static final Shape Unbounded = m2219constructorimpl(null);
    private final Shape shape;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ BlurredEdgeTreatment m2218boximpl(Shape shape) {
        return new BlurredEdgeTreatment(shape);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static Shape m2219constructorimpl(Shape shape) {
        return shape;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2220equalsimpl(Shape shape, Object obj) {
        return (obj instanceof BlurredEdgeTreatment) && Intrinsics.areEqual(shape, ((BlurredEdgeTreatment) obj).m2224unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2221equalsimpl0(Shape shape, Shape shape2) {
        return Intrinsics.areEqual(shape, shape2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2222hashCodeimpl(Shape shape) {
        if (shape == null) {
            return 0;
        }
    ...
    public static String m2223toStringimpl(Shape shape) {
        return "BlurredEdgeTreatment(shape=" + shape + ')';
    }

    public boolean equals(Object obj) {
        return m2220equalsimpl(this.shape, obj);
    }

    public int hashCode() {
        return m2222hashCodeimpl(this.shape);
    }

    public String toString() {
        return m2223toStringimpl(this.shape);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Shape m2224unboximpl() {
        return this.shape;
    }
