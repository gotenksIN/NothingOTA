...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m2237shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        if ((i & 4) != 0) {
            z = false;
            if (Dp.m5049compareTo0680j_4(f, Dp.m5050constructorimpl(0)) > 0) {
                z = true;
            }
        }
        return m2236shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m2236shadowziNgDLE(Modifier shadow, float f, Shape shape, boolean z) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m2234shadows4CzXII(shadow, f, shape, z, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* renamed from: shadow-s4CzXII$default  reason: not valid java name */
    public static /* synthetic */ Modifier m2235shadows4CzXII$default(Modifier modifier, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        boolean z2;
        ...
        return m2234shadows4CzXII(modifier, f, rectangleShape, z2, (i & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j, (i & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j2);
    }

    /* renamed from: shadow-s4CzXII  reason: not valid java name */
    public static final Modifier m2234shadows4CzXII(Modifier shadow, final float f, final Shape shape, final boolean z, final long j, final long j2) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (Dp.m5049compareTo0680j_4(f, Dp.m5050constructorimpl(0)) > 0 || z) {
            return InspectableValueKt.inspectableWrapper(shadow, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.draw.ShadowKt$shadow-s4CzXII$$inlined$debugInspectorInfo$1
                ...
                public final void invoke2(InspectorInfo inspectorInfo) {
                    ...
                    inspectorInfo.getProperties().set("elevation", Dp.m5048boximpl(f));
                    inspectorInfo.getProperties().set("shape", shape);
                    inspectorInfo.getProperties().set("clip", Boolean.valueOf(z));
                    inspectorInfo.getProperties().set("ambientColor", Color.m2546boximpl(j));
                    inspectorInfo.getProperties().set("spotColor", Color.m2546boximpl(j2));
                }
                ...
                public final void invoke2(GraphicsLayerScope graphicsLayer) {
                    ...
                    graphicsLayer.setShadowElevation(graphicsLayer.mo302toPx0680j_4(f));
                    graphicsLayer.setShape(shape);
                    graphicsLayer.setClip(z);
                    graphicsLayer.mo2741setAmbientShadowColor8_81llA(j);
                    graphicsLayer.mo2743setSpotShadowColor8_81llA(j2);
                }
            }));
        }
        return shadow;
