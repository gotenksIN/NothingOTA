...
public final class RectKt {
    ...
    public static final Rect m2358Recttz77jQw(long j, long j2) {
        return new Rect(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j), Offset.m2318getXimpl(j) + Size.m2387getWidthimpl(j2), Offset.m2319getYimpl(j) + Size.m2384getHeightimpl(j2));
    }

    /* renamed from: Rect-0a9Yr6o  reason: not valid java name */
    public static final Rect m2356Rect0a9Yr6o(long j, long j2) {
        return new Rect(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j), Offset.m2318getXimpl(j2), Offset.m2319getYimpl(j2));
    }

    /* renamed from: Rect-3MmeM6k  reason: not valid java name */
    public static final Rect m2357Rect3MmeM6k(long j, float f) {
        return new Rect(Offset.m2318getXimpl(j) - f, Offset.m2319getYimpl(j) - f, Offset.m2318getXimpl(j) + f, Offset.m2319getYimpl(j) + f);
    }
