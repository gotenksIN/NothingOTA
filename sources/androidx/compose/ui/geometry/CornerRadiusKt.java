...
public final class CornerRadiusKt {
    ...
    public static final long m2304lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m2293getXimpl(j), CornerRadius.m2293getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m2294getYimpl(j), CornerRadius.m2294getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        return CornerRadius.m2287constructorimpl((Float.floatToIntBits(f2) & 4294967295L) | (Float.floatToIntBits(f) << 32));
    }
}
