...
public final class MagnifierStyle {
    ...
    public final long m201getSizeMYxV2XQ$foundation_release() {
        return this.size;
    }

    /* renamed from: getCornerRadius-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m199getCornerRadiusD9Ej5fM$foundation_release() {
        return this.cornerRadius;
    }

    /* renamed from: getElevation-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m200getElevationD9Ej5fM$foundation_release() {
    ...
    public /* synthetic */ MagnifierStyle(long j, float f, float f2, boolean z, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? DpSize.Companion.m5157getUnspecifiedMYxV2XQ() : j, (i & 2) != 0 ? Dp.Companion.m5070getUnspecifiedD9Ej5fM() : f, (i & 4) != 0 ? Dp.Companion.m5070getUnspecifiedD9Ej5fM() : f2, (i & 8) != 0 ? true : z, (i & 16) != 0 ? false : z2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MagnifierStyle) {
            ...
            return this.useTextDefault == magnifierStyle.useTextDefault && DpSize.m5145equalsimpl0(this.size, magnifierStyle.size) && Dp.m5055equalsimpl0(this.cornerRadius, magnifierStyle.cornerRadius) && Dp.m5055equalsimpl0(this.elevation, magnifierStyle.elevation) && this.clippingEnabled == magnifierStyle.clippingEnabled && this.fishEyeEnabled == magnifierStyle.fishEyeEnabled;
        }
        return false;
    }

    public int hashCode() {
        return (((((((((Boolean.hashCode(this.useTextDefault) * 31) + DpSize.m5150hashCodeimpl(this.size)) * 31) + Dp.m5056hashCodeimpl(this.cornerRadius)) * 31) + Dp.m5056hashCodeimpl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31) + Boolean.hashCode(this.fishEyeEnabled);
    }

    public String toString() {
        return this.useTextDefault ? "MagnifierStyle.TextDefault" : "MagnifierStyle(size=" + ((Object) DpSize.m5155toStringimpl(this.size)) + ", cornerRadius=" + ((Object) Dp.m5061toStringimpl(this.cornerRadius)) + ", elevation=" + ((Object) Dp.m5061toStringimpl(this.elevation)) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }
