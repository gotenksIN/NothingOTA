...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m5050constructorimpl(30);
    ...
    public static /* synthetic */ Modifier m156basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = DefaultMarqueeIterations;
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.Companion.m211getImmediatelyZbEOnfQ();
        }
        int i6 = i2;
        if ((i5 & 4) != 0) {
        ...
        int i7 = i3;
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m205equalsimpl0(i6, MarqueeAnimationMode.Companion.m211getImmediatelyZbEOnfQ()) ? i7 : 0;
        }
        int i8 = i4;
        if ((i5 & 16) != 0) {
        ...
        return m155basicMarquee1Mj1MLw(modifier, i, i6, i7, i8, marqueeSpacing2, f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: createMarqueeAnimationSpec-Z4HSEVQ  reason: not valid java name */
    public static final AnimationSpec<Float> m157createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.mo302toPx0680j_4(f2)), f, i3);
        long m112constructorimpl$default = StartOffset.m112constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m92infiniteRepeatable9IiC70o$default(velocityBasedTween, null, m112constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m94repeatable91I0pcU$default(i, velocityBasedTween, null, m112constructorimpl$default, 4, null);
    }
    ...
    public static final MarqueeSpacing m153MarqueeSpacing0680j_4(final float f) {
        return new MarqueeSpacing() { // from class: androidx.compose.foundation.BasicMarqueeKt$MarqueeSpacing$1
            ...
            public final int calculateSpacing(Density MarqueeSpacing, int i, int i2) {
                ...
                return MarqueeSpacing.mo296roundToPx0680j_4(f);
            }
        };
    }

    /* renamed from: basicMarquee-1Mj1MLw  reason: not valid java name */
    public static final Modifier m155basicMarquee1Mj1MLw(Modifier basicMarquee, final int i, final int i2, final int i3, final int i4, final MarqueeSpacing spacing, final float f) {
        ...
        return ComposedModifierKt.composed(basicMarquee, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BasicMarqueeKt$basicMarquee-1Mj1MLw$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("animationMode", MarqueeAnimationMode.m202boximpl(i2));
                ...
                inspectorInfo.getProperties().set("velocity", Dp.m5048boximpl(f));
            }
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i5) {
                ...
                Object[] objArr = {Integer.valueOf(i), Integer.valueOf(i3), Integer.valueOf(i4), Dp.m5048boximpl(f), density, obj};
                int i6 = i;
                int i7 = i3;
                int i8 = i4;
                float f2 = f;
                ...
                if (z || rememberedValue == Composer.Companion.getEmpty()) {
                    rememberedValue = new MarqueeModifier(i6, i7, i8, Dp.m5050constructorimpl(f2 * (obj == LayoutDirection.Ltr ? 1.0f : -1.0f)), density, null);
                    composer.updateRememberedValue(rememberedValue);
                }
                composer.endReplaceableGroup();
                MarqueeModifier marqueeModifier = (MarqueeModifier) rememberedValue;
                marqueeModifier.setSpacing(spacing);
                marqueeModifier.m214setAnimationMode97h66l8(i2);
