...
public final class Image {
    ...
    public static final /* synthetic */ void Image(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        m496Image5hnEew(bitmap, str, companion, center, fit, f2, colorFilter2, FilterQuality.Companion.m2952getLowfv9h1I(), composer, (i & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 8 | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (i & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m496Image5hnEew(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, Composer composer, int i2, int i3) {
        Intrinsics.checkNotNullParameter(bitmap, "bitmap");
        ...
        int m3399getDefaultFilterQualityfv9h1I = (i3 & 128) != 0 ? DrawScope.Companion.m3399getDefaultFilterQualityfv9h1I() : i;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BitmapPainterKt.m3469BitmapPainterQZhYCtY$default(bitmap, 0L, 0L, m3399getDefaultFilterQualityfv9h1I, 6, null);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        Image((BitmapPainter) rememberedValue, str, companion, center, fit, f2, colorFilter2, composer, (i2 & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 8 | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final void Image(ImageVector imageVector, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        Image(VectorPainterKt.rememberVectorPainter(imageVector, composer, i & 14), str, companion, center, fit, f2, colorFilter2, composer, VectorPainter.$stable | (i & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (i & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final void Image(final Painter painter, final String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, final int i, final int i2) {
        ...
        startRestartGroup.endReplaceableGroup();
        Modifier paint$default = PainterModifier.paint$default(Clip.clipToBounds(companion2.then(companion)), painter, false, center, fit, f2, colorFilter2, 2, null);
        ImageKt$Image$2 imageKt$Image$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.ImageKt$Image$2
            ...
            public final MeasureResult mo313measure3p2s80s(MeasureScope Layout, List<? extends Measurable> list, long j) {
                ...
                return MeasureScope.layout$default(Layout, Constraints.m5309getMinWidthimpl(j), Constraints.m5308getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ImageKt$Image$2$measure$1
                    /* renamed from: invoke  reason: avoid collision after fix types in other method */
        ...
        Updater.m2503setimpl(m2496constructorimpl, imageKt$Image$2, ComposeUiNode.Companion.getSetMeasurePolicy());
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.ImageKt$Image$3
            ...
            public final void invoke(Composer composer2, int i3) {
                Image.Image(Painter.this, str, modifier2, alignment2, contentScale2, f3, colorFilter3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
}
