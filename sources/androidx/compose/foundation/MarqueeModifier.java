...
final class MarqueeModifier implements Modifier.Element, LayoutModifier, DrawModifier, FocusEventModifier {
    ...
    private final SnapshotState spacing$delegate;
    ...
    private MarqueeModifier(int i, int i2, int i3, float f, Density density) {
        ...
        mutableStateOf$default4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(BasicMarquee.getDefaultMarqueeSpacing(), null, 2, null);
        this.spacing$delegate = mutableStateOf$default4;
        mutableStateOf$default5 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m503boximpl(MarqueeAnimationMode.Companion.m512getImmediatelyZbEOnfQ()), null, 2, null);
        ...
        this.spacingPx$delegate = SnapshotStateKt.derivedStateOf(new Functions<Integer>() { // from class: androidx.compose.foundation.MarqueeModifier$spacingPx$2
    ...
    public final int m514getAnimationModeZbEOnfQ() {
        return ((MarqueeAnimationMode) this.animationMode$delegate.getValue()).m509unboximpl();
    }

    /* renamed from: setAnimationMode-97h66l8  reason: not valid java name */
    public final void m515setAnimationMode97h66l8(int i) {
        this.animationMode$delegate.setValue(MarqueeAnimationMode.m503boximpl(i));
    }
    ...
    public MeasureResult mo326measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo4376measureBRTryo0 = measurable.mo4376measureBRTryo0(Constraints.m5298copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        setContainerWidth(ConstraintsKt.m5321constrainWidthK40F9xA(j, mo4376measureBRTryo0.getWidth()));
        setContentWidth(mo4376measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measure, getContainerWidth(), mo4376measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float m2685getHeightimpl = Size.m2685getHeightimpl(contentDrawScope2.mo3397getSizeNHjbRc());
        ...
        drawContext.getTransform().mo3325clipRectN_I0leg(f2, 0.0f, f2 + getContainerWidth(), m2685getHeightimpl, m2846getIntersectrtfAjoo);
        if (z) {
    ...
    @Override // androidx.compose.p002ui.focus.FocusEventModifier
