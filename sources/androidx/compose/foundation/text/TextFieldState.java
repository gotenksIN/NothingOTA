...
public final class TextFieldState {
    ...
    private final SnapshotState minHeightForSingleLineField$delegate;
    ...
    public TextFieldState(TextDelegate textDelegate, RecomposeScope recomposeScope) {
        ...
        SnapshotState<TextLayoutResultProxy> mutableStateOf$default3;
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(C0780Dp.m5349boximpl(C0780Dp.m5351constructorimpl(0)), null, 2, null);
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.TextFieldState$onImeActionPerformed$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m1089invokeKlQnJC8(imeAction.m5027unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8  reason: not valid java name */
            public final void m1089invokeKlQnJC8(int i) {
                KeyboardActionRunner keyboardActionRunner;
                keyboardActionRunner = TextFieldState.this.keyboardActionRunner;
                keyboardActionRunner.m1020runActionKlQnJC8(i);
            }
        };
    ...
    public final float m1086getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((C0780Dp) this.minHeightForSingleLineField$delegate.getValue()).m5365unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4  reason: not valid java name */
    public final void m1087setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField$delegate.setValue(C0780Dp.m5349boximpl(f));
    }
    ...
    public final void m1088updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean z, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long j) {
        TextDelegate m1012updateTextDelegaterm0N8CA;
        ...
        this.selectionPaint.mo2739setColor8_81llA(j);
        ...
        m1012updateTextDelegaterm0N8CA = CoreText.m1012updateTextDelegaterm0N8CA(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, (r23 & 32) != 0 ? true : z, (r23 & 64) != 0 ? TextOverflow.Companion.m5292getClipgIe3tQ8() : 0, (r23 & 128) != 0 ? Integer.MAX_VALUE : 0, (r23 & 256) != 0 ? 1 : 0, CollectionsKt.emptyList());
        if (this.textDelegate != m1012updateTextDelegaterm0N8CA) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = m1012updateTextDelegaterm0N8CA;
    }
}
