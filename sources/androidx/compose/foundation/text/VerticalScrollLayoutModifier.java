...
final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public static /* synthetic */ VerticalScrollLayoutModifier copy$default(VerticalScrollLayoutModifier verticalScrollLayoutModifier, TextFieldScrollerPosition textFieldScrollerPosition, int i, TransformedText transformedText, Functions functions, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        if ((i2 & 8) != 0) {
            functions = verticalScrollLayoutModifier.textLayoutResultProvider;
        }
        return verticalScrollLayoutModifier.copy(textFieldScrollerPosition, i, transformedText, functions);
    }
    ...
    public final VerticalScrollLayoutModifier copy(TextFieldScrollerPosition scrollerPosition, int i, TransformedText transformedText, Functions<TextLayoutResultProxy> textLayoutResultProvider) {
    ...
    public VerticalScrollLayoutModifier(TextFieldScrollerPosition scrollerPosition, int i, TransformedText transformedText, Functions<TextLayoutResultProxy> textLayoutResultProvider) {
        Intrinsics.checkNotNullParameter(scrollerPosition, "scrollerPosition");
        Intrinsics.checkNotNullParameter(transformedText, "transformedText");
        Intrinsics.checkNotNullParameter(textLayoutResultProvider, "textLayoutResultProvider");
    ...
    public MeasureResult mo326measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo4376measureBRTryo0 = measurable.mo4376measureBRTryo0(Constraints.m5298copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int min = Math.min(mo4376measureBRTryo0.getHeight(), Constraints.m5306getMaxHeightimpl(j));
        return MeasureScope.layout$default(measure, mo4376measureBRTryo0.getWidth(), min, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.access$getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, mo4376measureBRTryo0.getWidth()), min, mo4376measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(layout, mo4376measureBRTryo0, 0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
