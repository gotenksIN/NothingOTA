...
final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo25measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo4075measureBRTryo0 = measurable.mo4075measureBRTryo0(Constraints.m4997copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int min = Math.min(mo4075measureBRTryo0.getHeight(), Constraints.m5005getMaxHeightimpl(j));
        return MeasureScope.layout$default(measure, mo4075measureBRTryo0.getWidth(), min, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.access$getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, mo4075measureBRTryo0.getWidth()), min, mo4075measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(layout, mo4075measureBRTryo0, 0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
