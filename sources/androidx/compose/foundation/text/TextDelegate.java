...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.Companion.m4991getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }

    /* renamed from: getOverflow-gIe3tQ8  reason: not valid java name */
    public final int m764getOverflowgIe3tQ8() {
    ...
    private final MultiParagraph m763layoutTextK40F9xA(long j, LayoutDirection layoutDirection) {
        layoutIntrinsics(layoutDirection);
        int m5008getMinWidthimpl = Constraints.m5008getMinWidthimpl(j);
        boolean z = false;
        int m5006getMaxWidthimpl = ((this.softWrap || TextOverflow.m4984equalsimpl0(this.overflow, TextOverflow.Companion.m4992getEllipsisgIe3tQ8())) && Constraints.m5002getHasBoundedWidthimpl(j)) ? Constraints.m5006getMaxWidthimpl(j) : Integer.MAX_VALUE;
        if (!this.softWrap && TextOverflow.m4984equalsimpl0(this.overflow, TextOverflow.Companion.m4992getEllipsisgIe3tQ8())) {
            z = true;
        }
        int i = z ? 1 : this.maxLines;
        if (m5008getMinWidthimpl != m5006getMaxWidthimpl) {
            m5006getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), m5008getMinWidthimpl, m5006getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), ConstraintsKt.Constraints$default(0, m5006getMaxWidthimpl, 0, Constraints.m5005getMaxHeightimpl(j), 5, null), i, TextOverflow.m4984equalsimpl0(this.overflow, TextOverflow.Companion.m4992getEllipsisgIe3tQ8()), null);
    }

    /* renamed from: layout-NN6Ew-U$default  reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m762layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m765layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* renamed from: layout-NN6Ew-U  reason: not valid java name */
    public final TextLayoutResult m765layoutNN6EwU(long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (textLayoutResult != null && TextLayoutHelperKt.m789canReuse7_7YC6M(textLayoutResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, j)) {
            return textLayoutResult.m4558copyO0kMr_c(new TextLayoutInput(textLayoutResult.getLayoutInput().getText(), this.style, textLayoutResult.getLayoutInput().getPlaceholders(), textLayoutResult.getLayoutInput().getMaxLines(), textLayoutResult.getLayoutInput().getSoftWrap(), textLayoutResult.getLayoutInput().m4556getOverflowgIe3tQ8(), textLayoutResult.getLayoutInput().getDensity(), textLayoutResult.getLayoutInput().getLayoutDirection(), textLayoutResult.getLayoutInput().getFontFamilyResolver(), j, (DefaultConstructorMarker) null), ConstraintsKt.m5017constrain4WqzIAM(j, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(textLayoutResult.getMultiParagraph().getWidth()), TextDelegateKt.ceilToIntPx(textLayoutResult.getMultiParagraph().getHeight()))));
        }
        MultiParagraph m763layoutTextK40F9xA = m763layoutTextK40F9xA(j, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, j, (DefaultConstructorMarker) null), m763layoutTextK40F9xA, ConstraintsKt.m5017constrain4WqzIAM(j, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(m763layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(m763layoutTextK40F9xA.getHeight()))), null);
    }
