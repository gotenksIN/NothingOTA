...
public final class SelectionManager {
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar) {
        ...
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2307boximpl(Offset.Companion.m2334getZeroF1C5BW0()), null, 2, null);
        this.dragBeginPosition$delegate = mutableStateOf$default3;
        mutableStateOf$default4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2307boximpl(Offset.Companion.m2334getZeroF1C5BW0()), null, 2, null);
        ...
        selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function3<LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m854invoked4ec7I(layoutCoordinates, offset.m2328unboximpl(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-d-4ec7I  reason: not valid java name */
            public final void m854invoked4ec7I(LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset m839convertToContainerCoordinatesQ7Q5hAU = SelectionManager.this.m839convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j);
                if (m839convertToContainerCoordinatesQ7Q5hAU != null) {
                    SelectionManager.this.m845startSelection9KIMszo(m839convertToContainerCoordinatesQ7Q5hAU.m2328unboximpl(), false, selectionMode);
        ...
        selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function5<LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool, SelectionAdjustment selectionAdjustment) {
                return m855invoke5iVPX68(layoutCoordinates, offset.m2328unboximpl(), offset2.m2328unboximpl(), bool.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-5iVPX68  reason: not valid java name */
            public final Boolean m855invoke5iVPX68(LayoutCoordinates layoutCoordinates, long j, long j2, boolean z, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                return Boolean.valueOf(SelectionManager.this.m853updateSelectionRHHTvR4$foundation_release(SelectionManager.this.m839convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j), SelectionManager.this.m839convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j2), z, selectionMode));
            }
        });
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.Companion, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m856invokeZmokQxo(keyEvent.m3813unboximpl());
            }

            /* renamed from: invoke-ZmokQxo  reason: not valid java name */
            public final Boolean m856invokeZmokQxo(android.view.KeyEvent it) {
                boolean z;
                Intrinsics.checkNotNullParameter(it, "it");
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset m2307boximpl = layoutCoordinates != null ? Offset.m2307boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, m2307boximpl)) {
            return;
        }
        this.previousPosition = m2307boximpl;
        updateHandleOffsets();
    ...
    public final void m841setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition$delegate.setValue(Offset.m2307boximpl(j));
    }

    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release  reason: not valid java name */
    public final long m848getDragBeginPositionF1C5BW0$foundation_release() {
        return ((Offset) this.dragBeginPosition$delegate.getValue()).m2328unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setDragTotalDistance-k-4lQ0M  reason: not valid java name */
    public final void m842setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance$delegate.setValue(Offset.m2307boximpl(j));
    }

    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release  reason: not valid java name */
    public final long m849getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance$delegate.getValue()).m2328unboximpl();
    }
    ...
    public final void updateHandleOffsets() {
        ...
        boolean z = true;
        long mo4081localPositionOfR5De75A = layoutCoordinates.mo4081localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release.mo807getHandlePositiondBAh8RU(selection, true));
        long mo4081localPositionOfR5De75A2 = layoutCoordinates.mo4081localPositionOfR5De75A(layoutCoordinates3, anchorSelectable$foundation_release2.mo807getHandlePositiondBAh8RU(selection, false));
        Rect visibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates);
        Offset m2307boximpl = Offset.m2307boximpl(mo4081localPositionOfR5De75A);
        m2307boximpl.m2328unboximpl();
        if (!(SelectionManagerKt.m859containsInclusiveUv8p0NA(visibleBounds, mo4081localPositionOfR5De75A) || getDraggingHandle() == Handle.SelectionStart)) {
            m2307boximpl = null;
        }
        m844setStartHandlePosition_kEHs6E(m2307boximpl);
        Offset m2307boximpl2 = Offset.m2307boximpl(mo4081localPositionOfR5De75A2);
        m2307boximpl2.m2328unboximpl();
        if (!SelectionManagerKt.m859containsInclusiveUv8p0NA(visibleBounds, mo4081localPositionOfR5De75A2) && getDraggingHandle() != Handle.SelectionEnd) {
            z = false;
        }
        m843setEndHandlePosition_kEHs6E(z ? m2307boximpl2 : null);
    }
    ...
    private final Rect getContentRect() {
        ...
        if (layoutCoordinates3 != null && layoutCoordinates3.isAttached()) {
            long mo4081localPositionOfR5De75A = layoutCoordinates3.mo4081localPositionOfR5De75A(layoutCoordinates, anchorSelectable$foundation_release.mo807getHandlePositiondBAh8RU(selection, true));
            long mo4081localPositionOfR5De75A2 = layoutCoordinates3.mo4081localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release2.mo807getHandlePositiondBAh8RU(selection, false));
            long mo4082localToRootMKHz9U = layoutCoordinates3.mo4082localToRootMKHz9U(mo4081localPositionOfR5De75A);
            long mo4082localToRootMKHz9U2 = layoutCoordinates3.mo4082localToRootMKHz9U(mo4081localPositionOfR5De75A2);
            return new Rect(Math.min(Offset.m2318getXimpl(mo4082localToRootMKHz9U), Offset.m2318getXimpl(mo4082localToRootMKHz9U2)), Math.min(Offset.m2319getYimpl(layoutCoordinates3.mo4082localToRootMKHz9U(layoutCoordinates3.mo4081localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release.getBoundingBox(selection.getStart().getOffset()).getTop())))), Offset.m2319getYimpl(layoutCoordinates3.mo4082localToRootMKHz9U(layoutCoordinates3.mo4081localPositionOfR5De75A(layoutCoordinates2, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release2.getBoundingBox(selection.getEnd().getOffset()).getTop()))))), Math.max(Offset.m2318getXimpl(mo4082localToRootMKHz9U), Offset.m2318getXimpl(mo4082localToRootMKHz9U2)), Math.max(Offset.m2319getYimpl(mo4082localToRootMKHz9U), Offset.m2319getYimpl(mo4082localToRootMKHz9U2)) + ((float) (SelectionHandlesKt.getHandleHeight() * 4.0d)));
        }
        return Rect.Companion.getZero();
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean z) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager$handleDragObserver$1
            ...
            public void mo755onDownk4lQ0M(long j) {
                ...
                long m826getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m826getAdjustedCoordinatesk4lQ0M(anchorSelectable$foundation_release.mo807getHandlePositiondBAh8RU(selection, z));
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m840setCurrentDragPosition_kEHs6E(Offset.m2307boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo4081localPositionOfR5De75A(layoutCoordinates, m826getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo757onStartk4lQ0M(long j) {
                LayoutCoordinates layoutCoordinates;
                long mo807getHandlePositiondBAh8RU;
                SelectionManager.this.hideSelectionToolbar$foundation_release();
                Selection selection = SelectionManager.this.getSelection();
                ...
                if (z) {
                    ...
                    mo807getHandlePositiondBAh8RU = selectable.mo807getHandlePositiondBAh8RU(selection, true);
                } else {
                    Intrinsics.checkNotNull(selectable2);
                    mo807getHandlePositiondBAh8RU = selectable2.mo807getHandlePositiondBAh8RU(selection, false);
                }
                long m826getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m826getAdjustedCoordinatesk4lQ0M(mo807getHandlePositiondBAh8RU);
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m841setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo4081localPositionOfR5De75A(layoutCoordinates, m826getAdjustedCoordinatesk4lQ0M));
                SelectionManager.this.m842setDragTotalDistancek4lQ0M(Offset.Companion.m2334getZeroF1C5BW0());
            }
            ...
            public void mo756onDragk4lQ0M(long j) {
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m842setDragTotalDistancek4lQ0M(Offset.m2323plusMKHz9U(selectionManager.m849getDragTotalDistanceF1C5BW0$foundation_release(), j));
                long m2323plusMKHz9U = Offset.m2323plusMKHz9U(SelectionManager.this.m848getDragBeginPositionF1C5BW0$foundation_release(), SelectionManager.this.m849getDragTotalDistanceF1C5BW0$foundation_release());
                if (SelectionManager.this.m853updateSelectionRHHTvR4$foundation_release(Offset.m2307boximpl(m2323plusMKHz9U), Offset.m2307boximpl(SelectionManager.this.m848getDragBeginPositionF1C5BW0$foundation_release()), z, SelectionAdjustment.Companion.getCharacterWithWordAccelerate())) {
                    SelectionManager.this.m841setDragBeginPositionk4lQ0M(m2323plusMKHz9U);
                    SelectionManager.this.m842setDragTotalDistancek4lQ0M(Offset.Companion.m2334getZeroF1C5BW0());
                }
            }
    ...
    public final Offset m839convertToContainerCoordinatesQ7Q5hAU(LayoutCoordinates layoutCoordinates, long j) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return null;
        }
        return Offset.m2307boximpl(requireContainerCoordinates$foundation_release().mo4081localPositionOfR5De75A(layoutCoordinates, j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo  reason: not valid java name */
    public final void m845startSelection9KIMszo(long j, boolean z, SelectionAdjustment selectionAdjustment) {
        m852updateSelection3R_tFg$foundation_release(j, j, null, z, selectionAdjustment);
    }

    /* renamed from: updateSelection-RHHTvR4$foundation_release  reason: not valid java name */
    public final boolean m853updateSelectionRHHTvR4$foundation_release(Offset offset, Offset offset2, boolean z, SelectionAdjustment adjustment) {
        Selection selection;
        long selectableId;
        Offset m839convertToContainerCoordinatesQ7Q5hAU;
        ...
        if (selectable == null) {
            m839convertToContainerCoordinatesQ7Q5hAU = null;
        } else {
            LayoutCoordinates layoutCoordinates = selectable.getLayoutCoordinates();
            Intrinsics.checkNotNull(layoutCoordinates);
            m839convertToContainerCoordinatesQ7Q5hAU = m839convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m826getAdjustedCoordinatesk4lQ0M(selectable.mo807getHandlePositiondBAh8RU(selection, !z)));
        }
        if (m839convertToContainerCoordinatesQ7Q5hAU != null) {
            long m2328unboximpl = m839convertToContainerCoordinatesQ7Q5hAU.m2328unboximpl();
            long m2328unboximpl2 = z ? offset.m2328unboximpl() : m2328unboximpl;
            if (!z) {
                m2328unboximpl = offset.m2328unboximpl();
            }
            return m852updateSelection3R_tFg$foundation_release(m2328unboximpl2, m2328unboximpl, offset2, z, adjustment);
        }
        return false;
    }

    /* renamed from: updateSelection-3R_-tFg$foundation_release  reason: not valid java name */
    public final boolean m852updateSelection3R_tFg$foundation_release(long j, long j2, Offset offset, boolean z, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        setDraggingHandle(z ? Handle.SelectionStart : Handle.SelectionEnd);
        m840setCurrentDragPosition_kEHs6E(z ? Offset.m2307boximpl(j) : Offset.m2307boximpl(j2));
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        List<Selectable> sort = this.selectionRegistrar.sort(requireContainerCoordinates$foundation_release());
        int size = sort.size();
        ...
        while (i < size) {
            ...
            Pair<Selection, Boolean> mo809updateSelectionqCDeeow = selectable.mo809updateSelectionqCDeeow(j, j2, offset, z, requireContainerCoordinates$foundation_release(), adjustment, this.selectionRegistrar.getSubselections().get(Long.valueOf(selectable.getSelectableId())));
            Selection component1 = mo809updateSelectionqCDeeow.component1();
            z2 = z2 || mo809updateSelectionqCDeeow.component2().booleanValue();
            if (component1 != null) {
    ...
    public final void m846contextMenuOpenAdjustmentk4lQ0M(long j) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m4581getCollapsedimpl(selection.m816toTextRanged9O1mEE()) : true) {
            m845startSelection9KIMszo(j, true, SelectionAdjustment.Companion.getWord());
        }
    }
}
