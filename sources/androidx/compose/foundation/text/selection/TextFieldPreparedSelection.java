...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public TextFieldPreparedSelection(TextFieldValue currentValue, OffsetMapping offsetMapping, TextLayoutResultProxy textLayoutResultProxy, TextPreparedSelectionState state) {
        super(currentValue.getAnnotatedString(), currentValue.m5097getSelectiond9O1mEE(), textLayoutResultProxy != null ? textLayoutResultProxy.getValue() : null, offsetMapping, state, null);
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m5092copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), m1105getSelectiond9O1mEE(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        if (TextRange.m4882getCollapsedimpl(m1105getSelectiond9O1mEE())) {
        ...
        return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m4886getMinimpl(m1105getSelectiond9O1mEE()), TextRange.m4886getMinimpl(m1105getSelectiond9O1mEE()))});
    }
    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r6, int r7) {
        ...
        L1b:
            ...
            int r1 = androidx.compose.p002ui.text.TextRange.m4883getEndimpl(r3)
            ...
            float r1 = r0.getLeft()
            float r0 = r0.getTop()
            long r2 = r2.m2652getSizeNHjbRc()
            float r2 = androidx.compose.p002ui.geometry.Size.m2685getHeightimpl(r2)
            float r7 = (float) r7
            float r2 = r2 * r7
            float r0 = r0 + r2
            ...
            int r6 = r6.m4860getOffsetForPositionk4lQ0M(r0)
