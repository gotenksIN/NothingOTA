...
public final class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m822copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m824copyUv8p0NA(handle, j);
    }
    ...
    public final long m823component2F1C5BW0() {
        return this.position;
    }

    /* renamed from: copy-Uv8p0NA  reason: not valid java name */
    public final SelectionHandleInfo m824copyUv8p0NA(Handle handle, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SelectionHandleInfo) {
            ...
            return this.handle == selectionHandleInfo.handle && Offset.m2315equalsimpl0(this.position, selectionHandleInfo.position);
        }
        return false;
    }

    public int hashCode() {
        return (this.handle.hashCode() * 31) + Offset.m2320hashCodeimpl(this.position);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m2326toStringimpl(this.position)) + ')';
    }
    ...
    public final long m825getPositionF1C5BW0() {
        return this.position;
    }
}
