...
public final class SelectionMagnifierKt {
    ...
    private static final TwoWayConverter<Offset, AnimationVector2D> UnspecifiedSafeOffsetVectorConverter = VectorConvertersKt.TwoWayConverter(new Function1<Offset, AnimationVector2D>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$UnspecifiedSafeOffsetVectorConverter$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector2D invoke(Offset offset) {
            return m827invokek4lQ0M(offset.m2328unboximpl());
        }

        /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
        public final AnimationVector2D m827invokek4lQ0M(long j) {
            AnimationVector2D animationVector2D;
            if (!OffsetKt.m2337isSpecifiedk4lQ0M(j)) {
        ...
        public /* bridge */ /* synthetic */ Offset invoke(AnimationVector2D animationVector2D) {
            return Offset.m2307boximpl(m828invoketuRUvjQ(animationVector2D));
        }

        /* renamed from: invoke-tuRUvjQ  reason: not valid java name */
        public final long m828invoketuRUvjQ(AnimationVector2D it) {
    ...
    static {
        ...
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m2307boximpl(Offset), 3, null);
    }
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer composer, int i) {
        ...
        if (rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new Animatable(Offset.m2307boximpl(rememberAnimatedMagnifierPosition$lambda$1(state)), UnspecifiedSafeOffsetVectorConverter, Offset.m2307boximpl(OffsetDisplacementThreshold));
