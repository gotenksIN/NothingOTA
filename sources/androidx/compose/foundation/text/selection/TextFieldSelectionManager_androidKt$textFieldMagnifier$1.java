...
public final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5202boximpl(IntSize.Companion.m5215getZeroYbymL2g()), null, 2, null);
        ...
        Function0<Offset> function0 = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1.1
            ...
            public /* bridge */ /* synthetic */ Offset invoke() {
                return Offset.m2307boximpl(m881invokeF1C5BW0());
            }

            /* renamed from: invoke-F1C5BW0  reason: not valid java name */
            public final long m881invokeF1C5BW0() {
                return TextFieldSelectionManagerKt.m880calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager.this, TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$1(mutableState));
            }
        };
                ...
                public final Modifier invoke2(final Function0<Offset> center) {
                    ...
                    Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.1
                        ...
                        public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                            return Offset.m2307boximpl(m882invoketuRUvjQ(density2));
                        }

                        /* renamed from: invoke-tuRUvjQ  reason: not valid java name */
                        public final long m882invoketuRUvjQ(Density magnifier) {
                            Intrinsics.checkNotNullParameter(magnifier, "$this$magnifier");
                            return center.invoke().m2328unboximpl();
                        }
                    };
                    ...
                    return MagnifierKt.magnifier$default(companion2, function1, null, 0.0f, textDefault, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.2
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                            m883invokeEaSLcWc(dpSize.m5156unboximpl());
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-EaSLcWc  reason: not valid java name */
                        public final void m883invokeEaSLcWc(long j) {
                            MutableState<IntSize> mutableState3 = mutableState2;
                            Density density3 = Density.this;
                            TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$2(mutableState3, IntSizeKt.IntSize(density3.mo296roundToPx0680j_4(DpSize.m5148getWidthD9Ej5fM(j)), density3.mo296roundToPx0680j_4(DpSize.m5146getHeightD9Ej5fM(j))));
                        }
                    }, 6, null);
                }
            };
    ...
    public static final long invoke$lambda$1(MutableState<IntSize> mutableState) {
        return mutableState.getValue().m5214unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void invoke$lambda$2(MutableState<IntSize> mutableState, long j) {
        mutableState.setValue(IntSize.m5202boximpl(j));
    }
}
