...
public final class SelectionManager_androidKt$selectionMagnifier$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        Functions<Offset> functions = new Functions<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            public /* bridge */ /* synthetic */ Offset invoke() {
                return Offset.m2608boximpl(m1162invokeF1C5BW0());
            }

            /* renamed from: invoke-F1C5BW0  reason: not valid java name */
            public final long m1162invokeF1C5BW0() {
                return SelectionManagerKt.m1159calculateSelectionMagnifierCenterAndroidO0kMr_c(SelectionManager.this, SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$1(snapshotState));
            }
        };
        ...
        if (changed || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = (Function1) new Function1<Functions<? extends Offset>, Modifier>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                public final Modifier invoke2(final Functions<Offset> center) {
                    ...
                    Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.1
                        ...
                        public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                            return Offset.m2608boximpl(m1163invoketuRUvjQ(density2));
                        }

                        /* renamed from: invoke-tuRUvjQ  reason: not valid java name */
                        public final long m1163invoketuRUvjQ(Density magnifier) {
                    ...
                    return Magnifier.magnifier$default(companion2, function1, null, 0.0f, textDefault, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                            m1164invokeEaSLcWc(dpSize.m5457unboximpl());
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-EaSLcWc  reason: not valid java name */
                        public final void m1164invokeEaSLcWc(long j) {
                            SnapshotState<IntSize> snapshotState3 = snapshotState2;
                            Density density3 = Density.this;
                            SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$2(snapshotState3, IntSizeKt.IntSize(density3.mo597roundToPx0680j_4(DpSize.m5449getWidthD9Ej5fM(j)), density3.mo597roundToPx0680j_4(DpSize.m5447getHeightD9Ej5fM(j))));
                        }
                    }, 6, null);
                }
            };
