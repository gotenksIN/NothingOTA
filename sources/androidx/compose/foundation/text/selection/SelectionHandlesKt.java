...
public final class SelectionHandlesKt {
    ...
    public static final long m826getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m5050constructorimpl(f);
        HandleHeight = Dp.m5050constructorimpl(f);
    }
}
