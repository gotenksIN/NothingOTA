...
public interface Selectable {
    ...
    long mo1109getRangeOfLineContainingjx7JFs(int i);
    ...
    Tuples<Selection, Boolean> mo1110updateSelectionqCDeeow(long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection);

    /* renamed from: updateSelection-qCDeeow$default  reason: not valid java name */
    static /* synthetic */ Tuples m1116updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
        if (obj == null) {
            return selectable.mo1110updateSelectionqCDeeow(j, j2, offset, (i & 8) != 0 ? true : z, layoutCoordinates, selectionAdjustment, (i & 64) != 0 ? null : selection);
        }
