...
public interface Selectable {
    ...
    long mo807getHandlePositiondBAh8RU(Selection selection, boolean z);
    ...
    long mo808getRangeOfLineContainingjx7JFs(int i);
    ...
    Pair<Selection, Boolean> mo809updateSelectionqCDeeow(long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection);

    /* renamed from: updateSelection-qCDeeow$default  reason: not valid java name */
    static /* synthetic */ Pair m815updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
        if (obj == null) {
            return selectable.mo809updateSelectionqCDeeow(j, j2, offset, (i & 8) != 0 ? true : z, layoutCoordinates, selectionAdjustment, (i & 64) != 0 ? null : selection);
        }
