...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m869getTextFieldSelectionbb3KNj8(TextLayoutResult textLayoutResult, int i, int i2, TextRange textRange, boolean z, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        if (textLayoutResult != null) {
            long TextRange = TextRangeKt.TextRange(i, i2);
            return (textRange == null && Intrinsics.areEqual(adjustment, SelectionAdjustment.Companion.getCharacter())) ? TextRange : adjustment.mo817adjustZXO7KMw(textLayoutResult, TextRange, -1, z, textRange);
        }
