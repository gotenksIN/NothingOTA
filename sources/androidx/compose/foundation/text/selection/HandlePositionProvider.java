...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo806calculatePositionllwVHH4(IntRect anchorBounds, long j, LayoutDirection layoutDirection, long j2) {
        ...
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5168getXimpl(this.offset)) - (IntSize.m5210getWidthimpl(j2) / 2), anchorBounds.getTop() + IntOffset.m5169getYimpl(this.offset));
                }
                throw new NoWhenBranchMatchedException();
            }
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5168getXimpl(this.offset)) - IntSize.m5210getWidthimpl(j2), anchorBounds.getTop() + IntOffset.m5169getYimpl(this.offset));
        }
        return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m5168getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m5169getYimpl(this.offset));
    }
}
