...
public final class SimpleLayoutKt {
    public static final void SimpleLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            SimpleLayoutKt$SimpleLayout$1 simpleLayoutKt$SimpleLayout$1 = new MeasurePolicy() { // from class: androidx.compose.foundation.text.selection.SimpleLayoutKt$SimpleLayout$1
                ...
                public final MeasureResult mo12measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    for (int i6 = 0; i6 < size; i6++) {
                        arrayList.add(measurables.get(i6).mo4075measureBRTryo0(j));
                    }
            ...
            int i5 = ((i3 >> 3) & 14) | ((i3 << 3) & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle);
            ...
            Updater.m2202setimpl(m2195constructorimpl, simpleLayoutKt$SimpleLayout$1, ComposeUiNode.Companion.getSetMeasurePolicy());
            ...
            materializerOf.invoke(SkippableUpdater.m2186boximpl(SkippableUpdater.m2187constructorimpl(startRestartGroup)), startRestartGroup, Integer.valueOf((i6 >> 3) & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle));
