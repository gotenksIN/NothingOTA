...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final long m1105getSelectiond9O1mEE() {
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m4883getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m4883getEndimpl(this.selection));
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.originalText.length()) {
            long m4862getWordBoundaryjx7JFs = textLayoutResult.m4862getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m4883getEndimpl(m4862getWordBoundaryjx7JFs) > i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m4883getEndimpl(m4862getWordBoundaryjx7JFs));
            }
            i++;
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long m4862getWordBoundaryjx7JFs = textLayoutResult.m4862getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m4888getStartimpl(m4862getWordBoundaryjx7JFs) < i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m4888getStartimpl(m4862getWordBoundaryjx7JFs));
            }
            i--;
        }
        return 0;
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        ...
        return this.offsetMapping.transformedToOriginal(textLayoutResult.m4860getOffsetForPositionk4lQ0M(OffsetKt.Offset(f.floatValue(), lineBottom)));
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4883getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4886getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4885getMaximpl(this.selection));
    }
    ...
    private final int getParagraphStart() {
        return StringHelpers.findParagraphStart(getText$foundation_release(), TextRange.m4886getMinimpl(this.selection));
    }

    private final int getParagraphEnd() {
        return StringHelpers.findParagraphEnd(getText$foundation_release(), TextRange.m4885getMaximpl(this.selection));
    }

    /* compiled from: TextPreparedSelection.kt */
    @Metadata(m41d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m40d2 = {"Landroidx/compose/foundation/text/selection/BaseTextPreparedSelection$Companion;", "", "()V", "NoCharacterFound", "", "foundation_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
    /* loaded from: classes.dex */
    ...
    public final T deselect() {
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            setCursor(TextRange.m4883getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            if (TextRange.m4882getCollapsedimpl(this.selection)) {
                ...
                setCursor(TextRange.m4886getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m4885getMaximpl(this.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m4888getStartimpl(this.originalSelection), TextRange.m4883getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
