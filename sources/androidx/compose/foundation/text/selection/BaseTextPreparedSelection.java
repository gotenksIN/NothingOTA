...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final long m803getOriginalSelectiond9O1mEE() {
    ...
    public final long m804getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: setSelection-5zc-tL8  reason: not valid java name */
    public final void m805setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m4582getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m4582getEndimpl(this.selection));
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.originalText.length()) {
            long m4561getWordBoundaryjx7JFs = textLayoutResult.m4561getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m4582getEndimpl(m4561getWordBoundaryjx7JFs) > i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m4582getEndimpl(m4561getWordBoundaryjx7JFs));
            }
            i++;
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long m4561getWordBoundaryjx7JFs = textLayoutResult.m4561getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m4587getStartimpl(m4561getWordBoundaryjx7JFs) < i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m4587getStartimpl(m4561getWordBoundaryjx7JFs));
            }
            i--;
        }
        return 0;
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        ...
        return this.offsetMapping.transformedToOriginal(textLayoutResult.m4559getOffsetForPositionk4lQ0M(OffsetKt.Offset(f.floatValue(), lineBottom)));
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4582getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4585getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4584getMaximpl(this.selection));
    }
    ...
    private final int getParagraphStart() {
        return StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m4585getMinimpl(this.selection));
    }

    private final int getParagraphEnd() {
        return StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m4584getMaximpl(this.selection));
    }
    ...
    public final T deselect() {
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            setCursor(TextRange.m4582getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            if (TextRange.m4581getCollapsedimpl(this.selection)) {
                ...
                setCursor(TextRange.m4585getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m4584getMaximpl(this.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m4587getStartimpl(this.originalSelection), TextRange.m4582getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
