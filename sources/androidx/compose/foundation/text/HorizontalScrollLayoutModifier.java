...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo25measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo4075measureBRTryo0 = measurable.mo4075measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m5005getMaxHeightimpl(j)) < Constraints.m5006getMaxWidthimpl(j) ? j : Constraints.m4997copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int min = Math.min(mo4075measureBRTryo0.getWidth(), Constraints.m5006getMaxWidthimpl(j));
        return MeasureScope.layout$default(measure, min, mo4075measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.access$getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, mo4075measureBRTryo0.getWidth()), min, mo4075measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(layout, mo4075measureBRTryo0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
