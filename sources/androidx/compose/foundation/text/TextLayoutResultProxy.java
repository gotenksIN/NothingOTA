...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m791getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m793getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k  reason: not valid java name */
    public final int m793getOffsetForPosition3MmeM6k(long j, boolean z) {
        if (z) {
            j = m790coercedInVisibleBoundsOfInputTextMKHz9U(j);
        }
        return this.value.m4559getOffsetForPositionk4lQ0M(m792relativeToInputTextMKHz9U(j));
    }

    public final int getLineForVerticalPosition(float f) {
        return this.value.getLineForVerticalPosition(Offset.m2319getYimpl(m792relativeToInputTextMKHz9U(m790coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, f)))));
    }
    ...
    public final boolean m794isPositionOnTextk4lQ0M(long j) {
        long m792relativeToInputTextMKHz9U = m792relativeToInputTextMKHz9U(m790coercedInVisibleBoundsOfInputTextMKHz9U(j));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m2319getYimpl(m792relativeToInputTextMKHz9U));
        return Offset.m2318getXimpl(m792relativeToInputTextMKHz9U) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m2318getXimpl(m792relativeToInputTextMKHz9U) <= this.value.getLineRight(lineForVerticalPosition);
    }
    ...
    private final long m792relativeToInputTextMKHz9U(long j) {
        Offset offset;
        ...
        if (layoutCoordinates != null) {
            ...
            if (layoutCoordinates2 != null) {
                offset = Offset.m2307boximpl((layoutCoordinates.isAttached() && layoutCoordinates2.isAttached()) ? layoutCoordinates.mo4081localPositionOfR5De75A(layoutCoordinates2, j) : j);
            } else {
                offset = null;
            }
            return offset != null ? offset.m2328unboximpl() : j;
        }
        return j;
    }
    ...
    */
    private final long m790coercedInVisibleBoundsOfInputTextMKHz9U(long r6) {
        ...
        L1e:
            ...
            androidx.compose.ui.geometry.Rect r2 = r0.getZero()
        L24:
            long r6 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m795access$coerceIn3MmeM6k(r6, r2)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m790coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}
