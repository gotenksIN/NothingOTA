...
public final class DeadKeyCombiner {
    ...
    public final Integer m715consumeZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        int m3826getUtf16CodePointZmokQxo = KeyEvent_androidKt.m3826getUtf16CodePointZmokQxo(event);
        if ((Integer.MIN_VALUE & m3826getUtf16CodePointZmokQxo) != 0) {
            this.deadKeyCode = Integer.valueOf(m3826getUtf16CodePointZmokQxo & Integer.MAX_VALUE);
            return null;
        }
        Integer num = this.deadKeyCode;
        if (num != null) {
            this.deadKeyCode = null;
            Integer valueOf = Integer.valueOf(KeyCharacterMap.getDeadChar(num.intValue(), m3826getUtf16CodePointZmokQxo));
            Integer num2 = valueOf.intValue() == 0 ? null : valueOf;
            return num2 == null ? Integer.valueOf(m3826getUtf16CodePointZmokQxo) : num2;
        }
        return Integer.valueOf(m3826getUtf16CodePointZmokQxo);
    }
}
