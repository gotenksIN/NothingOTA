...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m716cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m3817equalsimpl0(KeyEvent_androidKt.m3825getTypeZmokQxo(cancelsTextSelection), KeyEventType.Companion.m3822getKeyUpCS__XNY());
    }
}
