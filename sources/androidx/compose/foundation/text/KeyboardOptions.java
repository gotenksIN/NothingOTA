...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.Companion.m4763getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.Companion.m4789getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.Companion.m4735getDefaulteUduSuo() : i3, null);
    }

    /* renamed from: getCapitalization-IUNYP9k  reason: not valid java name */
    public final int m722getCapitalizationIUNYP9k() {
    ...
    public final int m724getKeyboardTypePjHm6EE() {
        return this.keyboardType;
    }

    /* renamed from: getImeAction-eUduSuo  reason: not valid java name */
    public final int m723getImeActioneUduSuo() {
    ...
    public static /* synthetic */ KeyboardOptions m720copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m721copy3m2b7yw(i, z, i2, i3);
    }

    /* renamed from: copy-3m2b7yw  reason: not valid java name */
    public final KeyboardOptions m721copy3m2b7yw(int i, boolean z, int i2, int i3) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KeyboardOptions) {
            ...
            return KeyboardCapitalization.m4754equalsimpl0(this.capitalization, keyboardOptions.capitalization) && this.autoCorrect == keyboardOptions.autoCorrect && KeyboardType.m4769equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m4723equalsimpl0(this.imeAction, keyboardOptions.imeAction);
        }
        return false;
    }

    public int hashCode() {
        return (((((KeyboardCapitalization.m4755hashCodeimpl(this.capitalization) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4770hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4724hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m4756toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4771toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4725toStringimpl(this.imeAction)) + ')';
    }
}
