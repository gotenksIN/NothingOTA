...
@DebugMetadata(m31c = "androidx.compose.foundation.text.TextFieldGestureModifiersKt$longPressDragGestureFilter$1", m30f = "TextFieldGestureModifiers.kt", m29i = {}, m28l = {35}, m27m = "invokeSuspend", m26n = {}, m25s = {})
...
final class TextFieldGestureModifiersKt$longPressDragGestureFilter$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (LongPressTextDragObserver.detectDragGesturesAfterLongPressWithObserver((PointerInputScope) this.L$0, this.$observer, this) == coroutine_suspended) {
