...
public final class TextFieldDelegate {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ Triple m1069layout_EkL_Y$foundation_release$default(Companion companion, TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
            if ((i & 8) != 0) {
        ...
        public final Triple<Integer, Integer, TextLayoutResult> m1071layout_EkL_Y$foundation_release(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult) {
            Intrinsics.checkNotNullParameter(textDelegate, "textDelegate");
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            TextLayoutResult m1066layoutNN6EwU = textDelegate.m1066layoutNN6EwU(j, layoutDirection, textLayoutResult);
            return new Triple<>(Integer.valueOf(IntSize.m5511getWidthimpl(m1066layoutNN6EwU.m4861getSizeYbymL2g())), Integer.valueOf(IntSize.m5510getHeightimpl(m1066layoutNN6EwU.m4861getSizeYbymL2g())), m1066layoutNN6EwU);
        }
        ...
        public final void draw$foundation_release(Canvas canvas, TextFieldValue value, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint selectionPaint) {
            ...
            if (!TextRange.m4882getCollapsedimpl(value.m5097getSelectiond9O1mEE()) && (originalToTransformed = offsetMapping.originalToTransformed(TextRange.m4886getMinimpl(value.m5097getSelectiond9O1mEE()))) != (originalToTransformed2 = offsetMapping.originalToTransformed(TextRange.m4885getMaximpl(value.m5097getSelectiond9O1mEE())))) {
        ...
        public final void notifyFocusedRect$foundation_release(TextFieldValue value, TextDelegate textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, TextInputSession textInputSession, boolean z, OffsetMapping offsetMapping) {
            ...
            Intrinsics.checkNotNullParameter(offsetMapping, "offsetMapping");
            if (z) {
                int originalToTransformed = offsetMapping.originalToTransformed(TextRange.m4885getMaximpl(value.m5097getSelectiond9O1mEE()));
                ...
                long mo4383localToRootMKHz9U = layoutCoordinates.mo4383localToRootMKHz9U(OffsetKt.Offset(rect.getLeft(), rect.getTop()));
                textInputSession.notifyFocusedRect(RectKt.m2659Recttz77jQw(OffsetKt.Offset(Offset.m2619getXimpl(mo4383localToRootMKHz9U), Offset.m2620getYimpl(mo4383localToRootMKHz9U)), SizeKt.Size(rect.getWidth(), rect.getHeight())));
            }
        }
        ...
        public final void m1072setCursorOffsetULxng0E$foundation_release(long j, TextLayoutResultProxy textLayoutResult, EditProcessor editProcessor, OffsetMapping offsetMapping, Function1<? super TextFieldValue, Unit> onValueChange) {
            Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
            Intrinsics.checkNotNullParameter(editProcessor, "editProcessor");
            Intrinsics.checkNotNullParameter(offsetMapping, "offsetMapping");
            Intrinsics.checkNotNullParameter(onValueChange, "onValueChange");
            onValueChange.invoke(TextFieldValue.m5092copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, TextRangeKt.TextRange(offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1092getOffsetForPosition3MmeM6k$default(textLayoutResult, j, false, 2, null))), (TextRange) null, 5, (Object) null));
        }
