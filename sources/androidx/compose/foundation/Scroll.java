...
public final class Scroll {
    public static final ScrollState rememberScrollState(final int i, Composer composer, int i2, int i3) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = (Functions) new Functions<ScrollState>() { // from class: androidx.compose.foundation.ScrollKt$rememberScrollState$1$1
        ...
        ScrollState scrollState = (ScrollState) RememberSaveable.m2509rememberSaveable(objArr, saver, (String) null, (Functions<? extends Object>) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Modifier semantics$default = SemanticsModifierKt.semantics$default(Modifier.Companion, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semantics) {
                        ...
                        ScrollAxisRange scrollAxisRange = new ScrollAxisRange(new Functions<Float>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1$accessibilityScrollState$1
                            /* JADX INFO: Access modifiers changed from: package-private */
                            {
                                super(0);
                            }
                        ...
                        }, new Functions<Float>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1$accessibilityScrollState$2
                            /* JADX INFO: Access modifiers changed from: package-private */
                            {
                                super(0);
                            }
                        ...
                        if (z6) {
                            ...
                            SemanticsPropertiesKt.scrollBy$default(semantics, null, new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1.1
                                ...
                                public final Boolean invoke(float f, float f2) {
                                    BuildersKt__Builders_commonKt.launch$default(CoroutineScope.this, null, null, new C02031(z7, scrollState5, f2, f, null), 3, null);
                                    return true;
                                }
                                ...
                                @DebugMetadata(m31c = "androidx.compose.foundation.ScrollKt$scroll$2$semantics$1$1$1", m30f = "Scroll.kt", m29i = {}, m28l = {285, 287}, m27m = "invokeSuspend", m26n = {}, m25s = {})
                                ...
                                public static final class C02031 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                    ...
                                    /* renamed from: $x */
                                    final /* synthetic */ float f33$x;

                                    /* renamed from: $y */
                                    final /* synthetic */ float f34$y;
                                    int label;

                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    C02031(boolean z, ScrollState scrollState, float f, float f2, Continuation<? super C02031> continuation) {
                                    ...
                                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                        return new C02031(this.$isVertical, this.$state, this.f34$y, this.f33$x, continuation);
                                    }
                                    ...
                                    public final Object invokeSuspend(Object obj) {
                                        ...
                                        if (i == 0) {
                                            ...
                                            if (this.$isVertical) {
                                                ...
                                                this.label = 1;
                                                if (ScrollExtensions.animateScrollBy$default(scrollState, this.f34$y, null, this, 2, null) == coroutine_suspended) {
                                                ...
                                                this.label = 2;
                                                if (ScrollExtensions.animateScrollBy$default(scrollState2, this.f33$x, null, this, 2, null) == coroutine_suspended) {
                                                    return coroutine_suspended;
                                                }
                                            }
                                        } else if (i != 1 && i != 2) {
