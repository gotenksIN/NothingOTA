...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo973createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        return new Outline.Rounded(RoundRectKt.m2671RoundRectZAM2FJo(SizeKt.m2709toRectuvyYCjk(j), CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f : f2, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f2 : f, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f3 : f4, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == LayoutDirection.Ltr ? f4 : f3, 0.0f, 2, null)));
    }
