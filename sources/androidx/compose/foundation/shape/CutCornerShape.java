...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo973createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2688getWidthimpl(j) - f, 0.0f);
        Path.lineTo(Size.m2688getWidthimpl(j), f);
        float f6 = layoutDirection == LayoutDirection.Ltr ? f3 : f4;
        Path.lineTo(Size.m2688getWidthimpl(j), Size.m2685getHeightimpl(j) - f6);
        Path.lineTo(Size.m2688getWidthimpl(j) - f6, Size.m2685getHeightimpl(j));
        if (layoutDirection == LayoutDirection.Ltr) {
            f3 = f4;
        }
        Path.lineTo(f3, Size.m2685getHeightimpl(j));
        Path.lineTo(0.0f, Size.m2685getHeightimpl(j) - f3);
        Path.close();
