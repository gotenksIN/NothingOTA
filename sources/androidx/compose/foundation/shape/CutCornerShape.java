...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo672createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2387getWidthimpl(j) - f, 0.0f);
        Path.lineTo(Size.m2387getWidthimpl(j), f);
        float f6 = layoutDirection == LayoutDirection.Ltr ? f3 : f4;
        Path.lineTo(Size.m2387getWidthimpl(j), Size.m2384getHeightimpl(j) - f6);
        Path.lineTo(Size.m2387getWidthimpl(j) - f6, Size.m2384getHeightimpl(j));
        if (layoutDirection == LayoutDirection.Ltr) {
            f3 = f4;
        }
        Path.lineTo(f3, Size.m2384getHeightimpl(j));
        Path.lineTo(0.0f, Size.m2384getHeightimpl(j) - f3);
        Path.close();
