...
public abstract class CornerBasedShape implements Shape {
    ...
    public final Outline mo194createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        float m2386getMinDimensionimpl = Size.m2386getMinDimensionimpl(j);
        float f = mo680toPxTmRCtEA + mo680toPxTmRCtEA4;
        if (f > m2386getMinDimensionimpl) {
            float f2 = m2386getMinDimensionimpl / f;
            mo680toPxTmRCtEA *= f2;
            mo680toPxTmRCtEA4 *= f2;
        }
        float f3 = mo680toPxTmRCtEA4;
        float f4 = mo680toPxTmRCtEA2 + mo680toPxTmRCtEA3;
        if (f4 > m2386getMinDimensionimpl) {
            float f5 = m2386getMinDimensionimpl / f4;
