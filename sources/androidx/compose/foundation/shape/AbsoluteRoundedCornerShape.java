...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo672createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        return new Outline.Rounded(RoundRectKt.m2370RoundRectZAM2FJo(SizeKt.m2408toRectuvyYCjk(j), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f2, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f3, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f4, 0.0f, 2, null)));
    }
    ...
    private final long m676toRadiusBz7bX_o(float f) {
