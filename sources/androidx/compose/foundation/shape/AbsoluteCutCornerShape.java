...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo672createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        Path.moveTo(0.0f, f);
        Path.lineTo(f, 0.0f);
        Path.lineTo(Size.m2387getWidthimpl(j) - f2, 0.0f);
        Path.lineTo(Size.m2387getWidthimpl(j), f2);
        Path.lineTo(Size.m2387getWidthimpl(j), Size.m2384getHeightimpl(j) - f3);
        Path.lineTo(Size.m2387getWidthimpl(j) - f3, Size.m2384getHeightimpl(j));
        Path.lineTo(f4, Size.m2384getHeightimpl(j));
        Path.lineTo(0.0f, Size.m2384getHeightimpl(j) - f4);
        Path.close();
