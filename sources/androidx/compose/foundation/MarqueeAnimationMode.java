...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m203constructorimpl(0);
    private static final int WhileFocused = m203constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m202boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m203constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m204equalsimpl(int i, Object obj) {
        return (obj instanceof MarqueeAnimationMode) && i == ((MarqueeAnimationMode) obj).m208unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m205equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m206hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m206hashCodeimpl(this.value);
    }
    ...
    public static String m207toStringimpl(int i) {
        if (m205equalsimpl0(i, Immediately)) {
            return "Immediately";
        }
        if (m205equalsimpl0(i, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m209getImmediatelyZbEOnfQ$annotations() {
        }

        /* renamed from: getWhileFocused-ZbEOnfQ$annotations  reason: not valid java name */
        public static /* synthetic */ void m210getWhileFocusedZbEOnfQ$annotations() {
        }
