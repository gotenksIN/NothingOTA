...
public final class PlaceableInfo {
    ...
    private PlaceableInfo(long j, int i) {
        ...
        this.mainAxisSize = i;
        this.animatedOffset = new Animatable<>(IntOffset.m5159boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.Companion), null, 4, null);
        this.targetOffset = j;
    ...
    public final long m538getTargetOffsetnOccac() {
        return this.targetOffset;
    }

    /* renamed from: setTargetOffset--gyyYBs  reason: not valid java name */
    public final void m539setTargetOffsetgyyYBs(long j) {
        this.targetOffset = j;
    }
