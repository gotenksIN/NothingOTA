...
public final class LazyList {
    ...
    */
    public static final void LazyList(final androidx.compose.p002ui.Modifier r33, final androidx.compose.foundation.lazy.LazyListState r34, final androidx.compose.foundation.layout.PaddingValues r35, final boolean r36, final boolean r37, final androidx.compose.foundation.gestures.FlingBehavior r38, final boolean r39, int r40, androidx.compose.p002ui.Alignment.Horizontal r41, androidx.compose.foundation.layout.Arrangement.Vertical r42, androidx.compose.p002ui.Alignment.Vertical r43, androidx.compose.foundation.layout.Arrangement.Horizontal r44, final kotlin.jvm.functions.Function1<? super androidx.compose.foundation.lazy.LazyListScope, kotlin.Unit> r45, androidx.compose.runtime.Composer r46, final int r47, final int r48, final int r49) {
        /*
            Method dump skipped, instructions count: 1013
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.LazyList.LazyList(androidx.compose.ui.Modifier, androidx.compose.foundation.lazy.LazyListState, androidx.compose.foundation.layout.PaddingValues, boolean, boolean, androidx.compose.foundation.gestures.FlingBehavior, boolean, int, androidx.compose.ui.Alignment$Horizontal, androidx.compose.foundation.layout.Arrangement$Vertical, androidx.compose.ui.Alignment$Vertical, androidx.compose.foundation.layout.Arrangement$Horizontal, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    public static final void ScrollPositionUpdater(final LazyListItemProvider lazyListItemProvider, final LazyListState lazyListState, Composer composer, final int i) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListKt$ScrollPositionUpdater$1
            ...
            public final void invoke(Composer composer2, int i3) {
                LazyList.ScrollPositionUpdater(LazyListItemProvider.this, lazyListState, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
        ...
        if (z3 || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyListMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m822invoke0kLqBqw(lazyLayoutMeasureScope, constraints.m5313unboximpl());
                }

                /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                public final LazyListMeasureResult m822invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i6;
                    int i7;
                    int i8;
                    ...
                    if (z2) {
                        i6 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(paddingValues.mo697calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i6 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(Padding.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z2) {
                        i7 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(paddingValues.mo698calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i7 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(Padding.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    int i9 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(paddingValues.mo699calculateTopPaddingD9Ej5fM());
                    int i10 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(paddingValues.mo696calculateBottomPaddingD9Ej5fM());
                    ...
                    long m5323offsetNN6EwU = ConstraintsKt.m5323offsetNN6EwU(j, -i12, -i11);
                    lazyListState.updateScrollPositionIfTheFirstItemWasMoved$foundation_release(lazyListItemProvider);
                    LazyLayoutMeasureScope lazyLayoutMeasureScope2 = lazyLayoutMeasureScope;
                    lazyListState.setDensity$foundation_release(lazyLayoutMeasureScope2);
                    lazyListItemProvider.getItemScope().setMaxSize(Constraints.m5307getMaxWidthimpl(m5323offsetNN6EwU), Constraints.m5306getMaxHeightimpl(m5323offsetNN6EwU));
                    if (z2) {
                        Arrangement.Vertical vertical5 = vertical4;
                        if (vertical5 == null) {
                            throw new IllegalArgumentException("Required value was null.".toString());
                        }
                        mo666getSpacingD9Ej5fM = vertical5.mo666getSpacingD9Ej5fM();
                    } else {
                        Arrangement.Horizontal horizontal5 = horizontal4;
                        if (horizontal5 == null) {
                            throw new IllegalArgumentException("Required value was null.".toString());
                        }
                        mo666getSpacingD9Ej5fM = horizontal5.mo666getSpacingD9Ej5fM();
                    }
                    final int i15 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(mo666getSpacingD9Ej5fM);
                    final int itemCount = lazyListItemProvider.getItemCount();
                    if (z2) {
                        m5307getMaxWidthimpl = Constraints.m5306getMaxHeightimpl(j) - i11;
                    } else {
                        m5307getMaxWidthimpl = Constraints.m5307getMaxWidthimpl(j) - i12;
                    }
                    ...
                    final int i17 = i8;
                    LazyMeasuredItemProvider lazyMeasuredItemProvider = new LazyMeasuredItemProvider(m5323offsetNN6EwU, z6, lazyListItemProvider2, lazyLayoutMeasureScope, new MeasuredItemFactory() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1$measuredItemProvider$1
                        @Override // androidx.compose.foundation.lazy.MeasuredItemFactory
                        /* renamed from: createItem-HK0c1C0  reason: not valid java name */
                        public final LazyMeasuredItem mo823createItemHK0c1C0(int i18, Object key, List<? extends Placeable> placeables) {
                    ...
                    lazyListState.m836setPremeasureConstraintsBRTryo0$foundation_release(lazyMeasuredItemProvider.m838getChildConstraintsmsEJaDk());
                    Snapshot.Companion companion = Snapshot.Companion;
                    LazyListState lazyListState2 = lazyListState;
                    Snapshot createNonObservableSnapshot = companion.createNonObservableSnapshot();
                    try {
                        Snapshot makeCurrent = createNonObservableSnapshot.makeCurrent();
                        int m805constructorimpl = DataIndex.m805constructorimpl(lazyListState2.getFirstVisibleItemIndex());
                        int firstVisibleItemScrollOffset = lazyListState2.getFirstVisibleItemScrollOffset();
                        Unit unit = Unit.INSTANCE;
                        createNonObservableSnapshot.restoreCurrent(makeCurrent);
                        createNonObservableSnapshot.dispose();
                        LazyListMeasureResult m827measureLazyListHh3qtAg = LazyListMeasure.m827measureLazyListHh3qtAg(itemCount, lazyListItemProvider, lazyMeasuredItemProvider, i16, i8, i14, i15, m805constructorimpl, firstVisibleItemScrollOffset, lazyListState.getScrollToBeConsumed$foundation_release(), m5323offsetNN6EwU, z2, lazyListItemProvider.getHeaderIndexes(), vertical4, horizontal4, z, lazyLayoutMeasureScope2, lazyListItemPlacementAnimator, lazyListBeyondBoundsInfo, i, lazyListState.getPinnedItems$foundation_release(), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(3);
                            }
                            ...
                            public final MeasureResult invoke(int i18, int i19, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                ...
                                return LazyLayoutMeasureScope.this.layout(ConstraintsKt.m5321constrainWidthK40F9xA(j, i18 + i12), ConstraintsKt.m5320constrainHeightK40F9xA(j, i19 + i11), MapsKt.emptyMap(), placement);
                            }
                        });
                        lazyListState.applyMeasureResult$foundation_release(m827measureLazyListHh3qtAg);
                        return m827measureLazyListHh3qtAg;
                    } catch (Throwable th) {
                        createNonObservableSnapshot.dispose();
                        throw th;
                    }
