...
public final class LazyStaggeredGridAnimateScrollScope implements LazyAnimateScrollScope {
    ...
    public Integer getTargetItemOffset(int i) {
        ...
        if (findVisibleItem != null) {
            ...
            return Integer.valueOf(this.state.isVertical$foundation_release() ? IntOffset.m5169getYimpl(mo627getOffsetnOccac) : IntOffset.m5168getXimpl(mo627getOffsetnOccac));
        }
        return null;
    }
    ...
    public float expectedDistanceTo(int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            i3 += this.state.isVertical$foundation_release() ? IntSize.m5209getHeightimpl(lazyStaggeredGridItemInfo.mo628getSizeYbymL2g()) : IntSize.m5210getWidthimpl(lazyStaggeredGridItemInfo.mo628getSizeYbymL2g());
        }
