...
public final class LazyStaggeredGridDslKt$itemsIndexed$5 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final void invoke(LazyStaggeredGridItemScope items, int i, Composer composer, int i2) {
        ...
        this.$itemContent.invoke(items, Integer.valueOf(i), this.$items.get(i), composer, Integer.valueOf((i3 & 14) | (i3 & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle)));
        if (ComposerKt.isTraceInProgress()) {
