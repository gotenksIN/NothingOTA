...
public final class LazyStaggeredGridKt {
    ...
    public static final void m629LazyStaggeredGridLJWHXA8(final LazyStaggeredGridState state, final Orientation orientation, final Function2<? super Density, ? super Constraints, int[]> slotSizesSums, Modifier modifier, PaddingValues paddingValues, boolean z, FlingBehavior flingBehavior, boolean z2, float f, float f2, final Function1<? super LazyStaggeredGridScope, Unit> content, Composer composer, final int i, final int i2, final int i3) {
        ...
        PaddingValues m408PaddingValues0680j_4 = (i3 & 16) != 0 ? PaddingKt.m408PaddingValues0680j_4(Dp.m5050constructorimpl(0)) : paddingValues;
        ...
        float m5050constructorimpl = (i3 & 256) != 0 ? Dp.m5050constructorimpl(0) : f;
        float m5050constructorimpl2 = (i3 & 512) != 0 ? Dp.m5050constructorimpl(0) : f2;
        ...
        LazyStaggeredGridItemProvider rememberStaggeredGridItemProvider = LazyStaggeredGridItemProviderKt.rememberStaggeredGridItemProvider(state, content, startRestartGroup, ((i2 << 3) & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 8);
        int i5 = i4 >> 6;
        int i6 = i4 >> 9;
        int i7 = i4;
        final boolean z5 = z3;
        final Modifier modifier2 = companion;
        Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> m638rememberStaggeredGridMeasurePolicynbWgWpA = LazyStaggeredGridMeasurePolicyKt.m638rememberStaggeredGridMeasurePolicynbWgWpA(state, rememberStaggeredGridItemProvider, m408PaddingValues0680j_4, z3, orientation, m5050constructorimpl, m5050constructorimpl2, slotSizesSums, startRestartGroup, (i5 & 7168) | (i5 & 896) | 8 | ((i4 << 9) & 57344) | (i6 & 458752) | (i6 & 3670016) | ((i4 << 15) & 29360128));
        LazyLayoutSemanticState rememberLazyStaggeredGridSemanticState = LazyStaggeredGridSemanticsKt.rememberLazyStaggeredGridSemanticState(state, z5, startRestartGroup, ((i7 >> 12) & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 8);
        ...
        Modifier overscroll = OverscrollKt.overscroll(ClipScrollableContainerKt.clipScrollableContainer(modifier2.then(state.getRemeasurementModifier$foundation_release()), orientation), overscrollEffect);
        ...
        final PaddingValues paddingValues2 = m408PaddingValues0680j_4;
        final FlingBehavior flingBehavior3 = flingBehavior2;
        final boolean z7 = z4;
        final float f3 = m5050constructorimpl;
        final float f4 = m5050constructorimpl2;
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$LazyStaggeredGrid$1
            ...
            public final void invoke(Composer composer2, int i8) {
                LazyStaggeredGridKt.m629LazyStaggeredGridLJWHXA8(LazyStaggeredGridState.this, orientation, slotSizesSums, modifier2, paddingValues2, z5, flingBehavior3, z7, f3, f4, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2), i3);
            }
        });
    }
