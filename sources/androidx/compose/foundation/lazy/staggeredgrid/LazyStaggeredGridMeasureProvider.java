...
final class LazyStaggeredGridMeasureProvider {
    ...
    private final long m640childConstraintsJhjzzOo(int i, int i2) {
        int i3 = (this.resolvedSlotSums[(i + i2) - 1] - (i == 0 ? 0 : this.resolvedSlotSums[i - 1])) + (this.crossAxisSpacing * (i2 - 1));
        if (this.isVertical) {
            return Constraints.Companion.m5016fixedWidthOenEA2s(i3);
        }
        return Constraints.Companion.m5015fixedHeightOenEA2s(i3);
    }

    /* renamed from: getAndMeasure-jy6DScQ  reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m641getAndMeasurejy6DScQ(int i, long j) {
        int i2 = (int) (j >> 32);
        int i3 = ((int) (j & 4294967295L)) - i2;
        return this.measuredItemFactory.createItem(i, i2, i3, this.itemProvider.getKey(i), this.measureScope.mo618measure0kLqBqw(i, m640childConstraintsJhjzzOo(i2, i3)));
    }
}
