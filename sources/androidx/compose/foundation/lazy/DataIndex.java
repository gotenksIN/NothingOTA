...
public final class DataIndex {
    ...
    public static final /* synthetic */ DataIndex m502boximpl(int i) {
        return new DataIndex(i);
    }

    /* renamed from: compareTo-ZjPyQlc  reason: not valid java name */
    public static final int m503compareToZjPyQlc(int i, int i2) {
        return i - i2;
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m504constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m506equalsimpl(int i, Object obj) {
        return (obj instanceof DataIndex) && i == ((DataIndex) obj).m514unboximpl();
    }
    ...
    public static final int m509incjQJCoq8(int i) {
        return m504constructorimpl(i + 1);
    }

    /* renamed from: dec-jQJCoq8  reason: not valid java name */
    public static final int m505decjQJCoq8(int i) {
        return m504constructorimpl(i - 1);
    }

    /* renamed from: plus-PBKCTt8  reason: not valid java name */
    public static final int m512plusPBKCTt8(int i, int i2) {
        return m504constructorimpl(i + i2);
    }

    /* renamed from: minus-PBKCTt8  reason: not valid java name */
    public static final int m510minusPBKCTt8(int i, int i2) {
        return m504constructorimpl(i - i2);
    }

    /* renamed from: minus-yUvdeeg  reason: not valid java name */
    public static final int m511minusyUvdeeg(int i, int i2) {
        return m504constructorimpl(i - i2);
    }
}
