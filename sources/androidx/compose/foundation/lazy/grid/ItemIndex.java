...
public final class ItemIndex {
    ...
    public static final /* synthetic */ ItemIndex m549boximpl(int i) {
        return new ItemIndex(i);
    }

    /* renamed from: compareTo-YGsSkvE  reason: not valid java name */
    public static final int m550compareToYGsSkvE(int i, int i2) {
        return i - i2;
    }
    ...
    public static boolean m553equalsimpl(int i, Object obj) {
        return (obj instanceof ItemIndex) && i == ((ItemIndex) obj).m561unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m554equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static String m560toStringimpl(int i) {
        return "ItemIndex(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m553equalsimpl(this.value, obj);
    }
