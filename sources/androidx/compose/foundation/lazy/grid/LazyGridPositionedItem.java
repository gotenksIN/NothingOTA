...
public final class LazyGridPositionedItem implements LazyGridItemInfo {
    ...
    public long mo570getOffsetnOccac() {
        return this.offset;
    }
    ...
    public long mo571getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final int getMainAxisSize() {
        return this.isVertical ? IntSize.m5209getHeightimpl(mo571getSizeYbymL2g()) : IntSize.m5210getWidthimpl(mo571getSizeYbymL2g());
    }

    public final int getCrossAxisSize() {
        return this.isVertical ? IntSize.m5210getWidthimpl(mo571getSizeYbymL2g()) : IntSize.m5209getHeightimpl(mo571getSizeYbymL2g());
    }

    public final int getCrossAxisOffset() {
        return this.isVertical ? IntOffset.m5168getXimpl(mo570getOffsetnOccac()) : IntOffset.m5169getYimpl(mo570getOffsetnOccac());
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (getAnimationSpec(i) != null) {
                mo570getOffsetnOccac = this.placementAnimator.m574getAnimatedOffsetYT5a7pE(getKey(), i, mainAxisSize, i2, mo570getOffsetnOccac());
            } else {
                mo570getOffsetnOccac = mo570getOffsetnOccac();
            }
            if (this.reverseLayout) {
                int m5168getXimpl = this.isVertical ? IntOffset.m5168getXimpl(mo570getOffsetnOccac) : (this.mainAxisLayoutSize - IntOffset.m5168getXimpl(mo570getOffsetnOccac)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m5169getYimpl = (this.mainAxisLayoutSize - IntOffset.m5169getYimpl(mo570getOffsetnOccac)) - getMainAxisSize(placeable);
                } else {
                    m5169getYimpl = IntOffset.m5169getYimpl(mo570getOffsetnOccac);
                }
                mo570getOffsetnOccac = IntOffsetKt.IntOffset(m5168getXimpl, m5169getYimpl);
            }
            if (this.isVertical) {
                long j = this.visualOffset;
                Placeable.PlacementScope.m4126placeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(mo570getOffsetnOccac) + IntOffset.m5168getXimpl(j), IntOffset.m5169getYimpl(mo570getOffsetnOccac) + IntOffset.m5169getYimpl(j)), 0.0f, null, 6, null);
            } else {
                long j2 = this.visualOffset;
                Placeable.PlacementScope.m4125placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(mo570getOffsetnOccac) + IntOffset.m5168getXimpl(j2), IntOffset.m5169getYimpl(mo570getOffsetnOccac) + IntOffset.m5169getYimpl(j2)), 0.0f, null, 6, null);
            }
        }
    }
    ...
    private final long m583copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
