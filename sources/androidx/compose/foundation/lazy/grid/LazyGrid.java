...
public final class LazyGrid {
    ...
    */
    public static final void LazyGrid(androidx.compose.p002ui.Modifier r35, final androidx.compose.foundation.lazy.grid.LazyGridState r36, final kotlin.jvm.functions.Function2<? super androidx.compose.p002ui.unit.Density, ? super androidx.compose.p002ui.unit.Constraints, ? extends java.util.List<java.lang.Integer>> r37, androidx.compose.foundation.layout.PaddingValues r38, boolean r39, final boolean r40, androidx.compose.foundation.gestures.FlingBehavior r41, final boolean r42, final androidx.compose.foundation.layout.Arrangement.Vertical r43, final androidx.compose.foundation.layout.Arrangement.Horizontal r44, final kotlin.jvm.functions.Function1<? super androidx.compose.foundation.lazy.grid.LazyGridScope, kotlin.Unit> r45, androidx.compose.runtime.Composer r46, final int r47, final int r48, final int r49) {
        /*
            Method dump skipped, instructions count: 920
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.grid.LazyGrid.LazyGrid(androidx.compose.ui.Modifier, androidx.compose.foundation.lazy.grid.LazyGridState, kotlin.jvm.functions.Function2, androidx.compose.foundation.layout.PaddingValues, boolean, boolean, androidx.compose.foundation.gestures.FlingBehavior, boolean, androidx.compose.foundation.layout.Arrangement$Vertical, androidx.compose.foundation.layout.Arrangement$Horizontal, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    public static final void ScrollPositionUpdater(final LazyGridItemProvider lazyGridItemProvider, final LazyGridState lazyGridState, Composer composer, final int i) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$ScrollPositionUpdater$1
            ...
            public final void invoke(Composer composer2, int i3) {
                LazyGrid.ScrollPositionUpdater(LazyGridItemProvider.this, lazyGridState, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
        ...
        if (z3 || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m877invoke0kLqBqw(lazyLayoutMeasureScope, constraints.m5313unboximpl());
                }

                /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                public final LazyGridMeasureResult m877invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i4;
                    int i5;
                    int i6;
                    float mo666getSpacingD9Ej5fM;
                    float mo666getSpacingD9Ej5fM2;
                    int m5307getMaxWidthimpl;
                    long IntOffset;
                    int firstVisibleItemScrollOffset;
                    int i7;
                    Intrinsics.checkNotNullParameter(lazyLayoutMeasureScope, "$this$null");
                    CheckScrollableContainerConstraints.m473checkScrollableContainerConstraintsK40F9xA(j, z2 ? Orientation.Vertical : Orientation.Horizontal);
                    if (z2) {
                        i4 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(paddingValues.mo697calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i4 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(Padding.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z2) {
                        i5 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(paddingValues.mo698calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(Padding.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    int i8 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(paddingValues.mo699calculateTopPaddingD9Ej5fM());
                    int i9 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(paddingValues.mo696calculateBottomPaddingD9Ej5fM());
                    final int i10 = i8 + i9;
                    final int i11 = i4 + i5;
                    boolean z4 = z2;
                    int i12 = z4 ? i10 : i11;
                    ...
                    long m5323offsetNN6EwU = ConstraintsKt.m5323offsetNN6EwU(j, -i11, -i10);
                    lazyGridState.updateScrollPositionIfTheFirstItemWasMoved$foundation_release(lazyGridItemProvider);
                    final LazyGridSpanLayoutProvider spanLayoutProvider = lazyGridItemProvider.getSpanLayoutProvider();
                    final List<Integer> invoke = function2.invoke(lazyLayoutMeasureScope, Constraints.m5295boximpl(j));
                    ...
                    if (z2) {
                        ...
                        mo666getSpacingD9Ej5fM = vertical3.mo666getSpacingD9Ej5fM();
                    } else {
                        Arrangement.Horizontal horizontal3 = horizontal2;
                        if (horizontal3 == null) {
                            throw new IllegalArgumentException("Required value was null.".toString());
                        }
                        mo666getSpacingD9Ej5fM = horizontal3.mo666getSpacingD9Ej5fM();
                    }
                    int i14 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(mo666getSpacingD9Ej5fM);
                    if (z2) {
                        Arrangement.Horizontal horizontal4 = horizontal2;
                        mo666getSpacingD9Ej5fM2 = horizontal4 != null ? horizontal4.mo666getSpacingD9Ej5fM() : C0780Dp.m5351constructorimpl(0);
                    } else {
                        Arrangement.Vertical vertical4 = vertical2;
                        mo666getSpacingD9Ej5fM2 = vertical4 != null ? vertical4.mo666getSpacingD9Ej5fM() : C0780Dp.m5351constructorimpl(0);
                    }
                    final int i15 = lazyLayoutMeasureScope.mo597roundToPx0680j_4(mo666getSpacingD9Ej5fM2);
                    int itemCount = lazyGridItemProvider.getItemCount();
                    if (z2) {
                        m5307getMaxWidthimpl = Constraints.m5306getMaxHeightimpl(j) - i10;
                    } else {
                        m5307getMaxWidthimpl = Constraints.m5307getMaxWidthimpl(j) - i11;
                    }
                    int i16 = m5307getMaxWidthimpl;
                    if (!z || i16 > 0) {
                    ...
                    LazyMeasuredItemProvider lazyMeasuredItemProvider = new LazyMeasuredItemProvider(lazyGridItemProvider2, lazyLayoutMeasureScope, i14, new MeasuredItemFactory() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredItemProvider$1
                        ...
                        public final LazyGridMeasuredItem mo879createItemPU_OBEw(int i18, Object key, int i19, int i20, List<? extends Placeable> placeables) {
                    ...
                    final LazyMeasuredLineProvider lazyMeasuredLineProvider = new LazyMeasuredLineProvider(z8, invoke, i15, itemCount, i14, lazyMeasuredItemProvider, spanLayoutProvider, new MeasuredLineFactory() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1
                        ...
                        public final LazyGridMeasuredLine mo880createLineH9FfpSk(int i18, LazyGridMeasuredItem[] items, List<LazyGridSpan> spans, int i19) {
                    ...
                    lazyGridState.setPrefetchInfoRetriever$foundation_release(new Function1<LineIndex, ArrayList<Tuples<? extends Integer, ? extends Constraints>>>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public /* bridge */ /* synthetic */ ArrayList<Tuples<? extends Integer, ? extends Constraints>> invoke(LineIndex lineIndex) {
                            return m878invokebKFJvoY(lineIndex.m910unboximpl());
                        }

                        /* renamed from: invoke-bKFJvoY  reason: not valid java name */
                        public final ArrayList<Tuples<Integer, Constraints>> m878invokebKFJvoY(int i18) {
                            LazyGridSpanLayoutProvider.LineConfiguration lineConfiguration = LazyGridSpanLayoutProvider.this.getLineConfiguration(i18);
                            int m852constructorimpl = ItemIndex.m852constructorimpl(lineConfiguration.getFirstItemIndex());
                            ArrayList<Tuples<Integer, Constraints>> arrayList = new ArrayList<>(lineConfiguration.getSpans().size());
                            ...
                            for (int i20 = 0; i20 < size; i20++) {
                                int m846getCurrentLineSpanimpl = LazyGridSpan.m846getCurrentLineSpanimpl(spans.get(i20).m849unboximpl());
                                arrayList.add(TuplesKt.m33to(Integer.valueOf(m852constructorimpl), Constraints.m5295boximpl(lazyMeasuredLineProvider2.m895childConstraintsJhjzzOo$foundation_release(i19, m846getCurrentLineSpanimpl))));
                                m852constructorimpl = ItemIndex.m852constructorimpl(m852constructorimpl + 1);
                                i19 += m846getCurrentLineSpanimpl;
                            }
                            return arrayList;
                        }
                    });
                    ...
                    try {
                        ...
                        if (lazyGridState2.getFirstVisibleItemIndex() >= itemCount && itemCount > 0) {
                            i7 = spanLayoutProvider.m891getLineIndexOfItem_Ze7BM(itemCount - 1);
                            firstVisibleItemScrollOffset = 0;
                            Unit unit = Unit.INSTANCE;
                            createNonObservableSnapshot.restoreCurrent(makeCurrent);
                            createNonObservableSnapshot.dispose();
                            LazyGridMeasureResult m881measureLazyGridt5wl_D8 = LazyGridMeasure.m881measureLazyGridt5wl_D8(itemCount, lazyGridItemProvider, lazyMeasuredLineProvider, lazyMeasuredItemProvider, i16, i6, i13, i14, i7, firstVisibleItemScrollOffset, lazyGridState.getScrollToBeConsumed$foundation_release(), m5323offsetNN6EwU, z2, vertical2, horizontal2, z, lazyLayoutMeasureScope2, lazyGridItemPlacementAnimator, spanLayoutProvider, lazyGridState.getPinnedItems$foundation_release(), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.3
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                                ...
                                public final MeasureResult invoke(int i18, int i19, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                    ...
                                    return LazyLayoutMeasureScope.this.layout(ConstraintsKt.m5321constrainWidthK40F9xA(j, i18 + i11), ConstraintsKt.m5320constrainHeightK40F9xA(j, i19 + i10), MapsKt.emptyMap(), placement);
                                }
                            });
                            lazyGridState.applyMeasureResult$foundation_release(m881measureLazyGridt5wl_D8);
                            return m881measureLazyGridt5wl_D8;
                        }
                        int m891getLineIndexOfItem_Ze7BM = spanLayoutProvider.m891getLineIndexOfItem_Ze7BM(lazyGridState2.getFirstVisibleItemIndex());
                        firstVisibleItemScrollOffset = lazyGridState2.getFirstVisibleItemScrollOffset();
                        i7 = m891getLineIndexOfItem_Ze7BM;
                        Unit unit2 = Unit.INSTANCE;
                        createNonObservableSnapshot.restoreCurrent(makeCurrent);
                        createNonObservableSnapshot.dispose();
                        LazyGridMeasureResult m881measureLazyGridt5wl_D82 = LazyGridMeasure.m881measureLazyGridt5wl_D8(itemCount, lazyGridItemProvider, lazyMeasuredLineProvider, lazyMeasuredItemProvider, i16, i6, i13, i14, i7, firstVisibleItemScrollOffset, lazyGridState.getScrollToBeConsumed$foundation_release(), m5323offsetNN6EwU, z2, vertical2, horizontal2, z, lazyLayoutMeasureScope2, lazyGridItemPlacementAnimator, spanLayoutProvider, lazyGridState.getPinnedItems$foundation_release(), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.3
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(3);
                            }
                        ...
                        lazyGridState.applyMeasureResult$foundation_release(m881measureLazyGridt5wl_D82);
                        return m881measureLazyGridt5wl_D82;
                    } catch (Throwable th) {
                        createNonObservableSnapshot.dispose();
                        throw th;
                    }
