...
public final class LazyMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m592getAndMeasureednRnyU$default(LazyMeasuredItemProvider lazyMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = lazyMeasuredItemProvider.defaultMainAxisSpacing;
        }
        return lazyMeasuredItemProvider.m593getAndMeasureednRnyU(i, i2, j);
    }

    /* renamed from: getAndMeasure-ednRnyU  reason: not valid java name */
    public final LazyGridMeasuredItem m593getAndMeasureednRnyU(int i, int i2, long j) {
        int m5007getMinHeightimpl;
        Object key = this.itemProvider.getKey(i);
        List<Placeable> mo618measure0kLqBqw = this.measureScope.mo618measure0kLqBqw(i, j);
        if (Constraints.m5004getHasFixedWidthimpl(j)) {
            m5007getMinHeightimpl = Constraints.m5008getMinWidthimpl(j);
        } else if (!Constraints.m5003getHasFixedHeightimpl(j)) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        } else {
            m5007getMinHeightimpl = Constraints.m5007getMinHeightimpl(j);
        }
        return this.measuredItemFactory.mo578createItemPU_OBEw(i, key, m5007getMinHeightimpl, i2, mo618measure0kLqBqw);
    }
