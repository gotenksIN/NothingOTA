    ...
    private static final List<LazyGridMeasuredItem> calculateExtraItems(LazyLayoutPinnedItemList lazyLayoutPinnedItemList, LazyMeasuredItemProvider lazyMeasuredItemProvider, LazyGridItemProvider lazyGridItemProvider, Function1<? super ItemIndex, Constraints> function1, Function1<? super Integer, Boolean> function12) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (function12.invoke(Integer.valueOf(findIndexByKey)).booleanValue()) {
                int m852constructorimpl = ItemIndex.m852constructorimpl(findIndexByKey);
                LazyGridMeasuredItem m893getAndMeasureednRnyU$default = LazyMeasuredItemProvider.m893getAndMeasureednRnyU$default(lazyMeasuredItemProvider, m852constructorimpl, 0, function1.invoke(ItemIndex.m850boximpl(m852constructorimpl)).m5313unboximpl(), 2, null);
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                arrayList.add(m893getAndMeasureednRnyU$default);
            }
        }
