...
public final class LazyMeasuredLineProvider {
    ...
    public final long m594childConstraintsJhjzzOo$foundation_release(int i, int i2) {
        ...
        if (this.isVertical) {
            return Constraints.Companion.m5016fixedWidthOenEA2s(coerceAtLeast);
        }
        return Constraints.Companion.m5015fixedHeightOenEA2s(coerceAtLeast);
    }

    /* renamed from: itemConstraints-HZ0wssc  reason: not valid java name */
    public final long m596itemConstraintsHZ0wssc(int i) {
        LazyGridSpanLayoutProvider lazyGridSpanLayoutProvider = this.spanLayoutProvider;
        return m594childConstraintsJhjzzOo$foundation_release(0, lazyGridSpanLayoutProvider.spanOf(i, lazyGridSpanLayoutProvider.getSlotsPerLine()));
    }

    /* renamed from: getAndMeasure-bKFJvoY  reason: not valid java name */
    public final LazyGridMeasuredLine m595getAndMeasurebKFJvoY(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            int m545getCurrentLineSpanimpl = GridItemSpan.m545getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i4).m548unboximpl());
            LazyGridMeasuredItem m593getAndMeasureednRnyU = this.measuredItemProvider.m593getAndMeasureednRnyU(ItemIndex.m551constructorimpl(lineConfiguration.getFirstItemIndex() + i4), i2, m594childConstraintsJhjzzOo$foundation_release(i3, m545getCurrentLineSpanimpl));
            i3 += m545getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i4] = m593getAndMeasureednRnyU;
        }
        return this.measuredLineFactory.mo579createLineH9FfpSk(i, lazyGridMeasuredItemArr, lineConfiguration.getSpans(), i2);
    }
