...
@DebugMetadata(m31c = "androidx.compose.foundation.lazy.grid.LazyGridItemPlacementAnimator$getAnimatedOffset$1", m30f = "LazyGridItemPlacementAnimator.kt", m29i = {}, m28l = {281}, m27m = "invokeSuspend", m26n = {}, m25s = {})
...
public final class LazyGridItemPlacementAnimator$getAnimatedOffset$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$item.getAnimatedOffset().snapTo(IntOffset.m5460boximpl(this.$item.m911getTargetOffsetnOccac()), this) == coroutine_suspended) {
