...
public final class LazyGridItemProviderImpl implements LazyGridItemProvider, LazyLayoutItemProvider {
    ...
    public long mo876getSpan_orMbw(LazyGridItemSpanScope getSpan, int i) {
        ...
        return interval.getValue().getSpan().invoke(getSpan, Integer.valueOf(i - interval.getStartIndex())).m849unboximpl();
    }
}
