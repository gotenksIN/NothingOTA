...
public final class LazyGridDslKt$itemsIndexed$3 extends Lambda implements Function2<LazyGridItemSpanScope, Integer, LazyGridSpan> {
    ...
    public LazyGridDslKt$itemsIndexed$3(Function3<? super LazyGridItemSpanScope, ? super Integer, ? super T, LazyGridSpan> function3, List<? extends T> list) {
        super(2);
        this.$span = function3;
        this.$items = list;
    }
    ...
    public /* bridge */ /* synthetic */ LazyGridSpan invoke(LazyGridItemSpanScope lazyGridItemSpanScope, Integer num) {
        return LazyGridSpan.m842boximpl(m867invoke_orMbw(lazyGridItemSpanScope, num.intValue()));
    }

    /* renamed from: invoke-_-orMbw  reason: not valid java name */
    public final long m867invoke_orMbw(LazyGridItemSpanScope lazyGridItemSpanScope, int i) {
        Intrinsics.checkNotNullParameter(lazyGridItemSpanScope, "$this$null");
        return this.$span.invoke(lazyGridItemSpanScope, Integer.valueOf(i), this.$items.get(i)).m849unboximpl();
    }
}
