...
public final class LazyGridScrollPosition {
    ...
    public LazyGridScrollPosition(int i, int i2) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ItemIndex.m549boximpl(ItemIndex.m551constructorimpl(i)), null, 2, null);
    ...
    private final void m586setIndexYGsSkvE(int i) {
        this.index$delegate.setValue(ItemIndex.m549boximpl(i));
    }

    /* renamed from: getIndex-VZbfaAc  reason: not valid java name */
    public final int m588getIndexVZbfaAc() {
        return ((ItemIndex) this.index$delegate.getValue()).m561unboximpl();
    }
        ...
        if (this.hadFirstNotEmptyLayout || measureResult.getTotalItemsCount() > 0) {
            ...
            try {
                ...
                if (firstVisibleLine2 != null && (items = firstVisibleLine2.getItems()) != null && (lazyGridMeasuredItem = (LazyGridMeasuredItem) ArraysKt.firstOrNull(items)) != null) {
                    i = lazyGridMeasuredItem.m581getIndexVZbfaAc();
                }
                m587updateyO3Fmg4(ItemIndex.m551constructorimpl(i), firstVisibleLineScrollOffset);
    ...
    public final void m589requestPositionyO3Fmg4(int i, int i2) {
        m587updateyO3Fmg4(i, i2);
    ...
    public final void updateScrollPositionIfTheFirstItemWasMoved(LazyGridItemProvider itemProvider) {
        ...
        try {
            Snapshot makeCurrent = createNonObservableSnapshot.makeCurrent();
            m587updateyO3Fmg4(ItemIndex.m551constructorimpl(LazyLayoutItemProviderKt.findIndexByKey(itemProvider, this.lastKnownFirstItemKey, m588getIndexVZbfaAc())), getScrollOffset());
            Unit unit = Unit.INSTANCE;
            createNonObservableSnapshot.restoreCurrent(makeCurrent);
        } finally {
            createNonObservableSnapshot.dispose();
    ...
    private final void m587updateyO3Fmg4(int i, int i2) {
        if (!(((float) i) >= 0.0f)) {
            throw new IllegalArgumentException(("Index should be non-negative (" + i + ')').toString());
        }
        if (!ItemIndex.m554equalsimpl0(i, m588getIndexVZbfaAc())) {
            m586setIndexYGsSkvE(i);
        }
