...
public final class LazyListState implements ScrollableState {
    ...
    public LazyListState(int i, int i2) {
        ...
        mutableStateOf$default5 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Constraints.m4994boximpl(ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null)), null, 2, null);
    ...
    public final int getFirstVisibleItemIndex() {
        return this.scrollPosition.m531getIndexjQJCoq8();
    }
    ...
    public final long m534getPremeasureConstraintsmsEJaDk$foundation_release() {
        return ((Constraints) this.premeasureConstraints$delegate.getValue()).m5012unboximpl();
    }

    /* renamed from: setPremeasureConstraints-BRTryo0$foundation_release */
    public final void m535setPremeasureConstraintsBRTryo0$foundation_release(long j) {
        this.premeasureConstraints$delegate.setValue(Constraints.m4994boximpl(j));
    }
    ...
    public final void snapToItemIndexInternal$foundation_release(int i, int i2) {
        this.scrollPosition.m532requestPositionAhXoVpI(DataIndex.m504constructorimpl(i), i2);
            ...
            if (!layoutInfo.getVisibleItemsInfo().isEmpty()) {
                ...
                if (index != this.indexToPrefetch) {
                    ...
                    if (z) {
                        ...
                        this.currentPrefetchHandle = this.prefetchState.m619schedulePrefetch0kLqBqw(index, m534getPremeasureConstraintsmsEJaDk$foundation_release());
                    }
                }
            }
        }
