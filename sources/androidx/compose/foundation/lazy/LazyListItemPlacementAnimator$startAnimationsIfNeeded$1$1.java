...
@DebugMetadata(m31c = "androidx.compose.foundation.lazy.LazyListItemPlacementAnimator$startAnimationsIfNeeded$1$1", m30f = "LazyListItemPlacementAnimator.kt", m29i = {}, m28l = {297}, m27m = "invokeSuspend", m26n = {}, m25s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                this.label = 1;
                if (Animatable.animateTo$default(this.$placeableInfo.getAnimatedOffset(), IntOffset.m5460boximpl(this.$placeableInfo.m839getTargetOffsetnOccac()), springSpec, null, null, this, 12, null) == coroutine_suspended) {
