...
public final class LazyListMeasureResult implements LazyListLayoutInfo, MeasureResult {
    ...
    public LazyListMeasureResult(LazyMeasuredItem lazyMeasuredItem, int i, boolean z, float f, MeasureResult measureResult, List<? extends LazyListItemInfo> visibleItemsInfo, int i2, int i3, int i4, boolean z2, Orientation orientation, int i5, int i6) {
    ...
    public long mo816getViewportSizeYbymL2g() {
