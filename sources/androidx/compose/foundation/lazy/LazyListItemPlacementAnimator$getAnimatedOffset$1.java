...
@DebugMetadata(m31c = "androidx.compose.foundation.lazy.LazyListItemPlacementAnimator$getAnimatedOffset$1", m30f = "LazyListItemPlacementAnimator.kt", m29i = {}, m28l = {217}, m27m = "invokeSuspend", m26n = {}, m25s = {})
...
public final class LazyListItemPlacementAnimator$getAnimatedOffset$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$item.getAnimatedOffset().snapTo(IntOffset.m5460boximpl(this.$item.m839getTargetOffsetnOccac()), this) == coroutine_suspended) {
