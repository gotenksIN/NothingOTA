...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T mo616layouto7g1Pn8(final int i, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        T t = null;
        while (t == null && m614hasMoreContentFR3nfPY((LazyListBeyondBoundsInfo.Interval) objectRef.element, i)) {
            this.beyondBoundsInfo.removeInterval((LazyListBeyondBoundsInfo.Interval) objectRef.element);
            objectRef.element = (T) m613addNextIntervalFR3nfPY((LazyListBeyondBoundsInfo.Interval) objectRef.element, i);
            ...
            t = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    boolean m614hasMoreContentFR3nfPY;
                    m614hasMoreContentFR3nfPY = LazyLayoutBeyondBoundsModifierLocal.this.m614hasMoreContentFR3nfPY(objectRef.element, i);
                    return m614hasMoreContentFR3nfPY;
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyListBeyondBoundsInfo.Interval) objectRef.element);
    ...
    */
    private final androidx.compose.foundation.lazy.LazyListBeyondBoundsInfo.Interval m613addNextIntervalFR3nfPY(androidx.compose.foundation.lazy.LazyListBeyondBoundsInfo.Interval r5, int r6) {
        /*
            r4 = this;
            int r0 = r5.getStart()
            int r5 = r5.getEnd()
            ...
            int r1 = r1.m4061getBeforehoxUOeE()
            boolean r1 = androidx.compose.ui.layout.BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(r6, r1)
            if (r1 == 0) goto L18
        L14:
            int r0 = r0 + (-1)
            goto L97
        L18:
            androidx.compose.ui.layout.BeyondBoundsLayout$LayoutDirection$Companion r1 = androidx.compose.ui.layout.BeyondBoundsLayout.LayoutDirection.Companion
            int r1 = r1.m4060getAfterhoxUOeE()
            boolean r1 = androidx.compose.ui.layout.BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(r6, r1)
            if (r1 == 0) goto L28
        L24:
            int r5 = r5 + 1
        ...
        L28:
            androidx.compose.ui.layout.BeyondBoundsLayout$LayoutDirection$Companion r1 = androidx.compose.ui.layout.BeyondBoundsLayout.LayoutDirection.Companion
            int r1 = r1.m4059getAbovehoxUOeE()
            boolean r1 = androidx.compose.ui.layout.BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(r6, r1)
            if (r1 == 0) goto L39
        ...
        L39:
            androidx.compose.ui.layout.BeyondBoundsLayout$LayoutDirection$Companion r1 = androidx.compose.ui.layout.BeyondBoundsLayout.LayoutDirection.Companion
            int r1 = r1.m4062getBelowhoxUOeE()
            boolean r1 = androidx.compose.ui.layout.BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(r6, r1)
            if (r1 == 0) goto L4a
            boolean r6 = r4.reverseLayout
            if (r6 == 0) goto L24
        ...
        L71:
            androidx.compose.ui.layout.BeyondBoundsLayout$LayoutDirection$Companion r1 = androidx.compose.ui.layout.BeyondBoundsLayout.LayoutDirection.Companion
            int r1 = r1.m4064getRighthoxUOeE()
            boolean r6 = androidx.compose.ui.layout.BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(r6, r1)
            if (r6 == 0) goto L9e
            androidx.compose.ui.unit.LayoutDirection r6 = r4.layoutDirection
            int[] r1 = androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal.WhenMappings.$EnumSwitchMapping$0
            int r6 = r6.ordinal()
        ...
        L9e:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal.m613addNextIntervalFR3nfPY(androidx.compose.foundation.lazy.LazyListBeyondBoundsInfo$Interval, int):androidx.compose.foundation.lazy.LazyListBeyondBoundsInfo$Interval");
    }
    ...
    public final boolean m614hasMoreContentFR3nfPY(LazyListBeyondBoundsInfo.Interval interval, int i) {
        if (m615isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        if (BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4061getBeforehoxUOeE())) {
            return hasMoreContent_FR3nfPY$hasMoreItemsBefore(interval);
        }
        if (BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4060getAfterhoxUOeE())) {
            return hasMoreContent_FR3nfPY$hasMoreItemsAfter(interval, this);
        }
        if (BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4059getAbovehoxUOeE())) {
        ...
        } else if (BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4062getBelowhoxUOeE())) {
        ...
        } else if (BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4063getLefthoxUOeE())) {
        ...
        } else if (!BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4064getRighthoxUOeE())) {
    ...
    private final boolean m615isOppositeToOrientation4vf7U8o(int i) {
        if (!(BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4059getAbovehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4062getBelowhoxUOeE()))) {
            if (!(BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4063getLefthoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4064getRighthoxUOeE()))) {
                if (!(BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4061getBeforehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m4055equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m4060getAfterhoxUOeE()))) {
                    LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
                    throw new KotlinNothingValueException();
                }
