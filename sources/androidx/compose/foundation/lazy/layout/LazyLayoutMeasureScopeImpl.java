...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public int mo295roundToPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo295roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo296roundToPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo296roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo301toPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo301toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo302toPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo302toPx0680j_4(f);
    }
    ...
    public List<Placeable> mo618measure0kLqBqw(int i, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(subcompose.get(i2).mo4075measureBRTryo0(j));
        }
    ...
    public float mo297toDpGaN1DYA(long j) {
        return this.subcomposeMeasureScope.mo297toDpGaN1DYA(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo299toDpu2uoSUM(int i) {
        return this.subcomposeMeasureScope.mo299toDpu2uoSUM(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo298toDpu2uoSUM(float f) {
        return this.subcomposeMeasureScope.mo298toDpu2uoSUM(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo305toSpkPz2Gy4(float f) {
        return this.subcomposeMeasureScope.mo305toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo306toSpkPz2Gy4(int i) {
        return this.subcomposeMeasureScope.mo306toSpkPz2Gy4(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-0xMU5do */
    public long mo304toSp0xMU5do(float f) {
        return this.subcomposeMeasureScope.mo304toSp0xMU5do(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSize-XkaWNTQ */
    public long mo303toSizeXkaWNTQ(long j) {
        return this.subcomposeMeasureScope.mo303toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo300toDpSizekrfVVM(long j) {
        return this.subcomposeMeasureScope.mo300toDpSizekrfVVM(j);
    }
}
