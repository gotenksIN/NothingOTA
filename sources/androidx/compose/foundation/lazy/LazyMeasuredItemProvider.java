...
public final class LazyMeasuredItemProvider {
    ...
    private LazyMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope, MeasuredItemFactory measuredItemFactory) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m5006getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m5005getMaxHeightimpl(j), 5, null);
    }

    /* renamed from: getChildConstraints-msEJaDk  reason: not valid java name */
    public final long m537getChildConstraintsmsEJaDk() {
        return this.childConstraints;
    }

    /* renamed from: getAndMeasure-ZjPyQlc  reason: not valid java name */
    public final LazyMeasuredItem m536getAndMeasureZjPyQlc(int i) {
        return this.measuredItemFactory.mo522createItemHK0c1C0(i, this.itemProvider.getKey(i), this.measureScope.mo618measure0kLqBqw(i, this.childConstraints));
    }
