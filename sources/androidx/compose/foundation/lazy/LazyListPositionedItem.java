...
public final class LazyListPositionedItem implements LazyListItemInfo {
    ...
    public final long m529getOffsetBjo55l4(int i) {
        return this.wrappers.get(i).m527getOffsetnOccac();
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (getAnimationSpec(i) != null) {
                m529getOffsetBjo55l4 = this.placementAnimator.m520getAnimatedOffsetYT5a7pE(getKey(), i, mainAxisSize, i2, m529getOffsetBjo55l4(i));
            } else {
                m529getOffsetBjo55l4 = m529getOffsetBjo55l4(i);
            }
            if (this.reverseLayout) {
                int m5168getXimpl = this.isVertical ? IntOffset.m5168getXimpl(m529getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m5168getXimpl(m529getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m5169getYimpl = (this.mainAxisLayoutSize - IntOffset.m5169getYimpl(m529getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m5169getYimpl = IntOffset.m5169getYimpl(m529getOffsetBjo55l4);
                }
                m529getOffsetBjo55l4 = IntOffsetKt.IntOffset(m5168getXimpl, m5169getYimpl);
            }
            if (this.isVertical) {
                long j = this.visualOffset;
                Placeable.PlacementScope.m4126placeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(m529getOffsetBjo55l4) + IntOffset.m5168getXimpl(j), IntOffset.m5169getYimpl(m529getOffsetBjo55l4) + IntOffset.m5169getYimpl(j)), 0.0f, null, 6, null);
            } else {
                long j2 = this.visualOffset;
                Placeable.PlacementScope.m4125placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(m529getOffsetBjo55l4) + IntOffset.m5168getXimpl(j2), IntOffset.m5169getYimpl(m529getOffsetBjo55l4) + IntOffset.m5169getYimpl(j2)), 0.0f, null, 6, null);
            }
        }
    }
    ...
    private final long m528copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
