...
public final class LazyListMeasure {
    ...
    */
    ...
    private static final void createItemsAfterList$addItem(Ref.ObjectRef<List<LazyMeasuredItem>> objectRef, LazyMeasuredItemProvider lazyMeasuredItemProvider, int i) {
        ...
        list.add(lazyMeasuredItemProvider.m837getAndMeasureZjPyQlc(DataIndex.m805constructorimpl(i)));
    }
    ...
    private static final List<LazyMeasuredItem> m826createItemsBeforeListtv8sHfA(LazyListBeyondBoundsInfo lazyListBeyondBoundsInfo, int i, LazyMeasuredItemProvider lazyMeasuredItemProvider, LazyListItemProvider lazyListItemProvider, int i2, int i3, LazyLayoutPinnedItemList lazyLayoutPinnedItemList) {
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
