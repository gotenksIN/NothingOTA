...
public final class ClipScrollableContainerKt {
    private static final float MaxSupportedElevation = Dp.m5050constructorimpl(30);
    private static final Modifier HorizontalScrollableClipModifier = ClipKt.clip(Modifier.Companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
        ...
        public Outline mo194createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            Intrinsics.checkNotNullParameter(density, "density");
            float mo296roundToPx0680j_4 = density.mo296roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(0.0f, -mo296roundToPx0680j_4, Size.m2387getWidthimpl(j), Size.m2384getHeightimpl(j) + mo296roundToPx0680j_4));
        }
    });
    private static final Modifier VerticalScrollableClipModifier = ClipKt.clip(Modifier.Companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
        ...
        public Outline mo194createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
            ...
            Intrinsics.checkNotNullParameter(density, "density");
            float mo296roundToPx0680j_4 = density.mo296roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(-mo296roundToPx0680j_4, 0.0f, Size.m2387getWidthimpl(j) + mo296roundToPx0680j_4, Size.m2384getHeightimpl(j)));
        }
    });
