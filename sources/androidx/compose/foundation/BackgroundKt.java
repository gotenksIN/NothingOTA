...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m152backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m151backgroundbw27NRU(modifier, j, shape);
    }

    /* renamed from: background-bw27NRU */
    public static final Modifier m151backgroundbw27NRU(Modifier background, final long j, final Shape shape) {
        Intrinsics.checkNotNullParameter(background, "$this$background");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return background.then(new Background(Color.m2546boximpl(j), null, 0.0f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.setValue(Color.m2546boximpl(j));
                inspectorInfo.getProperties().set("color", Color.m2546boximpl(j));
