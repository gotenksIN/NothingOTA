...
public final class OverscrollConfiguration {
    ...
    public /* synthetic */ OverscrollConfiguration(long j, PaddingValues paddingValues, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4284900966L) : j, (i & 2) != 0 ? PaddingKt.m410PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, null) : paddingValues, null);
    }

    /* renamed from: getGlowColor-0d7_KjU  reason: not valid java name */
    public final long m215getGlowColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(getClass(), obj != null ? obj.getClass() : null)) {
            ...
            return Color.m2557equalsimpl0(this.glowColor, overscrollConfiguration.glowColor) && Intrinsics.areEqual(this.drawPadding, overscrollConfiguration.drawPadding);
        }
        return false;
    }

    public int hashCode() {
        return (Color.m2563hashCodeimpl(this.glowColor) * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + ((Object) Color.m2564toStringimpl(this.glowColor)) + ", drawPadding=" + this.drawPadding + ')';
    }
}
