...
public final class Clickable_androidKt {
    ...
    public static final boolean m193isPressZmokQxo(KeyEvent isPress) {
        Intrinsics.checkNotNullParameter(isPress, "$this$isPress");
        return KeyEventType.m3817equalsimpl0(KeyEvent_androidKt.m3825getTypeZmokQxo(isPress), KeyEventType.Companion.m3821getKeyDownCS__XNY()) && m192isEnterZmokQxo(isPress);
    }

    /* renamed from: isClick-ZmokQxo  reason: not valid java name */
    public static final boolean m191isClickZmokQxo(KeyEvent isClick) {
        Intrinsics.checkNotNullParameter(isClick, "$this$isClick");
        return KeyEventType.m3817equalsimpl0(KeyEvent_androidKt.m3825getTypeZmokQxo(isClick), KeyEventType.Companion.m3822getKeyUpCS__XNY()) && m192isEnterZmokQxo(isClick);
    }

    /* renamed from: isEnter-ZmokQxo  reason: not valid java name */
    private static final boolean m192isEnterZmokQxo(KeyEvent keyEvent) {
        int m3833getNativeKeyCodeYVgTNJs = Key_androidKt.m3833getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m3824getKeyZmokQxo(keyEvent));
        return m3833getNativeKeyCodeYVgTNJs == 23 || m3833getNativeKeyCodeYVgTNJs == 66 || m3833getNativeKeyCodeYVgTNJs == 160;
    }
}
