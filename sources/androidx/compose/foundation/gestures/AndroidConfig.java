...
public final class AndroidConfig implements ScrollConfig {
    ...
    public long mo218calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long j) {
        Intrinsics.checkNotNullParameter(calculateMouseWheelScroll, "$this$calculateMouseWheelScroll");
        Intrinsics.checkNotNullParameter(event, "event");
        List<PointerInputChange> changes = event.getChanges();
        Offset m2307boximpl = Offset.m2307boximpl(Offset.Companion.m2334getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            m2307boximpl = Offset.m2307boximpl(Offset.m2323plusMKHz9U(m2307boximpl.m2328unboximpl(), changes.get(i).m3959getScrollDeltaF1C5BW0()));
        }
        return Offset.m2325timestuRUvjQ(m2307boximpl.m2328unboximpl(), -calculateMouseWheelScroll.mo302toPx0680j_4(Dp.m5050constructorimpl(64)));
    }
}
