...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        while (i4 < size2) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long m2322minusMKHz9U = Offset.m2322minusMKHz9U(pointerInputChange2.m3958getPreviousPositionF1C5BW0(), calculateCentroid2);
                long m2322minusMKHz9U2 = Offset.m2322minusMKHz9U(m3957getPositionF1C5BW0, calculateCentroid);
                float m327anglek4lQ0M = m327anglek4lQ0M(m2322minusMKHz9U2) - m327anglek4lQ0M(m2322minusMKHz9U);
                float m2316getDistanceimpl = Offset.m2316getDistanceimpl(Offset.m2323plusMKHz9U(m2322minusMKHz9U2, m2322minusMKHz9U)) / 2.0f;
                if (m327anglek4lQ0M > 180.0f) {
                    m327anglek4lQ0M -= 360.0f;
                } else if (m327anglek4lQ0M < -180.0f) {
                    m327anglek4lQ0M += 360.0f;
                }
                f3 += m327anglek4lQ0M * m2316getDistanceimpl;
                f2 += m2316getDistanceimpl;
            }
            i4++;
            f = 0.0f;
        }
    ...
    private static final float m327anglek4lQ0M(long j) {
        if (Offset.m2318getXimpl(j) == 0.0f) {
            if (Offset.m2319getYimpl(j) == 0.0f) {
                return 0.0f;
            }
        }
        return ((-((float) Math.atan2(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long calculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m2315equalsimpl0(calculateCentroid, Offset.Companion.m2333getUnspecifiedF1C5BW0())) {
            return Offset.Companion.m2334getZeroF1C5BW0();
        }
        return Offset.m2322minusMKHz9U(calculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                f += Offset.m2316getDistanceimpl(Offset.m2322minusMKHz9U(z ? pointerInputChange.m3957getPositionF1C5BW0() : pointerInputChange.m3958getPreviousPositionF1C5BW0(), calculateCentroid));
                i++;
            }
        }
        return f / i;
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long m2334getZeroF1C5BW0 = Offset.Companion.m2334getZeroF1C5BW0();
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        int i = 0;
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                m2334getZeroF1C5BW0 = Offset.m2323plusMKHz9U(m2334getZeroF1C5BW0, z ? pointerInputChange.m3957getPositionF1C5BW0() : pointerInputChange.m3958getPreviousPositionF1C5BW0());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m2313divtuRUvjQ(m2334getZeroF1C5BW0, i);
    }
}
