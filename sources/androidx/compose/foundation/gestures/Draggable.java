...
/* renamed from: androidx.compose.foundation.gestures.DefaultDraggableState */
/* loaded from: classes.dex */
public final class Draggable implements DraggableState {
    private final DragScope dragScope;
    private final Function1<Float, Unit> onDelta;
    private final MutatorMutex scrollMutex;

    /* JADX WARN: Multi-variable type inference failed */
    public Draggable(Function1<? super Float, Unit> onDelta) {
        ...
        this.dragScope = new DragScope() { // from class: androidx.compose.foundation.gestures.DefaultDraggableState$dragScope$1
            ...
            public void dragBy(float f) {
                Draggable.this.getOnDelta().invoke(Float.valueOf(f));
            }
        };
