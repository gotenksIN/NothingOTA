...
public final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dragBy(float f) {
        ...
        value.m311dispatchScroll3eAAhYA(this.latestScrollScope, value.m320toOffsettuRUvjQ(f), NestedScrollSource.Companion.m3856getDragWNlRxjI());
    }
    ...
    public void dispatchRawDelta(float f) {
        ScrollingLogic value = this.scrollLogic.getValue();
        value.m314performRawScrollMKHz9U(value.m320toOffsettuRUvjQ(f));
    }
}
