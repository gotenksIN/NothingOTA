...
public interface TransformScope {
    ...
    void mo226transformByd4ec7I(float f, long j, float f2);
    ...
    static /* synthetic */ void m328transformByd4ec7I$default(TransformScope transformScope, float f, long j, float f2, int i, Object obj) {
        if (obj != null) {
        ...
        transformScope.mo226transformByd4ec7I(f, j, f2);
    }
}
