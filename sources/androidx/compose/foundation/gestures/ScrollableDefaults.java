...
public final class ScrollableDefaults {
    ...
    public final FlingBehavior flingBehavior(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1107739818, i, -1, "androidx.compose.foundation.gestures.ScrollableDefaults.flingBehavior (Scrollable.kt:187)");
        }
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new Scrollable(rememberSplineBasedDecay, null, 2, null);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        Scrollable scrollable = (Scrollable) rememberedValue;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final OverscrollEffect overscrollEffect(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1809802212, i, -1, "androidx.compose.foundation.gestures.ScrollableDefaults.overscrollEffect (Scrollable.kt:200)");
        }
