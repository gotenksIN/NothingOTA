...
@DebugMetadata(m31c = "androidx.compose.foundation.gestures.TransformableStateKt$animateRotateBy$2", m30f = "TransformableState.kt", m29i = {}, m28l = {158}, m27m = "invokeSuspend", m26n = {}, m25s = {})
...
final class TransformableStateKt$animateRotateBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (SuspendAnimation.animateTo$default(AnimationState$default, boxFloat, animationSpec, false, new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animateRotateBy$2.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(AnimationScope<Float, AnimationVector1D> animateTo) {
                    ...
                    TransformScope.m629transformByd4ec7I$default(transformScope, 0.0f, 0L, animateTo.getValue().floatValue() - Ref.FloatRef.this.element, 3, null);
