...
public final class ContentInViewModifier implements BringIntoViewResponder, OnRemeasuredModifier, OnPlacedModifier {
    ...
    public ContentInViewModifier(CoroutineScope scope, Orientation orientation, ScrollableState scrollState, boolean z) {
        ...
        this.viewportSize = IntSize.Companion.m5215getZeroYbymL2g();
    ...
    public Rect calculateRectForParent(Rect localRect) {
        ...
        if (!(!IntSize.m5208equalsimpl0(this.viewportSize, IntSize.Companion.m5215getZeroYbymL2g()))) {
            throw new IllegalStateException("Expected BringIntoViewRequester to not be used before parents are placed.".toString());
        }
        return m221computeDestinationO0kMr_c(localRect, this.viewportSize);
    }
    ...
    public Object bringChildIntoView(Function0<Rect> function0, Continuation<? super Unit> continuation) {
        ...
        boolean z = false;
        if (invoke != null && !m223isMaxVisibleO0kMr_c$default(this, invoke, 0L, 1, null)) {
            z = true;
        }
        if (z) {
    ...
    public void mo225onRemeasuredozmzZPI(long j) {
        Rect focusedChildBounds;
        long j2 = this.viewportSize;
        this.viewportSize = j;
        if (m219compareToTemP2vQ(j, j2) < 0 && (focusedChildBounds = getFocusedChildBounds()) != null) {
            Rect rect = this.focusedChildBoundsFromPreviousRemeasure;
            if (rect == null) {
                rect = focusedChildBounds;
            }
            if (!this.isAnimationRunning && !this.trackingFocusedChild && m222isMaxVisibleO0kMr_c(rect, j2) && !m222isMaxVisibleO0kMr_c(focusedChildBounds, j)) {
    ...
    public final float calculateScrollDelta() {
        ...
        long m5220toSizeozmzZPI = IntSizeKt.m5220toSizeozmzZPI(this.viewportSize);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return relocationDistance(findBringIntoViewRequest.getLeft(), findBringIntoViewRequest.getRight(), Size.m2387getWidthimpl(m5220toSizeozmzZPI));
            }
            throw new NoWhenBranchMatchedException();
        }
        return relocationDistance(findBringIntoViewRequest.getTop(), findBringIntoViewRequest.getBottom(), Size.m2384getHeightimpl(m5220toSizeozmzZPI));
    }
    ...
    private final Rect findBringIntoViewRequest() {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (invoke != null) {
                    if (m220compareToiLBOSCw(invoke.m2351getSizeNHjbRc(), IntSizeKt.m5220toSizeozmzZPI(this.viewportSize)) > 0) {
                        return rect;
                    }
                    rect = invoke;
                }
    ...
    private final Rect m221computeDestinationO0kMr_c(Rect rect, long j) {
        return rect.m2355translatek4lQ0M(Offset.m2327unaryMinusF1C5BW0(m224relocationOffsetBMxPBkI(rect, j)));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: isMaxVisible-O0kMr_c$default  reason: not valid java name */
    public static /* synthetic */ boolean m223isMaxVisibleO0kMr_c$default(ContentInViewModifier contentInViewModifier, Rect rect, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = contentInViewModifier.viewportSize;
        }
        return contentInViewModifier.m222isMaxVisibleO0kMr_c(rect, j);
    }

    /* renamed from: isMaxVisible-O0kMr_c  reason: not valid java name */
    private final boolean m222isMaxVisibleO0kMr_c(Rect rect, long j) {
        return Offset.m2315equalsimpl0(m224relocationOffsetBMxPBkI(rect, j), Offset.Companion.m2334getZeroF1C5BW0());
    }

    /* renamed from: relocationOffset-BMxPBkI  reason: not valid java name */
    private final long m224relocationOffsetBMxPBkI(Rect rect, long j) {
        long m5220toSizeozmzZPI = IntSizeKt.m5220toSizeozmzZPI(j);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return OffsetKt.Offset(relocationDistance(rect.getLeft(), rect.getRight(), Size.m2387getWidthimpl(m5220toSizeozmzZPI)), 0.0f);
            }
            throw new NoWhenBranchMatchedException();
        }
        return OffsetKt.Offset(0.0f, relocationDistance(rect.getTop(), rect.getBottom(), Size.m2384getHeightimpl(m5220toSizeozmzZPI)));
    }
    ...
    private final int m219compareToTemP2vQ(long j, long j2) {
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return Intrinsics.compare(IntSize.m5210getWidthimpl(j), IntSize.m5210getWidthimpl(j2));
            }
            throw new NoWhenBranchMatchedException();
        }
        return Intrinsics.compare(IntSize.m5209getHeightimpl(j), IntSize.m5209getHeightimpl(j2));
    }

    /* renamed from: compareTo-iLBOSCw  reason: not valid java name */
    private final int m220compareToiLBOSCw(long j, long j2) {
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return Float.compare(Size.m2387getWidthimpl(j), Size.m2387getWidthimpl(j2));
            }
            throw new NoWhenBranchMatchedException();
        }
        return Float.compare(Size.m2384getHeightimpl(j), Size.m2384getHeightimpl(j2));
    }
