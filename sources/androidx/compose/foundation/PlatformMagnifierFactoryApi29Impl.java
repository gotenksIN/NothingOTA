...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl create(MagnifierStyle style, View view, Density density, float f) {
        ...
        long mo303toSizeXkaWNTQ = density.mo303toSizeXkaWNTQ(style.m201getSizeMYxV2XQ$foundation_release());
        float mo302toPx0680j_4 = density.mo302toPx0680j_4(style.m199getCornerRadiusD9Ej5fM$foundation_release());
        float mo302toPx0680j_42 = density.mo302toPx0680j_4(style.m200getElevationD9Ej5fM$foundation_release());
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (mo303toSizeXkaWNTQ != Size.Companion.m2395getUnspecifiedNHjbRc()) {
            builder.setSize(MathKt.roundToInt(Size.m2387getWidthimpl(mo303toSizeXkaWNTQ)), MathKt.roundToInt(Size.m2384getHeightimpl(mo303toSizeXkaWNTQ)));
        }
        if (!Float.isNaN(mo302toPx0680j_4)) {
            builder.setCornerRadius(mo302toPx0680j_4);
        }
        if (!Float.isNaN(mo302toPx0680j_42)) {
            builder.setElevation(mo302toPx0680j_42);
        }
        if (!Float.isNaN(f)) {
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo217updateWko1d7g(long j, long j2, float f) {
            if (!Float.isNaN(f)) {
                getMagnifier().setZoom(f);
            }
            if (OffsetKt.m2337isSpecifiedk4lQ0M(j2)) {
                getMagnifier().show(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j), Offset.m2318getXimpl(j2), Offset.m2319getYimpl(j2));
            } else {
                getMagnifier().show(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j));
            }
        }
    }
}
