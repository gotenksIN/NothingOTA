...
public final class InsetsPaddingModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo326measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo4376measureBRTryo0 = measurable.mo4376measureBRTryo0(ConstraintsKt.m5323offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.layout$default(measure, ConstraintsKt.m5321constrainWidthK40F9xA(j, mo4376measureBRTryo0.getWidth() + right), ConstraintsKt.m5320constrainHeightK40F9xA(j, mo4376measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
