...
public final class SizeKt {
    ...
    public static final Modifier m463width3ABfNKs(Modifier width, final float f) {
    ...
    public static final Modifier m444height3ABfNKs(Modifier height, final float f) {
    ...
    public static final Modifier m459size6HolHcs(Modifier size, long j) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return m460sizeVpY3zN4(size, DpSize.m5148getWidthD9Ej5fM(j), DpSize.m5146getHeightD9Ej5fM(j));
    }

    /* renamed from: widthIn-VpY3zN4$default */
    public static /* synthetic */ Modifier m465widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
            f2 = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        return m464widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4 */
    public static final Modifier m464widthInVpY3zN4(Modifier widthIn, final float f, final float f2) {
        ...
        return widthIn.then(new SizeModifier(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m5048boximpl(f));
                inspectorInfo.getProperties().set("max", Dp.m5048boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: heightIn-VpY3zN4$default */
    public static /* synthetic */ Modifier m446heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m445heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4 */
    public static final Modifier m445heightInVpY3zN4(Modifier heightIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m462sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        return m461sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0 */
    public static final Modifier m461sizeInqDBjuR0(Modifier sizeIn, final float f, final float f2, final float f3, final float f4) {
        ...
        return sizeIn.then(new SizeModifier(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m5048boximpl(f));
                inspectorInfo.getProperties().set("minHeight", Dp.m5048boximpl(f2));
                inspectorInfo.getProperties().set("maxWidth", Dp.m5048boximpl(f3));
                inspectorInfo.getProperties().set("maxHeight", Dp.m5048boximpl(f4));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs */
    public static final Modifier m455requiredWidth3ABfNKs(Modifier requiredWidth, final float f) {
    ...
    public static final Modifier m447requiredHeight3ABfNKs(Modifier requiredHeight, final float f) {
    ...
    public static final Modifier m451requiredSize6HolHcs(Modifier requiredSize, long j) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
        return m452requiredSizeVpY3zN4(requiredSize, DpSize.m5148getWidthD9Ej5fM(j), DpSize.m5146getHeightD9Ej5fM(j));
    }

    /* renamed from: requiredWidthIn-VpY3zN4$default */
    public static /* synthetic */ Modifier m457requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m456requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4 */
    public static final Modifier m456requiredWidthInVpY3zN4(Modifier requiredWidthIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m449requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m448requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4 */
    public static final Modifier m448requiredHeightInVpY3zN4(Modifier requiredHeightIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m454requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m453requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0 */
    public static final Modifier m453requiredSizeInqDBjuR0(Modifier requiredSizeIn, final float f, final float f2, final float f3, final float f4) {
    ...
    public static /* synthetic */ Modifier m443defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.Companion.m5070getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m442defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4 */
    public static final Modifier m442defaultMinSizeVpY3zN4(Modifier defaultMinSize, final float f, final float f2) {
    ...
    private static final WrapContentModifier createWrapContentWidthModifier(final Alignment.Horizontal horizontal, final boolean z) {
        return new WrapContentModifier(Direction.Horizontal, z, new Function2<IntSize, LayoutDirection, IntOffset>() { // from class: androidx.compose.foundation.layout.SizeKt$createWrapContentWidthModifier$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
                return IntOffset.m5159boximpl(m468invoke5SAbXVA(intSize.m5214unboximpl(), layoutDirection));
            }

            /* renamed from: invoke-5SAbXVA  reason: not valid java name */
            public final long m468invoke5SAbXVA(long j, LayoutDirection layoutDirection) {
                Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
                return IntOffsetKt.IntOffset(Alignment.Horizontal.this.align(0, IntSize.m5210getWidthimpl(j), layoutDirection), 0);
            }
    ...
    private static final WrapContentModifier createWrapContentHeightModifier(final Alignment.Vertical vertical, final boolean z) {
        return new WrapContentModifier(Direction.Vertical, z, new Function2<IntSize, LayoutDirection, IntOffset>() { // from class: androidx.compose.foundation.layout.SizeKt$createWrapContentHeightModifier$1
            ...
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
                return IntOffset.m5159boximpl(m466invoke5SAbXVA(intSize.m5214unboximpl(), layoutDirection));
            }

            /* renamed from: invoke-5SAbXVA  reason: not valid java name */
            public final long m466invoke5SAbXVA(long j, LayoutDirection layoutDirection) {
                Intrinsics.checkNotNullParameter(layoutDirection, "<anonymous parameter 1>");
                return IntOffsetKt.IntOffset(0, Alignment.Vertical.this.align(0, IntSize.m5209getHeightimpl(j)));
            }
    ...
    private static final WrapContentModifier createWrapContentSizeModifier(final Alignment alignment, final boolean z) {
        return new WrapContentModifier(Direction.Both, z, new Function2<IntSize, LayoutDirection, IntOffset>() { // from class: androidx.compose.foundation.layout.SizeKt$createWrapContentSizeModifier$1
            ...
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
                return IntOffset.m5159boximpl(m467invoke5SAbXVA(intSize.m5214unboximpl(), layoutDirection));
            }

            /* renamed from: invoke-5SAbXVA  reason: not valid java name */
            public final long m467invoke5SAbXVA(long j, LayoutDirection layoutDirection) {
                Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
                return Alignment.this.mo2212alignKFBX0sM(IntSize.Companion.m5215getZeroYbymL2g(), j, layoutDirection);
            }
    ...
    public static final Modifier m458size3ABfNKs(Modifier size, final float f) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
    ...
    public static final Modifier m460sizeVpY3zN4(Modifier size, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return size.then(new SizeModifier(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("height", Dp.m5048boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredSize-3ABfNKs */
    public static final Modifier m450requiredSize3ABfNKs(Modifier requiredSize, final float f) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
    ...
    public static final Modifier m452requiredSizeVpY3zN4(Modifier requiredSize, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
