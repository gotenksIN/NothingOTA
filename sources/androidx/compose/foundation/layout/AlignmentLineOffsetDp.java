...
final class AlignmentLineOffsetDp extends InspectorValueInfo implements LayoutModifier {
    ...
    public final float m346getBeforeD9Ej5fM() {
        return this.before;
    }

    /* renamed from: getAfter-D9Ej5fM  reason: not valid java name */
    public final float m345getAfterD9Ej5fM() {
        return this.after;
    }
    ...
    private AlignmentLineOffsetDp(AlignmentLine alignmentLine, float f, float f2, Function1<? super InspectorInfo, Unit> function1) {
        ...
        this.before = f;
        this.after = f2;
        if (!((f >= 0.0f || Dp.m5055equalsimpl0(f, Dp.Companion.m5070getUnspecifiedD9Ej5fM())) && (f2 >= 0.0f || Dp.m5055equalsimpl0(f2, Dp.Companion.m5070getUnspecifiedD9Ej5fM())))) {
    ...
    public MeasureResult mo25measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return AlignmentLineKt.m335access$alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, j);
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m5056hashCodeimpl(this.before)) * 31) + Dp.m5056hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDp.alignmentLine) && Dp.m5055equalsimpl0(this.before, alignmentLineOffsetDp.before) && Dp.m5055equalsimpl0(this.after, alignmentLineOffsetDp.after);
    }

    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) Dp.m5061toStringimpl(this.before)) + ", after=" + ((Object) Dp.m5061toStringimpl(this.after)) + ')';
    }
}
