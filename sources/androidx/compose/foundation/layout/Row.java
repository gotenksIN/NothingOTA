...
public final class Row {
    ...
    public static final void Row(Modifier modifier, Arrangement.Horizontal horizontal, Alignment.Vertical vertical, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i, int i2) {
        ...
        int i3 = i >> 3;
        MeasurePolicy rowMeasurePolicy = rowMeasurePolicy(horizontal, vertical, composer, (i3 & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i3 & 14));
        ...
        content.invoke(RowScopeInstance.INSTANCE, composer, Integer.valueOf(((i >> 6) & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 6));
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    static {
        ...
        float mo666getSpacingD9Ej5fM = Arrangement.INSTANCE.getStart().mo666getSpacingD9Ej5fM();
        ...
        DefaultRowMeasurePolicy = RowColumnImplKt.m737rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.RowKt$DefaultRowMeasurePolicy$1
        ...
        }, mo666getSpacingD9Ej5fM, SizeMode.Wrap, vertical$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy rowMeasurePolicy(final Arrangement.Horizontal horizontalArrangement, Alignment.Vertical verticalAlignment, Composer composer, int i) {
        ...
        if (Intrinsics.areEqual(horizontalArrangement, Arrangement.INSTANCE.getStart()) && Intrinsics.areEqual(verticalAlignment, Alignment.Companion.getTop())) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Horizontal;
                float mo666getSpacingD9Ej5fM = horizontalArrangement.mo666getSpacingD9Ej5fM();
                ...
                rememberedValue = RowColumnImplKt.m737rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.RowKt$rowMeasurePolicy$1$1
