    ...
    */
    ...
    private static final MeasurePolicy rowMeasurementHelper(Arrangement.Horizontal horizontal, Alignment.Vertical vertical, int i, Composer composer, int i2, int i3) {
        ...
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = m394flowMeasurePolicy942rkJo(LayoutOrientation.Horizontal, mainAxisRowArrangement, horizontal.mo365getSpacingD9Ej5fM(), SizeMode.Wrap, crossAxisAlignment, crossAxisRowArrangement, i);
    ...
    private static final MeasurePolicy columnMeasurementHelper(Arrangement.Vertical vertical, Alignment.Horizontal horizontal, int i, Composer composer, int i2, int i3) {
        ...
        Object rememberedValue2 = composer.rememberedValue();
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = m394flowMeasurePolicy942rkJo(LayoutOrientation.Vertical, mainAxisColumnArrangement, vertical.mo365getSpacingD9Ej5fM(), SizeMode.Wrap, crossAxisAlignment, crossAxisColumnArrangement, i);
            composer.updateRememberedValue(rememberedValue2);
        }
        composer.endReplaceableGroup();
        MeasurePolicy measurePolicy = (MeasurePolicy) rememberedValue2;
    ...
    private static final MeasurePolicy m394flowMeasurePolicy942rkJo(final LayoutOrientation layoutOrientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, final float f, final SizeMode sizeMode, final CrossAxisAlignment crossAxisAlignment, final Function4<? super Integer, ? super int[], ? super MeasureScope, ? super int[], Unit> function4, final int i) {
        return new MeasurePolicy(function5, f, sizeMode, crossAxisAlignment, i, function4) { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1
            ...
            public MeasureResult mo12measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                final FlowResult breakDownItems = FlowLayoutKt.breakDownItems(measure, rowColumnMeasurementHelper, LayoutOrientation.this, new OrientationIndependentConstraints(j, LayoutOrientation.this, null), this.$maxItemsInMainAxis);
                ...
                return MeasureScope.layout$default(measure, ConstraintsKt.m5020constrainWidthK40F9xA(j, crossAxisTotalSize), ConstraintsKt.m5019constrainHeightK40F9xA(j, mainAxisTotalSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1$measure$1
                    /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i2) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (LayoutOrientation.this == LayoutOrientation.Horizontal) {
                    return minIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo296roundToPx0680j_4(this.$arrangementSpacing));
                }
                return intrinsicCrossAxisSize(measurables, i2, intrinsicMeasureScope.mo296roundToPx0680j_4(this.$arrangementSpacing));
            }
            ...
            public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i2) {
                ...
                return maxIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo296roundToPx0680j_4(this.$arrangementSpacing));
            }
            ...
            public final int minIntrinsicMainAxisSize(List<? extends IntrinsicMeasurable> measurables, int i2, int i3) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                minIntrinsicMainAxisSize = FlowLayoutKt.minIntrinsicMainAxisSize(measurables, this.minMainAxisIntrinsicItemSize, this.minCrossAxisIntrinsicItemSize, i2, i3, this.$maxItemsInMainAxis);
            ...
            public final int intrinsicCrossAxisSize(List<? extends IntrinsicMeasurable> measurables, int i2, int i3) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                intrinsicCrossAxisSize = FlowLayoutKt.intrinsicCrossAxisSize(measurables, this.minMainAxisIntrinsicItemSize, this.minCrossAxisIntrinsicItemSize, i2, i3, this.$maxItemsInMainAxis);
    ...
    private static final int measureAndCache(Measurable measurable, OrientationIndependentConstraints orientationIndependentConstraints, LayoutOrientation layoutOrientation, Function1<? super Placeable, Unit> function1) {
        if (RowColumnImplKt.getWeight(RowColumnImplKt.getRowColumnParentData(measurable)) == 0.0f) {
            Placeable mo4075measureBRTryo0 = measurable.mo4075measureBRTryo0(OrientationIndependentConstraints.copy$default(orientationIndependentConstraints, 0, 0, 0, 0, 14, null).m407toBoxConstraintsOenEA2s(layoutOrientation));
            function1.invoke(mo4075measureBRTryo0);
            return mainAxisSize(mo4075measureBRTryo0, layoutOrientation);
        }
    ...
    public static final FlowResult breakDownItems(MeasureScope measureScope, RowColumnMeasurementHelper measureHelper, LayoutOrientation orientation, OrientationIndependentConstraints constraints, int i) {
        ...
        int ceil = (int) Math.ceil(measureScope.mo302toPx0680j_4(measureHelper.m437getArrangementSpacingD9Ej5fM()));
        ...
        long m407toBoxConstraintsOenEA2s = OrientationIndependentConstraints.copy$default(orientationIndependentConstraints, mainAxisMin, 0, 0, 0, 14, null).m407toBoxConstraintsOenEA2s(orientation);
        int i10 = 0;
        int i11 = 0;
        int i12 = 0;
        ...
        int i13 = mainAxisMin;
        while (num != null) {
            RowColumnMeasureHelperResult m438measureWithoutPlacing_EkL_Y = measureHelper.m438measureWithoutPlacing_EkL_Y(measureScope, m407toBoxConstraintsOenEA2s, i10, num.intValue());
            i11 += m438measureWithoutPlacing_EkL_Y.getCrossAxisSize();
            i13 = Math.max(i13, m438measureWithoutPlacing_EkL_Y.getMainAxisSize());
            mutableVector.add(m438measureWithoutPlacing_EkL_Y);
            i10 = num.intValue();
            i12++;
