...
final class RequiredMaxIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long mo700calculateContentConstraintsl58MMJ0(MeasureScope calculateContentConstraints, Measurable measurable, long j) {
        ...
        return Constraints.Companion.m5317fixedWidthOenEA2s(measurable.maxIntrinsicWidth(Constraints.m5306getMaxHeightimpl(j)));
    }
