...
public final class OrientationIndependentConstraints {
    ...
    private OrientationIndependentConstraints(long j, LayoutOrientation layoutOrientation) {
        this(layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5008getMinWidthimpl(j) : Constraints.m5007getMinHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5006getMaxWidthimpl(j) : Constraints.m5005getMaxHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5007getMinHeightimpl(j) : Constraints.m5008getMinWidthimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5005getMaxHeightimpl(j) : Constraints.m5006getMaxWidthimpl(j));
    }
    ...
    public final long m407toBoxConstraintsOenEA2s(LayoutOrientation orientation) {
