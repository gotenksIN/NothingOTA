...
public final class OrientationIndependentConstraints {
    ...
    private OrientationIndependentConstraints(long j, LayoutOrientation layoutOrientation) {
        this(layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5309getMinWidthimpl(j) : Constraints.m5308getMinHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5307getMaxWidthimpl(j) : Constraints.m5306getMaxHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5308getMinHeightimpl(j) : Constraints.m5309getMinWidthimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5306getMaxHeightimpl(j) : Constraints.m5307getMaxWidthimpl(j));
    }
    ...
    public final long m708toBoxConstraintsOenEA2s(LayoutOrientation orientation) {
