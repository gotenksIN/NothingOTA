...
public final class WindowInsetsConnection_androidKt {
    ...
    /* renamed from: P1 */
    private static final float f37P1 = 0.175f;

    /* renamed from: P2 */
    private static final float f38P2 = 0.35000002f;
    ...
    public static final Modifier imeNestedScroll(Modifier modifier) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$imeNestedScroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Modifier nestedScroll$default = NestedScrollModifierKt.nestedScroll$default(composed, WindowInsetsConnection_androidKt.m773rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.Companion.current(composer, 8).getIme(), WindowInsetsSides.Companion.m795getBottomJoeWqyM(), composer, 48), null, 2, null);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final NestedScrollModifier m773rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int i, Composer composer, int i2) {
        ...
        SideCalculator m742chooseCalculatorni1skBw = SideCalculator.Companion.m742chooseCalculatorni1skBw(i, (LayoutDirection) consume);
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "C:CompositionLocal.kt#9igjgp");
        Object consume2 = composer.consume(AndroidCompositionLocals_androidKt.getLocalView());
        ComposerKt.sourceInformationMarkerEnd(composer);
        View view = (View) consume2;
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "C:CompositionLocal.kt#9igjgp");
        Object consume3 = composer.consume(CompositionLocals.getLocalDensity());
        ComposerKt.sourceInformationMarkerEnd(composer);
        Density density = (Density) consume3;
        Object[] objArr = {windowInsets, view, m742chooseCalculatorni1skBw, density};
        ...
        if (z || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new WindowInsetsNestedScrollConnection(windowInsets, view, m742chooseCalculatorni1skBw, density);
