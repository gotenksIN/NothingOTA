...
final class WindowInsetsSize extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    private final SnapshotState unconsumedInsets$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public WindowInsetsSize(WindowInsets insets, Function1<? super InspectorInfo, Unit> inspectorInfo, Function2<? super WindowInsets, ? super Density, Integer> heightCalc) {
        super(inspectorInfo);
    ...
    public MeasureResult mo326measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo4376measureBRTryo0 = measurable.mo4376measureBRTryo0(Constraints.m5298copyZbe2FdA$default(j, 0, 0, intValue, intValue, 3, null));
        return MeasureScope.layout$default(measure, mo4376measureBRTryo0.getWidth(), intValue, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WindowInsetsSize) {
            WindowInsetsSize windowInsetsSize = (WindowInsetsSize) obj;
            return Intrinsics.areEqual(this.insets, windowInsetsSize.insets) && Intrinsics.areEqual(this.heightCalc, windowInsetsSize.heightCalc);
        }
        return false;
    }
