...
public final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo310onPreScrollOzD1aCk(long j, int i) {
        return m478scroll8S9VItk(j, this.sideCalculator.hideMotion(Offset.m2318getXimpl(j), Offset.m2319getYimpl(j)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo309onPostScrollDzOQY0M(long j, long j2, int i) {
        return m478scroll8S9VItk(j2, this.sideCalculator.showMotion(Offset.m2318getXimpl(j2), Offset.m2319getYimpl(j2)));
    }

    /* renamed from: scroll-8S9VItk  reason: not valid java name */
    private final long m478scroll8S9VItk(long j, float f) {
        ...
        if (!(f == 0.0f)) {
            ...
            if (this.windowInsets.isVisible() != (i > 0) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo439consumedOffsetsMKHz9U(j);
                }
    ...
    public Object mo479onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m477flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m5275getXimpl(j), Velocity.m5276getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo308onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m477flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m5275getXimpl(j2), Velocity.m5276getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m477flinghuYlsQE(long r27, float r29, boolean r30, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r31) {
        /*
            Method dump skipped, instructions count: 421
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m477flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
