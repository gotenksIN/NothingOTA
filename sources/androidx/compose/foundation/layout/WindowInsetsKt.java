...
public final class WindowInsetsKt {
    ...
    public static final WindowInsets m475onlybOOhFvg(WindowInsets only, int i) {
    ...
    public static final WindowInsets m473WindowInsetsa9UjIt4(float f, float f2, float f3, float f4) {
        return new FixedDpInsets(f, f2, f3, f4, null);
    }

    /* renamed from: WindowInsets-a9UjIt4$default  reason: not valid java name */
    public static /* synthetic */ WindowInsets m474WindowInsetsa9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m473WindowInsetsa9UjIt4(f, f2, f3, f4);
    }
}
