...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo396calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return density.mo299toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float mo398calculateTopPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo299toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public float mo397calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density density = this.density;
        return density.mo299toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float mo395calculateBottomPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo299toDpu2uoSUM(this.insets.getBottom(density));
    }
