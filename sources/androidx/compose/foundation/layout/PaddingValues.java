...
public interface PaddingValues {
    ...
    float mo396calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM */
    float mo397calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateTopPadding-D9Ej5fM */
    float mo398calculateTopPaddingD9Ej5fM();
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m424getBottomD9Ej5fM$annotations() {
        }

        /* renamed from: getLeft-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m425getLeftD9Ej5fM$annotations() {
        }

        /* renamed from: getRight-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m426getRightD9Ej5fM$annotations() {
        }

        /* renamed from: getTop-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m427getTopD9Ej5fM$annotations() {
        }
        ...
        /* renamed from: calculateLeftPadding-u2uoSUM */
        public float mo396calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateTopPadding-D9Ej5fM */
        public float mo398calculateTopPaddingD9Ej5fM() {
            return this.top;
        }

        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateRightPadding-u2uoSUM */
        public float mo397calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.right;
        }
        ...
        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateBottomPadding-D9Ej5fM */
        public float mo395calculateBottomPaddingD9Ej5fM() {
            return this.bottom;
        }
        ...
        public boolean equals(Object obj) {
            if (obj instanceof Absolute) {
                ...
                return Dp.m5055equalsimpl0(this.left, absolute.left) && Dp.m5055equalsimpl0(this.top, absolute.top) && Dp.m5055equalsimpl0(this.right, absolute.right) && Dp.m5055equalsimpl0(this.bottom, absolute.bottom);
            }
            return false;
        }
        ...
        public String toString() {
            return "PaddingValues.Absolute(left=" + ((Object) Dp.m5061toStringimpl(this.left)) + ", top=" + ((Object) Dp.m5061toStringimpl(this.top)) + ", right=" + ((Object) Dp.m5061toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m5061toStringimpl(this.bottom)) + ')';
        }

        public /* synthetic */ Absolute(float f, float f2, float f3, float f4, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? Dp.m5050constructorimpl(0) : f, (i & 2) != 0 ? Dp.m5050constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m5050constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m5050constructorimpl(0) : f4, null);
        }
    }
}
