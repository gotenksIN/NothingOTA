...
final class OffsetPxModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo25measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, mo4075measureBRTryo0.getWidth(), mo4075measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                long m5177unboximpl = OffsetPxModifier.this.getOffset().invoke(measure).m5177unboximpl();
                if (OffsetPxModifier.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, mo4075measureBRTryo0, IntOffset.m5168getXimpl(m5177unboximpl), IntOffset.m5169getYimpl(m5177unboximpl), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(layout, mo4075measureBRTryo0, IntOffset.m5168getXimpl(m5177unboximpl), IntOffset.m5169getYimpl(m5177unboximpl), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }
