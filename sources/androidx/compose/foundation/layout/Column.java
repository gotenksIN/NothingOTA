...
public final class Column {
    ...
    public static final void Column(Modifier modifier, Arrangement.Vertical vertical, Alignment.Horizontal horizontal, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i, int i2) {
        ...
        int i3 = i >> 3;
        MeasurePolicy columnMeasurePolicy = columnMeasurePolicy(vertical, horizontal, composer, (i3 & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i3 & 14));
        ...
        content.invoke(ColumnScopeInstance.INSTANCE, composer, Integer.valueOf(((i >> 6) & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 6));
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    static {
        ...
        float mo666getSpacingD9Ej5fM = Arrangement.INSTANCE.getTop().mo666getSpacingD9Ej5fM();
        ...
        DefaultColumnMeasurePolicy = RowColumnImplKt.m737rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.ColumnKt$DefaultColumnMeasurePolicy$1
        ...
        }, mo666getSpacingD9Ej5fM, SizeMode.Wrap, horizontal$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy columnMeasurePolicy(final Arrangement.Vertical verticalArrangement, Alignment.Horizontal horizontalAlignment, Composer composer, int i) {
        ...
        if (Intrinsics.areEqual(verticalArrangement, Arrangement.INSTANCE.getTop()) && Intrinsics.areEqual(horizontalAlignment, Alignment.Companion.getStart())) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Vertical;
                float mo666getSpacingD9Ej5fM = verticalArrangement.mo666getSpacingD9Ej5fM();
                ...
                rememberedValue = RowColumnImplKt.m737rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.ColumnKt$columnMeasurePolicy$1$1
