...
public final class AlignmentLineOffsetTextUnit extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo25measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        MeasureResult m336alignmentLineOffsetMeasuretjqqzMA;
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        m336alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m336alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, !TextUnitKt.m5249isUnspecifiedR2X_6o(this.before) ? measure.mo297toDpGaN1DYA(this.before) : Dp.Companion.m5070getUnspecifiedD9Ej5fM(), !TextUnitKt.m5249isUnspecifiedR2X_6o(this.after) ? measure.mo297toDpGaN1DYA(this.after) : Dp.Companion.m5070getUnspecifiedD9Ej5fM(), measurable, j);
        return m336alignmentLineOffsetMeasuretjqqzMA;
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m5232hashCodeimpl(this.before)) * 31) + TextUnit.m5232hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnit.alignmentLine) && TextUnit.m5228equalsimpl0(this.before, alignmentLineOffsetTextUnit.before) && TextUnit.m5228equalsimpl0(this.after, alignmentLineOffsetTextUnit.after);
    }

    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) TextUnit.m5238toStringimpl(this.before)) + ", after=" + ((Object) TextUnit.m5238toStringimpl(this.after)) + ')';
    }
}
