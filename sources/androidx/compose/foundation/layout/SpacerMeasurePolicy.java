...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        return MeasureScope.layout$default(measure, Constraints.m5004getHasFixedWidthimpl(j) ? Constraints.m5006getMaxWidthimpl(j) : 0, Constraints.m5003getHasFixedHeightimpl(j) ? Constraints.m5005getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
