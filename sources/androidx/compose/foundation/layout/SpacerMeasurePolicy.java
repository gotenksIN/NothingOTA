...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo313measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        return MeasureScope.layout$default(measure, Constraints.m5305getHasFixedWidthimpl(j) ? Constraints.m5307getMaxWidthimpl(j) : 0, Constraints.m5304getHasFixedHeightimpl(j) ? Constraints.m5306getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
