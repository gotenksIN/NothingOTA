...
final class PaddingValuesInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.mo296roundToPx0680j_4(this.paddingValues.mo396calculateLeftPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo296roundToPx0680j_4(this.paddingValues.mo398calculateTopPaddingD9Ej5fM());
    }
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo296roundToPx0680j_4(this.paddingValues.mo397calculateRightPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo296roundToPx0680j_4(this.paddingValues.mo395calculateBottomPaddingD9Ej5fM());
    }

    public String toString() {
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        return "PaddingValues(" + ((Object) Dp.m5061toStringimpl(this.paddingValues.mo396calculateLeftPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m5061toStringimpl(this.paddingValues.mo398calculateTopPaddingD9Ej5fM())) + ", " + ((Object) Dp.m5061toStringimpl(this.paddingValues.mo397calculateRightPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m5061toStringimpl(this.paddingValues.mo395calculateBottomPaddingD9Ej5fM())) + ')';
    }
