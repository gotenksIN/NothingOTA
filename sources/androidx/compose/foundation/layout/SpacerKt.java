...
public final class SpacerKt {
    public static final void Spacer(Modifier modifier, Composer composer, int i) {
        ...
        int i2 = (((((i << 3) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 384) << 9) & 7168) | 6;
        ...
        Updater.m2202setimpl(m2195constructorimpl, spacerMeasurePolicy, ComposeUiNode.Companion.getSetMeasurePolicy());
        ...
        materializerOf.invoke(SkippableUpdater.m2186boximpl(SkippableUpdater.m2187constructorimpl(composer)), composer, Integer.valueOf((i2 >> 3) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle));
