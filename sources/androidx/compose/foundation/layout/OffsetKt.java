...
public final class OffsetKt {
    ...
    public static final Modifier m403offsetVpY3zN4(Modifier offset, final float f, final float f2) {
        ...
        return offset.then(new OffsetModifier(f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt$offset-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("x", Dp.m5048boximpl(f));
                inspectorInfo.getProperties().set("y", Dp.m5048boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: absoluteOffset-VpY3zN4 */
    public static final Modifier m401absoluteOffsetVpY3zN4(Modifier absoluteOffset, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m404offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m403offsetVpY3zN4(modifier, f, f2);
    }

    /* renamed from: absoluteOffset-VpY3zN4$default */
    public static /* synthetic */ Modifier m402absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5050constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m401absoluteOffsetVpY3zN4(modifier, f, f2);
    }
}
