...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo12measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> list, long j) {
            Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
            Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
            return MeasureScope.layout$default(MeasurePolicy, Constraints.m5008getMinWidthimpl(j), Constraints.m5007getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$measure$1
    ...
    public static final void Box(Modifier modifier, Alignment alignment, boolean z, Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i, int i2) {
        ...
        int i3 = i >> 3;
        MeasurePolicy rememberBoxMeasurePolicy = rememberBoxMeasurePolicy(alignment, z, composer, (i3 & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i3 & 14));
        ...
        content.invoke(BoxScopeInstance.INSTANCE, composer, Integer.valueOf(((i >> 6) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 6));
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean z) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1
            @Override // androidx.compose.ui.layout.MeasurePolicy
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo12measure3p2s80s(final MeasureScope MeasurePolicy, final List<? extends Measurable> measurables, long j) {
                ...
                if (measurables.isEmpty()) {
                    return MeasureScope.layout$default(MeasurePolicy, Constraints.m5008getMinWidthimpl(j), Constraints.m5007getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$1
                        /* renamed from: invoke  reason: avoid collision after fix types in other method */
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                        }
                ...
                long m4997copyZbe2FdA$default = z ? j : Constraints.m4997copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                if (measurables.size() == 1) {
                    final Measurable measurable = measurables.get(0);
                    matchesParentSize3 = BoxKt.getMatchesParentSize(measurable);
                    if (!matchesParentSize3) {
                        Placeable mo4075measureBRTryo02 = measurable.mo4075measureBRTryo0(m4997copyZbe2FdA$default);
                        int max = Math.max(Constraints.m5008getMinWidthimpl(j), mo4075measureBRTryo02.getWidth());
                        i = Math.max(Constraints.m5007getMinHeightimpl(j), mo4075measureBRTryo02.getHeight());
                        mo4075measureBRTryo0 = mo4075measureBRTryo02;
                        m5008getMinWidthimpl = max;
                    } else {
                        m5008getMinWidthimpl = Constraints.m5008getMinWidthimpl(j);
                        int m5007getMinHeightimpl = Constraints.m5007getMinHeightimpl(j);
                        mo4075measureBRTryo0 = measurable.mo4075measureBRTryo0(Constraints.Companion.m5014fixedJhjzzOo(Constraints.m5008getMinWidthimpl(j), Constraints.m5007getMinHeightimpl(j)));
                        i = m5007getMinHeightimpl;
                    }
                    final Alignment alignment2 = alignment;
                    final int i2 = m5008getMinWidthimpl;
                    final int i3 = i;
                    return MeasureScope.layout$default(MeasurePolicy, m5008getMinWidthimpl, i, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$2
                ...
                intRef.element = Constraints.m5008getMinWidthimpl(j);
                final Ref.IntRef intRef2 = new Ref.IntRef();
                intRef2.element = Constraints.m5007getMinHeightimpl(j);
                ...
                for (int i4 = 0; i4 < size; i4++) {
                    ...
                    if (matchesParentSize2) {
                        ...
                        Placeable mo4075measureBRTryo03 = measurable2.mo4075measureBRTryo0(m4997copyZbe2FdA$default);
                        placeableArr[i4] = mo4075measureBRTryo03;
                        intRef.element = Math.max(intRef.element, mo4075measureBRTryo03.getWidth());
                        intRef2.element = Math.max(intRef2.element, mo4075measureBRTryo03.getHeight());
                    }
                }
                if (z2) {
                    ...
                    for (int i5 = 0; i5 < size2; i5++) {
                        ...
                        if (matchesParentSize) {
                            placeableArr[i5] = measurable3.mo4075measureBRTryo0(Constraints);
                        }
                    }
                }
    ...
    public static final void placeInBox(Placeable.PlacementScope placementScope, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int i, int i2, Alignment alignment) {
        ...
        Placeable.PlacementScope.m4123place70tqf50$default(placementScope, placeable, ((boxChildData == null || (alignment2 = boxChildData.getAlignment()) == null) ? alignment : alignment2).mo2212alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(i, i2), layoutDirection), 0.0f, 2, null);
    }
    ...
    public static final void Box(final Modifier modifier, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            Function0<ComposeUiNode> constructor = ComposeUiNode.Companion.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(modifier);
            int i3 = (((((i2 << 3) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 384) << 9) & 7168) | 6;
