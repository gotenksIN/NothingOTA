...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long mo399calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default MeasureResult mo25measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long mo399calculateContentConstraintsl58MMJ0 = mo399calculateContentConstraintsl58MMJ0(measure, measurable, j);
        if (getEnforceIncoming()) {
            mo399calculateContentConstraintsl58MMJ0 = ConstraintsKt.m5018constrainN9IONVI(j, mo399calculateContentConstraintsl58MMJ0);
        }
        final Placeable mo4075measureBRTryo0 = measurable.mo4075measureBRTryo0(mo399calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measure, mo4075measureBRTryo0.getWidth(), mo4075measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m4124placeRelative70tqf50$default(layout, Placeable.this, IntOffset.Companion.m5178getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
