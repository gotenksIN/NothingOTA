...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long mo700calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default MeasureResult mo326measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long mo700calculateContentConstraintsl58MMJ0 = mo700calculateContentConstraintsl58MMJ0(measure, measurable, j);
        if (getEnforceIncoming()) {
            mo700calculateContentConstraintsl58MMJ0 = ConstraintsKt.m5319constrainN9IONVI(j, mo700calculateContentConstraintsl58MMJ0);
        }
        final Placeable mo4376measureBRTryo0 = measurable.mo4376measureBRTryo0(mo700calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measure, mo4376measureBRTryo0.getWidth(), mo4376measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m4425placeRelative70tqf50$default(layout, Placeable.this, IntOffset.Companion.m5479getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
