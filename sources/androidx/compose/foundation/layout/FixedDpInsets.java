...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.mo296roundToPx0680j_4(this.leftDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo296roundToPx0680j_4(this.topDp);
    }
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo296roundToPx0680j_4(this.rightDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo296roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m5061toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m5061toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m5061toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m5061toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FixedDpInsets) {
            ...
            return Dp.m5055equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m5055equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m5055equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m5055equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
        }
        return false;
    }

    public int hashCode() {
        return (((((Dp.m5056hashCodeimpl(this.leftDp) * 31) + Dp.m5056hashCodeimpl(this.topDp)) * 31) + Dp.m5056hashCodeimpl(this.rightDp)) * 31) + Dp.m5056hashCodeimpl(this.bottomDp);
    }
}
