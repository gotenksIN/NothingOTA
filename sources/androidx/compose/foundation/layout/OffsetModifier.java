...
final class OffsetModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo25measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, mo4075measureBRTryo0.getWidth(), mo4075measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (OffsetModifier.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, mo4075measureBRTryo0, measure.mo296roundToPx0680j_4(OffsetModifier.this.m405getXD9Ej5fM()), measure.mo296roundToPx0680j_4(OffsetModifier.this.m406getYD9Ej5fM()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, mo4075measureBRTryo0, measure.mo296roundToPx0680j_4(OffsetModifier.this.m405getXD9Ej5fM()), measure.mo296roundToPx0680j_4(OffsetModifier.this.m406getYD9Ej5fM()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m5055equalsimpl0(this.x, offsetModifier.x) && Dp.m5055equalsimpl0(this.y, offsetModifier.y) && this.rtlAware == offsetModifier.rtlAware;
    }

    public int hashCode() {
        return (((Dp.m5056hashCodeimpl(this.x) * 31) + Dp.m5056hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifier(x=" + ((Object) Dp.m5061toStringimpl(this.x)) + ", y=" + ((Object) Dp.m5061toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
}
