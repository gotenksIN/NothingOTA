...
public final class BorderStroke {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BorderStroke) {
            ...
            return Dp.m5055equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
        }
        return false;
    }

    public int hashCode() {
        return (Dp.m5056hashCodeimpl(this.width) * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m5061toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }

    /* renamed from: copy-D5KLDUw$default  reason: not valid java name */
    public static /* synthetic */ BorderStroke m168copyD5KLDUw$default(BorderStroke borderStroke, float f, Brush brush, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderStroke.m169copyD5KLDUw(f, brush);
    }

    /* renamed from: copy-D5KLDUw  reason: not valid java name */
    public final BorderStroke m169copyD5KLDUw(float f, Brush brush) {
