...
final class GlowEdgeEffectCompat extends EdgeEffect {
    ...
    public GlowEdgeEffectCompat(Context context) {
        ...
        this.oppositeReleaseDeltaThreshold = AndroidDensity_androidKt.Density(context).mo603toPx0680j_4(C0780Dp.m5351constructorimpl(1));
    }
