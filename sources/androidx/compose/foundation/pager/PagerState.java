...
public final class PagerState implements ScrollableState {
    ...
    public final float getPositionThresholdFraction() {
        return Math.min(getDensity().mo302toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
