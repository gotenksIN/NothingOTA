...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = C0780Dp.m5351constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, Composer composer, int i2, int i3) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = (Functions) new Functions<PagerState>() { // from class: androidx.compose.foundation.pager.PagerStateKt$rememberPagerState$1$1
        ...
        PagerState pagerState = (PagerState) RememberSaveable.m2509rememberSaveable(objArr, saver, (String) null, (Functions<? extends Object>) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
