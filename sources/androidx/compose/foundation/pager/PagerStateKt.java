...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m5050constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, Composer composer, int i2, int i3) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = (Function0) new Function0<PagerState>() { // from class: androidx.compose.foundation.pager.PagerStateKt$rememberPagerState$1$1
        ...
        PagerState pagerState = (PagerState) RememberSaveableKt.m2208rememberSaveable(objArr, saver, (String) null, (Function0<? extends Object>) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
