    ...
    */
    ...
    public static final void m658PagerwKDqQAw(final Modifier modifier, final PagerState state, final int i, final PageSize pageSize, final float f, final Orientation orientation, final int i2, Alignment.Vertical vertical, Alignment.Horizontal horizontal, final PaddingValues contentPadding, final SnapFlingBehavior flingBehavior, final boolean z, final boolean z2, final Function1<? super Integer, ? extends Object> function1, final NestedScrollConnection pageNestedScrollConnection, final Function3<? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer composer, final int i3, final int i4, final int i5) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = Dp.m5048boximpl(calculateContentPaddings(contentPadding, orientation, layoutDirection));
            startRestartGroup.updateRememberedValue(rememberedValue);
        }
        startRestartGroup.endReplaceableGroup();
        final float m5064unboximpl = ((Dp) rememberedValue).m5064unboximpl();
        ...
        Dp m5048boximpl = Dp.m5048boximpl(f);
        Dp m5048boximpl2 = Dp.m5048boximpl(f);
        int i7 = (i3 >> 6) & 896;
        startRestartGroup.startReplaceableGroup(1618982084);
        ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1,2,3):Composables.kt#9igjgp");
        boolean changed3 = startRestartGroup.changed(m5048boximpl2) | startRestartGroup.changed(density) | startRestartGroup.changed(state);
        ...
        startRestartGroup.endReplaceableGroup();
        EffectsKt.LaunchedEffect(density, state, m5048boximpl, (Function2) pagerKt$Pager$2$1, startRestartGroup, i7 | i6 | 4096);
        int i8 = (i3 >> 3) & 14;
        ...
        BoxWithConstraintsKt.BoxWithConstraints(modifier.then(companion), null, false, ComposableLambdaKt.composableLambda(startRestartGroup, -1677736225, true, new Function3<BoxWithConstraintsScope, Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$Pager$4
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$Pager$5
            ...
            public final void invoke(Composer composer2, int i9) {
                PagerKt.m658PagerwKDqQAw(Modifier.this, state, i, pageSize, f, orientation, i2, vertical3, horizontal3, contentPadding, flingBehavior, z, z2, function1, pageNestedScrollConnection, pageContent, composer2, RecomposeScopeImplKt.updateChangedFlags(i3 | 1), RecomposeScopeImplKt.updateChangedFlags(i4), i5);
            }
        });
    }
    ...
    public static final float calculateContentPaddings(PaddingValues paddingValues, Orientation orientation, LayoutDirection layoutDirection) {
        float mo396calculateLeftPaddingu2uoSUM;
        float mo397calculateRightPaddingu2uoSUM;
        if (orientation == Orientation.Vertical) {
            mo396calculateLeftPaddingu2uoSUM = paddingValues.mo398calculateTopPaddingD9Ej5fM();
        } else {
            mo396calculateLeftPaddingu2uoSUM = paddingValues.mo396calculateLeftPaddingu2uoSUM(layoutDirection);
        }
        if (orientation == Orientation.Vertical) {
            mo397calculateRightPaddingu2uoSUM = paddingValues.mo395calculateBottomPaddingD9Ej5fM();
        } else {
            mo397calculateRightPaddingu2uoSUM = paddingValues.mo397calculateRightPaddingu2uoSUM(layoutDirection);
        }
        return Dp.m5050constructorimpl(mo396calculateLeftPaddingu2uoSUM + mo397calculateRightPaddingu2uoSUM);
    }
