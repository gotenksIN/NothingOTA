...
public final class ConsumeAllFlingOnDirection implements NestedScrollConnection {
    ...
    public final long m655consumeOnOrientationQWom1Mo(long j, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Velocity.m5271copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m5271copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null);
    }

    /* renamed from: consumeOnOrientation-8S9VItk  reason: not valid java name */
    public final long m654consumeOnOrientation8S9VItk(long j, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Offset.m2312copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
        }
        return Offset.m2312copydBAh8RU$default(j, 0.0f, 0.0f, 1, null);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo309onPostScrollDzOQY0M(long j, long j2, int i) {
        return NestedScrollSource.m3851equalsimpl0(i, NestedScrollSource.Companion.m3857getFlingWNlRxjI()) ? m654consumeOnOrientation8S9VItk(j2, this.orientation) : Offset.Companion.m2334getZeroF1C5BW0();
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo308onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return Velocity.m5266boximpl(m655consumeOnOrientationQWom1Mo(j2, this.orientation));
    }
}
