    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                DrawScope.m3392drawRectnJ9OG0$default(contentDrawScope, Color.m2856copywmQWz5c$default(Color.Companion.m2883getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3397getSizeNHjbRc(), 0.0f, null, null, 0, C0032R.styleable.AppCompatTheme_windowFixedWidthMajor, null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                DrawScope.m3392drawRectnJ9OG0$default(contentDrawScope, Color.m2856copywmQWz5c$default(Color.Companion.m2883getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3397getSizeNHjbRc(), 0.0f, null, null, 0, C0032R.styleable.AppCompatTheme_windowFixedWidthMajor, null);
            }
        }
    }
