...
final class ScrollingLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo25measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        CheckScrollableContainerConstraintsKt.m172checkScrollableContainerConstraintsK40F9xA(j, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        final Placeable mo4075measureBRTryo0 = measurable.mo4075measureBRTryo0(Constraints.m4997copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m5006getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m5005getMaxHeightimpl(j), 5, null));
        int coerceAtMost = RangesKt.coerceAtMost(mo4075measureBRTryo0.getWidth(), Constraints.m5006getMaxWidthimpl(j));
        int coerceAtMost2 = RangesKt.coerceAtMost(mo4075measureBRTryo0.getHeight(), Constraints.m5005getMaxHeightimpl(j));
        final int height = mo4075measureBRTryo0.getHeight() - coerceAtMost2;
        int width = mo4075measureBRTryo0.getWidth() - coerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        return MeasureScope.layout$default(measure, coerceAtMost, coerceAtMost2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.placeRelativeWithLayer$default(layout, mo4075measureBRTryo0, ScrollingLayoutModifier.this.isVertical() ? 0 : i, ScrollingLayoutModifier.this.isVertical() ? i : 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
