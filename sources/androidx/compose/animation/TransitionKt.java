...
public final class TransitionKt {
    public static final <S> State<Color> animateColor(Transition<S> transition, Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function3, String str, Function3<? super S, ? super Composer, ? super Integer, Color> targetValueByState, Composer composer, int i, int i2) {
        ...
        String str2 = str;
        ColorSpace m2560getColorSpaceimpl = Color.m2560getColorSpaceimpl(targetValueByState.invoke(transition.getTargetState(), composer, Integer.valueOf((i >> 6) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle)).m2566unboximpl());
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "C(remember)P(1):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2560getColorSpaceimpl);
    ...
    public static final State<Color> m79animateColorDTcfvLk(InfiniteTransition animateColor, long j, long j2, InfiniteRepeatableSpec<Color> animationSpec, String str, Composer composer, int i, int i2) {
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = ColorVectorConverterKt.getVectorConverter(Color.Companion).invoke(Color.m2560getColorSpaceimpl(j2));
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        int i3 = i << 3;
        State<Color> animateValue = InfiniteTransitionKt.animateValue(animateColor, Color.m2546boximpl(j), Color.m2546boximpl(j2), (TwoWayConverter) rememberedValue, animationSpec, str2, composer, InfiniteTransition.$stable | 4096 | (i & 14) | (i & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i & 896) | (InfiniteRepeatableSpec.$stable << 12) | (57344 & i3) | (i3 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m80animateColorRIQooxk(InfiniteTransition animateColor, long j, long j2, InfiniteRepeatableSpec animationSpec, Composer composer, int i) {
        Intrinsics.checkNotNullParameter(animateColor, "$this$animateColor");
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        ...
        State<Color> m79animateColorDTcfvLk = m79animateColorDTcfvLk(animateColor, j, j2, animationSpec, "ColorAnimation", composer, InfiniteTransition.$stable | 24576 | (i & 14) | (i & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i & 896) | (InfiniteRepeatableSpec.$stable << 9) | (i & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m79animateColorDTcfvLk;
    }
}
