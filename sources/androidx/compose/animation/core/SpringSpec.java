...
public final class SpringSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public <V extends AnimationVectors> VectorizedSpringSpec<V> vectorize(VectorConverters<T, V> converter) {
