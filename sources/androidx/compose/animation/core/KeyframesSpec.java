...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> {
        ...
        /* renamed from: at */
        public final KeyframeEntity<T> m296at(T t, int i) {
        ...
        public final KeyframeEntity<T> atFraction(T t, float f) {
            return m296at(t, MathKt.roundToInt(this.durationMillis * f));
        }
    ...
    public <V extends AnimationVectors> VectorizedKeyframesSpec<V> vectorize(VectorConverters<T, V> converter) {
    ...
    public static final class KeyframeEntity<T> {
        ...
        public final <V extends AnimationVectors> Tuples<V, Easing> toPair$animation_core_release(Function1<? super T, ? extends V> convertToVector) {
            Intrinsics.checkNotNullParameter(convertToVector, "convertToVector");
            return TuplesKt.m33to(convertToVector.invoke((T) this.value), this.easing);
        }
