...
public final class StartOffset {
    ...
    public static boolean m113equalsimpl(long j, Object obj) {
        return (obj instanceof StartOffset) && j == ((StartOffset) obj).m119unboximpl();
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m110constructorimpl(int i, int i2) {
    ...
    public static /* synthetic */ long m112constructorimpl$default(int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i3 & 2) != 0) {
            i2 = StartOffsetType.Companion.m127getDelayEo1U57Q();
        }
        return m110constructorimpl(i, i2);
    }

    /* renamed from: getOffsetMillis-impl  reason: not valid java name */
    public static final int m115getOffsetMillisimpl(long j) {
        return Math.abs((int) j);
    }

    /* renamed from: getOffsetType-Eo1U57Q  reason: not valid java name */
    public static final int m116getOffsetTypeEo1U57Q(long j) {
        boolean z = j > 0;
        if (z) {
            return StartOffsetType.Companion.m128getFastForwardEo1U57Q();
        }
        if (z) {
            throw new NoWhenBranchMatchedException();
        }
        return StartOffsetType.Companion.m127getDelayEo1U57Q();
    }
}
