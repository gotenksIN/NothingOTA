...
public interface Animation<T, V extends AnimationVectors> {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static <T, V extends AnimationVectors> boolean isFinishedFromNanos(Animation<T, V> animation, long j) {
