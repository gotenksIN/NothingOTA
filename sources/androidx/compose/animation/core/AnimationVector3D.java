...
public final class AnimationVector3D extends AnimationVectors {
    ...
    public String toString() {
        return "AnimationVector3D: v1 = " + this.f20v1 + ", v2 = " + this.f21v2 + ", v3 = " + this.f22v3;
    }

    public boolean equals(Object obj) {
        if (obj instanceof AnimationVector3D) {
            AnimationVector3D animationVector3D = (AnimationVector3D) obj;
            if (animationVector3D.f20v1 == this.f20v1) {
                if (animationVector3D.f21v2 == this.f21v2) {
                    return (animationVector3D.f22v3 > this.f22v3 ? 1 : (animationVector3D.f22v3 == this.f22v3 ? 0 : -1)) == 0;
                }
                return false;
            }
            return false;
    ...
    public int hashCode() {
        return (((Float.hashCode(this.f20v1) * 31) + Float.hashCode(this.f21v2)) * 31) + Float.hashCode(this.f22v3);
    }
}
