...
public final class VectorizedAnimationSpecKt {
    ...
    public static final <V extends AnimationVectors> V getValueFromMillis(VectorizedAnimationSpec<V> vectorizedAnimationSpec, long j, V start, V end, V startVelocity) {
        Intrinsics.checkNotNullParameter(vectorizedAnimationSpec, "<this>");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final <V extends AnimationVectors> Animations createSpringAnimations(final V v, final float f, final float f2) {
        if (v != null) {
