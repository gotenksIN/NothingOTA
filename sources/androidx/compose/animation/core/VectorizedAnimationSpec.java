...
public interface VectorizedAnimationSpec<V extends AnimationVectors> {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static <V extends AnimationVectors> V getEndVelocity(VectorizedAnimationSpec<V> vectorizedAnimationSpec, V initialValue, V targetValue, V initialVelocity) {
