...
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(durationBasedAnimationSpec, (i & 2) != 0 ? RepeatMode.Restart : repeatMode, (i & 4) != 0 ? StartOffset.m112constructorimpl$default(0, 0, 2, null) : j, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof InfiniteRepeatableSpec) {
            ...
            return Intrinsics.areEqual(infiniteRepeatableSpec.animation, this.animation) && infiniteRepeatableSpec.repeatMode == this.repeatMode && StartOffset.m114equalsimpl0(infiniteRepeatableSpec.initialStartOffset, this.initialStartOffset);
        }
        return false;
    }
