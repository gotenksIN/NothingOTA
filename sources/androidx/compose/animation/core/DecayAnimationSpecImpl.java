...
public final class DecayAnimationSpecImpl<T> implements DecayAnimationSpec<T> {
    ...
    public <V extends AnimationVectors> VectorizedDecayAnimationSpec<V> vectorize(VectorConverters<T, V> typeConverter) {
