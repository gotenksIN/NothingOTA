...
public final class AnimateAsState {
    ...
    private static final SpringSpec<C0780Dp> dpDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, C0780Dp.m5349boximpl(VisibilityThresholds.getVisibilityThreshold(C0780Dp.Companion)), 3, null);
    private static final SpringSpec<Size> sizeDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Size.m2676boximpl(VisibilityThresholds.getVisibilityThreshold(Size.Companion)), 3, null);
    private static final SpringSpec<Offset> offsetDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Offset.m2608boximpl(VisibilityThresholds.getVisibilityThreshold(Offset.Companion)), 3, null);
    private static final SpringSpec<Rect> rectDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, VisibilityThresholds.getVisibilityThreshold(Rect.Companion), 3, null);
    ...
    private static final SpringSpec<IntOffset> intOffsetDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5460boximpl(VisibilityThresholds.getVisibilityThreshold(IntOffset.Companion)), 3, null);
    private static final SpringSpec<IntSize> intSizeDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, IntSize.m5503boximpl(VisibilityThresholds.getVisibilityThreshold(IntSize.Companion)), 3, null);
    ...
    public static final State<C0780Dp> m382animateDpAsStateAjpBEmI(float f, AnimationSpec<C0780Dp> animationSpec, String str, Function1<? super C0780Dp, Unit> function1, Composer composer, int i, int i2) {
        ...
        SpringSpec<C0780Dp> springSpec = (i2 & 2) != 0 ? dpDefaultSpring : animationSpec;
        String str2 = (i2 & 4) != 0 ? "DpAnimation" : str;
        Function1<? super C0780Dp, Unit> function12 = (i2 & 8) != 0 ? null : function1;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1407150062, i, -1, "androidx.compose.animation.core.animateDpAsState (AnimateAsState.kt:108)");
        }
        int i3 = i << 6;
        State<C0780Dp> animateValueAsState = animateValueAsState(C0780Dp.m5349boximpl(f), VectorConvertersKt.getVectorConverter(C0780Dp.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Size> m391animateSizeAsStateYLp_XPw(long j, AnimationSpec<Size> animationSpec, String str, Function1<? super Size, Unit> function1, Composer composer, int i, int i2) {
        ...
        int i3 = i << 6;
        State<Size> animateValueAsState = animateValueAsState(Size.m2676boximpl(j), VectorConvertersKt.getVectorConverter(Size.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Offset> m388animateOffsetAsState7362WCg(long j, AnimationSpec<Offset> animationSpec, String str, Function1<? super Offset, Unit> function1, Composer composer, int i, int i2) {
        ...
        int i3 = i << 6;
        State<Offset> animateValueAsState = animateValueAsState(Offset.m2608boximpl(j), VectorConvertersKt.getVectorConverter(Offset.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<IntOffset> m385animateIntOffsetAsStateHyPO7BM(long j, AnimationSpec<IntOffset> animationSpec, String str, Function1<? super IntOffset, Unit> function1, Composer composer, int i, int i2) {
        ...
        int i3 = i << 6;
        State<IntOffset> animateValueAsState = animateValueAsState(IntOffset.m5460boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<IntSize> m386animateIntSizeAsState4goxYXU(long j, AnimationSpec<IntSize> animationSpec, String str, Function1<? super IntSize, Unit> function1, Composer composer, int i, int i2) {
        ...
        int i3 = i << 6;
        State<IntSize> animateValueAsState = animateValueAsState(IntSize.m5503boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final <T, V extends AnimationVectors> State<T> animateValueAsState(final T t, VectorConverters<T, V> typeConverter, AnimationSpec<T> animationSpec, T t2, String str, Function1<? super T, Unit> function1, Composer composer, int i, int i2) {
        ...
        composer.endReplaceableGroup();
        SnapshotState snapshotState = (SnapshotState) rememberedValue2;
        composer.startReplaceableGroup(-492369756);
        ComposerKt.sourceInformation(composer, "C(remember):Composables.kt#9igjgp");
        ...
        EffectsKt.SideEffect(new Functions<Unit>() { // from class: androidx.compose.animation.core.AnimateAsStateKt$animateValueAsState$2
            ...
            public final void invoke2() {
                channel.mo7156trySendJP2dKIU(t);
            }
        }, composer, 0);
        ...
        State<T> state = (State) snapshotState.getValue();
        if (state == null) {
    ...
    public static final /* synthetic */ State animateFloatAsState(float f, AnimationSpec animationSpec, float f2, Function1 function1, Composer composer, int i, int i2) {
        ...
        State<Float> animateFloatAsState = animateFloatAsState(f, animationSpec2, f3, null, function12, composer, (i & 14) | (i & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i & 896) | ((i << 3) & 57344), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m383animateDpAsStateKz89ssw(float f, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        ...
        State animateValueAsState = animateValueAsState(C0780Dp.m5349boximpl(f), VectorConvertersKt.getVectorConverter(C0780Dp.Companion), animationSpec2, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m390animateSizeAsStateLjSzlW0(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        ...
        State animateValueAsState = animateValueAsState(Size.m2676boximpl(j), VectorConvertersKt.getVectorConverter(Size.Companion), springSpec, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m389animateOffsetAsStateN6fFfp4(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        ...
        State animateValueAsState = animateValueAsState(Offset.m2608boximpl(j), VectorConvertersKt.getVectorConverter(Offset.Companion), springSpec, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m384animateIntOffsetAsState8f6pmRE(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        ...
        State animateValueAsState = animateValueAsState(IntOffset.m5460boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.Companion), springSpec, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m387animateIntSizeAsStatezTRF_AQ(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        ...
        State animateValueAsState = animateValueAsState(IntSize.m5503boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), springSpec, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    @Deprecated(level = DeprecationLevel.HIDDEN, message = "animate*AsState APIs now have a new label parameter added.")
    public static final /* synthetic */ State animateValueAsState(Object obj, VectorConverters typeConverter, AnimationSpec animationSpec, Object obj2, Function1 function1, Composer composer, int i, int i2) {
        ...
        int i3 = i & 8;
        State animateValueAsState = animateValueAsState(obj, typeConverter, animationSpec2, obj3, "ValueAnimation", function12, composer, (i3 << 9) | i3 | 24576 | (i & 14) | (i & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i & 896) | (i & 7168) | ((i << 3) & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
