...
public final class AnimationScope<T, V extends AnimationVectors> {
    ...
    public AnimationScope(T t, VectorConverters<T, V> typeConverter, V initialVelocityVector, long j, T t2, long j2, boolean z, Functions<Unit> onCancel) {
