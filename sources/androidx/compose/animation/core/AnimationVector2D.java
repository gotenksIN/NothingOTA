...
public final class AnimationVector2D extends AnimationVectors {
    ...
    public String toString() {
        return "AnimationVector2D: v1 = " + this.f18v1 + ", v2 = " + this.f19v2;
    }

    public boolean equals(Object obj) {
        if (obj instanceof AnimationVector2D) {
            AnimationVector2D animationVector2D = (AnimationVector2D) obj;
            if (animationVector2D.f18v1 == this.f18v1) {
                return (animationVector2D.f19v2 > this.f19v2 ? 1 : (animationVector2D.f19v2 == this.f19v2 ? 0 : -1)) == 0;
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        return (Float.hashCode(this.f18v1) * 31) + Float.hashCode(this.f19v2);
    }
}
