...
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, durationBasedAnimationSpec, (i2 & 4) != 0 ? RepeatMode.Restart : repeatMode, (i2 & 8) != 0 ? StartOffset.m112constructorimpl$default(0, 0, 2, null) : j, (DefaultConstructorMarker) null);
    }
    ...
    public final long m107getInitialStartOffsetRmkjzm4() {
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(i, animation, repeatMode, StartOffset.m112constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RepeatableSpec) {
            ...
            return repeatableSpec.iterations == this.iterations && Intrinsics.areEqual(repeatableSpec.animation, this.animation) && repeatableSpec.repeatMode == this.repeatMode && StartOffset.m114equalsimpl0(repeatableSpec.initialStartOffset, this.initialStartOffset);
        }
        return false;
    }
