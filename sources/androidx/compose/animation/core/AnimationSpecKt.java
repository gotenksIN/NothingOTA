...
public final class AnimationSpecKt {
    ...
    public static final <T> RepeatableSpec<T> m93repeatable91I0pcU(int i, DurationBasedAnimationSpec<T> animation, RepeatMode repeatMode, long j) {
    ...
    public static final /* synthetic */ RepeatableSpec repeatable(int i, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
        return new RepeatableSpec(i, animation, repeatMode, StartOffset.m112constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> InfiniteRepeatableSpec<T> m91infiniteRepeatable9IiC70o(DurationBasedAnimationSpec<T> animation, RepeatMode repeatMode, long j) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
