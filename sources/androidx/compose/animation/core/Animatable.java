...
public final class Animatable<T, V extends AnimationVectors> {
    ...
    public Animatable(T t, VectorConverters<T, V> typeConverter, T t2, String label) {
    ...
    public /* synthetic */ Animatable(Object obj, VectorConverters vectorConverters, Object obj2, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(obj, vectorConverters, (i & 4) != 0 ? null : obj2, (i & 8) != 0 ? "Animatable" : str);
    }
    ...
    public /* synthetic */ Animatable(Object obj, VectorConverters vectorConverters, Object obj2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(obj, vectorConverters, (i & 4) != 0 ? null : obj2);
    }
    ...
    public /* synthetic */ Animatable(Object obj, VectorConverters typeConverter, Object obj2) {
    ...
    public final Object animateDecay(T t, DecayAnimationSpec<T> decayAnimationSpec, Function1<? super Animatable<T, V>, Unit> function1, Continuation<? super AnimationResult<T, V>> continuation) {
        return runAnimation(new DecayAnimation((DecayAnimationSpec) decayAnimationSpec, (VectorConverters) this.typeConverter, (Object) getValue(), (AnimationVectors) this.typeConverter.getConvertToVector().invoke(t)), t, function1, continuation);
    }
