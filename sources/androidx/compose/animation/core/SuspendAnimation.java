...
public final class SuspendAnimation {
    ...
    public static final <T, V extends AnimationVectors> Object animate(final VectorConverters<T, V> vectorConverters, T t, T t2, T t3, AnimationSpec<T> animationSpec, final Function2<? super T, ? super T, Unit> function2, Continuation<? super Unit> continuation) {
        V newInstance;
        if (t3 == null || (newInstance = vectorConverters.getConvertToVector().invoke(t3)) == null) {
            newInstance = AnimationVectorsKt.newInstance(vectorConverters.getConvertToVector().invoke(t));
        }
        Object animate$default = animate$default(new AnimationState(vectorConverters, t, newInstance, 0L, 0L, false, 56, null), new TargetBasedAnimation(animationSpec, vectorConverters, t, t2, newInstance), 0L, new Function1<AnimationScope<T, V>, Unit>() { // from class: androidx.compose.animation.core.SuspendAnimationKt$animate$3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final void invoke(AnimationScope<T, V> animate) {
                Intrinsics.checkNotNullParameter(animate, "$this$animate");
                function2.invoke(animate.getValue(), vectorConverters.getConvertFromVector().invoke(animate.getVelocityVector()));
            }
        }, continuation, 2, null);
        return animate$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animate$default : Unit.INSTANCE;
    }
    ...
    public static final <T, V extends AnimationVectors> Object animateTo(AnimationState<T, V> animationState, T t, AnimationSpec<T> animationSpec, boolean z, Function1<? super AnimationScope<T, V>, Unit> function1, Continuation<? super Unit> continuation) {
    ...
    public static final <T, V extends AnimationVectors> Object animateDecay(AnimationState<T, V> animationState, DecayAnimationSpec<T> decayAnimationSpec, boolean z, Function1<? super AnimationScope<T, V>, Unit> function1, Continuation<? super Unit> continuation) {
        Object animate = animate(animationState, new DecayAnimation((DecayAnimationSpec) decayAnimationSpec, (VectorConverters) animationState.getTypeConverter(), (Object) animationState.getValue(), (AnimationVectors) animationState.getVelocityVector()), z ? animationState.getLastFrameTimeNanos() : Long.MIN_VALUE, function1, continuation);
        return animate == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animate : Unit.INSTANCE;
    }

    /* JADX WARN: Removed duplicated region for block: B:109:0x0131  */
    /* JADX WARN: Removed duplicated region for block: B:117:0x014a  */
    /* JADX WARN: Removed duplicated region for block: B:125:0x0121 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:74:0x002c  */
    /* JADX WARN: Removed duplicated region for block: B:84:0x0066  */
    /* JADX WARN: Removed duplicated region for block: B:97:0x00f5 A[Catch: CancellationException -> 0x0062, TRY_LEAVE, TryCatch #0 {CancellationException -> 0x0062, blocks: (B:80:0x005b, B:95:0x00e8, B:97:0x00f5), top: B:119:0x005b }] */
    ...
    */
    public static final <T, V extends androidx.compose.animation.core.AnimationVectors> java.lang.Object animate(final androidx.compose.animation.core.AnimationState<T, V> r25, final androidx.compose.animation.core.Animation<T, V> r26, long r27, final kotlin.jvm.functions.Function1<? super androidx.compose.animation.core.AnimationScope<T, V>, kotlin.Unit> r29, kotlin.coroutines.Continuation<? super kotlin.Unit> r30) {
        /*
            Method dump skipped, instructions count: 334
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.core.SuspendAnimation.animate(androidx.compose.animation.core.AnimationState, androidx.compose.animation.core.Animation, long, kotlin.jvm.functions.Function1, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public static final <R, T, V extends AnimationVectors> Object callWithFrameNanos(Animation<T, V> animation, final Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        if (animation.isInfinite()) {
            return InfiniteAnimationPolicy.withInfiniteAnimationFrameNanos(function1, continuation);
        }
    ...
    public static final <T, V extends AnimationVectors> void updateState(AnimationScope<T, V> animationScope, AnimationState<T, V> state) {
    ...
    public static final <T, V extends AnimationVectors> void doAnimationFrameWithScale(AnimationScope<T, V> animationScope, long j, float f, Animation<T, V> animation, AnimationState<T, V> animationState, Function1<? super AnimationScope<T, V>, Unit> function1) {
        long startTimeNanos;
        if (f == 0.0f) {
    ...
    private static final <T, V extends AnimationVectors> void doAnimationFrame(AnimationScope<T, V> animationScope, long j, long j2, Animation<T, V> animation, AnimationState<T, V> animationState, Function1<? super AnimationScope<T, V>, Unit> function1) {
