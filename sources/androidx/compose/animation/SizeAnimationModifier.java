...
public final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final class AnimData {
        ...
        public final AnimData m73copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long j) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof AnimData) {
                ...
                return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m5208equalsimpl0(this.startSize, animData.startSize);
            }
            return false;
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m5211hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m5213toStringimpl(this.startSize)) + ')';
        }
    ...
    public MeasureResult mo25measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        long m70animateTomzRDjE0 = m70animateTomzRDjE0(IntSizeKt.IntSize(mo4075measureBRTryo0.getWidth(), mo4075measureBRTryo0.getHeight()));
        return MeasureScope.layout$default(measure, IntSize.m5210getWidthimpl(m70animateTomzRDjE0), IntSize.m5209getHeightimpl(m70animateTomzRDjE0), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public final long m70animateTomzRDjE0(long j) {
        AnimData animData = getAnimData();
        if (animData != null) {
            if (!IntSize.m5208equalsimpl0(j, animData.getAnim().getTargetValue().m5214unboximpl())) {
                animData.m75setStartSizeozmzZPI(animData.getAnim().getValue().m5214unboximpl());
            ...
            animData = new AnimData(new Animatable(IntSize.m5202boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), IntSize.m5202boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), j, null);
        }
        setAnimData(animData);
        return animData.getAnim().getValue().m5214unboximpl();
    }
}
