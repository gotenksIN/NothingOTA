...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        for (Measurable measurable : list) {
            arrayList.add(measurable.mo4075measureBRTryo0(j));
        }
        ...
        this.scope.getTargetSize$animation_release().setValue(IntSize.m5202boximpl(IntSizeKt.IntSize(width3, height3)));
