...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m59sizeByStateUzc_VyU(EnterExitState targetState, long j) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        ChangeSize value = this.expand.getValue();
        long m5214unboximpl = value != null ? value.getSize().invoke(IntSize.m5202boximpl(j)).m5214unboximpl() : j;
        ChangeSize value2 = this.shrink.getValue();
        long m5214unboximpl2 = value2 != null ? value2.getSize().invoke(IntSize.m5202boximpl(j)).m5214unboximpl() : j;
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return m5214unboximpl2;
                }
                throw new NoWhenBranchMatchedException();
            }
            return m5214unboximpl;
        }
        return j;
    }

    /* renamed from: targetOffsetByState-oFUgxo0  reason: not valid java name */
    public final long m60targetOffsetByStateoFUgxo0(EnterExitState targetState, long j) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
            ...
            if (i != 1) {
                if (i != 2) {
                    if (i == 3) {
                        ...
                        if (value != null) {
                            long m5214unboximpl = value.getSize().invoke(IntSize.m5202boximpl(j)).m5214unboximpl();
                            Alignment value2 = this.alignment.getValue();
                            Intrinsics.checkNotNull(value2);
                            long mo2212alignKFBX0sM = value2.mo2212alignKFBX0sM(j, m5214unboximpl, LayoutDirection.Ltr);
                            Alignment alignment = this.currentAlignment;
                            Intrinsics.checkNotNull(alignment);
                            long mo2212alignKFBX0sM2 = alignment.mo2212alignKFBX0sM(j, m5214unboximpl, LayoutDirection.Ltr);
                            return IntOffsetKt.IntOffset(IntOffset.m5168getXimpl(mo2212alignKFBX0sM) - IntOffset.m5168getXimpl(mo2212alignKFBX0sM2), IntOffset.m5169getYimpl(mo2212alignKFBX0sM) - IntOffset.m5169getYimpl(mo2212alignKFBX0sM2));
                        }
                        return IntOffset.Companion.m5178getZeronOccac();
                    }
                    throw new NoWhenBranchMatchedException();
                }
                return IntOffset.Companion.m5178getZeronOccac();
    ...
    public MeasureResult mo25measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final long IntSize = IntSizeKt.IntSize(mo4075measureBRTryo0.getWidth(), mo4075measureBRTryo0.getHeight());
        long m5214unboximpl = this.sizeAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$currentSize$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m5202boximpl(m61invokeYEO4UFw(enterExitState));
            }

            /* renamed from: invoke-YEO4UFw  reason: not valid java name */
            public final long m61invokeYEO4UFw(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return ExpandShrinkModifier.this.m59sizeByStateUzc_VyU(it, IntSize);
            }
        }).getValue().m5214unboximpl();
        final long m5177unboximpl = this.offsetAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$offsetDelta$1
            @Override // kotlin.jvm.functions.Function1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m5159boximpl(m62invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4  reason: not valid java name */
            public final long m62invokeBjo55l4(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return ExpandShrinkModifier.this.m60targetOffsetByStateoFUgxo0(it, IntSize);
            }
        }).getValue().m5177unboximpl();
        Alignment alignment = this.currentAlignment;
        final long mo2212alignKFBX0sM = alignment != null ? alignment.mo2212alignKFBX0sM(IntSize, m5214unboximpl, LayoutDirection.Ltr) : IntOffset.Companion.m5178getZeronOccac();
        return MeasureScope.layout$default(measure, IntSize.m5210getWidthimpl(m5214unboximpl), IntSize.m5209getHeightimpl(m5214unboximpl), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, Placeable.this, IntOffset.m5168getXimpl(mo2212alignKFBX0sM) + IntOffset.m5168getXimpl(m5177unboximpl), IntOffset.m5169getYimpl(mo2212alignKFBX0sM) + IntOffset.m5169getYimpl(m5177unboximpl), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
