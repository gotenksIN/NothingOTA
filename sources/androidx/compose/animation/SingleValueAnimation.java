...
public final class SingleValueAnimation {
    ...
    public static final State<Color> m370animateColorAsStateeuL9pac(long j, AnimationSpec<Color> animationSpec, String str, Function1<? super Color, Unit> function1, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = ColorVectorConverter.getVectorConverter(Color.Companion).invoke(Color.m2861getColorSpaceimpl(j));
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        int i3 = i << 6;
        State<Color> animateValueAsState = AnimateAsState.animateValueAsState(Color.m2847boximpl(j), (VectorConverters) rememberedValue, springSpec, null, str2, function12, composer, (i & 14) | 576 | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m369animateColorAsStateKTwxG1Y(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        ...
        State<Color> m370animateColorAsStateeuL9pac = m370animateColorAsStateeuL9pac(j, animationSpec2, null, function12, composer, (i & 14) | 64 | ((i << 3) & 7168), 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final Animatable<Color, AnimationVector4D> m368Animatable8_81llA(long j) {
        return new Animatable<>(Color.m2847boximpl(j), ColorVectorConverter.getVectorConverter(Color.Companion).invoke(Color.m2861getColorSpaceimpl(j)), null, null, 12, null);
    }
}
