...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m77targetValueByStateoFUgxo0(EnterExitState targetState, long j) {
        ...
        long m5178getZeronOccac = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.Companion.m5178getZeronOccac() : slideOffset2.invoke(IntSize.m5202boximpl(j)).m5177unboximpl();
        Slide value2 = this.slideOut.getValue();
        long m5178getZeronOccac2 = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.Companion.m5178getZeronOccac() : slideOffset.invoke(IntSize.m5202boximpl(j)).m5177unboximpl();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return m5178getZeronOccac2;
                }
                throw new NoWhenBranchMatchedException();
            }
            return m5178getZeronOccac;
        }
    ...
    public MeasureResult mo25measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, mo4075measureBRTryo0.getWidth(), mo4075measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SlideModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m4126placeWithLayeraW9wM$default(layout, mo4075measureBRTryo0, lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                        return IntOffset.m5159boximpl(m78invokeBjo55l4(enterExitState));
                    }

                    /* renamed from: invoke-Bjo55l4  reason: not valid java name */
                    public final long m78invokeBjo55l4(EnterExitState it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        return SlideModifier.this.m77targetValueByStateoFUgxo0(it, j2);
                    }
                }).getValue().m5177unboximpl(), 0.0f, null, 6, null);
            }
        }, 4, null);
    }
}
