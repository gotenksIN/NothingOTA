...
final class AnimatedVisibility implements MeasurePolicy {
    ...
    public MeasureResult mo313measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        for (Measurable measurable : list) {
            arrayList.add(measurable.mo4376measureBRTryo0(j));
        }
        ...
        this.scope.getTargetSize$animation_release().setValue(IntSize.m5503boximpl(IntSizeKt.IntSize(width3, height3)));
