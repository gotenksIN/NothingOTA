...
public final class TransitionData {
    ...
    public final TransitionData copy(Fade fade, Slide slide, EnterExitTransition enterExitTransition, Scale scale) {
    ...
    public int hashCode() {
        ...
        int hashCode3 = (hashCode2 + (enterExitTransition == null ? 0 : enterExitTransition.hashCode())) * 31;
    ...
    public TransitionData(Fade fade, Slide slide, EnterExitTransition enterExitTransition, Scale scale) {
        this.fade = fade;
        this.slide = slide;
