...
public final class Scale {
    ...
    public final long m64component2SzJe1aQ() {
    ...
    public final Scale m65copybnNdC4k(float f, long j, FiniteAnimationSpec<Float> animationSpec) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Scale) {
            ...
            return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m2931equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
        }
        return false;
    }

    public int hashCode() {
        return (((Float.hashCode(this.scale) * 31) + TransformOrigin.m2934hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m2935toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
