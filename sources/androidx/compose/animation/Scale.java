...
public final class Scale {
    ...
    public static /* synthetic */ Scale m364copybnNdC4k$default(Scale scale, float f, long j, FiniteAnimationSpec finiteAnimationSpec, int i, Object obj) {
        if ((i & 1) != 0) {
            f = scale.scale;
        }
        if ((i & 2) != 0) {
        ...
        return scale.m366copybnNdC4k(f, j, finiteAnimationSpec);
    }
    ...
    public final long m365component2SzJe1aQ() {
    ...
    public final Scale m366copybnNdC4k(float f, long j, FiniteAnimationSpec<Float> animationSpec) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Scale) {
            ...
            return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m3232equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
        }
        return false;
    }

    public int hashCode() {
        return (((Float.hashCode(this.scale) * 31) + TransformOrigin.m3235hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m3236toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
    ...
    public final long m367getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
