...
public final class CompositionKt {
    ...
    public static final List<Tuples<Exception, Boolean>> currentCompositionErrors() {
        ...
        for (RecomposerErrorInfo recomposerErrorInfo : currentErrors$runtime_release) {
            arrayList.add(TuplesKt.m33to(recomposerErrorInfo.getCause(), Boolean.valueOf(recomposerErrorInfo.getRecoverable())));
        }
        return arrayList;
    }
