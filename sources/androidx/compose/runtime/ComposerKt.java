...
public final class ComposerKt {
    ...
    @ComposeCompilerApi
    public static final <T> T cache(Composer composer, boolean z, Functions<? extends T> block) {
    ...
    public static final void runtimeCheck(boolean z, Functions<? extends Object> lazyMessage) {
