...
public final class NestedReadonlySnapshot extends Snapshot {
    ...
    public NestedReadonlySnapshot(int i, SnapshotIdSet invalid, final Function1<Object, Unit> function1, Snapshot parent) {
        ...
        this.parent = parent;
        parent.mo2510nestedActivated$runtime_release(this);
        if (function1 != null) {
    ...
    public void dispose() {
        ...
        this.parent.mo2511nestedDeactivated$runtime_release(this);
        super.dispose();
    }
