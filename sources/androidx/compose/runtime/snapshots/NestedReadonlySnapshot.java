...
public final class NestedReadonlySnapshot extends Snapshot {
    ...
    public NestedReadonlySnapshot(int i, SnapshotIdSet invalid, final Function1<Object, Unit> function1, Snapshot parent) {
        ...
        this.parent = parent;
        parent.mo2209nestedActivated$runtime_release(this);
        if (function1 != null) {
    ...
    public void dispose() {
        ...
        this.parent.mo2210nestedDeactivated$runtime_release(this);
        super.dispose();
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    /* renamed from: recordModified$runtime_release */
    public Void mo2211recordModified$runtime_release(StateObject state) {
        Intrinsics.checkNotNullParameter(state, "state");
    ...
    public Void mo2210nestedDeactivated$runtime_release(Snapshot snapshot) {
    ...
    public Void mo2209nestedActivated$runtime_release(Snapshot snapshot) {
        Intrinsics.checkNotNullParameter(snapshot, "snapshot");
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
