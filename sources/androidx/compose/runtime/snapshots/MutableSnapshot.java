...
public class MutableSnapshot extends Snapshot {
    ...
    */
    ...
    public void dispose() {
        ...
        super.dispose();
        mo2511nestedDeactivated$runtime_release(this);
    }
    ...
    public void mo2510nestedActivated$runtime_release(Snapshot snapshot) {
    ...
    public void mo2511nestedDeactivated$runtime_release(Snapshot snapshot) {
        Intrinsics.checkNotNullParameter(snapshot, "snapshot");
    ...
    */
    ...
    public final <T> T advance$runtime_release(Functions<? extends T> block) {
        int i;
        SnapshotIdSet snapshotIdSet;
    ...
    public void mo2512recordModified$runtime_release(StateObject state) {
    ...
    /* compiled from: Snapshot.kt */
    @Metadata(m41d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0015\n\u0000\b\u0082\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m40d2 = {"Landroidx/compose/runtime/snapshots/MutableSnapshot$Companion;", "", "()V", "EmptyIntArray", "", "runtime_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
    /* loaded from: classes.dex */
    ...
    public final void recordPreviousList$runtime_release(SnapshotIdSet snapshots) {
        ...
        synchronized (SnapshotKt.getLock()) {
            this.previousIds = this.previousIds.m287or(snapshots);
            Unit unit = Unit.INSTANCE;
        }
    }
}
