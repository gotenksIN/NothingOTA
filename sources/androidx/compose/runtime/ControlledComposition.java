...
public interface ControlledComposition extends Composition {
    ...
    <R> R delegateInvalidations(ControlledComposition controlledComposition, int i, Functions<? extends R> functions);

    void disposeUnusedMovableContent(MovableContentState movableContentState);

    boolean getHasPendingChanges();

    void insertMovableContent(List<Tuples<MovableContentStateReference, MovableContentStateReference>> list);
    ...
    void prepareCompose(Functions<Unit> functions);
