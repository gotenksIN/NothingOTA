...
public final class PersistentHashMapContentViews<K, V> extends AbstractSet<Map.Entry<? extends K, ? extends V>> implements ImmutableSet<Map.Entry<? extends K, ? extends V>> {
    ...
    public PersistentHashMapContentViews(PersistentHashMap<K, V> map) {
