...
public abstract class TrieNodeBaseIterator<K, V, T> implements Iterator<T>, KMarkers {
    ...
    public final boolean hasNextNode() {
        commonFunctions.m2508assert(this.index >= this.dataSize);
