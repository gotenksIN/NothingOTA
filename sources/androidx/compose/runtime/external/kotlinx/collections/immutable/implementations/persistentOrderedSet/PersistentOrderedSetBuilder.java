...
public final class PersistentOrderedSetBuilder<E> extends AbstractMutableSet<E> implements PersistentSet.Builder<E> {
    ...
    public PersistentSet<E> build() {
        ...
        if (build == this.set.getHashMap$runtime_release()) {
            CommonFunctionsKt.m2207assert(this.firstElement == this.set.getFirstElement$runtime_release());
            CommonFunctionsKt.m2207assert(this.lastElement == this.set.getLastElement$runtime_release());
