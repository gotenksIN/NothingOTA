...
final class PersistentOrderedMapBuilderContentIterators<K, V> extends PersistentHashMapContentIterators<K, V> implements Map.Entry<K, V>, KMutableMap.Entry {
    private LinkedValue<V> links;
    private final Map<K, LinkedValue<V>> mutableMap;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PersistentOrderedMapBuilderContentIterators(Map<K, LinkedValue<V>> mutableMap, K k, LinkedValue<V> links) {
