...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> trieNode, MutableCounter mutableCounter, MutabilityOwnership mutabilityOwnership) {
        commonFunctions.m2508assert(this.nodeMap == 0);
        commonFunctions.m2508assert(this.dataMap == 0);
        commonFunctions.m2508assert(trieNode.nodeMap == 0);
        commonFunctions.m2508assert(trieNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> otherNode, int i, MutableCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
