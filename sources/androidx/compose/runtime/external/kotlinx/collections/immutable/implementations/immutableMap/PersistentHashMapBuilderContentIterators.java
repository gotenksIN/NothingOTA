...
public final class PersistentHashMapBuilderContentIterators<K, V> extends PersistentHashMapContentIterators<K, V> implements Map.Entry<K, V>, KMutableMap.Entry {
    ...
    public PersistentHashMapBuilderContentIterators(PersistentHashMapBuilderEntriesIterator<K, V> parentIterator, K k, V v) {
        super(k, v);
