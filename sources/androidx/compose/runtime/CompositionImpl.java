...
public final class CompositionImpl implements ControlledComposition, RecomposeScopeOwner {
    ...
    public CompositionImpl(CompositionContext parent, Applier<?> applier, CoroutineContext coroutineContext) {
        ...
        this.composable = ComposableSingletons$CompositionKt.INSTANCE.m2170getLambda1$runtime_release();
    }
    ...
    public void dispose() {
        synchronized (this.lock) {
            if (!this.disposed) {
                this.disposed = true;
                this.composable = ComposableSingletons$CompositionKt.INSTANCE.m2171getLambda2$runtime_release();
