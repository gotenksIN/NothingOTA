...
public final class MovableContentStateReference {
    ...
    private List<Tuples<RecomposeScopeImpl, IdentityArraySet<Object>>> invalidations;
    private final PersistentCompositionLocalMap locals;
    private final Object parameter;
    private final SlotTable slotTable;

    public MovableContentStateReference(MovableContent<Object> content, Object obj, ControlledComposition composition, SlotTable slotTable, Anchor anchor, List<Tuples<RecomposeScopeImpl, IdentityArraySet<Object>>> invalidations, PersistentCompositionLocalMap locals) {
    ...
    public final List<Tuples<RecomposeScopeImpl, IdentityArraySet<Object>>> getInvalidations$runtime_release() {
        return this.invalidations;
    }

    public final void setInvalidations$runtime_release(List<Tuples<RecomposeScopeImpl, IdentityArraySet<Object>>> list) {
