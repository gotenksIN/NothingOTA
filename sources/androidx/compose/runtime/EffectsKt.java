...
public final class EffectsKt {
    ...
    public static final void SideEffect(Functions<Unit> effect, Composer composer, int i) {
    ...
    public static final CoroutineScope rememberCoroutineScope(Functions<? extends CoroutineContext> functions, Composer composer, int i, int i2) {
        composer.startReplaceableGroup(773894976);
        ComposerKt.sourceInformation(composer, "CC(rememberCoroutineScope)488@20446L144:Effects.kt#9igjgp");
        if ((i2 & 1) != 0) {
            functions = new Functions<EmptyCoroutineContext>() { // from class: androidx.compose.runtime.EffectsKt$rememberCoroutineScope$1
