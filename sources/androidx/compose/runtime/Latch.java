...
public final class Latch {
    ...
    public final <R> R withClosed(Functions<? extends R> block) {
    ...
    public final void openLatch() {
        synchronized (this.lock) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                list.get(i).resumeWith(Result.m5649constructorimpl(Unit.INSTANCE));
            }
            list.clear();
            Unit unit = Unit.INSTANCE;
        }
