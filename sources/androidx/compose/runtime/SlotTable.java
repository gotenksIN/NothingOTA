...
public final class SlotTable implements CompositionData, Iterable<CompositionGroup>, KMarkers {
    ...
    public final Object slot$runtime_release(int i, int i2) {
        ...
        boolean z = true;
        int i3 = i + 1;
        int access$dataAnchor = (i3 < this.groupsSize ? SlotTableKt.access$dataAnchor(this.groups, i3) : this.slots.length) - access$slotAnchor;
        if (i2 < 0 || i2 >= access$dataAnchor) {
            z = false;
        }
        return z ? this.slots[access$slotAnchor + i2] : Composer.Companion.getEmpty();
    }
