...
public final class GroupKind {
    ...
    private static final int Group = m2175constructorimpl(0);
    private static final int Node = m2175constructorimpl(1);
    private static final int ReusableNode = m2175constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ GroupKind m2174boximpl(int i) {
    ...
    public static boolean m2176equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m2182unboximpl();
    }
    ...
    public static String m2181toStringimpl(int i) {
    ...
    public String toString() {
        return m2181toStringimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m2182unboximpl() {
        return this.value;
    }
    ...
    public static final boolean m2179isNodeimpl(int i) {
        return i != Companion.m2183getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl  reason: not valid java name */
    public static final boolean m2180isReusableimpl(int i) {
        return i != Companion.m2184getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m2183getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs  reason: not valid java name */
        public final int m2184getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs  reason: not valid java name */
        public final int m2185getReusableNodeULZAiWs() {
