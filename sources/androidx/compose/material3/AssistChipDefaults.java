...
public final class AssistChipDefaults {
    ...
    private static final float Height = AssistChipTokens.INSTANCE.m1614getContainerHeightD9Ej5fM();
    private static final float IconSize = AssistChipTokens.INSTANCE.m1623getIconSizeD9Ej5fM();

    private AssistChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM  reason: not valid java name */
    public final float m920getHeightD9Ej5fM() {
        return Height;
    }

    /* renamed from: getIconSize-D9Ej5fM  reason: not valid java name */
    public final float m921getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: assistChipColors-oq7We08  reason: not valid java name */
    public final ChipColors m916assistChipColorsoq7We08(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, Composer composer, int i, int i2) {
        ...
        long m2591getTransparent0d7_KjU2 = (i2 & 16) != 0 ? Color.Companion.m2591getTransparent0d7_KjU() : j5;
        long m2555copywmQWz5c$default = (i2 & 32) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long m2555copywmQWz5c$default2 = (i2 & 64) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j7;
        long j10 = (i2 & 128) != 0 ? m2555copywmQWz5c$default2 : j8;
        ...
        ChipColors chipColors = new ChipColors(m2591getTransparent0d7_KjU, color, color2, j9, m2591getTransparent0d7_KjU2, m2555copywmQWz5c$default, m2555copywmQWz5c$default2, j10, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ChipElevation m917assistChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1621getFlatContainerElevationD9Ej5fM = (i2 & 1) != 0 ? AssistChipTokens.INSTANCE.m1621getFlatContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m1621getFlatContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m1621getFlatContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m1621getFlatContainerElevationD9Ej5fM : f4;
        float m1615getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? AssistChipTokens.INSTANCE.m1615getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? m1621getFlatContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(245366099, i, -1, "androidx.compose.material3.AssistChipDefaults.assistChipElevation (Chip.kt:679)");
        }
        ChipElevation chipElevation = new ChipElevation(m1621getFlatContainerElevationD9Ej5fM, f7, f8, f9, m1615getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipBorder m915assistChipBorderd_3_b6Q(long j, long j2, float f, Composer composer, int i, int i2) {
        ...
        long m2555copywmQWz5c$default = (i2 & 2) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j2;
        float m1622getFlatOutlineWidthD9Ej5fM = (i2 & 4) != 0 ? AssistChipTokens.INSTANCE.m1622getFlatOutlineWidthD9Ej5fM() : f;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(382372847, i, -1, "androidx.compose.material3.AssistChipDefaults.assistChipBorder (Chip.kt:703)");
        }
        ChipBorder chipBorder = new ChipBorder(color, m2555copywmQWz5c$default, m1622getFlatOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipColors m918elevatedAssistChipColorsoq7We08(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, Composer composer, int i, int i2) {
        ...
        long m2555copywmQWz5c$default = (i2 & 16) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2555copywmQWz5c$default2 = (i2 & 32) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long m2555copywmQWz5c$default3 = (i2 & 64) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j7;
        long j10 = (i2 & 128) != 0 ? m2555copywmQWz5c$default3 : j8;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipColors chipColors = new ChipColors(color, color2, color3, j9, m2555copywmQWz5c$default, m2555copywmQWz5c$default2, m2555copywmQWz5c$default3, j10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipElevation m919elevatedAssistChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1616getElevatedContainerElevationD9Ej5fM = (i2 & 1) != 0 ? AssistChipTokens.INSTANCE.m1616getElevatedContainerElevationD9Ej5fM() : f;
        float m1620getElevatedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? AssistChipTokens.INSTANCE.m1620getElevatedPressedContainerElevationD9Ej5fM() : f2;
        float m1618getElevatedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? AssistChipTokens.INSTANCE.m1618getElevatedFocusContainerElevationD9Ej5fM() : f3;
        float m1619getElevatedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? AssistChipTokens.INSTANCE.m1619getElevatedHoverContainerElevationD9Ej5fM() : f4;
        float m1615getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? AssistChipTokens.INSTANCE.m1615getDraggedContainerElevationD9Ej5fM() : f5;
        float m1617getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? AssistChipTokens.INSTANCE.m1617getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipElevation chipElevation = new ChipElevation(m1616getElevatedContainerElevationD9Ej5fM, m1620getElevatedPressedContainerElevationD9Ej5fM, m1618getElevatedFocusContainerElevationD9Ej5fM, m1619getElevatedHoverContainerElevationD9Ej5fM, m1615getDraggedContainerElevationD9Ej5fM, m1617getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
