...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public final long m1512getSizeMYxV2XQ() {
        return this.size;
    }
    ...
    public MeasureResult mo326measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final int max = Math.max(mo4376measureBRTryo0.getWidth(), measure.mo597roundToPx0680j_4(DpSize.m5449getWidthD9Ej5fM(this.size)));
        final int max2 = Math.max(mo4376measureBRTryo0.getHeight(), measure.mo597roundToPx0680j_4(DpSize.m5447getHeightD9Ej5fM(this.size)));
        return MeasureScope.layout$default(measure, max, max2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, mo4376measureBRTryo0, MathKt.roundToInt((max - mo4376measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((max2 - mo4376measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return DpSize.m5446equalsimpl0(this.size, minimumInteractiveComponentSizeModifier.size);
    }

    public int hashCode() {
        return DpSize.m5451hashCodeimpl(this.size);
    }
}
