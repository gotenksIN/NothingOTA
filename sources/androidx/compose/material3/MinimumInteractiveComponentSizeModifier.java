...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public final long m1211getSizeMYxV2XQ() {
        return this.size;
    }
    ...
    public MeasureResult mo25measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final int max = Math.max(mo4075measureBRTryo0.getWidth(), measure.mo296roundToPx0680j_4(DpSize.m5148getWidthD9Ej5fM(this.size)));
        final int max2 = Math.max(mo4075measureBRTryo0.getHeight(), measure.mo296roundToPx0680j_4(DpSize.m5146getHeightD9Ej5fM(this.size)));
        return MeasureScope.layout$default(measure, max, max2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, mo4075measureBRTryo0, MathKt.roundToInt((max - mo4075measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((max2 - mo4075measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return DpSize.m5145equalsimpl0(this.size, minimumInteractiveComponentSizeModifier.size);
    }

    public int hashCode() {
        return DpSize.m5150hashCodeimpl(this.size);
    }
}
