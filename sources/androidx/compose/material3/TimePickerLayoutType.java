...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m1515constructorimpl(0);
    private static final int Vertical = m1515constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m1514boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1515constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1516equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).m1520unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1517equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static String m1519toStringimpl(int i) {
        return m1517equalsimpl0(i, Horizontal) ? "Horizontal" : m1517equalsimpl0(i, Vertical) ? "Vertical" : "Unknown";
    }
}
