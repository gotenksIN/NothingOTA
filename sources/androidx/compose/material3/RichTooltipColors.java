...
public final class RichTooltipColors {
    ...
    public final long m1285getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getContentColor-0d7_KjU  reason: not valid java name */
    public final long m1286getContentColor0d7_KjU() {
        return this.contentColor;
    }

    /* renamed from: getTitleContentColor-0d7_KjU  reason: not valid java name */
    public final long m1287getTitleContentColor0d7_KjU() {
        return this.titleContentColor;
    }

    /* renamed from: getActionContentColor-0d7_KjU  reason: not valid java name */
    public final long m1284getActionContentColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RichTooltipColors) {
            ...
            return Color.m2557equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m2557equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m2557equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m2557equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((Color.m2563hashCodeimpl(this.containerColor) * 31) + Color.m2563hashCodeimpl(this.contentColor)) * 31) + Color.m2563hashCodeimpl(this.titleContentColor)) * 31) + Color.m2563hashCodeimpl(this.actionContentColor);
    }
}
