...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5050constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m5050constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m5050constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m1748getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m1747getLevel0D9Ej5fM();
    ...
    public final float m1901getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1902getContainerWidthD9Ej5fM() {
    ...
    public final float m1904getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1905getStandardContainerElevationD9Ej5fM() {
