...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = C0780Dp.m5351constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = C0780Dp.m5351constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = C0780Dp.m5351constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m2049getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m2048getLevel0D9Ej5fM();
    ...
    public final float m2202getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2203getContainerWidthD9Ej5fM() {
    ...
    public final float m2205getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m2206getStandardContainerElevationD9Ej5fM() {
