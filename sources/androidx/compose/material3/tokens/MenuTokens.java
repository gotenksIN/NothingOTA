...
public final class MenuTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m1749getLevel2D9Ej5fM();
    ...
    private static final float ListItemContainerHeight = Dp.m5050constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 24.0d;
        ListItemLeadingIconSize = Dp.m5050constructorimpl(f);
        ListItemTrailingIconSize = Dp.m5050constructorimpl(f);
    }
    ...
    public final float m1892getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m1893getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m1894getListItemTrailingIconSizeD9Ej5fM() {
