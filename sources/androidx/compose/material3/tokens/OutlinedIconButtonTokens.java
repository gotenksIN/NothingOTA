...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5050constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5050constructorimpl((float) 24.0d);
    ...
    public final float m1934getContainerSizeD9Ej5fM() {
    ...
    public final float m1935getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m1936getUnselectedOutlineWidthD9Ej5fM() {
