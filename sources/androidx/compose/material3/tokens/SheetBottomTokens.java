...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m5050constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m5050constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m1748getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m1748getLevel1D9Ej5fM();
    ...
    public final float m2039getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM  reason: not valid java name */
    public final float m2040getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2041getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m2042getDockedStandardContainerElevationD9Ej5fM() {
