...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = C0780Dp.m5351constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = C0780Dp.m5351constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m2049getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m2049getLevel1D9Ej5fM();
    ...
    public final float m2340getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM  reason: not valid java name */
    public final float m2341getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2342getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m2343getDockedStandardContainerElevationD9Ej5fM() {
