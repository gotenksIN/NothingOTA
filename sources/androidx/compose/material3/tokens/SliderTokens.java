...
public final class SliderTokens {
    ...
    private static final float LabelContainerHeight = Dp.m5050constructorimpl((float) 28.0d);
    ...
    private static final float OverlapHandleOutlineWidth = Dp.m5050constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5050constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m5050constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m5050constructorimpl(f2);
        HandleWidth = Dp.m5050constructorimpl(f2);
        InactiveTrackHeight = Dp.m5050constructorimpl(f);
    }
    ...
    public final float m2043getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2044getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2045getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM  reason: not valid java name */
    public final float m2046getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2047getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2048getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2049getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m2050getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2052getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM  reason: not valid java name */
    public final float m2054getTrackElevationD9Ej5fM() {
    ...
    public final float m2051getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2053getTickMarksContainerSizeD9Ej5fM() {
