...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2048getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2049getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2048getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = C0780Dp.m5351constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2048getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = C0780Dp.m5351constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = C0780Dp.m5351constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = C0780Dp.m5351constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = C0780Dp.m5351constructorimpl(f2);
        HandleWidth = C0780Dp.m5351constructorimpl(f2);
        InactiveTrackHeight = C0780Dp.m5351constructorimpl(f);
    }
    ...
    public final float m2344getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2345getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2346getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM  reason: not valid java name */
    public final float m2347getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2348getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2349getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2350getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m2351getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2353getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM  reason: not valid java name */
    public final float m2355getTrackElevationD9Ej5fM() {
    ...
    public final float m2352getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2354getTickMarksContainerSizeD9Ej5fM() {
