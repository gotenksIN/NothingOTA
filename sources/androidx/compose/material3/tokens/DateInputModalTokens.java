...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m5050constructorimpl((float) 512.0d);
    ...
    public final float m1708getContainerElevationD9Ej5fM() {
    ...
    public final float m1711getHeaderContainerHeightD9Ej5fM() {
        return HeaderContainerHeight;
    }

    /* renamed from: getHeaderContainerWidth-D9Ej5fM  reason: not valid java name */
    public final float m1712getHeaderContainerWidthD9Ej5fM() {
