...
public final class BadgeTokens {
    ...
    private static final float LargeSize = C0780Dp.m5351constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = C0780Dp.m5351constructorimpl((float) 6.0d);
    ...
    public final float m1925getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m1926getSizeD9Ej5fM() {
        return Size;
    }
}
