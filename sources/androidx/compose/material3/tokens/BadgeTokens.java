...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m5050constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m5050constructorimpl((float) 6.0d);
    ...
    public final float m1624getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
