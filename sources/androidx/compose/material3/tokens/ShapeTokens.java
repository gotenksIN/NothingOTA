...
public final class ShapeTokens {
    ...
    private static final RoundedCornerShape CornerMedium = RoundedCornerShapeKt.m990RoundedCornerShape0680j_4(C0780Dp.m5351constructorimpl((float) 12.0d));
    private static final Shape CornerNone = RectangleShape.getRectangleShape();
    private static final RoundedCornerShape CornerSmall = RoundedCornerShapeKt.m990RoundedCornerShape0680j_4(C0780Dp.m5351constructorimpl((float) 8.0d));
    ...
    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m990RoundedCornerShape0680j_4(C0780Dp.m5351constructorimpl(f));
        float f2 = (float) 0.0d;
        CornerExtraLargeTop = RoundedCornerShapeKt.m991RoundedCornerShapea9UjIt4(C0780Dp.m5351constructorimpl(f), C0780Dp.m5351constructorimpl(f), C0780Dp.m5351constructorimpl(f2), C0780Dp.m5351constructorimpl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m990RoundedCornerShape0680j_4(C0780Dp.m5351constructorimpl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m991RoundedCornerShapea9UjIt4(C0780Dp.m5351constructorimpl(f3), C0780Dp.m5351constructorimpl(f3), C0780Dp.m5351constructorimpl(f2), C0780Dp.m5351constructorimpl(f2));
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m990RoundedCornerShape0680j_4(C0780Dp.m5351constructorimpl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m991RoundedCornerShapea9UjIt4(C0780Dp.m5351constructorimpl(f2), C0780Dp.m5351constructorimpl(f4), C0780Dp.m5351constructorimpl(f4), C0780Dp.m5351constructorimpl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m991RoundedCornerShapea9UjIt4(C0780Dp.m5351constructorimpl(f4), C0780Dp.m5351constructorimpl(f4), C0780Dp.m5351constructorimpl(f2), C0780Dp.m5351constructorimpl(f2));
    }
}
