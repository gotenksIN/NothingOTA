...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5050constructorimpl((float) 64.0d);
    ...
    private static final float ContainerHeight = Dp.m5050constructorimpl((float) 80.0d);
    ...
    public final float m1895getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1896getActiveIndicatorWidthD9Ej5fM() {
