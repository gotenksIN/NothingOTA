...
public final class ElevationTokens {
    ...
    private static final float Level0 = Dp.m5050constructorimpl((float) 0.0d);
    private static final float Level1 = Dp.m5050constructorimpl((float) 1.0d);
    private static final float Level2 = Dp.m5050constructorimpl((float) 3.0d);
    private static final float Level3 = Dp.m5050constructorimpl((float) 6.0d);
    private static final float Level4 = Dp.m5050constructorimpl((float) 8.0d);
    private static final float Level5 = Dp.m5050constructorimpl((float) 12.0d);

    private ElevationTokens() {
    }

    /* renamed from: getLevel0-D9Ej5fM  reason: not valid java name */
    public final float m1747getLevel0D9Ej5fM() {
        return Level0;
    }

    /* renamed from: getLevel1-D9Ej5fM  reason: not valid java name */
    public final float m1748getLevel1D9Ej5fM() {
        return Level1;
    }

    /* renamed from: getLevel2-D9Ej5fM  reason: not valid java name */
    public final float m1749getLevel2D9Ej5fM() {
        return Level2;
    }

    /* renamed from: getLevel3-D9Ej5fM  reason: not valid java name */
    public final float m1750getLevel3D9Ej5fM() {
        return Level3;
    }

    /* renamed from: getLevel4-D9Ej5fM  reason: not valid java name */
    public final float m1751getLevel4D9Ej5fM() {
        return Level4;
    }

    /* renamed from: getLevel5-D9Ej5fM  reason: not valid java name */
    public final float m1752getLevel5D9Ej5fM() {
        return Level5;
    }
}
