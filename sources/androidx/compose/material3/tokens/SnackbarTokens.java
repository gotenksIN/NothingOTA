...
public final class SnackbarTokens {
    ...
    private static final float SingleLineContainerHeight = Dp.m5050constructorimpl((float) 48.0d);
    private static final float TwoLinesContainerHeight = Dp.m5050constructorimpl((float) 68.0d);
    ...
    public final float m2057getSingleLineContainerHeightD9Ej5fM() {
        return SingleLineContainerHeight;
    }

    /* renamed from: getTwoLinesContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m2058getTwoLinesContainerHeightD9Ej5fM() {
