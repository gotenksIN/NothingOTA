...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5050constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m5050constructorimpl((float) 48.0d);
    ...
    public final float m1648getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1649getSizeD9Ej5fM() {
        return Size;
    }
}
