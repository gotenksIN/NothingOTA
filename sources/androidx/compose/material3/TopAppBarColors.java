...
public final class TopAppBarColors {
    ...
    public final long m1602getNavigationIconContentColor0d7_KjU$material3_release() {
    ...
    public final long m1603getTitleContentColor0d7_KjU$material3_release() {
        return this.titleContentColor;
    }

    /* renamed from: getActionIconContentColor-0d7_KjU$material3_release  reason: not valid java name */
    public final long m1601getActionIconContentColor0d7_KjU$material3_release() {
        return this.actionIconContentColor;
    }

    /* renamed from: containerColor-XeAY9LY$material3_release  reason: not valid java name */
    public final long m1600containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long m2607lerpjxsXWHM = ColorKt.m2607lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2607lerpjxsXWHM;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2557equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m2557equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m2557equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m2557equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m2557equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m2563hashCodeimpl(this.containerColor) * 31) + Color.m2563hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m2563hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m2563hashCodeimpl(this.titleContentColor)) * 31) + Color.m2563hashCodeimpl(this.actionIconContentColor);
    }
}
