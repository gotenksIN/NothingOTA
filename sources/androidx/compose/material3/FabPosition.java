...
public final class FabPosition {
    ...
    private static final int Center = m1130constructorimpl(0);
    private static final int End = m1130constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FabPosition m1129boximpl(int i) {
    ...
    public static boolean m1131equalsimpl(int i, Object obj) {
        return (obj instanceof FabPosition) && i == ((FabPosition) obj).m1135unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1132equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1133hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1136getCenterERTFSPs() {
            return FabPosition.Center;
        }

        /* renamed from: getEnd-ERTFSPs  reason: not valid java name */
        public final int m1137getEndERTFSPs() {
    ...
    public String toString() {
        return m1134toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1134toStringimpl(int i) {
        return m1132equalsimpl0(i, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
}
