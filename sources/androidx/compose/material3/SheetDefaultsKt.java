...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m5050constructorimpl(22);
    private static final float BottomSheetMaxWidth = Dp.m5050constructorimpl(640);
    ...
    public static final NestedScrollConnection ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(final SheetState sheetState, final Orientation orientation, final Function1<? super Float, Unit> onFling) {
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1
            ...
            public long mo310onPreScrollOzD1aCk(long j, int i) {
                ...
                if (offsetToFloat < 0.0f && NestedScrollSource.m3851equalsimpl0(i, NestedScrollSource.Companion.m3856getDragWNlRxjI())) {
            ...
            private final float velocityToFloat(long j) {
                return orientation == Orientation.Horizontal ? Velocity.m5275getXimpl(j) : Velocity.m5276getYimpl(j);
            }

            private final float offsetToFloat(long j) {
                return orientation == Orientation.Horizontal ? Offset.m2318getXimpl(j) : Offset.m2319getYimpl(j);
            }
        };
    }
    ...
    public static final SheetState rememberSheetState(boolean z, Function1<? super SheetValue, Boolean> function1, SheetValue sheetValue, boolean z2, Composer composer, int i, int i2) {
        ...
        SheetState sheetState = (SheetState) RememberSaveableKt.m2208rememberSaveable(objArr, Saver, (String) null, (Function0<? extends Object>) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
