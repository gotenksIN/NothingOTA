...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        ...
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m681CornerSize0680j_4(Dp.m5050constructorimpl(f)), CornerSizeKt.m681CornerSize0680j_4(Dp.m5050constructorimpl(f)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape cornerBasedShape) {
        Intrinsics.checkNotNullParameter(cornerBasedShape, "<this>");
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m681CornerSize0680j_4(Dp.m5050constructorimpl(f)), CornerSizeKt.m681CornerSize0680j_4(Dp.m5050constructorimpl(f)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape cornerBasedShape) {
        Intrinsics.checkNotNullParameter(cornerBasedShape, "<this>");
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, CornerSizeKt.m681CornerSize0680j_4(Dp.m5050constructorimpl(f)), CornerSizeKt.m681CornerSize0680j_4(Dp.m5050constructorimpl(f)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        Intrinsics.checkNotNullParameter(cornerBasedShape, "<this>");
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m681CornerSize0680j_4(Dp.m5050constructorimpl(f)), null, null, CornerSizeKt.m681CornerSize0680j_4(Dp.m5050constructorimpl(f)), 6, null);
    }
}
