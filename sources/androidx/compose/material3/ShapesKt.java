...
public final class ShapesKt {
    ...
    public static final Shape fromToken(Shapes shapes, ShapeKeyTokens value) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[value.ordinal()]) {
            ...
            case 10:
                return RectangleShape.getRectangleShape();
            case 11:
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        ...
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m982CornerSize0680j_4(C0780Dp.m5351constructorimpl(f)), CornerSizeKt.m982CornerSize0680j_4(C0780Dp.m5351constructorimpl(f)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape cornerBasedShape) {
        Intrinsics.checkNotNullParameter(cornerBasedShape, "<this>");
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m982CornerSize0680j_4(C0780Dp.m5351constructorimpl(f)), CornerSizeKt.m982CornerSize0680j_4(C0780Dp.m5351constructorimpl(f)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape cornerBasedShape) {
        Intrinsics.checkNotNullParameter(cornerBasedShape, "<this>");
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, CornerSizeKt.m982CornerSize0680j_4(C0780Dp.m5351constructorimpl(f)), CornerSizeKt.m982CornerSize0680j_4(C0780Dp.m5351constructorimpl(f)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        Intrinsics.checkNotNullParameter(cornerBasedShape, "<this>");
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m982CornerSize0680j_4(C0780Dp.m5351constructorimpl(f)), null, null, CornerSizeKt.m982CornerSize0680j_4(C0780Dp.m5351constructorimpl(f)), 6, null);
    }
}
