...
public final class DragGestureDetectorCopyKt {
    ...
    */
    public static final java.lang.Object m1109awaitHorizontalPointerSlopOrCancellationgDDlDlE(androidx.compose.ui.input.pointer.AwaitPointerEventScope r19, long r20, int r22, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.PointerInputChange, ? super java.lang.Float, kotlin.Unit> r23, kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r24) {
        /*
            Method dump skipped, instructions count: 392
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.DragGestureDetectorCopyKt.m1109awaitHorizontalPointerSlopOrCancellationgDDlDlE(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: awaitPointerSlopOrCancellation-pn7EDYM  reason: not valid java name */
    private static final Object m1110awaitPointerSlopOrCancellationpn7EDYM(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function1<? super Offset, Float> function1, Continuation<? super PointerInputChange> continuation) {
        float f;
        PointerInputChange pointerInputChange;
        PointerInputChange pointerInputChange2;
        if (m1111isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), j)) {
            return null;
        }
        float m1112pointerSlopE8SPZFQ = m1112pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
        ...
        while (true) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange3)) {
                ...
                float floatValue = f + (function1.invoke(Offset.m2307boximpl(pointerInputChange3.m3957getPositionF1C5BW0())).floatValue() - function1.invoke(Offset.m2307boximpl(pointerInputChange3.m3958getPreviousPositionF1C5BW0())).floatValue());
                if (Math.abs(floatValue) < m1112pointerSlopE8SPZFQ) {
                    ...
                    function2.invoke(pointerInputChange3, Float.valueOf(floatValue - (Math.signum(floatValue) * m1112pointerSlopE8SPZFQ)));
                    if (pointerInputChange3.isConsumed()) {
    ...
    private static final boolean m1111isPointerUpDmW0f2w(PointerEvent pointerEvent, long j) {
        PointerInputChange pointerInputChange;
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        boolean z = false;
    ...
    public static final float m1112pointerSlopE8SPZFQ(ViewConfiguration pointerSlop, int i) {
