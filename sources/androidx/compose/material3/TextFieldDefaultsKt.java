...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m1473animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        State<Color> indicatorColor$material3_release = textFieldColors.indicatorColor$material3_release(z, z2, interactionSource, composer, (i & 14) | (i & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i & 896) | (i & 7168));
        ...
        if (z) {
            ...
            rememberUpdatedState = AnimateAsStateKt.m81animateDpAsStateAjpBEmI(f3, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1927737286);
            ComposerKt.sourceInformation(composer, "2118@112993L46");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Dp.m5048boximpl(f2), composer, (i >> 15) & 14);
            composer.endReplaceableGroup();
        }
        State<BorderStroke> rememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(rememberUpdatedState.getValue().m5064unboximpl(), new SolidColor(indicatorColor$material3_release.getValue().m2566unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
