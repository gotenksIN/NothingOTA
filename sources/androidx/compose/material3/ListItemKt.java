...
public final class ListItemKt {
    ...
    */
    public static final void m1490ListItemHXNGIdc(final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r40, androidx.compose.p002ui.Modifier r41, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r42, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r43, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r44, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r45, androidx.compose.material3.ListItem r46, float r47, float r48, androidx.compose.runtime.Composer r49, final int r50, final int r51) {
        /*
            Method dump skipped, instructions count: 942
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ListItemKt.m1490ListItemHXNGIdc(kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.material3.ListItemColors, float, float, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    public static final void m1489LeadingContent3IgeMak(final RowScope rowScope, final long j, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColor.getLocalContentColor().provides(Color.m2847boximpl(j))}, ComposableLambdaKt.composableLambda(startRestartGroup, 315166618, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$LeadingContent$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        Modifier then = Padding.m720paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, f, 0.0f, 11, null).then(!z ? rowScope.align(Modifier.Companion, Alignment.Companion.getCenterVertically()) : Modifier.Companion);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$LeadingContent$2
            ...
            public final void invoke(Composer composer2, int i3) {
                ListItemKt.m1489LeadingContent3IgeMak(RowScope.this, j, z, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void m1493TrailingContent3IgeMak(final RowScope rowScope, final long j, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m718paddingVpY3zN4$default = Padding.m718paddingVpY3zN4$default(Modifier.Companion, TrailingHorizontalPadding, 0.0f, 2, null);
            Modifier.Companion companion = Modifier.Companion;
            if (!z) {
                companion = rowScope.align(companion, Alignment.Companion.getCenterVertically());
            }
            Modifier then = m718paddingVpY3zN4$default.then(companion);
            ...
            int i3 = i2 >> 3;
            m1492ProvideTextStyleFromToken3JVO9M(j, ListTokens.INSTANCE.getListItemTrailingSupportingTextFont(), function2, startRestartGroup, (i3 & 14) | 48 | (i3 & 896));
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$TrailingContent$2
            ...
            public final void invoke(Composer composer2, int i4) {
                ListItemKt.m1493TrailingContent3IgeMak(RowScope.this, j, z, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void m1492ProvideTextStyleFromToken3JVO9M(final long j, final TypographyKeyTokens typographyKeyTokens, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        final int i2;
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColor.getLocalContentColor().provides(Color.m2847boximpl(j))}, ComposableLambdaKt.composableLambda(startRestartGroup, -514310925, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ProvideTextStyleFromToken$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    Text.ProvideTextStyle(TextStyle.this, function2, composer2, (i2 >> 3) & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ProvideTextStyleFromToken$2
            ...
            public final void invoke(Composer composer2, int i3) {
                ListItemKt.m1492ProvideTextStyleFromToken3JVO9M(j, typographyKeyTokens, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    static {
        float f = 8;
        ListItemVerticalPadding = C0780Dp.m5351constructorimpl(f);
        float f2 = 16;
        ListItemThreeLineVerticalPadding = C0780Dp.m5351constructorimpl(f2);
        ListItemHorizontalPadding = C0780Dp.m5351constructorimpl(f2);
        LeadingContentEndPadding = C0780Dp.m5351constructorimpl(f2);
        ContentEndPadding = C0780Dp.m5351constructorimpl(f);
        TrailingHorizontalPadding = C0780Dp.m5351constructorimpl(f);
    }
}
