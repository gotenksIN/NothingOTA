...
public final class BadgeKt {
    private static final float BadgeOffset = Dp.m5050constructorimpl(0);
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m922BadgeeopBjH0(androidx.compose.ui.Modifier r17, long r18, long r20, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r22, androidx.compose.runtime.Composer r23, final int r24, final int r25) {
        /*
            Method dump skipped, instructions count: 665
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.BadgeKt.m922BadgeeopBjH0(androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    static {
        float f = 4;
        BadgeWithContentHorizontalPadding = Dp.m5050constructorimpl(f);
        BadgeWithContentHorizontalOffset = Dp.m5050constructorimpl(-Dp.m5050constructorimpl(f));
        BadgeWithContentVerticalOffset = Dp.m5050constructorimpl(-Dp.m5050constructorimpl(f));
    }
}
