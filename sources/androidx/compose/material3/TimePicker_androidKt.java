...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m1522getVerticalQJTpgSE = TimePickerLayoutType.Companion.m1521getHorizontalQJTpgSE();
        } else {
            m1522getVerticalQJTpgSE = TimePickerLayoutType.Companion.m1522getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1522getVerticalQJTpgSE;
    }
}
