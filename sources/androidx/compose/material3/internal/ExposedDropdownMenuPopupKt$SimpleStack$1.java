    ...
    public final MeasureResult mo313measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
        ...
        if (size != 0) {
            ...
            if (size == 1) {
                ...
                return MeasureScope.layout$default(Layout, mo4376measureBRTryo0.getWidth(), mo4376measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$SimpleStack$1$measure$2
                    {
                        super(1);
                    }
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                arrayList.add(measurables.get(i4).mo4376measureBRTryo0(j));
            }
