...
public final class SliderColors {
    ...
    public final State<Color> thumbColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(z ? this.thumbColor : this.disabledThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2858equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m2858equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m2858equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m2858equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m2858equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m2858equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m2858equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m2858equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m2858equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m2858equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m2864hashCodeimpl(this.thumbColor) * 31) + Color.m2864hashCodeimpl(this.activeTrackColor)) * 31) + Color.m2864hashCodeimpl(this.activeTickColor)) * 31) + Color.m2864hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m2864hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m2864hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m2864hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m2864hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m2864hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m2864hashCodeimpl(this.disabledInactiveTickColor);
    }
}
