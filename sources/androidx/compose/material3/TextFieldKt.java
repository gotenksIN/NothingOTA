...
public final class TextFieldKt {
    private static final float TextFieldWithLabelVerticalPadding = Dp.m5050constructorimpl(8);
    ...
    */
    ...
    public static final void TextFieldLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> textField, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final boolean z, final float f, final Function2<? super Composer, ? super Integer, Unit> container, final Function2<? super Composer, ? super Integer, Unit> function26, final PaddingValues paddingValues, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 1533916891) != 306783378 || (i4 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            int i7 = (i3 << 3) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
            ...
            Updater.m2202setimpl(m2195constructorimpl, textFieldMeasurePolicy, ComposeUiNode.Companion.getSetMeasurePolicy());
            ...
            if (function23 != null) {
                calculateEndPadding = Dp.m5050constructorimpl(RangesKt.coerceAtLeast(Dp.m5050constructorimpl(calculateEndPadding - TextFieldImplKt.getHorizontalIconPadding()), Dp.m5050constructorimpl(i6)));
            }
            ...
            if (function2 != null) {
                ...
                Modifier m419paddingqDBjuR0$default3 = PaddingKt.m419paddingqDBjuR0$default(SizeKt.wrapContentHeight$default(SizeKt.m446heightInVpY3zN4$default(LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.LabelId), DpKt.m5093lerpMdfbLM(TextFieldImplKt.getMinTextLineHeight(), TextFieldImplKt.getMinFocusedLabelLineHeight(), f), 0.0f, 2, null), null, false, 3, null), f3, 0.0f, calculateEndPadding, 0.0f, 10, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf6 = LayoutKt.materializerOf(m419paddingqDBjuR0$default3);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
            ...
            startRestartGroup.endReplaceableGroup();
            Modifier m419paddingqDBjuR0$default4 = PaddingKt.m419paddingqDBjuR0$default(SizeKt.wrapContentHeight$default(SizeKt.m446heightInVpY3zN4$default(Modifier.Companion, TextFieldImplKt.getMinTextLineHeight(), 0.0f, 2, null), null, false, 3, null), function24 == null ? f3 : Dp.m5050constructorimpl(0), 0.0f, function25 == null ? f2 : Dp.m5050constructorimpl(0), 0.0f, 10, null);
            startRestartGroup.startReplaceableGroup(-95269212);
            ComposerKt.sourceInformation(startRestartGroup, "601@27970L105");
            if (function3 != null) {
                function3.invoke(LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.PlaceholderId).then(m419paddingqDBjuR0$default4), startRestartGroup, Integer.valueOf((i3 >> 6) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle));
            }
            startRestartGroup.endReplaceableGroup();
            Modifier then3 = LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.TextFieldId).then(m419paddingqDBjuR0$default4);
            startRestartGroup.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    public static final int m1481calculateWidthyeHjK3Y(int i, int i2, int i3, int i4, int i5, int i6, int i7, long j) {
        int i8 = i3 + i4;
        return Math.max(i + Math.max(i5 + i8, Math.max(i7 + i8, i6)) + i2, Constraints.m5008getMinWidthimpl(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateHeight-mKXJcVc  reason: not valid java name */
    public static final int m1480calculateHeightmKXJcVc(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z, long j, float f, PaddingValues paddingValues) {
        float m5050constructorimpl;
        int max;
        boolean z2 = i2 > 0;
        if (!z2 || z) {
            m5050constructorimpl = Dp.m5050constructorimpl(paddingValues.mo398calculateTopPaddingD9Ej5fM() + paddingValues.mo395calculateBottomPaddingD9Ej5fM());
        } else {
            m5050constructorimpl = Dp.m5050constructorimpl(TextFieldImplKt.getTextFieldPadding() * 2);
        }
        float f2 = m5050constructorimpl * f;
        if (z2 && z) {
            f2 += i2;
            max = Math.max(i, i7);
        } else {
        ...
        return Math.max(Constraints.m5007getMinHeightimpl(j), ComparisonsKt.maxOf(i3, i4, i5, i6, MathKt.roundToInt(f2 + max)) + i8);
    }
    ...
    public static final void placeWithoutLabel(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, boolean z, float f, PaddingValues paddingValues) {
        Placeable.PlacementScope.m4123place70tqf50$default(placementScope, placeable7, IntOffset.Companion.m5178getZeronOccac(), 0.0f, 2, null);
        int heightOrZero = i2 - TextFieldImplKt.heightOrZero(placeable8);
        int roundToInt = MathKt.roundToInt(paddingValues.mo398calculateTopPaddingD9Ej5fM() * f);
        if (placeable3 != null) {
    ...
    public static final Modifier drawIndicatorLine(Modifier modifier, final BorderStroke indicatorBorder) {
        ...
        final float m170getWidthD9Ej5fM = indicatorBorder.m170getWidthD9Ej5fM();
        return DrawModifierKt.drawWithContent(modifier, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.TextFieldKt$drawIndicatorLine$1
            ...
            public final void invoke2(ContentDrawScope drawWithContent) {
                ...
                if (Dp.m5055equalsimpl0(m170getWidthD9Ej5fM, Dp.Companion.m5068getHairlineD9Ej5fM())) {
                    return;
                }
                float density = m170getWidthD9Ej5fM * drawWithContent.getDensity();
                float m2384getHeightimpl = Size.m2384getHeightimpl(drawWithContent.mo3096getSizeNHjbRc()) - (density / 2);
                DrawScope.m3082drawLine1RTmtNc$default(drawWithContent, indicatorBorder.getBrush(), OffsetKt.Offset(0.0f, m2384getHeightimpl), OffsetKt.Offset(Size.m2387getWidthimpl(drawWithContent.mo3096getSizeNHjbRc()), m2384getHeightimpl), density, 0, null, 0.0f, null, 0, 496, null);
            }
        });
    }
