...
public final class DateInputKt {
    ...
    private static final float InputTextNonErroneousBottomPadding = Dp.m5050constructorimpl(16);
    ...
    public static final void DateInputContent(final StateData stateData, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> dateValidator, Composer composer, final int i) {
        ...
        if ((i4 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            String m1397getStringNWtq28 = Strings_androidKt.m1397getStringNWtq28(Strings.Companion.m1343getDateInputInvalidForPatternadMyvUU(), startRestartGroup, 6);
            String m1397getStringNWtq282 = Strings_androidKt.m1397getStringNWtq28(Strings.Companion.m1345getDateInputInvalidYearRangeadMyvUU(), startRestartGroup, 6);
            String m1397getStringNWtq283 = Strings_androidKt.m1397getStringNWtq28(Strings.Companion.m1344getDateInputInvalidNotAllowedadMyvUU(), startRestartGroup, 6);
            ...
            if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                ...
                DateInputValidator dateInputValidator = new DateInputValidator(stateData, dateInputFormat2, dateFormatter, dateValidator, m1397getStringNWtq28, m1397getStringNWtq282, m1397getStringNWtq283, "");
            ...
            final String m1397getStringNWtq284 = Strings_androidKt.m1397getStringNWtq28(Strings.Companion.m1346getDateInputLabeladMyvUU(), startRestartGroup, i3);
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(startRestartGroup, -438341159, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputContent$1
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    String str2 = m1397getStringNWtq284;
                    Modifier.Companion companion = Modifier.Companion;
                    final String str3 = m1397getStringNWtq284;
                    ...
                    TextKt.m1484Text4IGK_g(str2, SemanticsModifierKt.semantics$default(companion, false, (Function1) rememberedValue3, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131068);
                    if (ComposerKt.isTraceInProgress()) {
            ...
            ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(startRestartGroup, 1914447672, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputContent$2
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    TextKt.m1484Text4IGK_g(upperCase, SemanticsModifierKt.clearAndSetSemantics(Modifier.Companion, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputContent$2.1
                        /* renamed from: invoke  reason: avoid collision after fix types in other method */
            ...
            m1064DateInputTextFieldzm97o8M(padding, composableLambda, composableLambda2, stateData, value, (Function1) rememberedValue3, InputIdentifier.Companion.m1184getSingleDateInputJ2x2o4M(), dateInputValidator2, dateInputFormat, defaultLocale, startRestartGroup, ((i4 << 9) & 7168) | 1075315126);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void m1064DateInputTextFieldzm97o8M(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final StateData stateData, final CalendarDate calendarDate, final Function1<? super CalendarDate, Unit> onDateChanged, final int i, final DateInputValidator dateInputValidator, final DateInputFormat dateInputFormat, final Locale locale, Composer composer, final int i2) {
        ...
        final MutableState mutableState = (MutableState) RememberSaveableKt.m2208rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) null, (String) null, (Function0<? extends Object>) new Function0<MutableState<String>>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$errorText$1
            ...
            public final void invoke2(TextFieldValue input) {
                ...
                if (input.getText().length() <= DateInputFormat.this.getPatternWithoutDelimiters().length()) {
                    ...
                    if (z) {
                        ...
                        mutableState.setValue(dateInputValidator.m1065validateXivgLIo(parse, i, locale));
        ...
        Modifier m419paddingqDBjuR0$default = PaddingKt.m419paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, f, 7, null);
        startRestartGroup.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
        ...
        startRestartGroup.endReplaceableGroup();
        int i3 = i2 << 15;
        OutlinedTextFieldKt.OutlinedTextField(DateInputTextField_zm97o8M$lambda$3, (Function1<? super TextFieldValue, Unit>) function1, SemanticsModifierKt.semantics$default(m419paddingqDBjuR0$default, false, (Function1) rememberedValue, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(startRestartGroup, 785795078, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if (!StringsKt.isBlank(mutableState.getValue())) {
                    TextKt.m1484Text4IGK_g(mutableState.getValue(), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
                }
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
        }), !StringsKt.isBlank((CharSequence) mutableState.getValue()), (VisualTransformation) new DateVisualTransformation(dateInputFormat), new KeyboardOptions(0, false, KeyboardType.Companion.m4785getNumberPjHm6EE(), ImeAction.Companion.m4736getDoneeUduSuo(), 1, null), (KeyboardActions) null, true, 0, 0, (MutableInteractionSource) null, (Shape) null, (TextFieldColors) null, startRestartGroup, (3670016 & i3) | (i3 & 29360128), 12779904, 0, 8195896);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$4
            ...
            public final void invoke(Composer composer2, int i4) {
                DateInputKt.m1064DateInputTextFieldzm97o8M(Modifier.this, function2, function22, stateData, calendarDate, onDateChanged, i, dateInputValidator, dateInputFormat, locale, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
    ...
    static {
        float f = 24;
        InputTextFieldPadding = PaddingKt.m412PaddingValuesa9UjIt4$default(Dp.m5050constructorimpl(f), Dp.m5050constructorimpl(10), Dp.m5050constructorimpl(f), 0.0f, 8, null);
    }
}
