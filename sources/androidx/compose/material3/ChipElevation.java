...
public final class ChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5048boximpl(f2), new ChipElevation$animateElevation$2(animatable, f2, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1373769675);
            ComposerKt.sourceInformation(composer, "1552@74943L570");
            EffectsKt.LaunchedEffect(Dp.m5048boximpl(f2), new ChipElevation$animateElevation$3(animatable, this, f2, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m5055equalsimpl0(this.elevation, chipElevation.elevation) && Dp.m5055equalsimpl0(this.pressedElevation, chipElevation.pressedElevation) && Dp.m5055equalsimpl0(this.focusedElevation, chipElevation.focusedElevation) && Dp.m5055equalsimpl0(this.hoveredElevation, chipElevation.hoveredElevation) && Dp.m5055equalsimpl0(this.disabledElevation, chipElevation.disabledElevation);
    }
