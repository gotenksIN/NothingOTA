...
public final class AnimatedPaddingValues implements PaddingValues {
    ...
    public float mo398calculateTopPaddingD9Ej5fM() {
        return Dp.m5050constructorimpl(this.topPadding.getValue().m5064unboximpl() * this.animationProgress.getValue().floatValue());
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateBottomPadding-D9Ej5fM */
    public float mo395calculateBottomPaddingD9Ej5fM() {
        return Dp.m5050constructorimpl(SearchBarKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }
