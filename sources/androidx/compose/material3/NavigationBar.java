...
/* renamed from: androidx.compose.material3.NavigationBarDefaults */
/* loaded from: classes.dex */
public final class NavigationBar {
    public static final int $stable = 0;
    public static final NavigationBar INSTANCE = new NavigationBar();
    private static final float Elevation = NavigationBarTokens.INSTANCE.m2198getContainerElevationD9Ej5fM();

    private NavigationBar() {
    }

    /* renamed from: getElevation-D9Ej5fM  reason: not valid java name */
    public final float m1520getElevationD9Ej5fM() {
        return Elevation;
    }
