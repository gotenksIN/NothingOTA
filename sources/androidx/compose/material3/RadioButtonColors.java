...
public final class RadioButtonColors {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2557equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m2557equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m2557equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m2557equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m2563hashCodeimpl(this.selectedColor) * 31) + Color.m2563hashCodeimpl(this.unselectedColor)) * 31) + Color.m2563hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m2563hashCodeimpl(this.disabledUnselectedColor);
    }
}
