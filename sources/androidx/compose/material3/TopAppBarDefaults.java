...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m1608topAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        long m1024applyTonalElevationHht5A8o = (i2 & 2) != 0 ? ColorSchemeKt.m1024applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer, 6), color, TopAppBarSmallTokens.INSTANCE.m2122getOnScrollContainerElevationD9Ej5fM()) : j2;
        ...
        TopAppBarColors topAppBarColors = new TopAppBarColors(color, m1024applyTonalElevationHht5A8o, color2, color3, color4, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TopAppBarColors m1607smallTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        TopAppBarColors m1608topAppBarColorszjMxDiM = m1608topAppBarColorszjMxDiM(color, m1024applyTonalElevationHht5A8o, color2, color3, color4, composer, (i & 14) | (i & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i & 896) | (i & 7168) | (57344 & i) | (i & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m1608topAppBarColorszjMxDiM;
    }
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m475onlybOOhFvg = WindowInsetsKt.m475onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, composer, 8), WindowInsetsSides.m486plusgK_yJZ4(WindowInsetsSides.Companion.m496getHorizontalJoeWqyM(), WindowInsetsSides.Companion.m500getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m475onlybOOhFvg;
    }

    /* renamed from: centerAlignedTopAppBarColors-zjMxDiM  reason: not valid java name */
    public final TopAppBarColors m1604centerAlignedTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
    ...
    public final TopAppBarColors m1606mediumTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
    ...
    public final TopAppBarColors m1605largeTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
