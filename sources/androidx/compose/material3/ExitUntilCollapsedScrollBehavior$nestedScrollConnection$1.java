...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo310onPreScrollOzD1aCk(long j, int i) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m2319getYimpl(j) > 0.0f) {
    ...
    public long mo309onPostScrollDzOQY0M(long j, long j2, int i) {
        if (this.this$0.getCanScroll().invoke().booleanValue()) {
            ...
            state.setContentOffset(state.getContentOffset() + Offset.m2319getYimpl(j));
            if (Offset.m2319getYimpl(j2) < 0.0f || Offset.m2319getYimpl(j) < 0.0f) {
                float heightOffset = this.this$0.getState().getHeightOffset();
                this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2319getYimpl(j));
                return OffsetKt.Offset(0.0f, this.this$0.getState().getHeightOffset() - heightOffset);
            }
            if ((Offset.m2319getYimpl(j) == 0.0f) && Offset.m2319getYimpl(j2) > 0.0f) {
                this.this$0.getState().setContentOffset(0.0f);
            }
            if (Offset.m2319getYimpl(j2) > 0.0f) {
                float heightOffset2 = this.this$0.getState().getHeightOffset();
                this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2319getYimpl(j2));
    ...
    */
    public java.lang.Object mo308onPostFlingRZ2iAVY(long r10, long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        ...
        L81:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo308onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
