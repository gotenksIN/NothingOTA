...
public final class NavigationBarKt {
    ...
    private static final float NavigationBarHeight = NavigationBarTokens.INSTANCE.m2199getContainerHeightD9Ej5fM();
    private static final float NavigationBarItemHorizontalPadding = C0780Dp.m5351constructorimpl(8);
    private static final float NavigationBarItemVerticalPadding = C0780Dp.m5351constructorimpl(16);
    private static final float IndicatorVerticalOffset = C0780Dp.m5351constructorimpl(12);
    ...
    */
    public static final void m1524NavigationBarHsRjFd4(androidx.compose.p002ui.Modifier r25, long r26, long r28, float r30, androidx.compose.foundation.layout.WindowInsets r31, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 426
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.NavigationBarKt.m1524NavigationBarHsRjFd4(androidx.compose.ui.Modifier, long, long, float, androidx.compose.foundation.layout.WindowInsets, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void NavigationBarItem(final androidx.compose.foundation.layout.RowScope r36, final boolean r37, final kotlin.jvm.functions.Functions<kotlin.Unit> r38, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r39, androidx.compose.p002ui.Modifier r40, boolean r41, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r42, boolean r43, androidx.compose.material3.NavigationBarItemColors r44, androidx.compose.foundation.interaction.MutableInteractionSource r45, androidx.compose.runtime.Composer r46, final int r47, final int r48) {
        /*
    ...
    private static final int NavigationBarItem$lambda$3(SnapshotState<Integer> snapshotState) {
        return snapshotState.getValue().intValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void NavigationBarItem$lambda$4(SnapshotState<Integer> snapshotState, int i) {
        ...
        if ((374491 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItemBaselineLayout$2
                ...
                public final MeasureResult mo313measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    Object obj;
                    Placeable placeable;
                    MeasureResult m1528placeLabelAndIconzUg2_y0;
                    MeasureResult m1527placeIconX9ElhV4;
                    ...
                    for (Measurable measurable : list) {
                        if (Intrinsics.areEqual(androidx.compose.p002ui.layout.LayoutId.getLayoutId(measurable), "icon")) {
                            ...
                            float f4 = 2;
                            int i3 = width + Layout.mo597roundToPx0680j_4(C0780Dp.m5351constructorimpl(f2 * f4));
                            int roundToInt = MathKt.roundToInt(i3 * f);
                            int height = mo4376measureBRTryo0.getHeight();
                            f3 = NavigationBarKt.IndicatorVerticalPadding;
                            int i4 = height + Layout.mo597roundToPx0680j_4(C0780Dp.m5351constructorimpl(f3 * f4));
                            for (Measurable measurable2 : list) {
                                if (Intrinsics.areEqual(androidx.compose.p002ui.layout.LayoutId.getLayoutId(measurable2), "indicatorRipple")) {
                                    Placeable mo4376measureBRTryo02 = measurable2.mo4376measureBRTryo0(Constraints.Companion.m5315fixedJhjzzOo(i3, i4));
                                    ...
                                    Placeable mo4376measureBRTryo03 = measurable3 != null ? measurable3.mo4376measureBRTryo0(Constraints.Companion.m5315fixedJhjzzOo(roundToInt, i4)) : null;
                                    if (function24 != null) {
                                    ...
                                    placeable = null;
                                    if (function24 == null) {
                                        m1527placeIconX9ElhV4 = NavigationBarKt.m1527placeIconX9ElhV4(Layout, mo4376measureBRTryo0, mo4376measureBRTryo02, mo4376measureBRTryo03, j);
                                        return m1527placeIconX9ElhV4;
                                    }
                                    Intrinsics.checkNotNull(placeable);
                                    m1528placeLabelAndIconzUg2_y0 = NavigationBarKt.m1528placeLabelAndIconzUg2_y0(Layout, placeable, mo4376measureBRTryo0, mo4376measureBRTryo02, mo4376measureBRTryo03, j, z, f);
                                    return m1528placeLabelAndIconzUg2_y0;
                                }
                            }
                            throw new NoSuchElementException("Collection contains no element matching the predicate.");
                        }
            ...
            if (function24 != null) {
                Modifier m718paddingVpY3zN4$default = Padding.m718paddingVpY3zN4$default(Alpha.alpha(androidx.compose.p002ui.layout.LayoutId.layoutId(Modifier.Companion, LabelLayoutIdTag), z ? 1.0f : f), C0780Dp.m5351constructorimpl(NavigationBarItemHorizontalPadding / 2), 0.0f, 2, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf3 = LayoutKt.materializerOf(m718paddingVpY3zN4$default);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
    ...
    public static final MeasureResult m1527placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int m5307getMaxWidthimpl = Constraints.m5307getMaxWidthimpl(j);
        final int m5306getMaxHeightimpl = Constraints.m5306getMaxHeightimpl(j);
        final int width = (m5307getMaxWidthimpl - placeable.getWidth()) / 2;
        final int height = (m5306getMaxHeightimpl - placeable.getHeight()) / 2;
        final int width2 = (m5307getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int height2 = (m5306getMaxHeightimpl - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, m5307getMaxWidthimpl, m5306getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable4, (m5307getMaxWidthimpl - placeable4.getWidth()) / 2, (m5306getMaxHeightimpl - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
    ...
    public static final MeasureResult m1528placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        ...
        final int width = (m5307getMaxWidthimpl - placeable.getWidth()) / 2;
        final int width2 = (m5307getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int width3 = (m5307getMaxWidthimpl - placeable3.getWidth()) / 2;
        final int i2 = i - measureScope.mo597roundToPx0680j_4(IndicatorVerticalPadding);
        return MeasureScope.layout$default(measureScope, m5307getMaxWidthimpl, m5306getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeLabelAndIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
    ...
    static {
        float f = 2;
        IndicatorHorizontalPadding = C0780Dp.m5351constructorimpl(C0780Dp.m5351constructorimpl(NavigationBarTokens.INSTANCE.m2197getActiveIndicatorWidthD9Ej5fM() - NavigationBarTokens.INSTANCE.m2200getIconSizeD9Ej5fM()) / f);
        IndicatorVerticalPadding = C0780Dp.m5351constructorimpl(C0780Dp.m5351constructorimpl(NavigationBarTokens.INSTANCE.m2196getActiveIndicatorHeightD9Ej5fM() - NavigationBarTokens.INSTANCE.m2200getIconSizeD9Ej5fM()) / f);
    }
