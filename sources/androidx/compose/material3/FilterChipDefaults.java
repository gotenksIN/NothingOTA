...
public final class FilterChipDefaults {
    ...
    private static final float Height = FilterChipTokens.INSTANCE.m1849getContainerHeightD9Ej5fM();
    private static final float IconSize = FilterChipTokens.INSTANCE.m1865getIconSizeD9Ej5fM();

    private FilterChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM  reason: not valid java name */
    public final float m1143getHeightD9Ej5fM() {
        return Height;
    }

    /* renamed from: getIconSize-D9Ej5fM  reason: not valid java name */
    public final float m1144getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: filterChipColors-XqyqHi0  reason: not valid java name */
    public final SelectableChipColors m1141filterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        long m2591getTransparent0d7_KjU = (i3 & 1) != 0 ? Color.Companion.m2591getTransparent0d7_KjU() : j;
        ...
        long m2591getTransparent0d7_KjU2 = (i3 & 8) != 0 ? Color.Companion.m2591getTransparent0d7_KjU() : j4;
        long m2555copywmQWz5c$default = (i3 & 16) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2555copywmQWz5c$default2 = (i3 & 32) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long j13 = (i3 & 64) != 0 ? m2555copywmQWz5c$default2 : j7;
        long color3 = (i3 & 128) != 0 ? ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatSelectedContainerColor(), composer, 6) : j8;
        long m2555copywmQWz5c$default3 = (i3 & 256) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledSelectedContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j9;
        ...
        SelectableChipColors selectableChipColors = new SelectableChipColors(m2591getTransparent0d7_KjU, color, color2, color2, m2591getTransparent0d7_KjU2, m2555copywmQWz5c$default, m2555copywmQWz5c$default2, j13, color3, m2555copywmQWz5c$default3, color4, color5, j14, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SelectableChipElevation m1142filterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1856getFlatContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilterChipTokens.INSTANCE.m1856getFlatContainerElevationD9Ej5fM() : f;
        float m1860getFlatSelectedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilterChipTokens.INSTANCE.m1860getFlatSelectedPressedContainerElevationD9Ej5fM() : f2;
        float m1857getFlatSelectedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilterChipTokens.INSTANCE.m1857getFlatSelectedFocusContainerElevationD9Ej5fM() : f3;
        float m1858getFlatSelectedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilterChipTokens.INSTANCE.m1858getFlatSelectedHoverContainerElevationD9Ej5fM() : f4;
        float m1850getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m1850getDraggedContainerElevationD9Ej5fM() : f5;
        float f7 = (i2 & 32) != 0 ? m1856getFlatContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-757972185, i, -1, "androidx.compose.material3.FilterChipDefaults.filterChipElevation (Chip.kt:866)");
        }
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(m1856getFlatContainerElevationD9Ej5fM, m1860getFlatSelectedPressedContainerElevationD9Ej5fM, m1857getFlatSelectedFocusContainerElevationD9Ej5fM, m1858getFlatSelectedHoverContainerElevationD9Ej5fM, m1850getDraggedContainerElevationD9Ej5fM, f7, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipBorder m1140filterChipBordergHcDVlo(long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long m2591getTransparent0d7_KjU = (i2 & 2) != 0 ? Color.Companion.m2591getTransparent0d7_KjU() : j2;
        long m2555copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2591getTransparent0d7_KjU2 = (i2 & 8) != 0 ? Color.Companion.m2591getTransparent0d7_KjU() : j4;
        float m1863getFlatUnselectedOutlineWidthD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m1863getFlatUnselectedOutlineWidthD9Ej5fM() : f;
        float m1859getFlatSelectedOutlineWidthD9Ej5fM = (i2 & 32) != 0 ? FilterChipTokens.INSTANCE.m1859getFlatSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1884534961, i, -1, "androidx.compose.material3.FilterChipDefaults.filterChipBorder (Chip.kt:896)");
        }
        SelectableChipBorder selectableChipBorder = new SelectableChipBorder(color, m2591getTransparent0d7_KjU, m2555copywmQWz5c$default, m2591getTransparent0d7_KjU2, m1863getFlatUnselectedOutlineWidthD9Ej5fM, m1859getFlatSelectedOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipColors m1138elevatedFilterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        long m2555copywmQWz5c$default = (i3 & 8) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m2555copywmQWz5c$default2 = (i3 & 16) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2555copywmQWz5c$default3 = (i3 & 32) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long j13 = (i3 & 64) != 0 ? m2555copywmQWz5c$default3 : j7;
        long color4 = (i3 & 128) != 0 ? ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getElevatedSelectedContainerColor(), composer, 6) : j8;
        long j14 = (i3 & 256) != 0 ? m2555copywmQWz5c$default : j9;
        ...
        SelectableChipColors selectableChipColors = new SelectableChipColors(color, color2, color3, color3, m2555copywmQWz5c$default, m2555copywmQWz5c$default2, m2555copywmQWz5c$default3, j13, color4, j14, color5, color6, j15, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipElevation m1139elevatedFilterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1851getElevatedContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilterChipTokens.INSTANCE.m1851getElevatedContainerElevationD9Ej5fM() : f;
        float m1855getElevatedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilterChipTokens.INSTANCE.m1855getElevatedPressedContainerElevationD9Ej5fM() : f2;
        float m1853getElevatedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilterChipTokens.INSTANCE.m1853getElevatedFocusContainerElevationD9Ej5fM() : f3;
        float m1854getElevatedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilterChipTokens.INSTANCE.m1854getElevatedHoverContainerElevationD9Ej5fM() : f4;
        float m1850getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m1850getDraggedContainerElevationD9Ej5fM() : f5;
        float m1852getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? FilterChipTokens.INSTANCE.m1852getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(m1851getElevatedContainerElevationD9Ej5fM, m1855getElevatedPressedContainerElevationD9Ej5fM, m1853getElevatedFocusContainerElevationD9Ej5fM, m1854getElevatedHoverContainerElevationD9Ej5fM, m1850getDraggedContainerElevationD9Ej5fM, m1852getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
