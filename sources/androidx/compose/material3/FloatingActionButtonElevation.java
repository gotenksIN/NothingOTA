...
public class FloatingActionButtonElevation {
    ...
    public final State<Dp> shadowElevation$material3_release(InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Dp> animateElevation = animateElevation(interactionSource, composer, (i & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i & 14));
        if (ComposerKt.isTraceInProgress()) {
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5048boximpl(f2), new FloatingActionButtonElevation$animateElevation$2(animatable, this, f2, interaction, null), composer, 64);
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m5055equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m5055equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m5055equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation) && Dp.m5055equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
    }

    public int hashCode() {
        return (((((Dp.m5056hashCodeimpl(this.defaultElevation) * 31) + Dp.m5056hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5056hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5056hashCodeimpl(this.hoveredElevation);
    }
}
