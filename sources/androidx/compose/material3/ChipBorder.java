...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, Composer composer, int i) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m171BorderStrokecXLIe8U(this.borderWidth, z ? this.borderColor : this.disabledBorderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2557equalsimpl0(this.borderColor, chipBorder.borderColor) && Color.m2557equalsimpl0(this.disabledBorderColor, chipBorder.disabledBorderColor) && Dp.m5055equalsimpl0(this.borderWidth, chipBorder.borderWidth);
    }

    public int hashCode() {
        return (((Color.m2563hashCodeimpl(this.borderColor) * 31) + Color.m2563hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.m5056hashCodeimpl(this.borderWidth);
    }
}
