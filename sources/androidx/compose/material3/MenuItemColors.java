...
public final class MenuItemColors {
    ...
    public final State<Color> textColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(z ? this.textColor : this.disabledTextColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(z ? this.leadingIconColor : this.disabledLeadingIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(z ? this.trailingIconColor : this.disabledTrailingIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2858equalsimpl0(this.textColor, menuItemColors.textColor) && Color.m2858equalsimpl0(this.leadingIconColor, menuItemColors.leadingIconColor) && Color.m2858equalsimpl0(this.trailingIconColor, menuItemColors.trailingIconColor) && Color.m2858equalsimpl0(this.disabledTextColor, menuItemColors.disabledTextColor) && Color.m2858equalsimpl0(this.disabledLeadingIconColor, menuItemColors.disabledLeadingIconColor) && Color.m2858equalsimpl0(this.disabledTrailingIconColor, menuItemColors.disabledTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((Color.m2864hashCodeimpl(this.textColor) * 31) + Color.m2864hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2864hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2864hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2864hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2864hashCodeimpl(this.disabledTrailingIconColor);
    }
}
