...
public final class ComposableSingletons$ModalBottomSheet_androidKt {
    ...
    public static Function2<Composer, Integer, Unit> f23lambda1 = ComposableLambdaKt.composableLambdaInstance(2103486466, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$ModalBottomSheet_androidKt$lambda-1$1
    ...
    public static Function2<Composer, Integer, Unit> f24lambda2 = ComposableLambdaKt.composableLambdaInstance(1964472464, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$ModalBottomSheet_androidKt$lambda-2$1
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Unit invoke(Composer composer, Integer num) {
            invoke(composer, num.intValue());
            return Unit.INSTANCE;
    ...
    public static Function2<Composer, Integer, Unit> f25lambda3 = ComposableLambdaKt.composableLambdaInstance(163832305, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$ModalBottomSheet_androidKt$lambda-3$1
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Unit invoke(Composer composer, Integer num) {
            invoke(composer, num.intValue());
            return Unit.INSTANCE;
    ...
    public final Function2<Composer, Integer, Unit> m1049getLambda1$material3_release() {
        return f23lambda1;
    }

    /* renamed from: getLambda-2$material3_release  reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1050getLambda2$material3_release() {
        return f24lambda2;
    }

    /* renamed from: getLambda-3$material3_release  reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1051getLambda3$material3_release() {
        return f25lambda3;
    }
}
