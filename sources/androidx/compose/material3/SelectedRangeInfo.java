...
public final class SelectedRangeInfo {
    ...
    public static final class Companion {
        ...
        public final SelectedRangeInfo calculateRangeInfo(CalendarMonth month, CalendarDate calendarDate, CalendarDate calendarDate2) {
            ...
            return new SelectedRangeInfo(new Pair(IntOffset.m5159boximpl(IntOffsetKt.IntOffset(daysFromStartOfWeekToFirstOfMonth % 7, daysFromStartOfWeekToFirstOfMonth / 7)), IntOffset.m5159boximpl(IntOffsetKt.IntOffset(daysFromStartOfWeekToFirstOfMonth2 % 7, daysFromStartOfWeekToFirstOfMonth2 / 7))), z, z2);
        }
    }
}
