...
public final class FixedThreshold implements ThresholdConfig {
    ...
    private final float m1145component1D9Ej5fM() {
        return this.offset;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ FixedThreshold m1146copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m1147copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final FixedThreshold m1147copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof FixedThreshold) && Dp.m5055equalsimpl0(this.offset, ((FixedThreshold) obj).offset);
    }

    public int hashCode() {
        return Dp.m5056hashCodeimpl(this.offset);
    }

    public String toString() {
        return "FixedThreshold(offset=" + ((Object) Dp.m5061toStringimpl(this.offset)) + ')';
    }
    ...
    public float computeThreshold(Density density, float f, float f2) {
        ...
        return f + (density.mo302toPx0680j_4(this.offset) * Math.signum(f2 - f));
    }
}
