...
public final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m1199constructorimpl(1);
    private static final int TwoLine = m1199constructorimpl(2);
    private static final int ThreeLine = m1199constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ListItemType m1197boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1199constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1200equalsimpl(int i, Object obj) {
        return (obj instanceof ListItemType) && i == ((ListItemType) obj).m1205unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1201equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1202hashCodeimpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m1200equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m1202hashCodeimpl(this.lines);
    }

    public String toString() {
        return m1203toStringimpl(this.lines);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m1205unboximpl() {
        return this.lines;
    }

    @Override // java.lang.Comparable
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m1204compareToyh95HIg(listItemType.m1205unboximpl());
    }
    ...
    public static int m1198compareToyh95HIg(int i, int i2) {
        return Intrinsics.compare(i, i2);
    }

    /* renamed from: compareTo-yh95HIg  reason: not valid java name */
    public int m1204compareToyh95HIg(int i) {
        return m1198compareToyh95HIg(this.lines, i);
    }
    ...
    public static final class Companion {
        ...
        public final int m1207getOneLineAlXitO8() {
            return ListItemType.OneLine;
        }

        /* renamed from: getTwoLine-AlXitO8  reason: not valid java name */
        public final int m1209getTwoLineAlXitO8() {
            return ListItemType.TwoLine;
        }

        /* renamed from: getThreeLine-AlXitO8  reason: not valid java name */
        public final int m1208getThreeLineAlXitO8() {
            return ListItemType.ThreeLine;
        }

        /* renamed from: getListItemType-7AlIA9s$material3_release  reason: not valid java name */
        public final int m1206getListItemType7AlIA9s$material3_release(boolean z, boolean z2) {
            if (z && z2) {
                return m1208getThreeLineAlXitO8();
            }
            if (z || z2) {
                return m1209getTwoLineAlXitO8();
            }
            return m1207getOneLineAlXitO8();
        }
    }
}
