...
public final class TooltipPopup_androidKt {
    public static final void TooltipPopup(final PopupPositionProvider popupPositionProvider, final Function0<Unit> onDismissRequest, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            AndroidPopup_androidKt.Popup(popupPositionProvider, onDismissRequest, new PopupProperties(true, false, false, null, false, false, 62, null), content, startRestartGroup, (i2 & 14) | 384 | (i2 & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | ((i2 << 3) & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
