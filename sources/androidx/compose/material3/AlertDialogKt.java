...
public final class AlertDialogKt {
    ...
    private static final float DialogMinWidth = Dp.m5050constructorimpl(280);
    private static final float DialogMaxWidth = Dp.m5050constructorimpl(560);
    ...
    */
    public static final void m905AlertDialogContent4hvqGtA(final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r25, androidx.compose.ui.Modifier r26, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r27, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r28, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r29, final androidx.compose.ui.graphics.Shape r30, final long r31, final float r33, final long r34, final long r36, final long r38, final long r40, androidx.compose.runtime.Composer r42, final int r43, final int r44, final int r45) {
        /*
            Method dump skipped, instructions count: 595
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AlertDialogKt.m905AlertDialogContent4hvqGtA(kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.ui.graphics.Shape, long, float, long, long, long, long, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* renamed from: AlertDialogFlowRow-ixp7dh8  reason: not valid java name */
    public static final void m906AlertDialogFlowRowixp7dh8(final float f, final float f2, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        int i2;
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1
                ...
                public final MeasureResult mo12measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    for (Measurable measurable : measurables) {
                        ...
                        if (measure_3p2s80s$canAddToCurrentSequence(arrayList6, intRef5, Layout, f, j, mo4075measureBRTryo0)) {
                            intRef = intRef5;
                            intRef2 = intRef4;
                        ...
                        if (!arrayList2.isEmpty()) {
                            intRef8.element += Layout.mo296roundToPx0680j_4(f);
                        }
                        arrayList2.add(mo4075measureBRTryo0);
                        intRef8.element += mo4075measureBRTryo0.getWidth();
                        intRef6 = intRef7;
                        intRef6.element = Math.max(intRef6.element, mo4075measureBRTryo0.getHeight());
                        intRef5 = intRef8;
                    ...
                    final int max = Math.max(intRef3.element, Constraints.m5008getMinWidthimpl(j));
                    int max2 = Math.max(intRef9.element, Constraints.m5007getMinHeightimpl(j));
                    final float f3 = f;
                    return MeasureScope.layout$default(Layout, max, max2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$measure$1
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            ...
                            for (Object obj : arrayList3) {
                                ...
                                int i6 = 0;
                                while (i6 < size) {
                                    iArr[i6] = ((Placeable) list2.get(i6)).getWidth() + (i6 < CollectionsKt.getLastIndex(list2) ? measureScope.mo296roundToPx0680j_4(f4) : 0);
                                    i6++;
                                }
                ...
                private static final boolean measure_3p2s80s$canAddToCurrentSequence(List<Placeable> list, Ref.IntRef intRef, MeasureScope measureScope, float f3, long j, Placeable placeable) {
                    return list.isEmpty() || (intRef.element + measureScope.mo296roundToPx0680j_4(f3)) + placeable.getWidth() <= Constraints.m5006getMaxWidthimpl(j);
                }
                ...
                private static final void measure_3p2s80s$startNewSequence(List<List<Placeable>> list, Ref.IntRef intRef, MeasureScope measureScope, float f3, List<Placeable> list2, List<Integer> list3, Ref.IntRef intRef2, List<Integer> list4, Ref.IntRef intRef3, Ref.IntRef intRef4) {
                    ...
                    if (!list5.isEmpty()) {
                        intRef.element += measureScope.mo296roundToPx0680j_4(f3);
                    }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$2
            ...
            public final void invoke(Composer composer2, int i4) {
                AlertDialogKt.m906AlertDialogFlowRowixp7dh8(f, f2, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    static {
        float f = 24;
        DialogPadding = PaddingKt.m408PaddingValues0680j_4(Dp.m5050constructorimpl(f));
        float f2 = 16;
        IconPadding = PaddingKt.m412PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5050constructorimpl(f2), 7, null);
        TitlePadding = PaddingKt.m412PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5050constructorimpl(f2), 7, null);
        TextPadding = PaddingKt.m412PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5050constructorimpl(f), 7, null);
    }
}
