...
public final class RadioButtonDefaults {
    ...
    public final RadioButton m1584colorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2856copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(RadioButtonTokens.INSTANCE.getDisabledSelectedIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2856copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(RadioButtonTokens.INSTANCE.getDisabledUnselectedIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-351083046, i, -1, "androidx.compose.material3.RadioButtonDefaults.colors (RadioButton.kt:144)");
        }
        RadioButton radioButton = new RadioButton(color, color2, m2856copywmQWz5c$default, m2856copywmQWz5c$default2, null);
        if (ComposerKt.isTraceInProgress()) {
