...
public final class DateInput {
    ...
    public static final void DateInputContent(final StateData stateData, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> dateValidator, Composer composer, final int i) {
        ...
        if ((i4 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                ...
                DateInputValidator dateInputValidator = new DateInputValidator(stateData, dateInputFormat2, dateFormatter, dateValidator, m1698getStringNWtq28, m1698getStringNWtq282, m1698getStringNWtq283, "");
            ...
            final String m1698getStringNWtq284 = Strings_androidKt.m1698getStringNWtq28(Strings.Companion.m1647getDateInputLabeladMyvUU(), startRestartGroup, i3);
            Modifier padding = Padding.padding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), InputTextFieldPadding);
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(startRestartGroup, -438341159, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputContent$1
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    String str2 = m1698getStringNWtq284;
                    Modifier.Companion companion = Modifier.Companion;
                    final String str3 = m1698getStringNWtq284;
            ...
            ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(startRestartGroup, 1914447672, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputContent$2
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    Text.m1785Text4IGK_g(upperCase, SemanticsModifierKt.clearAndSetSemantics(Modifier.Companion, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputContent$2.1
                        /* renamed from: invoke  reason: avoid collision after fix types in other method */
            ...
            m1365DateInputTextFieldzm97o8M(padding, composableLambda, composableLambda2, stateData, value, (Function1) rememberedValue3, InputIdentifier.Companion.m1485getSingleDateInputJ2x2o4M(), dateInputValidator2, dateInputFormat, defaultLocale, startRestartGroup, ((i4 << 9) & 7168) | 1075315126);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void m1365DateInputTextFieldzm97o8M(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final StateData stateData, final CalendarDate calendarDate, final Function1<? super CalendarDate, Unit> onDateChanged, final int i, final DateInputValidator dateInputValidator, final DateInputFormat dateInputFormat, final Locale locale, Composer composer, final int i2) {
        ...
        final SnapshotState snapshotState = (SnapshotState) RememberSaveable.m2509rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) null, (String) null, (Functions<? extends Object>) new Functions<SnapshotState<String>>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$errorText$1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // kotlin.jvm.functions.Functions
            public final SnapshotState<String> invoke() {
                SnapshotState<String> mutableStateOf$default;
                mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default("", null, 2, null);
                return mutableStateOf$default;
            }
        }, startRestartGroup, 3080, 6);
        final SnapshotState rememberSaveable = RememberSaveable.rememberSaveable(new Object[0], (Saver) TextFieldValue.Companion.getSaver(), (String) null, (Functions) new Functions<SnapshotState<TextFieldValue>>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$text$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
                ...
                if (input.getText().length() <= DateInputFormat.this.getPatternWithoutDelimiters().length()) {
                    ...
                    while (true) {
                        if (i3 >= text.length()) {
                            z = true;
                            break;
                        } else if (!Character.isDigit(text.charAt(i3))) {
                            z = false;
                            break;
                        } else {
                            i3++;
                    ...
                    if (z) {
                        ...
                        snapshotState.setValue(dateInputValidator.m1366validateXivgLIo(parse, i, locale));
                        onDateChanged.invoke(snapshotState.getValue().length() == 0 ? parse : null);
                    }
                }
            }
        };
        ...
        Modifier m720paddingqDBjuR0$default = Padding.m720paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, f, 7, null);
        startRestartGroup.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
            ...
            rememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$2$1
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics) {
                    ...
                    if (!StringsKt.isBlank(snapshotState.getValue())) {
                        SemanticsPropertiesKt.error(semantics, snapshotState.getValue());
                    }
                }
            };
            startRestartGroup.updateRememberedValue(rememberedValue);
        ...
        startRestartGroup.endReplaceableGroup();
        int i3 = i2 << 15;
        OutlinedTextField.OutlinedTextField(DateInputTextField_zm97o8M$lambda$3, (Function1<? super TextFieldValue, Unit>) function1, SemanticsModifierKt.semantics$default(m720paddingqDBjuR0$default, false, (Function1) rememberedValue, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(startRestartGroup, 785795078, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if (!StringsKt.isBlank(snapshotState.getValue())) {
                    Text.m1785Text4IGK_g(snapshotState.getValue(), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
                }
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
        }), !StringsKt.isBlank((CharSequence) snapshotState.getValue()), (VisualTransformation) new DateVisualTransformation(dateInputFormat), new KeyboardOptions(0, false, KeyboardType.Companion.m5086getNumberPjHm6EE(), ImeAction.Companion.m5037getDoneeUduSuo(), 1, null), (KeyboardActions) null, true, 0, 0, (MutableInteractionSource) null, (Shape) null, (TextFieldColors) null, startRestartGroup, (3670016 & i3) | (i3 & 29360128), 12779904, 0, 8195896);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$4
            ...
            public final void invoke(Composer composer2, int i4) {
                DateInput.m1365DateInputTextFieldzm97o8M(Modifier.this, function2, function22, stateData, calendarDate, onDateChanged, i, dateInputValidator, dateInputFormat, locale, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }

    private static final TextFieldValue DateInputTextField_zm97o8M$lambda$3(SnapshotState<TextFieldValue> snapshotState) {
    ...
    static {
        float f = 24;
        InputTextFieldPadding = Padding.m713PaddingValuesa9UjIt4$default(C0780Dp.m5351constructorimpl(f), C0780Dp.m5351constructorimpl(10), C0780Dp.m5351constructorimpl(f), 0.0f, 8, null);
    }
}
