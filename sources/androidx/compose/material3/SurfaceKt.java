...
public final class SurfaceKt {
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteTonalElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material3.SurfaceKt$LocalAbsoluteTonalElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m5048boximpl(m1414invokeD9Ej5fM());
        }

        /* renamed from: invoke-D9Ej5fM  reason: not valid java name */
        public final float m1414invokeD9Ej5fM() {
            return Dp.m5050constructorimpl(0);
        }
    }, 1, null);

    /* renamed from: Surface-T9BRK9s  reason: not valid java name */
    public static final void m1406SurfaceT9BRK9s(Modifier modifier, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, int i2) {
        ...
        final long m990getSurface0d7_KjU = (i2 & 4) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m990getSurface0d7_KjU() : j;
        long m1026contentColorForek8zF_U = (i2 & 8) != 0 ? ColorSchemeKt.m1026contentColorForek8zF_U(m990getSurface0d7_KjU, composer, (i >> 6) & 14) : j2;
        float m5050constructorimpl = (i2 & 16) != 0 ? Dp.m5050constructorimpl(0) : f;
        float m5050constructorimpl2 = (i2 & 32) != 0 ? Dp.m5050constructorimpl(0) : f2;
        ...
        final float m5050constructorimpl3 = Dp.m5050constructorimpl(((Dp) consume).m5064unboximpl() + m5050constructorimpl);
        ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m2546boximpl(m1026contentColorForek8zF_U)), providableCompositionLocal.provides(Dp.m5048boximpl(m5050constructorimpl3))};
        final BorderStroke borderStroke3 = borderStroke2;
        final float f3 = m5050constructorimpl2;
        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.composableLambda(composer, -70914509, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1
            ...
            public final void invoke(Composer composer2, int i3) {
                long m1413surfaceColorAtElevationCLU3JFs;
                Modifier m1412surface8ww4TTg;
                ...
                if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    m1413surfaceColorAtElevationCLU3JFs = SurfaceKt.m1413surfaceColorAtElevationCLU3JFs(m990getSurface0d7_KjU, m5050constructorimpl3, composer2, (i >> 6) & 14);
                    m1412surface8ww4TTg = SurfaceKt.m1412surface8ww4TTg(modifier2, shape2, m1413surfaceColorAtElevationCLU3JFs, borderStroke3, f3);
                    Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(m1412surface8ww4TTg, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1.1
    ...
    public static final void m1409Surfaceo_FOJdg(final Function0<Unit> onClick, Modifier modifier, boolean z, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        ...
        long m990getSurface0d7_KjU = (i3 & 16) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m990getSurface0d7_KjU() : j;
        long m1026contentColorForek8zF_U = (i3 & 32) != 0 ? ColorSchemeKt.m1026contentColorForek8zF_U(m990getSurface0d7_KjU, composer, (i >> 12) & 14) : j2;
        float m5050constructorimpl = (i3 & 64) != 0 ? Dp.m5050constructorimpl(0) : f;
        float m5050constructorimpl2 = (i3 & 128) != 0 ? Dp.m5050constructorimpl(0) : f2;
        ...
        final long j3 = m990getSurface0d7_KjU;
        final BorderStroke borderStroke3 = borderStroke2;
        final float f3 = m5050constructorimpl2;
        ...
        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.composableLambda(composer, 1279702876, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$3
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Shape shape3 = shape2;
                    m1413surfaceColorAtElevationCLU3JFs = SurfaceKt.m1413surfaceColorAtElevationCLU3JFs(j3, m5050constructorimpl3, composer2, (i >> 12) & 14);
                    m1412surface8ww4TTg = SurfaceKt.m1412surface8ww4TTg(minimumInteractiveComponentSize, shape3, m1413surfaceColorAtElevationCLU3JFs, borderStroke3, f3);
                    Modifier m174clickableO2vRcR0$default = ClickableKt.m174clickableO2vRcR0$default(m1412surface8ww4TTg, mutableInteractionSource3, RippleKt.m898rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z2, null, null, onClick, 24, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) consume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.Companion.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m174clickableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    public static final void m1407Surfaced85dljk(final boolean z, final Function0<Unit> onClick, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        MutableInteractionSource mutableInteractionSource2;
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        long m990getSurface0d7_KjU = (i3 & 32) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m990getSurface0d7_KjU() : j;
        long m1026contentColorForek8zF_U = (i3 & 64) != 0 ? ColorSchemeKt.m1026contentColorForek8zF_U(m990getSurface0d7_KjU, composer, (i >> 15) & 14) : j2;
        float m5050constructorimpl = (i3 & 128) != 0 ? Dp.m5050constructorimpl(0) : f;
        float m5050constructorimpl2 = (i3 & 256) != 0 ? Dp.m5050constructorimpl(0) : f2;
        ...
        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.composableLambda(composer, -1164547968, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$5
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier minimumInteractiveComponentSize = InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.this);
                    Shape shape3 = shape2;
                    m1413surfaceColorAtElevationCLU3JFs = SurfaceKt.m1413surfaceColorAtElevationCLU3JFs(j3, m5050constructorimpl3, composer2, (i >> 15) & 14);
                    m1412surface8ww4TTg = SurfaceKt.m1412surface8ww4TTg(minimumInteractiveComponentSize, shape3, m1413surfaceColorAtElevationCLU3JFs, borderStroke3, f3);
                    Modifier m661selectableO2vRcR0$default = SelectableKt.m661selectableO2vRcR0$default(m1412surface8ww4TTg, z, mutableInteractionSource3, RippleKt.m898rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z3, null, onClick, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) consume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.Companion.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m661selectableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    /* renamed from: Surface-d85dljk  reason: not valid java name */
    public static final void m1408Surfaced85dljk(final boolean z, final Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        MutableInteractionSource mutableInteractionSource2;
        ...
        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.composableLambda(composer, 712720927, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$7
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    m1413surfaceColorAtElevationCLU3JFs = SurfaceKt.m1413surfaceColorAtElevationCLU3JFs(j3, m5050constructorimpl3, composer2, (i >> 15) & 14);
                    m1412surface8ww4TTg = SurfaceKt.m1412surface8ww4TTg(minimumInteractiveComponentSize, shape3, m1413surfaceColorAtElevationCLU3JFs, borderStroke3, f3);
                    Modifier m665toggleableO2vRcR0$default = ToggleableKt.m665toggleableO2vRcR0$default(m1412surface8ww4TTg, z, mutableInteractionSource3, RippleKt.m898rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z3, null, onCheckedChange, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) consume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.Companion.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m665toggleableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    public static final Modifier m1412surface8ww4TTg(Modifier modifier, Shape shape, long j, BorderStroke borderStroke, float f) {
        return ClipKt.clip(BackgroundKt.m151backgroundbw27NRU(ShadowKt.m2235shadows4CzXII$default(modifier, f, shape, false, 0L, 0L, 24, null).then(borderStroke != null ? BorderKt.border(Modifier.Companion, borderStroke, shape) : Modifier.Companion), j, shape), shape);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: surfaceColorAtElevation-CLU3JFs  reason: not valid java name */
    public static final long m1413surfaceColorAtElevationCLU3JFs(long j, float f, Composer composer, int i) {
        ...
        if (Color.m2557equalsimpl0(j, MaterialTheme.INSTANCE.getColorScheme(composer, 6).m990getSurface0d7_KjU())) {
            j = ColorSchemeKt.m1031surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), f);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
