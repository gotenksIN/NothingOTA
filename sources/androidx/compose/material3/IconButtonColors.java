...
public final class IconButtonColors {
    ...
    public final State<Color> contentColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2546boximpl(z ? this.contentColor : this.disabledContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2557equalsimpl0(this.containerColor, iconButtonColors.containerColor) && Color.m2557equalsimpl0(this.contentColor, iconButtonColors.contentColor) && Color.m2557equalsimpl0(this.disabledContainerColor, iconButtonColors.disabledContainerColor) && Color.m2557equalsimpl0(this.disabledContentColor, iconButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m2563hashCodeimpl(this.containerColor) * 31) + Color.m2563hashCodeimpl(this.contentColor)) * 31) + Color.m2563hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2563hashCodeimpl(this.disabledContentColor);
    }
}
