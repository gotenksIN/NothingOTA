...
public final class IconButtonDefaults {
    ...
    public final IconButton m1463iconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        ...
        if ((i2 & 2) != 0) {
            ...
            j5 = ((Color) consume).m2867unboximpl();
        } else {
            j5 = j2;
        }
        long m2892getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.Companion.m2892getTransparent0d7_KjU() : j3;
        long m2856copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2856copywmQWz5c$default(j5, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButton iconButton = new IconButton(m2892getTransparent0d7_KjU, j5, m2892getTransparent0d7_KjU2, m2856copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconToggleButtonColors m1464iconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        if ((i2 & 2) != 0) {
            ...
            Object consume = composer.consume(ContentColor.getLocalContentColor());
            ComposerKt.sourceInformationMarkerEnd(composer);
            j7 = ((Color) consume).m2867unboximpl();
        } else {
            j7 = j2;
        }
        long m2892getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.Companion.m2892getTransparent0d7_KjU() : j3;
        long m2856copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2856copywmQWz5c$default(j7, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m2892getTransparent0d7_KjU3 = (i2 & 16) != 0 ? Color.Companion.m2892getTransparent0d7_KjU() : j5;
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(m2892getTransparent0d7_KjU, j7, m2892getTransparent0d7_KjU2, m2856copywmQWz5c$default, m2892getTransparent0d7_KjU3, color, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButton m1459filledIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2856copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2856copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButton iconButton = new IconButton(color, m1327contentColorForek8zF_U, m2856copywmQWz5c$default, m2856copywmQWz5c$default2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconToggleButtonColors m1460filledIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long m1327contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1327contentColorForek8zF_U(color3, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(color, color2, m2856copywmQWz5c$default, m2856copywmQWz5c$default2, color3, m1327contentColorForek8zF_U, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButton m1461filledTonalIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m1327contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1327contentColorForek8zF_U(color, composer, i & 14) : j2;
        long m2856copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2856copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconToggleButtonColors m1462filledTonalIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(color, m1327contentColorForek8zF_U, m2856copywmQWz5c$default, m2856copywmQWz5c$default2, color2, color3, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButton m1465outlinedIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
    ...
    public final IconToggleButtonColors m1466outlinedIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m1327contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1327contentColorForek8zF_U(color, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(m2892getTransparent0d7_KjU, j7, m2892getTransparent0d7_KjU2, m2856copywmQWz5c$default, color, m1327contentColorForek8zF_U, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke outlinedIconToggleButtonBorder(boolean z, boolean z2, Composer composer, int i) {
        ...
        BorderStroke outlinedIconButtonBorder = outlinedIconButtonBorder(z, composer, (i & 14) | ((i >> 3) & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean z, Composer composer, int i) {
        ...
        if (z) {
            ...
            Object consume = composer.consume(ContentColor.getLocalContentColor());
            ComposerKt.sourceInformationMarkerEnd(composer);
            m2856copywmQWz5c$default = ((Color) consume).m2867unboximpl();
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1252615269);
            ComposerKt.sourceInformation(composer, "791@38860L7");
            ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume2 = composer.consume(ContentColor.getLocalContentColor());
            ComposerKt.sourceInformationMarkerEnd(composer);
            m2856copywmQWz5c$default = Color.m2856copywmQWz5c$default(((Color) consume2).m2867unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceableGroup();
        }
        Color m2847boximpl = Color.m2847boximpl(m2856copywmQWz5c$default);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2847boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BorderStrokeKt.m472BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m2237getUnselectedOutlineWidthD9Ej5fM(), m2856copywmQWz5c$default);
