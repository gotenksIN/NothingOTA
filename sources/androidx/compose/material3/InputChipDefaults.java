...
public final class InputChipDefaults {
    ...
    public final SelectableChipColors m1475inputChipColorskwJvTHA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, Composer composer, int i, int i2, int i3) {
        ...
        long m2892getTransparent0d7_KjU2 = (i3 & 16) != 0 ? Color.Companion.m2892getTransparent0d7_KjU() : j5;
        long m2856copywmQWz5c$default = (i3 & 32) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long m2856copywmQWz5c$default2 = (i3 & 64) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j7;
        long m2856copywmQWz5c$default3 = (i3 & 128) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j8;
        long color4 = (i3 & 256) != 0 ? ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getSelectedContainerColor(), composer, 6) : j9;
        long m2856copywmQWz5c$default4 = (i3 & 512) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledSelectedContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j10;
        ...
        SelectableChipColors selectableChipColors = new SelectableChipColors(m2892getTransparent0d7_KjU, color, color2, color3, m2892getTransparent0d7_KjU2, m2856copywmQWz5c$default, m2856copywmQWz5c$default2, m2856copywmQWz5c$default3, color4, m2856copywmQWz5c$default4, color5, color6, color7, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SelectableChipElevation m1476inputChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2170getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? InputChipTokens.INSTANCE.m2170getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m2170getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m2170getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m2170getContainerElevationD9Ej5fM : f4;
        float m2172getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m2172getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? m2170getContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1745270109, i, -1, "androidx.compose.material3.InputChipDefaults.inputChipElevation (Chip.kt:1086)");
        }
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(m2170getContainerElevationD9Ej5fM, f7, f8, f9, m2172getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipBorder m1474inputChipBordergHcDVlo(long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long m2856copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2892getTransparent0d7_KjU2 = (i2 & 8) != 0 ? Color.Companion.m2892getTransparent0d7_KjU() : j4;
        float m2176getUnselectedOutlineWidthD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m2176getUnselectedOutlineWidthD9Ej5fM() : f;
        float m2174getSelectedOutlineWidthD9Ej5fM = (i2 & 32) != 0 ? InputChipTokens.INSTANCE.m2174getSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-324924235, i, -1, "androidx.compose.material3.InputChipDefaults.inputChipBorder (Chip.kt:1115)");
        }
        SelectableChipBorder selectableChipBorder = new SelectableChipBorder(color, m2892getTransparent0d7_KjU, m2856copywmQWz5c$default, m2892getTransparent0d7_KjU2, m2176getUnselectedOutlineWidthD9Ej5fM, m2174getSelectedOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
