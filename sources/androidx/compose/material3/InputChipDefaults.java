...
public final class InputChipDefaults {
    ...
    private static final float Height = InputChipTokens.INSTANCE.m1870getContainerHeightD9Ej5fM();
    private static final float IconSize = InputChipTokens.INSTANCE.m1872getLeadingIconSizeD9Ej5fM();
    private static final float AvatarSize = InputChipTokens.INSTANCE.m1868getAvatarSizeD9Ej5fM();

    private InputChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM  reason: not valid java name */
    public final float m1171getHeightD9Ej5fM() {
        return Height;
    }

    /* renamed from: getIconSize-D9Ej5fM  reason: not valid java name */
    public final float m1172getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: getAvatarSize-D9Ej5fM  reason: not valid java name */
    public final float m1170getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }

    /* renamed from: inputChipColors-kwJvTHA  reason: not valid java name */
    public final SelectableChipColors m1174inputChipColorskwJvTHA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, Composer composer, int i, int i2, int i3) {
        ...
        long m2591getTransparent0d7_KjU2 = (i3 & 16) != 0 ? Color.Companion.m2591getTransparent0d7_KjU() : j5;
        long m2555copywmQWz5c$default = (i3 & 32) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long m2555copywmQWz5c$default2 = (i3 & 64) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j7;
        long m2555copywmQWz5c$default3 = (i3 & 128) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j8;
        long color4 = (i3 & 256) != 0 ? ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getSelectedContainerColor(), composer, 6) : j9;
        long m2555copywmQWz5c$default4 = (i3 & 512) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledSelectedContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j10;
        ...
        SelectableChipColors selectableChipColors = new SelectableChipColors(m2591getTransparent0d7_KjU, color, color2, color3, m2591getTransparent0d7_KjU2, m2555copywmQWz5c$default, m2555copywmQWz5c$default2, m2555copywmQWz5c$default3, color4, m2555copywmQWz5c$default4, color5, color6, color7, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SelectableChipElevation m1175inputChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1869getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? InputChipTokens.INSTANCE.m1869getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m1869getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m1869getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m1869getContainerElevationD9Ej5fM : f4;
        float m1871getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m1871getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? m1869getContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1745270109, i, -1, "androidx.compose.material3.InputChipDefaults.inputChipElevation (Chip.kt:1086)");
        }
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(m1869getContainerElevationD9Ej5fM, f7, f8, f9, m1871getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipBorder m1173inputChipBordergHcDVlo(long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long m2555copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2591getTransparent0d7_KjU2 = (i2 & 8) != 0 ? Color.Companion.m2591getTransparent0d7_KjU() : j4;
        float m1875getUnselectedOutlineWidthD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m1875getUnselectedOutlineWidthD9Ej5fM() : f;
        float m1873getSelectedOutlineWidthD9Ej5fM = (i2 & 32) != 0 ? InputChipTokens.INSTANCE.m1873getSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-324924235, i, -1, "androidx.compose.material3.InputChipDefaults.inputChipBorder (Chip.kt:1115)");
        }
        SelectableChipBorder selectableChipBorder = new SelectableChipBorder(color, m2591getTransparent0d7_KjU, m2555copywmQWz5c$default, m2591getTransparent0d7_KjU2, m1875getUnselectedOutlineWidthD9Ej5fM, m1873getSelectedOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
