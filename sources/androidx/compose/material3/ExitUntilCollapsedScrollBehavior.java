...
public final class ExitUntilCollapsedScrollBehavior implements TopAppBarScrollBehavior {
    ...
    public ExitUntilCollapsedScrollBehavior(TopAppBarState state, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, Functions<Boolean> canScroll) {
    ...
    public /* synthetic */ ExitUntilCollapsedScrollBehavior(TopAppBarState topAppBarState, AnimationSpec animationSpec, DecayAnimationSpec decayAnimationSpec, C05301 c05301, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(topAppBarState, animationSpec, decayAnimationSpec, (i & 8) != 0 ? new Functions<Boolean>() { // from class: androidx.compose.material3.ExitUntilCollapsedScrollBehavior.1
