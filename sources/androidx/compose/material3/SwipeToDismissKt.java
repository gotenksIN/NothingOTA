...
public final class SwipeToDismissKt {
    private static final float DismissThreshold = Dp.m5050constructorimpl((float) androidx.appcompat.R.styleable.AppCompatTheme_windowMinWidthMinor);
    ...
    public static final DismissState rememberDismissState(final DismissValue dismissValue, final Function1<? super DismissValue, Boolean> function1, final Function2<? super Density, ? super Float, Float> function2, Composer composer, int i, int i2) {
        ...
        DismissState dismissState = (DismissState) RememberSaveableKt.m2208rememberSaveable(objArr, Saver, (String) null, (Function0<? extends Object>) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
