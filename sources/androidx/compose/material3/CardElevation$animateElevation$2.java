        ...
        if (i == 0) {
            ...
            if (this.$enabled) {
                ...
                if (Dp.m5055equalsimpl0(m5064unboximpl, f)) {
                    start = new PressInteraction.Press(Offset.Companion.m2334getZeroF1C5BW0(), null);
                } else {
                    ...
                    if (Dp.m5055equalsimpl0(m5064unboximpl, f2)) {
                        ...
                        if (Dp.m5055equalsimpl0(m5064unboximpl, f3)) {
                            ...
                            if (Dp.m5055equalsimpl0(m5064unboximpl, f4)) {
                ...
                this.label = 1;
                if (ElevationKt.m1121animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, this) == coroutine_suspended) {
