...
public final class TabKt {
    ...
    private static final float SmallTabHeight = PrimaryNavigationTabTokens.INSTANCE.m2026getContainerHeightD9Ej5fM();
    private static final float LargeTabHeight = Dp.m5050constructorimpl(72);
    private static final float HorizontalTextPadding = Dp.m5050constructorimpl(16);
    private static final float SingleLineTextBaselineWithIcon = Dp.m5050constructorimpl(14);
    private static final float DoubleLineTextBaselineWithIcon = Dp.m5050constructorimpl(6);
    private static final long IconDistanceFromBaseline = TextUnitKt.getSp(20);
    private static final float TextDistanceFromLeadingIcon = Dp.m5050constructorimpl(8);
    ...
    */
    public static final void m1433TabwqdebIU(final boolean r27, final kotlin.jvm.functions.Function0<kotlin.Unit> r28, androidx.compose.ui.Modifier r29, boolean r30, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, long r33, long r35, androidx.compose.foundation.interaction.MutableInteractionSource r37, androidx.compose.runtime.Composer r38, final int r39, final int r40) {
        /*
            Method dump skipped, instructions count: 664
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m1433TabwqdebIU(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m1432TabbogVsAg(final boolean r23, final kotlin.jvm.functions.Function0<kotlin.Unit> r24, androidx.compose.ui.Modifier r25, boolean r26, long r27, long r29, androidx.compose.foundation.interaction.MutableInteractionSource r31, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 586
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m1432TabbogVsAg(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: TabTransition-Klgx-Pg  reason: not valid java name */
    public static final void m1434TabTransitionKlgxPg(final long j, final long j2, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            ColorSpace m2560getColorSpaceimpl = Color.m2560getColorSpaceimpl(j3);
            startRestartGroup.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation(startRestartGroup, "C(remember)P(1):Composables.kt#9igjgp");
            boolean changed = startRestartGroup.changed(m2560getColorSpaceimpl);
            TwoWayConverter<Color, AnimationVector4D> rememberedValue = startRestartGroup.rememberedValue();
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = ColorVectorConverterKt.getVectorConverter(Color.Companion).invoke(m2560getColorSpaceimpl);
            ...
            startRestartGroup.endReplaceableGroup();
            Color m2546boximpl = Color.m2546boximpl(j4);
            ...
            startRestartGroup.endReplaceableGroup();
            State createTransitionAnimation = TransitionKt.createTransitionAnimation(updateTransition, m2546boximpl, Color.m2546boximpl(j5), tabKt$TabTransition$color$2.invoke((TabKt$TabTransition$color$2) updateTransition.getSegment(), (Transition.Segment) startRestartGroup, (Composer) 0), twoWayConverter, "ColorAnimation", startRestartGroup, 32768);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2546boximpl(TabTransition_Klgx_Pg$lambda$5(createTransitionAnimation)))}, function2, startRestartGroup, (i3 & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$TabTransition$1
            ...
            public final void invoke(Composer composer2, int i4) {
                TabKt.m1434TabTransitionKlgxPg(j, j2, z, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
        ...
        if ((i2 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2
                ...
                public final MeasureResult mo12measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    final Placeable mo4075measureBRTryo0;
                    ...
                    if (function2 != null) {
                        for (Measurable measurable : measurables) {
                            mo4075measureBRTryo0 = Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "text") ? measurable.mo4075measureBRTryo0(Constraints.m4997copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null)) : null;
                        }
                    ...
                    if (function22 != null) {
                        for (Measurable measurable2 : measurables) {
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "icon")) {
                                placeable = measurable2.mo4075measureBRTryo0(j);
                            }
                        }
                        throw new NoSuchElementException("Collection contains no element matching the predicate.");
                    }
                    placeable = null;
                    final int max = Math.max(mo4075measureBRTryo0 != null ? mo4075measureBRTryo0.getWidth() : 0, placeable != null ? placeable.getWidth() : 0);
                    int i3 = Layout.mo296roundToPx0680j_4((mo4075measureBRTryo0 == null || placeable == null) ? TabKt.SmallTabHeight : TabKt.LargeTabHeight);
                    ...
                    final int max2 = Math.max(i3, height + height2 + Layout.mo295roundToPxR2X_6o(j2));
                    final Integer valueOf = mo4075measureBRTryo0 != null ? Integer.valueOf(mo4075measureBRTryo0.get(AlignmentLineKt.getFirstBaseline())) : null;
                    final Integer valueOf2 = mo4075measureBRTryo0 != null ? Integer.valueOf(mo4075measureBRTryo0.get(AlignmentLineKt.getLastBaseline())) : null;
                    return MeasureScope.layout$default(Layout, max, max2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2$measure$1
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            ...
                            if (placeable3 == null || (placeable2 = placeable) == null) {
                                if (placeable3 != null) {
                                    TabKt.placeTextOrIcon(layout, placeable3, max2);
                                    return;
                                }
                            ...
                            TabKt.placeTextAndIcon(layout, measureScope, placeable3, placeable2, i4, i5, intValue, num2.intValue());
                        }
                    }, 4, null);
                }
            };
            ...
            if (function2 != null) {
                Modifier m417paddingVpY3zN4$default = PaddingKt.m417paddingVpY3zN4$default(LayoutIdKt.layoutId(Modifier.Companion, "text"), HorizontalTextPadding, 0.0f, 2, null);
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope placementScope, Density density, Placeable placeable, Placeable placeable2, int i, int i2, int i3, int i4) {
        ...
        int mo296roundToPx0680j_4 = density.mo296roundToPx0680j_4(f) + density.mo296roundToPx0680j_4(PrimaryNavigationTabTokens.INSTANCE.m2024getActiveIndicatorHeightD9Ej5fM());
        int i5 = (i2 - i4) - mo296roundToPx0680j_4;
        Placeable.PlacementScope.placeRelative$default(placementScope, placeable, (i - placeable.getWidth()) / 2, i5, 0.0f, 4, null);
        Placeable.PlacementScope.placeRelative$default(placementScope, placeable2, (i - placeable2.getWidth()) / 2, i5 - ((placeable2.getHeight() + density.mo295roundToPxR2X_6o(IconDistanceFromBaseline)) - i3), 0.0f, 4, null);
    }
