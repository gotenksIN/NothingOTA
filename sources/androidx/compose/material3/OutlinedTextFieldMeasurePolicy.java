...
public final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo12measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        Object obj6;
        Object obj7;
        final int m1258calculateWidthDHJA7U0;
        final int m1257calculateHeightDHJA7U0;
        ...
        Placeable mo4075measureBRTryo03 = measurable3 != null ? measurable3.mo4075measureBRTryo0(ConstraintsKt.m5023offsetNN6EwU$default(m4997copyZbe2FdA$default, -widthOrZero2, 0, 2, null)) : null;
        int widthOrZero3 = widthOrZero2 + TextFieldImplKt.widthOrZero(mo4075measureBRTryo03);
        int max3 = Math.max(max2, TextFieldImplKt.heightOrZero(mo4075measureBRTryo03));
        ...
        if (measurable4 != null) {
            i = max3;
            placeable = measurable4.mo4075measureBRTryo0(ConstraintsKt.m5023offsetNN6EwU$default(m4997copyZbe2FdA$default, -widthOrZero3, 0, 2, null));
        } else {
            i = max3;
            placeable = null;
        }
        ...
        int i3 = measure.mo296roundToPx0680j_4(this.paddingValues.mo396calculateLeftPaddingu2uoSUM(measure.getLayoutDirection())) + measure.mo296roundToPx0680j_4(this.paddingValues.mo397calculateRightPaddingu2uoSUM(measure.getLayoutDirection()));
        int i4 = z ? (-widthOrZero4) - i3 : -i3;
        int i5 = -i2;
        long m5022offsetNN6EwU = ConstraintsKt.m5022offsetNN6EwU(m4997copyZbe2FdA$default, i4, i5);
        ...
        if (mo4075measureBRTryo04 != null) {
            this.onLabelMeasured.invoke(Size.m2375boximpl(SizeKt.Size(mo4075measureBRTryo04.getWidth(), mo4075measureBRTryo04.getHeight())));
        }
        int max5 = Math.max(TextFieldImplKt.heightOrZero(mo4075measureBRTryo04) / 2, measure.mo296roundToPx0680j_4(this.paddingValues.mo398calculateTopPaddingD9Ej5fM()));
        long m4997copyZbe2FdA$default2 = Constraints.m4997copyZbe2FdA$default(ConstraintsKt.m5022offsetNN6EwU(j, -widthOrZero4, i5 - max5), 0, 0, 0, 0, 11, null);
        ...
        while (it6.hasNext()) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable6), TextFieldImplKt.TextFieldId)) {
                final Placeable mo4075measureBRTryo05 = measurable6.mo4075measureBRTryo0(m4997copyZbe2FdA$default2);
                long m4997copyZbe2FdA$default3 = Constraints.m4997copyZbe2FdA$default(m4997copyZbe2FdA$default2, 0, 0, 0, 0, 14, null);
                ...
                Placeable mo4075measureBRTryo06 = measurable7 != null ? measurable7.mo4075measureBRTryo0(m4997copyZbe2FdA$default3) : null;
                long m4997copyZbe2FdA$default4 = Constraints.m4997copyZbe2FdA$default(ConstraintsKt.m5023offsetNN6EwU$default(m4997copyZbe2FdA$default, 0, -Math.max(max4, Math.max(TextFieldImplKt.heightOrZero(mo4075measureBRTryo05), TextFieldImplKt.heightOrZero(mo4075measureBRTryo06)) + max5 + i2), 1, null), 0, 0, 0, 0, 11, null);
                ...
                Placeable mo4075measureBRTryo07 = measurable8 != null ? measurable8.mo4075measureBRTryo0(m4997copyZbe2FdA$default4) : null;
                int heightOrZero = TextFieldImplKt.heightOrZero(mo4075measureBRTryo07);
                m1258calculateWidthDHJA7U0 = OutlinedTextFieldKt.m1258calculateWidthDHJA7U0(TextFieldImplKt.widthOrZero(mo4075measureBRTryo0), TextFieldImplKt.widthOrZero(mo4075measureBRTryo02), TextFieldImplKt.widthOrZero(mo4075measureBRTryo03), TextFieldImplKt.widthOrZero(placeable2), mo4075measureBRTryo05.getWidth(), TextFieldImplKt.widthOrZero(mo4075measureBRTryo04), TextFieldImplKt.widthOrZero(mo4075measureBRTryo06), z, j, measure.getDensity(), this.paddingValues);
                m1257calculateHeightDHJA7U0 = OutlinedTextFieldKt.m1257calculateHeightDHJA7U0(TextFieldImplKt.heightOrZero(mo4075measureBRTryo0), TextFieldImplKt.heightOrZero(mo4075measureBRTryo02), TextFieldImplKt.heightOrZero(mo4075measureBRTryo03), TextFieldImplKt.heightOrZero(placeable2), mo4075measureBRTryo05.getHeight(), TextFieldImplKt.heightOrZero(mo4075measureBRTryo04), TextFieldImplKt.heightOrZero(mo4075measureBRTryo06), TextFieldImplKt.heightOrZero(mo4075measureBRTryo07), j, measure.getDensity(), this.paddingValues);
                int i6 = m1257calculateHeightDHJA7U0 - heightOrZero;
                for (Measurable measurable9 : list) {
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable9), TextFieldImplKt.ContainerId)) {
                        final Placeable mo4075measureBRTryo08 = measurable9.mo4075measureBRTryo0(ConstraintsKt.Constraints(m1258calculateWidthDHJA7U0 != Integer.MAX_VALUE ? m1258calculateWidthDHJA7U0 : 0, m1258calculateWidthDHJA7U0, i6 != Integer.MAX_VALUE ? i6 : 0, i6));
                        final Placeable placeable3 = mo4075measureBRTryo0;
                        final Placeable placeable4 = mo4075measureBRTryo02;
                        final Placeable placeable5 = mo4075measureBRTryo03;
                        final Placeable placeable6 = placeable2;
                        final Placeable placeable7 = mo4075measureBRTryo04;
                        final Placeable placeable8 = mo4075measureBRTryo06;
                        final Placeable placeable9 = mo4075measureBRTryo07;
                        return MeasureScope.layout$default(measure, m1258calculateWidthDHJA7U0, m1257calculateHeightDHJA7U0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldMeasurePolicy$measure$2
                            /* JADX INFO: Access modifiers changed from: package-private */
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                int i7 = m1257calculateHeightDHJA7U0;
                                int i8 = m1258calculateWidthDHJA7U0;
                                ...
                                Placeable placeable14 = mo4075measureBRTryo05;
                                ...
                                OutlinedTextFieldKt.place(layout, i7, i8, placeable10, placeable11, placeable12, placeable13, placeable14, placeable15, placeable16, placeable17, placeable18, f, z2, density, layoutDirection, paddingValues);
                            }
                        }, 4, null);
                    }
                }
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj5;
        Object obj6;
        int m1258calculateWidthDHJA7U0;
        ...
        for (Object obj7 : list2) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj7), TextFieldImplKt.TextFieldId)) {
                ...
                m1258calculateWidthDHJA7U0 = OutlinedTextFieldKt.m1258calculateWidthDHJA7U0(intValue4, intValue3, intValue5, intValue6, intValue, intValue2, intrinsicMeasurable6 != null ? function2.invoke(intrinsicMeasurable6, Integer.valueOf(i)).intValue() : 0, this.animationProgress < 1.0f, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1258calculateWidthDHJA7U0;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj6;
        Object obj7;
        int m1257calculateHeightDHJA7U0;
        List<? extends IntrinsicMeasurable> list2 = list;
        for (Object obj8 : list2) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj8), TextFieldImplKt.TextFieldId)) {
                ...
                m1257calculateHeightDHJA7U0 = OutlinedTextFieldKt.m1257calculateHeightDHJA7U0(intValue4, intValue3, intValue5, intValue6, intValue, intValue2, intValue7, intrinsicMeasurable7 != null ? function2.invoke(intrinsicMeasurable7, Integer.valueOf(i)).intValue() : 0, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1257calculateHeightDHJA7U0;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
