...
public final class SliderKt {
    ...
    */
    public static final void Slider(final float r44, final kotlin.jvm.functions.Function1<? super java.lang.Float, kotlin.Unit> r45, androidx.compose.p002ui.Modifier r46, boolean r47, kotlin.ranges.ClosedFloatingPointRange<java.lang.Float> r48, int r49, kotlin.jvm.functions.Functions<kotlin.Unit> r50, androidx.compose.material3.SliderColors r51, androidx.compose.foundation.interaction.MutableInteractionSource r52, androidx.compose.runtime.Composer r53, final int r54, final int r55) {
        /*
    ...
    */
    ...
    public static final void SliderImpl(final Modifier modifier, final boolean z, final MutableInteractionSource mutableInteractionSource, final Function1<? super Float, Unit> function1, final Functions<Unit> functions, final int i, final float f, final ClosedFloatingPointRange<Float> closedFloatingPointRange, final Function3<? super SliderPositions, ? super Composer, ? super Integer, Unit> function3, final Function3<? super SliderPositions, ? super Composer, ? super Integer, Unit> function32, Composer composer, final int i2) {
        int i3;
        int i4;
        boolean z2;
        String str;
        ...
        if ((57344 & i2) == 0) {
            i3 |= startRestartGroup.changedInstance(functions) ? 16384 : 8192;
        }
        if ((458752 & i2) == 0) {
        ...
        if ((1533916891 & i6) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.endReplaceableGroup();
            final SnapshotState snapshotState4 = (SnapshotState) rememberedValue5;
            startRestartGroup.startReplaceableGroup(-492369756);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember):Composables.kt#9igjgp");
            ...
            startRestartGroup.endReplaceableGroup();
            final SnapshotState snapshotState5 = (SnapshotState) rememberedValue6;
            ...
            if (changed3 || rememberedValue8 == Composer.Companion.getEmpty()) {
                ...
                SliderDraggableState sliderDraggableState = new SliderDraggableState(new Function1<Float, Unit>() { // from class: androidx.compose.material3.SliderKt$SliderImpl$draggableState$1$1
                    ...
                    public final void invoke(float f4) {
                        ...
                        float f5 = 2;
                        float max = Math.max(snapshotState3.getValue().floatValue() - (snapshotState2.getValue().floatValue() / f5), 0.0f);
                        float min = Math.min(snapshotState2.getValue().floatValue() / f5, max);
                        SnapshotState<Float> snapshotState6 = snapshotState4;
                        snapshotState6.setValue(Float.valueOf(snapshotState6.getValue().floatValue() + f4 + snapshotState5.getValue().floatValue()));
                        snapshotState5.setValue(Float.valueOf(0.0f));
                        snapValueToTick = SliderKt.snapValueToTick(snapshotState4.getValue().floatValue(), fArr, min, max);
            ...
            State rememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new Functions<Unit>() { // from class: androidx.compose.material3.SliderKt$SliderImpl$gestureEndAction$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                ...
                public final void invoke2() {
                    ...
                    if (SliderDraggableState.this.isDragging() || (functions2 = functions) == null) {
                        return;
                    }
                    functions2.invoke();
                }
            ...
            Modifier sliderTapModifier = sliderTapModifier(Modifier.Companion, sliderDraggableState3, mutableInteractionSource, ((Number) snapshotState3.getValue()).intValue(), z2, snapshotState4, rememberUpdatedState2, snapshotState5, z);
            ...
            composer3 = composer2;
            Modifier then = Focusable.focusable(sliderSemantics(SizeKt.m755requiredSizeInqDBjuR0$default(InteractiveComponentSize.minimumInteractiveComponentSize(modifier), SliderTokens.INSTANCE.m2348getHandleWidthD9Ej5fM(), SliderTokens.INSTANCE.m2347getHandleHeightD9Ej5fM(), 0.0f, 0.0f, 12, null), f, z, function1, functions, closedFloatingPointRange, i), z, mutableInteractionSource).then(sliderTapModifier).then(draggable);
            final float f4 = f3;
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.SliderKt$SliderImpl$2
                ...
                public final MeasureResult mo313measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    for (Measurable measurable : list) {
                        if (androidx.compose.p002ui.layout.LayoutId.getLayoutId(measurable) == SliderComponents.THUMB) {
                            final Placeable mo4376measureBRTryo0 = measurable.mo4376measureBRTryo0(j);
                            for (Measurable measurable2 : list) {
                                if (androidx.compose.p002ui.layout.LayoutId.getLayoutId(measurable2) == SliderComponents.TRACK) {
                                    z3 = true;
                                    continue;
                                } else {
                                    z3 = false;
                                ...
                                if (z3) {
                                    final Placeable mo4376measureBRTryo02 = measurable2.mo4376measureBRTryo0(Constraints.m5298copyZbe2FdA$default(ConstraintsKt.m5324offsetNN6EwU$default(j, -mo4376measureBRTryo0.getWidth(), 0, 2, null), 0, 0, 0, 0, 11, null));
                                    int width = mo4376measureBRTryo02.getWidth() + mo4376measureBRTryo0.getWidth();
                                    int max = Math.max(mo4376measureBRTryo02.getHeight(), mo4376measureBRTryo0.getHeight());
                                    snapshotState6.setValue(Float.valueOf(mo4376measureBRTryo0.getWidth()));
                                    snapshotState3.setValue(Integer.valueOf(width));
                                    final int width2 = mo4376measureBRTryo0.getWidth() / 2;
                                    final int roundToInt = MathKt.roundToInt(mo4376measureBRTryo02.getWidth() * f4);
                                    final int height = (max - mo4376measureBRTryo02.getHeight()) / 2;
                                    final int height2 = (max - mo4376measureBRTryo0.getHeight()) / 2;
                                    return MeasureScope.layout$default(Layout, width, max, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SliderKt$SliderImpl$2$measure$1
                                        ...
                                        public final void invoke2(Placeable.PlacementScope layout) {
                                            ...
                                            Placeable.PlacementScope.placeRelative$default(layout, mo4376measureBRTryo0, roundToInt, height2, 0.0f, 4, null);
                                        }
                                    }, 4, null);
                                }
                            }
            ...
            Object consume2 = composer3.consume(CompositionLocals.getLocalDensity());
            ComposerKt.sourceInformationMarkerEnd(composer3);
            Density density = (Density) consume2;
            ComposerKt.sourceInformationMarkerStart(composer3, 2023513938, str3);
            Object consume3 = composer3.consume(CompositionLocals.getLocalLayoutDirection());
            ComposerKt.sourceInformationMarkerEnd(composer3);
            LayoutDirection layoutDirection = (LayoutDirection) consume3;
            ComposerKt.sourceInformationMarkerStart(composer3, 2023513938, str3);
            Object consume4 = composer3.consume(CompositionLocals.getLocalViewConfiguration());
            ComposerKt.sourceInformationMarkerEnd(composer3);
            ...
            Modifier layoutId = androidx.compose.p002ui.layout.LayoutId.layoutId(Modifier.Companion, SliderComponents.THUMB);
            ...
            function3.invoke(sliderPositions3, composer3, Integer.valueOf((i7 & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 6));
            ComposerKt.sourceInformationMarkerEnd(composer3);
            ComposerKt.sourceInformationMarkerEnd(composer3);
            ...
            composer3.endReplaceableGroup();
            composer3.endReplaceableGroup();
            Modifier layoutId2 = androidx.compose.p002ui.layout.LayoutId.layoutId(Modifier.Companion, SliderComponents.TRACK);
            composer3.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(composer3, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
            ...
            ComposerKt.sourceInformation(composer3, "C(Layout)P(!1,2)74@2915L7,75@2970L7,76@3029L7,77@3041L460:Layout.kt#80mrfh");
            ComposerKt.sourceInformationMarkerStart(composer3, 2023513938, "C:CompositionLocal.kt#9igjgp");
            Object consume8 = composer3.consume(CompositionLocals.getLocalDensity());
            ComposerKt.sourceInformationMarkerEnd(composer3);
            Density density3 = (Density) consume8;
            ComposerKt.sourceInformationMarkerStart(composer3, 2023513938, "C:CompositionLocal.kt#9igjgp");
            Object consume9 = composer3.consume(CompositionLocals.getLocalLayoutDirection());
            ComposerKt.sourceInformationMarkerEnd(composer3);
            LayoutDirection layoutDirection3 = (LayoutDirection) consume9;
            ComposerKt.sourceInformationMarkerStart(composer3, 2023513938, "C:CompositionLocal.kt#9igjgp");
            Object consume10 = composer3.consume(CompositionLocals.getLocalViewConfiguration());
            ComposerKt.sourceInformationMarkerEnd(composer3);
            ...
            function32.invoke(sliderPositions3, composer3, Integer.valueOf(((i5 >> 24) & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 6));
            ComposerKt.sourceInformationMarkerEnd(composer3);
            ComposerKt.sourceInformationMarkerEnd(composer3);
            composer3.endReplaceableGroup();
            composer3.endNode();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SliderKt$SliderImpl$3
            ...
            public final void invoke(Composer composer4, int i8) {
                SliderKt.SliderImpl(Modifier.this, z, mutableInteractionSource, function1, functions, i, f, closedFloatingPointRange, function3, function32, composer4, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final float RangeSliderImpl$lambda$25(SnapshotState<Float> snapshotState) {
        return snapshotState.getValue().floatValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void RangeSliderImpl$lambda$26(SnapshotState<Float> snapshotState, float f) {
        snapshotState.setValue(Float.valueOf(f));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final float RangeSliderImpl$lambda$28(SnapshotState<Float> snapshotState) {
        return snapshotState.getValue().floatValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void RangeSliderImpl$lambda$29(SnapshotState<Float> snapshotState, float f) {
        snapshotState.setValue(Float.valueOf(f));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final int RangeSliderImpl$lambda$31(SnapshotState<Integer> snapshotState) {
        return snapshotState.getValue().intValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void RangeSliderImpl$lambda$32(SnapshotState<Integer> snapshotState, int i) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.Object m1617awaitSlop8vUncbI(androidx.compose.p002ui.input.pointer.AwaitPointerEventScope r8, long r9, int r11, kotlin.coroutines.Continuation<? super kotlin.Tuples<androidx.compose.p002ui.input.pointer.PointerInputChange, java.lang.Float>> r12) {
        /*
        ...
        L37:
            ...
            r2 = r9
            r4 = r11
            java.lang.Object r8 = androidx.compose.material3.DragGestureDetectorCopy.m1410awaitHorizontalPointerSlopOrCancellationgDDlDlE(r1, r2, r4, r5, r6)
            if (r8 != r0) goto L55
            return r0
        L55:
            r7 = r12
        ...
        L58:
            ...
            kotlin.Pair r8 = kotlin.TuplesKt.m33to(r12, r8)
            goto L68
        L67:
            r8 = 0
        L68:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderKt.m1617awaitSlop8vUncbI(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    static /* synthetic */ Modifier sliderSemantics$default(Modifier modifier, float f, boolean z, Function1 function1, Functions functions, ClosedFloatingPointRange closedFloatingPointRange, int i, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            functions = null;
        }
        ...
        return sliderSemantics(modifier, f, z, function1, functions2, closedFloatingPointRange2, i);
    }

    private static final Modifier sliderSemantics(Modifier modifier, float f, final boolean z, final Function1<? super Float, Unit> function1, final Functions<Unit> functions, final ClosedFloatingPointRange<Float> closedFloatingPointRange, final int i) {
        ...
        return ProgressSemantics.progressSemantics(SemanticsModifierKt.semantics$default(modifier, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.SliderKt$sliderSemantics$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                ...
                SemanticsPropertiesKt.setProgress$default(semantics, null, new Function1<Float, Boolean>() { // from class: androidx.compose.material3.SliderKt$sliderSemantics$1.1
                    ...
                    public final Boolean invoke(float f3) {
                        ...
                        if (i4 > 0 && (i3 = i4 + 1) >= 0) {
                            ...
                            int i5 = 0;
                            while (true) {
                                float lerp = MathHelpers.lerp(closedFloatingPointRange2.getStart().floatValue(), closedFloatingPointRange2.getEndInclusive().floatValue(), i5 / (i2 + 1));
                        ...
                        if (!(coerceIn2 == f2)) {
                            ...
                            Functions<Unit> functions3 = functions2;
                            if (functions3 != null) {
                                functions3.invoke();
                            }
                            z2 = true;
    ...
    static {
        float m2348getHandleWidthD9Ej5fM = SliderTokens.INSTANCE.m2348getHandleWidthD9Ej5fM();
        ThumbWidth = m2348getHandleWidthD9Ej5fM;
        float m2347getHandleHeightD9Ej5fM = SliderTokens.INSTANCE.m2347getHandleHeightD9Ej5fM();
        ThumbHeight = m2347getHandleHeightD9Ej5fM;
        ThumbSize = DpKt.m5373DpSizeYgX7TsA(m2348getHandleWidthD9Ej5fM, m2347getHandleHeightD9Ej5fM);
        ThumbDefaultElevation = C0780Dp.m5351constructorimpl(1);
        ThumbPressedElevation = C0780Dp.m5351constructorimpl(6);
        TickSize = SliderTokens.INSTANCE.m2354getTickMarksContainerSizeD9Ej5fM();
        TrackHeight = SliderTokens.INSTANCE.m2349getInactiveTrackHeightD9Ej5fM();
        float m5351constructorimpl = C0780Dp.m5351constructorimpl(48);
        SliderHeight = m5351constructorimpl;
        float m5351constructorimpl2 = C0780Dp.m5351constructorimpl(144);
        SliderMinWidth = m5351constructorimpl2;
        DefaultSliderConstraints = SizeKt.m747heightInVpY3zN4$default(SizeKt.m766widthInVpY3zN4$default(Modifier.Companion, m5351constructorimpl2, 0.0f, 2, null), 0.0f, m5351constructorimpl, 1, null);
    ...
    public static final float snapValueToTick(float f, float[] fArr, float f2, float f3) {
        ...
        if (fArr.length == 0) {
            ...
            if (lastIndex != 0) {
                float abs = Math.abs(MathHelpers.lerp(f2, f3, f4) - f);
                ?? it = new IntRange(1, lastIndex).iterator();
                while (it.hasNext()) {
                    float f5 = fArr[it.nextInt()];
                    float abs2 = Math.abs(MathHelpers.lerp(f2, f3, f5) - f);
        ...
        return valueOf != null ? MathHelpers.lerp(f2, f3, valueOf.floatValue()) : f;
    }

    private static final Modifier sliderTapModifier(Modifier modifier, final DraggableState draggableState, final MutableInteractionSource mutableInteractionSource, final int i, final boolean z, final State<Float> state, final State<? extends Functions<Unit>> state2, final SnapshotState<Float> snapshotState, final boolean z2) {
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.SliderKt$sliderTapModifier$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("pressOffset", snapshotState);
            ...
            @DebugMetadata(m31c = "androidx.compose.material3.SliderKt$sliderTapModifier$2$1", m30f = "Slider.kt", m29i = {}, m28l = {1176}, m27m = "invokeSuspend", m26n = {}, m25s = {})
            /* renamed from: androidx.compose.material3.SliderKt$sliderTapModifier$2$1 */
            /* loaded from: classes.dex */
            public static final class C06051 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
                final /* synthetic */ DraggableState $draggableState;
                final /* synthetic */ State<Functions<Unit>> $gestureEndAction;
                final /* synthetic */ boolean $isRtl;
                final /* synthetic */ int $maxPx;
                final /* synthetic */ SnapshotState<Float> $pressOffset;
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C06051(boolean z, int i, SnapshotState<Float> snapshotState, State<Float> state, CoroutineScope coroutineScope, DraggableState draggableState, State<? extends Functions<Unit>> state2, Continuation<? super C06051> continuation) {
                    super(2, continuation);
                    this.$isRtl = z;
                    this.$maxPx = i;
                    this.$pressOffset = snapshotState;
                ...
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    C06051 c06051 = new C06051(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, this.$scope, this.$draggableState, this.$gestureEndAction, continuation);
                    c06051.L$0 = obj;
                    return c06051;
                }
                ...
                /* compiled from: Slider.kt */
                @Metadata(m39k = 3, m38mv = {1, 8, 0}, m36xi = 48)
                @DebugMetadata(m31c = "androidx.compose.material3.SliderKt$sliderTapModifier$2$1$1", m30f = "Slider.kt", m29i = {}, m28l = {1181}, m27m = "invokeSuspend", m26n = {}, m25s = {})
                /* renamed from: androidx.compose.material3.SliderKt$sliderTapModifier$2$1$1 */
                /* loaded from: classes.dex */
                public static final class C06061 extends SuspendLambda implements Function3<TapGestureDetector, Offset, Continuation<? super Unit>, Object> {
                    final /* synthetic */ boolean $isRtl;
                    final /* synthetic */ int $maxPx;
                    final /* synthetic */ SnapshotState<Float> $pressOffset;
                    final /* synthetic */ State<Float> $rawOffset;
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C06061(boolean z, int i, SnapshotState<Float> snapshotState, State<Float> state, Continuation<? super C06061> continuation) {
                    ...
                    public /* bridge */ /* synthetic */ Object invoke(TapGestureDetector tapGestureDetector, Offset offset, Continuation<? super Unit> continuation) {
                        return m1618invoked4ec7I(tapGestureDetector, offset.m2629unboximpl(), continuation);
                    }

                    /* renamed from: invoke-d-4ec7I  reason: not valid java name */
                    public final Object m1618invoked4ec7I(TapGestureDetector tapGestureDetector, long j, Continuation<? super Unit> continuation) {
                        C06061 c06061 = new C06061(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, continuation);
                        c06061.L$0 = tapGestureDetector;
                        c06061.J$0 = j;
                        return c06061.invokeSuspend(Unit.INSTANCE);
                    }
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        try {
                            if (i == 0) {
                                ...
                                long j = this.J$0;
                                this.$pressOffset.setValue(boxing.boxFloat((this.$isRtl ? this.$maxPx - Offset.m2619getXimpl(j) : Offset.m2619getXimpl(j)) - this.$rawOffset.getValue().floatValue()));
                                this.label = 1;
                                if (tapGestureDetector.awaitRelease(this) == coroutine_suspended) {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        final State<Functions<Unit>> state = this.$gestureEndAction;
                        this.label = 1;
                        if (TapGestureDetectorKt.detectTapGestures$default((PointerInputScope) this.L$0, null, null, new C06061(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, null), new Function1<Offset, Unit>() { // from class: androidx.compose.material3.SliderKt.sliderTapModifier.2.1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                                m1619invokek4lQ0M(offset.m2629unboximpl());
                                return Unit.INSTANCE;
                            }

                            /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                            public final void m1619invokek4lQ0M(long j) {
                                BuildersKt__Builders_commonKt.launch$default(CoroutineScope.this, null, null, new C06081(draggableState, state, null), 3, null);
                            }

                            /* JADX INFO: Access modifiers changed from: package-private */
                            /* compiled from: Slider.kt */
                            @Metadata(m39k = 3, m38mv = {1, 8, 0}, m36xi = 48)
                            @DebugMetadata(m31c = "androidx.compose.material3.SliderKt$sliderTapModifier$2$1$2$1", m30f = "Slider.kt", m29i = {}, m28l = {1188}, m27m = "invokeSuspend", m26n = {}, m25s = {})
                            ...
                            public static final class C06081 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                ...
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                C06081(DraggableState draggableState, State<? extends Functions<Unit>> state, Continuation<? super C06081> continuation) {
                                    super(2, continuation);
                                    this.$draggableState = draggableState;
                                ...
                                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                    return new C06081(this.$draggableState, this.$gestureEndAction, continuation);
                                }
                                ...
                                /* compiled from: Slider.kt */
                                @Metadata(m39k = 3, m38mv = {1, 8, 0}, m36xi = 48)
                                @DebugMetadata(m31c = "androidx.compose.material3.SliderKt$sliderTapModifier$2$1$2$1$1", m30f = "Slider.kt", m29i = {}, m28l = {}, m27m = "invokeSuspend", m26n = {}, m25s = {})
                                /* renamed from: androidx.compose.material3.SliderKt$sliderTapModifier$2$1$2$1$1 */
                                /* loaded from: classes.dex */
                                public static final class C06091 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
                                    private /* synthetic */ Object L$0;
                                    int label;
                                    ...
                                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                        C06091 c06091 = new C06091(continuation);
                                        c06091.L$0 = obj;
                                        return c06091;
                                    }
                                    ...
                                    public final Object invoke(DragScope dragScope, Continuation<? super Unit> continuation) {
                                        return ((C06091) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
                                    }
                                ...
                                public final Object invokeSuspend(Object obj) {
                                    ...
                                    if (i == 0) {
                                        ResultKt.throwOnFailure(obj);
                                        this.label = 1;
                                        if (this.$draggableState.drag(MutatePriority.UserInput, new C06091(null), this) == coroutine_suspended) {
                                            return coroutine_suspended;
                                        }
                                    } else if (i != 1) {
                                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
