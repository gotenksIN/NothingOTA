...
public final class MenuDefaults {
    ...
    public final MenuItemColors m1210itemColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long m2555copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(MenuTokens.INSTANCE.getListItemDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m2555copywmQWz5c$default2 = (i2 & 16) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(MenuTokens.INSTANCE.getListItemDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2555copywmQWz5c$default3 = (i2 & 32) != 0 ? Color.m2555copywmQWz5c$default(ColorSchemeKt.toColor(MenuTokens.INSTANCE.getListItemDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1278543580, i, -1, "androidx.compose.material3.MenuDefaults.itemColors (Menu.kt:234)");
        }
        MenuItemColors menuItemColors = new MenuItemColors(color, color2, color3, m2555copywmQWz5c$default, m2555copywmQWz5c$default2, m2555copywmQWz5c$default3, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    static {
        ...
        DropdownMenuItemContentPadding = PaddingKt.m409PaddingValuesYgX7TsA(f, Dp.m5050constructorimpl(0));
    }
}
