...
public final class Switch {
    ...
    public /* synthetic */ Switch(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12, j13, j14, j15, j16);
    }

    private Switch(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2858equalsimpl0(this.checkedThumbColor, r7.checkedThumbColor) && Color.m2858equalsimpl0(this.checkedTrackColor, r7.checkedTrackColor) && Color.m2858equalsimpl0(this.checkedBorderColor, r7.checkedBorderColor) && Color.m2858equalsimpl0(this.checkedIconColor, r7.checkedIconColor) && Color.m2858equalsimpl0(this.uncheckedThumbColor, r7.uncheckedThumbColor) && Color.m2858equalsimpl0(this.uncheckedTrackColor, r7.uncheckedTrackColor) && Color.m2858equalsimpl0(this.uncheckedBorderColor, r7.uncheckedBorderColor) && Color.m2858equalsimpl0(this.uncheckedIconColor, r7.uncheckedIconColor) && Color.m2858equalsimpl0(this.disabledCheckedThumbColor, r7.disabledCheckedThumbColor) && Color.m2858equalsimpl0(this.disabledCheckedTrackColor, r7.disabledCheckedTrackColor) && Color.m2858equalsimpl0(this.disabledCheckedBorderColor, r7.disabledCheckedBorderColor) && Color.m2858equalsimpl0(this.disabledCheckedIconColor, r7.disabledCheckedIconColor) && Color.m2858equalsimpl0(this.disabledUncheckedThumbColor, r7.disabledUncheckedThumbColor) && Color.m2858equalsimpl0(this.disabledUncheckedTrackColor, r7.disabledUncheckedTrackColor) && Color.m2858equalsimpl0(this.disabledUncheckedBorderColor, r7.disabledUncheckedBorderColor) && Color.m2858equalsimpl0(this.disabledUncheckedIconColor, r7.disabledUncheckedIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((Color.m2864hashCodeimpl(this.checkedThumbColor) * 31) + Color.m2864hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m2864hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m2864hashCodeimpl(this.checkedIconColor)) * 31) + Color.m2864hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m2864hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m2864hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m2864hashCodeimpl(this.uncheckedIconColor)) * 31) + Color.m2864hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m2864hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m2864hashCodeimpl(this.disabledCheckedBorderColor)) * 31) + Color.m2864hashCodeimpl(this.disabledCheckedIconColor)) * 31) + Color.m2864hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m2864hashCodeimpl(this.disabledUncheckedTrackColor)) * 31) + Color.m2864hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m2864hashCodeimpl(this.disabledUncheckedIconColor);
    }
}
