    ...
    public static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                this.continuation.resumeWith(Result.m5373constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                Result.Companion companion = Result.Companion;
                this.continuation.resumeWith(Result.m5373constructorimpl(SnackbarResult.Dismissed));
            }
        }
