...
public final class SearchBarColors {
    ...
    public final long m1593getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getDividerColor-0d7_KjU  reason: not valid java name */
    public final long m1594getDividerColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(getClass(), obj != null ? obj.getClass() : null)) {
            ...
            return Color.m2858equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m2858equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && Intrinsics.areEqual(this.inputFieldColors, searchBarColors.inputFieldColors);
        }
        return false;
    }

    public int hashCode() {
        return (((Color.m2864hashCodeimpl(this.containerColor) * 31) + Color.m2864hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
