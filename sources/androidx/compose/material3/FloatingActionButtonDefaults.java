...
public final class FloatingActionButtonDefaults {
    ...
    private static final float LargeIconSize = FabPrimaryLargeTokens.INSTANCE.m1768getIconSizeD9Ej5fM();

    private FloatingActionButtonDefaults() {
    }

    /* renamed from: getLargeIconSize-D9Ej5fM  reason: not valid java name */
    public final float m1151getLargeIconSizeD9Ej5fM() {
    ...
    public final FloatingActionButtonElevation m1150elevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FabPrimaryTokens.INSTANCE.m1785getContainerElevationD9Ej5fM();
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = FabPrimaryTokens.INSTANCE.m1795getPressedContainerElevationD9Ej5fM();
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = FabPrimaryTokens.INSTANCE.m1788getFocusContainerElevationD9Ej5fM();
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = FabPrimaryTokens.INSTANCE.m1789getHoverContainerElevationD9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m1152loweredElevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FabPrimaryTokens.INSTANCE.m1791getLoweredContainerElevationD9Ej5fM();
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = FabPrimaryTokens.INSTANCE.m1794getLoweredPressedContainerElevationD9Ej5fM();
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = FabPrimaryTokens.INSTANCE.m1792getLoweredFocusContainerElevationD9Ej5fM();
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = FabPrimaryTokens.INSTANCE.m1793getLoweredHoverContainerElevationD9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m1149bottomAppBarFabElevationa9UjIt4(float f, float f2, float f3, float f4) {
    ...
    public static /* synthetic */ FloatingActionButtonElevation m1148bottomAppBarFabElevationa9UjIt4$default(FloatingActionButtonDefaults floatingActionButtonDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return floatingActionButtonDefaults.m1149bottomAppBarFabElevationa9UjIt4(f, f2, f3, f4);
    }
}
