...
public final class SelectableChipColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2557equalsimpl0(this.containerColor, selectableChipColors.containerColor) && Color.m2557equalsimpl0(this.labelColor, selectableChipColors.labelColor) && Color.m2557equalsimpl0(this.leadingIconColor, selectableChipColors.leadingIconColor) && Color.m2557equalsimpl0(this.trailingIconColor, selectableChipColors.trailingIconColor) && Color.m2557equalsimpl0(this.disabledContainerColor, selectableChipColors.disabledContainerColor) && Color.m2557equalsimpl0(this.disabledLabelColor, selectableChipColors.disabledLabelColor) && Color.m2557equalsimpl0(this.disabledLeadingIconColor, selectableChipColors.disabledLeadingIconColor) && Color.m2557equalsimpl0(this.disabledTrailingIconColor, selectableChipColors.disabledTrailingIconColor) && Color.m2557equalsimpl0(this.selectedContainerColor, selectableChipColors.selectedContainerColor) && Color.m2557equalsimpl0(this.disabledSelectedContainerColor, selectableChipColors.disabledSelectedContainerColor) && Color.m2557equalsimpl0(this.selectedLabelColor, selectableChipColors.selectedLabelColor) && Color.m2557equalsimpl0(this.selectedLeadingIconColor, selectableChipColors.selectedLeadingIconColor) && Color.m2557equalsimpl0(this.selectedTrailingIconColor, selectableChipColors.selectedTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((Color.m2563hashCodeimpl(this.containerColor) * 31) + Color.m2563hashCodeimpl(this.labelColor)) * 31) + Color.m2563hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2563hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2563hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2563hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2563hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2563hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2563hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m2563hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m2563hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m2563hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m2563hashCodeimpl(this.selectedTrailingIconColor);
    }
}
