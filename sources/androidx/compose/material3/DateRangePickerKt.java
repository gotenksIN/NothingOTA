...
public final class DateRangePickerKt {
    ...
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m412PaddingValuesa9UjIt4$default(Dp.m5050constructorimpl(24), Dp.m5050constructorimpl(20), 0.0f, Dp.m5050constructorimpl(8), 4, null);
    private static final float HeaderHeightOffset = Dp.m5050constructorimpl(60);
    ...
    */
    ...
    public static final DateRangePickerState m1085rememberDateRangePickerStatepMw4iz8(Long l, Long l2, Long l3, IntRange intRange, int i, Composer composer, int i2, int i3) {
        ...
        final int m1106getPickerjFl4v0 = (i3 & 16) != 0 ? DisplayMode.Companion.m1106getPickerjFl4v0() : i;
        ...
        DateRangePickerState dateRangePickerState = (DateRangePickerState) RememberSaveableKt.m2208rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) DateRangePickerState.Companion.Saver(), (String) null, (Function0<? extends Object>) new Function0<DateRangePickerState>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1
            ...
            public final DateRangePickerState invoke() {
                return new DateRangePickerState(l4, l5, l6, yearRange, m1106getPickerjFl4v0, null);
            }
        }, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SwitchableDateEntryContent(final DateRangePickerState dateRangePickerState, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i3 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            int m1088getDisplayModejFl4v0 = dateRangePickerState.m1088getDisplayModejFl4v0();
            CrossfadeKt.Crossfade(DisplayMode.m1098boximpl(m1088getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.Companion, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer2, Integer num) {
                    m1087invokeQujVXRc(displayMode.m1104unboximpl(), composer2, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc  reason: not valid java name */
                public final void m1087invokeQujVXRc(int i4, Composer composer2, int i5) {
                    int i6;
                    ...
                    if ((i6 & 91) != 18 || !composer2.getSkipping()) {
                        ...
                        if (DisplayMode.m1101equalsimpl0(i4, DisplayMode.Companion.m1106getPickerjFl4v0())) {
                            ...
                            int i7 = i3;
                            DateRangePickerKt.DateRangePickerContent(stateData$material3_release, datePickerFormatter2, function12, datePickerColors2, composer2, (i7 & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i7 & 896) | (i7 & 7168));
                            ...
                            int i8 = i3;
                            DateRangeInputKt.DateRangeInputContent(stateData$material3_release2, datePickerFormatter3, function13, composer2, (i8 & 896) | (i8 & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle));
                            composer2.endReplaceableGroup();
                        } else {
    ...
    public static final void DateRangePickerContent(final StateData stateData, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m417paddingVpY3zN4$default = PaddingKt.m417paddingVpY3zN4$default(Modifier.Companion, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
            ...
            int i3 = i2 << 6;
            VerticalMonthsList(function12, stateData, rememberLazyListState, datePickerFormatter, function1, datePickerColors, startRestartGroup, ((i2 << 3) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | (i3 & 7168) | (57344 & i3) | (i3 & 458752));
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endReplaceableGroup();
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont()), ComposableLambdaKt.composableLambda(startRestartGroup, 56792252, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        composer2.endReplaceableGroup();
                        final String m1397getStringNWtq28 = Strings_androidKt.m1397getStringNWtq28(Strings.Companion.m1369getDateRangePickerScrollToShowPreviousMonthadMyvUU(), composer2, 6);
                        final String m1397getStringNWtq282 = Strings_androidKt.m1397getStringNWtq28(Strings.Companion.m1368getDateRangePickerScrollToShowNextMonthadMyvUU(), composer2, 6);
                                ...
                                LazyListScope.items$default(LazyColumn, totalMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(1246706073, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1.2.1
                                    ...
                                    public final void invoke(LazyItemScope items, int i7, Composer composer3, int i8) {
                                        ...
                                        if ((i9 & 731) != 146 || !composer3.getSkipping()) {
                                            ...
                                            TextKt.m1484Text4IGK_g(formatMonthYear$material3_release, SemanticsModifierKt.semantics$default(ClickableKt.m176clickableXHw0xAI$default(PaddingKt.padding(Modifier.Companion, DateRangePickerKt.getCalendarMonthSubheadPadding()), false, null, null, new Function0<Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1
                                                /* renamed from: invoke  reason: avoid collision after fix types in other method */
                                            ...
                                            }, 1, null), datePickerColors4.m1069getSubheadContentColor0d7_KjU$material3_release(), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131064);
                                            int i11 = i10 << 3;
                                            int i12 = i10 << 6;
                                            DatePickerKt.Month(plusMonths, function17, calendarDate3, stateData4, true, function18, datePickerFormatter4, datePickerColors4, composer3, ((i10 << 9) & 3670016) | (i11 & 458752) | (i11 & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 24576 | (i12 & 7168) | (29360128 & i12));
                                            ComposerKt.sourceInformationMarkerEnd(composer3);
                                            ComposerKt.sourceInformationMarkerEnd(composer3);
                        ...
                        }, composer2, (i3 >> 3) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle, 252);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
    ...
    public static final void m1084drawRangeBackgroundmxwnekA(ContentDrawScope drawRangeBackground, SelectedRangeInfo selectedRangeInfo, long j) {
        ...
        float f = drawRangeBackground.mo302toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f2 = drawRangeBackground.mo302toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f3 = drawRangeBackground.mo302toPx0680j_4(DatePickerModalTokens.INSTANCE.m1718getDateStateLayerHeightD9Ej5fM());
        float f4 = 2;
        float f5 = (f2 - f3) / f4;
        float f6 = 7;
        float m2387getWidthimpl2 = (Size.m2387getWidthimpl(drawRangeBackground.mo3096getSizeNHjbRc()) - (f6 * f)) / f6;
        long m5177unboximpl = selectedRangeInfo.getGridCoordinates().getFirst().m5177unboximpl();
        int m5160component1impl = IntOffset.m5160component1impl(m5177unboximpl);
        int m5161component2impl = IntOffset.m5161component2impl(m5177unboximpl);
        long m5177unboximpl2 = selectedRangeInfo.getGridCoordinates().getSecond().m5177unboximpl();
        int m5160component1impl2 = IntOffset.m5160component1impl(m5177unboximpl2);
        int m5161component2impl2 = IntOffset.m5161component2impl(m5177unboximpl2);
        float f7 = f + m2387getWidthimpl2;
        float f8 = m2387getWidthimpl2 / f4;
        float f9 = (m5160component1impl * f7) + (selectedRangeInfo.getFirstIsSelectionStart() ? f / f4 : 0.0f) + f8;
        float f10 = (m5161component2impl * f2) + f5;
        float f11 = m5160component1impl2 * f7;
        if (selectedRangeInfo.getLastIsSelectionEnd()) {
            f /= f4;
        }
        float f12 = f11 + f + f8;
        float f13 = (m5161component2impl2 * f2) + f5;
        boolean z = drawRangeBackground.getLayoutDirection() == LayoutDirection.Rtl;
        if (z) {
            f9 = Size.m2387getWidthimpl(drawRangeBackground.mo3096getSizeNHjbRc()) - f9;
            f12 = Size.m2387getWidthimpl(drawRangeBackground.mo3096getSizeNHjbRc()) - f12;
        }
        ContentDrawScope contentDrawScope = drawRangeBackground;
        long Offset = OffsetKt.Offset(f9, f10);
        if (m5161component2impl == m5161component2impl2) {
            m2387getWidthimpl = f12 - f9;
        } else {
            m2387getWidthimpl = z ? -f9 : Size.m2387getWidthimpl(drawRangeBackground.mo3096getSizeNHjbRc()) - f9;
        }
        DrawScope.m3091drawRectnJ9OG0$default(contentDrawScope, j, Offset, SizeKt.Size(m2387getWidthimpl, f3), 0.0f, null, null, 0, 120, null);
        if (m5161component2impl != m5161component2impl2) {
            for (int i = (m5161component2impl2 - m5161component2impl) - 1; i > 0; i--) {
                DrawScope.m3091drawRectnJ9OG0$default(contentDrawScope, j, OffsetKt.Offset(0.0f, (i * f2) + f10), SizeKt.Size(Size.m2387getWidthimpl(drawRangeBackground.mo3096getSizeNHjbRc()), f3), 0.0f, null, null, 0, 120, null);
            }
            long Offset2 = OffsetKt.Offset(drawRangeBackground.getLayoutDirection() != LayoutDirection.Ltr ? Size.m2387getWidthimpl(drawRangeBackground.mo3096getSizeNHjbRc()) : 0.0f, f13);
            if (z) {
                f12 -= Size.m2387getWidthimpl(drawRangeBackground.mo3096getSizeNHjbRc());
            }
            DrawScope.m3091drawRectnJ9OG0$default(contentDrawScope, j, Offset2, SizeKt.Size(f12, f3), 0.0f, null, null, 0, 120, null);
        }
    }
    ...
    static {
        float f = 64;
        float f2 = 12;
        DateRangePickerTitlePadding = PaddingKt.m412PaddingValuesa9UjIt4$default(Dp.m5050constructorimpl(f), 0.0f, Dp.m5050constructorimpl(f2), 0.0f, 10, null);
        DateRangePickerHeadlinePadding = PaddingKt.m412PaddingValuesa9UjIt4$default(Dp.m5050constructorimpl(f), 0.0f, Dp.m5050constructorimpl(f2), Dp.m5050constructorimpl(f2), 2, null);
    }
}
