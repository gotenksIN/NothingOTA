...
public final class SwipeableV2Kt {
    ...
    public static final <T> Modifier swipeAnchors(Modifier modifier, final SwipeableV2State<T> state, final Set<? extends T> possibleValues, final AnchorChangeHandler<T> anchorChangeHandler, final Function2<? super T, ? super IntSize, Float> calculateAnchor) {
        ...
        return modifier.then(new SwipeAnchorsModifier(new Function1<Density, Unit>() { // from class: androidx.compose.material3.SwipeableV2Kt$swipeAnchors$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                m1423invokeozmzZPI(intSize.m5214unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-ozmzZPI  reason: not valid java name */
            public final void m1423invokeozmzZPI(long j) {
                ...
                for (Object obj : possibleValues) {
                    Float invoke = function2.invoke(obj, IntSize.m5202boximpl(j));
                    if (invoke != null) {
    ...
    public static final <T> SwipeableV2State<T> rememberSwipeableV2State(final T initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer composer, int i, int i2) {
        ...
        SwipeableV2State<T> swipeableV2State = (SwipeableV2State) RememberSaveableKt.m2208rememberSaveable(new Object[]{initialValue, animationSpec, function1}, (Saver<Object, ? extends Object>) SwipeableV2State.Companion.m1425SavereqLRuRQ(animationSpec, function1, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m1421getVelocityThresholdD9Ej5fM()), (String) null, (Function0<? extends Object>) new Function0<SwipeableV2State<T>>() { // from class: androidx.compose.material3.SwipeableV2Kt$rememberSwipeableV2State$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final SwipeableV2State<T> invoke() {
                return new SwipeableV2State<>(initialValue, animationSpec, function1, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m1421getVelocityThresholdD9Ej5fM(), null);
            }
        }, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Function2<Density, Float, Float> m1422fixedPositionalThreshold0680j_4(final float f) {
        return new Function2<Density, Float, Float>() { // from class: androidx.compose.material3.SwipeableV2Kt$fixedPositionalThreshold$1
            ...
            public final Float invoke(Density density, float f2) {
                ...
                return Float.valueOf(density.mo302toPx0680j_4(f));
            }
        };
    }
