...
public final class SwipeableV2Kt {
    ...
    public static /* synthetic */ Modifier swipeAnchors$default(Modifier modifier, SwipeableV2State swipeableV2State, Set set, SwipeableV2 swipeableV2, Function2 function2, int i, Object obj) {
        if ((i & 4) != 0) {
            swipeableV2 = null;
        }
        return swipeAnchors(modifier, swipeableV2State, set, swipeableV2, function2);
    }

    public static final <T> Modifier swipeAnchors(Modifier modifier, final SwipeableV2State<T> state, final Set<? extends T> possibleValues, final SwipeableV2<T> swipeableV2, final Function2<? super T, ? super IntSize, Float> calculateAnchor) {
        Intrinsics.checkNotNullParameter(modifier, "<this>");
        Intrinsics.checkNotNullParameter(state, "state");
        ...
        return modifier.then(new SwipeAnchorsModifier(new Function1<Density, Unit>() { // from class: androidx.compose.material3.SwipeableV2Kt$swipeAnchors$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                m1724invokeozmzZPI(intSize.m5515unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-ozmzZPI  reason: not valid java name */
            public final void m1724invokeozmzZPI(long j) {
                SwipeableV2<T> swipeableV22;
                ...
                for (Object obj : possibleValues) {
                    Float invoke = function2.invoke(obj, IntSize.m5503boximpl(j));
                    if (invoke != null) {
                ...
                if (!state.updateAnchors$material3_release(linkedHashMap) || (swipeableV22 = swipeableV2) == 0) {
                    return;
                }
                swipeableV22.onAnchorsChanged(targetValue, anchors$material3_release, linkedHashMap);
            }
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("anchorChangeHandler", swipeableV2);
    ...
    public static final <T> SwipeableV2State<T> rememberSwipeableV2State(final T initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer composer, int i, int i2) {
        ...
        SwipeableV2State<T> swipeableV2State = (SwipeableV2State) RememberSaveable.m2509rememberSaveable(new Object[]{initialValue, animationSpec, function1}, (Saver<Object, ? extends Object>) SwipeableV2State.Companion.m1726SavereqLRuRQ(animationSpec, function1, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m1722getVelocityThresholdD9Ej5fM()), (String) null, (Functions<? extends Object>) new Functions<SwipeableV2State<T>>() { // from class: androidx.compose.material3.SwipeableV2Kt$rememberSwipeableV2State$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final SwipeableV2State<T> invoke() {
                return new SwipeableV2State<>(initialValue, animationSpec, function1, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m1722getVelocityThresholdD9Ej5fM(), null);
            }
        }, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Function2<Density, Float, Float> m1723fixedPositionalThreshold0680j_4(final float f) {
        return new Function2<Density, Float, Float>() { // from class: androidx.compose.material3.SwipeableV2Kt$fixedPositionalThreshold$1
            ...
            public final Float invoke(Density density, float f2) {
                ...
                return Float.valueOf(density.mo603toPx0680j_4(f));
            }
        };
    }
