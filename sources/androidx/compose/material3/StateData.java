...
public final class StateData {
    ...
    private StateData(Long l, Long l2, Long l3, IntRange yearRange, int i) {
        SnapshotState<CalendarDate> mutableStateOf$default;
        SnapshotState<CalendarDate> mutableStateOf$default2;
        CalendarMonth currentMonth;
        SnapshotState mutableStateOf$default3;
        SnapshotState<DisplayMode> mutableStateOf$default4;
        ...
        mutableStateOf$default4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m1399boximpl(i), null, 2, null);
    ...
    public final SnapshotState<CalendarDate> getSelectedStartDate() {
        return this.selectedStartDate;
    }

    public final void setSelectedStartDate(SnapshotState<CalendarDate> snapshotState) {
        Intrinsics.checkNotNullParameter(snapshotState, "<set-?>");
        this.selectedStartDate = snapshotState;
    }

    public final SnapshotState<CalendarDate> getSelectedEndDate() {
        return this.selectedEndDate;
    }

    public final void setSelectedEndDate(SnapshotState<CalendarDate> snapshotState) {
        Intrinsics.checkNotNullParameter(snapshotState, "<set-?>");
        this.selectedEndDate = snapshotState;
    }
    ...
    public final SnapshotState<DisplayMode> getDisplayMode() {
        return this.displayMode;
    }

    public final void setDisplayMode(SnapshotState<DisplayMode> snapshotState) {
        Intrinsics.checkNotNullParameter(snapshotState, "<set-?>");
        this.displayMode = snapshotState;
    }
    ...
    public final void m1626switchDisplayModevCnGnXg(int i) {
        ...
        this.displayMode.setValue(DisplayMode.m1399boximpl(i));
    }

    /* compiled from: DatePicker.kt */
    @Metadata(m41d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00010\u0004¨\u0006\u0006"}, m40d2 = {"Landroidx/compose/material3/StateData$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material3/StateData;", "material3_release"}, m39k = 1, m38mv = {1, 8, 0}, m36xi = 48)
    /* loaded from: classes.dex */
    public static final class Companion {
        ...
        public final Saver<StateData, Object> Saver() {
            return ListSaver.listSaver(new Function2<SaverScope, StateData, List<? extends Object>>() { // from class: androidx.compose.material3.StateData$Companion$Saver$1
                ...
                public final List<Object> invoke(SaverScope listSaver, StateData it) {
                    ...
                    objArr[5] = Integer.valueOf(it.getDisplayMode().getValue().m1405unboximpl());
                ...
                public final StateData invoke2(List<? extends Object> value) {
                    ...
                    return new StateData(l, l2, l3, intRange, DisplayMode.m1400constructorimpl(((Integer) obj3).intValue()), null);
                }
            });
        }
    }
