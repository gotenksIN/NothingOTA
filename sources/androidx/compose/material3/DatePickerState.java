...
public final class DatePickerState {
    ...
    public final int m1082getDisplayModejFl4v0() {
        return ((DisplayMode) this.displayMode$delegate.getValue()).m1104unboximpl();
    }

    /* renamed from: setDisplayMode-vCnGnXg  reason: not valid java name */
    public final void m1083setDisplayModevCnGnXg(int i) {
        this.displayMode$delegate.setValue(DisplayMode.m1098boximpl(i));
    }
