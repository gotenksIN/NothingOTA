...
public final class Chip {
    ...
    public final ChipColors m1217assistChipColorsoq7We08(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, Composer composer, int i, int i2) {
        ...
        long m2892getTransparent0d7_KjU2 = (i2 & 16) != 0 ? Color.Companion.m2892getTransparent0d7_KjU() : j5;
        long m2856copywmQWz5c$default = (i2 & 32) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long m2856copywmQWz5c$default2 = (i2 & 64) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j7;
        long j10 = (i2 & 128) != 0 ? m2856copywmQWz5c$default2 : j8;
        ...
        ChipColors chipColors = new ChipColors(m2892getTransparent0d7_KjU, color, color2, j9, m2892getTransparent0d7_KjU2, m2856copywmQWz5c$default, m2856copywmQWz5c$default2, j10, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ChipElevation m1218assistChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1922getFlatContainerElevationD9Ej5fM = (i2 & 1) != 0 ? AssistChipTokens.INSTANCE.m1922getFlatContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m1922getFlatContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m1922getFlatContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m1922getFlatContainerElevationD9Ej5fM : f4;
        float m1916getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? AssistChipTokens.INSTANCE.m1916getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? m1922getFlatContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(245366099, i, -1, "androidx.compose.material3.AssistChipDefaults.assistChipElevation (Chip.kt:679)");
        }
        ChipElevation chipElevation = new ChipElevation(m1922getFlatContainerElevationD9Ej5fM, f7, f8, f9, m1916getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipBorder m1216assistChipBorderd_3_b6Q(long j, long j2, float f, Composer composer, int i, int i2) {
        ...
        long m2856copywmQWz5c$default = (i2 & 2) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j2;
        float m1923getFlatOutlineWidthD9Ej5fM = (i2 & 4) != 0 ? AssistChipTokens.INSTANCE.m1923getFlatOutlineWidthD9Ej5fM() : f;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(382372847, i, -1, "androidx.compose.material3.AssistChipDefaults.assistChipBorder (Chip.kt:703)");
        }
        ChipBorder chipBorder = new ChipBorder(color, m2856copywmQWz5c$default, m1923getFlatOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipColors m1219elevatedAssistChipColorsoq7We08(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, Composer composer, int i, int i2) {
        ...
        long m2856copywmQWz5c$default = (i2 & 16) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2856copywmQWz5c$default2 = (i2 & 32) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long m2856copywmQWz5c$default3 = (i2 & 64) != 0 ? Color.m2856copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j7;
        long j10 = (i2 & 128) != 0 ? m2856copywmQWz5c$default3 : j8;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipColors chipColors = new ChipColors(color, color2, color3, j9, m2856copywmQWz5c$default, m2856copywmQWz5c$default2, m2856copywmQWz5c$default3, j10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipElevation m1220elevatedAssistChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m1917getElevatedContainerElevationD9Ej5fM = (i2 & 1) != 0 ? AssistChipTokens.INSTANCE.m1917getElevatedContainerElevationD9Ej5fM() : f;
        float m1921getElevatedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? AssistChipTokens.INSTANCE.m1921getElevatedPressedContainerElevationD9Ej5fM() : f2;
        float m1919getElevatedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? AssistChipTokens.INSTANCE.m1919getElevatedFocusContainerElevationD9Ej5fM() : f3;
        float m1920getElevatedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? AssistChipTokens.INSTANCE.m1920getElevatedHoverContainerElevationD9Ej5fM() : f4;
        float m1916getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? AssistChipTokens.INSTANCE.m1916getDraggedContainerElevationD9Ej5fM() : f5;
        float m1918getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? AssistChipTokens.INSTANCE.m1918getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipElevation chipElevation = new ChipElevation(m1917getElevatedContainerElevationD9Ej5fM, m1921getElevatedPressedContainerElevationD9Ej5fM, m1919getElevatedFocusContainerElevationD9Ej5fM, m1920getElevatedHoverContainerElevationD9Ej5fM, m1916getDraggedContainerElevationD9Ej5fM, m1918getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
