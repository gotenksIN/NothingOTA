...
public final class IconToggleButtonColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2557equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m2557equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m2557equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m2557equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m2557equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m2557equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m2563hashCodeimpl(this.containerColor) * 31) + Color.m2563hashCodeimpl(this.contentColor)) * 31) + Color.m2563hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2563hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2563hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m2563hashCodeimpl(this.checkedContentColor);
    }
}
