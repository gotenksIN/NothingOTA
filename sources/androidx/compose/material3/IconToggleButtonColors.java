...
public final class IconToggleButtonColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2858equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m2858equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m2858equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m2858equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m2858equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m2858equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m2864hashCodeimpl(this.containerColor) * 31) + Color.m2864hashCodeimpl(this.contentColor)) * 31) + Color.m2864hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2864hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2864hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m2864hashCodeimpl(this.checkedContentColor);
    }
}
