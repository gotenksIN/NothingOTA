...
public final class NavigationRailItemColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2858equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m2858equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m2858equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m2858equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m2858equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m2858equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m2858equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m2864hashCodeimpl(this.selectedIconColor) * 31) + Color.m2864hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m2864hashCodeimpl(this.selectedTextColor)) * 31) + Color.m2864hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m2864hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m2864hashCodeimpl(this.disabledIconColor)) * 31) + Color.m2864hashCodeimpl(this.disabledTextColor);
    }
}
