...
public final class SelectableChipElevation {
    ...
    public final State<Dp> tonalElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Dp> animateElevation = animateElevation(z, interactionSource, composer, (i & 896) | (i & 14) | (i & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle));
        if (ComposerKt.isTraceInProgress()) {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = new Animatable(Dp.m5048boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.Companion), null, null, 12, null);
        ...
        if (!z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5048boximpl(f2), new SelectableChipElevation$animateElevation$2(animatable, f2, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-699481799);
            ComposerKt.sourceInformation(composer, "1712@81209L570");
            EffectsKt.LaunchedEffect(Dp.m5048boximpl(f2), new SelectableChipElevation$animateElevation$3(animatable, this, f2, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m5055equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m5055equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m5055equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m5055equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m5055equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m5056hashCodeimpl(this.elevation) * 31) + Dp.m5056hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5056hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5056hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m5056hashCodeimpl(this.disabledElevation);
    }
}
