...
public final class TimePickerDefaults {
    ...
    public final TimePickerColors m1496colorsu3YEpmA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, Composer composer, int i, int i2, int i3) {
        ...
        long m2591getTransparent0d7_KjU = (i3 & 128) != 0 ? Color.Companion.m2591getTransparent0d7_KjU() : j8;
        ...
        TimePickerColors timePickerColors = new TimePickerColors(color, color4, color5, color6, color2, color3, color7, m2591getTransparent0d7_KjU, color8, color9, color10, color11, color12, color13, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final int m1497layoutTypesDNSZnc(Composer composer, int i) {
