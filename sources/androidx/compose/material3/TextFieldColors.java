...
public final class TextFieldColors {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> indicatorColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimation.m370animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
    ...
    public final State<Color> containerColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> m370animateColorAsStateeuL9pac = SingleValueAnimation.m370animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> cursorColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(z ? this.errorCursorColor : this.cursorColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2858equalsimpl0(this.focusedTextColor, textFieldColors.focusedTextColor) && Color.m2858equalsimpl0(this.unfocusedTextColor, textFieldColors.unfocusedTextColor) && Color.m2858equalsimpl0(this.disabledTextColor, textFieldColors.disabledTextColor) && Color.m2858equalsimpl0(this.errorTextColor, textFieldColors.errorTextColor) && Color.m2858equalsimpl0(this.focusedContainerColor, textFieldColors.focusedContainerColor) && Color.m2858equalsimpl0(this.unfocusedContainerColor, textFieldColors.unfocusedContainerColor) && Color.m2858equalsimpl0(this.disabledContainerColor, textFieldColors.disabledContainerColor) && Color.m2858equalsimpl0(this.errorContainerColor, textFieldColors.errorContainerColor) && Color.m2858equalsimpl0(this.cursorColor, textFieldColors.cursorColor) && Color.m2858equalsimpl0(this.errorCursorColor, textFieldColors.errorCursorColor) && Intrinsics.areEqual(this.textSelectionColors, textFieldColors.textSelectionColors) && Color.m2858equalsimpl0(this.focusedIndicatorColor, textFieldColors.focusedIndicatorColor) && Color.m2858equalsimpl0(this.unfocusedIndicatorColor, textFieldColors.unfocusedIndicatorColor) && Color.m2858equalsimpl0(this.disabledIndicatorColor, textFieldColors.disabledIndicatorColor) && Color.m2858equalsimpl0(this.errorIndicatorColor, textFieldColors.errorIndicatorColor) && Color.m2858equalsimpl0(this.focusedLeadingIconColor, textFieldColors.focusedLeadingIconColor) && Color.m2858equalsimpl0(this.unfocusedLeadingIconColor, textFieldColors.unfocusedLeadingIconColor) && Color.m2858equalsimpl0(this.disabledLeadingIconColor, textFieldColors.disabledLeadingIconColor) && Color.m2858equalsimpl0(this.errorLeadingIconColor, textFieldColors.errorLeadingIconColor) && Color.m2858equalsimpl0(this.focusedTrailingIconColor, textFieldColors.focusedTrailingIconColor) && Color.m2858equalsimpl0(this.unfocusedTrailingIconColor, textFieldColors.unfocusedTrailingIconColor) && Color.m2858equalsimpl0(this.disabledTrailingIconColor, textFieldColors.disabledTrailingIconColor) && Color.m2858equalsimpl0(this.errorTrailingIconColor, textFieldColors.errorTrailingIconColor) && Color.m2858equalsimpl0(this.focusedLabelColor, textFieldColors.focusedLabelColor) && Color.m2858equalsimpl0(this.unfocusedLabelColor, textFieldColors.unfocusedLabelColor) && Color.m2858equalsimpl0(this.disabledLabelColor, textFieldColors.disabledLabelColor) && Color.m2858equalsimpl0(this.errorLabelColor, textFieldColors.errorLabelColor) && Color.m2858equalsimpl0(this.focusedPlaceholderColor, textFieldColors.focusedPlaceholderColor) && Color.m2858equalsimpl0(this.unfocusedPlaceholderColor, textFieldColors.unfocusedPlaceholderColor) && Color.m2858equalsimpl0(this.disabledPlaceholderColor, textFieldColors.disabledPlaceholderColor) && Color.m2858equalsimpl0(this.errorPlaceholderColor, textFieldColors.errorPlaceholderColor) && Color.m2858equalsimpl0(this.focusedSupportingTextColor, textFieldColors.focusedSupportingTextColor) && Color.m2858equalsimpl0(this.unfocusedSupportingTextColor, textFieldColors.unfocusedSupportingTextColor) && Color.m2858equalsimpl0(this.disabledSupportingTextColor, textFieldColors.disabledSupportingTextColor) && Color.m2858equalsimpl0(this.errorSupportingTextColor, textFieldColors.errorSupportingTextColor) && Color.m2858equalsimpl0(this.focusedPrefixColor, textFieldColors.focusedPrefixColor) && Color.m2858equalsimpl0(this.unfocusedPrefixColor, textFieldColors.unfocusedPrefixColor) && Color.m2858equalsimpl0(this.disabledPrefixColor, textFieldColors.disabledPrefixColor) && Color.m2858equalsimpl0(this.errorPrefixColor, textFieldColors.errorPrefixColor) && Color.m2858equalsimpl0(this.focusedSuffixColor, textFieldColors.focusedSuffixColor) && Color.m2858equalsimpl0(this.unfocusedSuffixColor, textFieldColors.unfocusedSuffixColor) && Color.m2858equalsimpl0(this.disabledSuffixColor, textFieldColors.disabledSuffixColor) && Color.m2858equalsimpl0(this.errorSuffixColor, textFieldColors.errorSuffixColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((Color.m2864hashCodeimpl(this.focusedTextColor) * 31) + Color.m2864hashCodeimpl(this.unfocusedTextColor)) * 31) + Color.m2864hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2864hashCodeimpl(this.errorTextColor)) * 31) + Color.m2864hashCodeimpl(this.focusedContainerColor)) * 31) + Color.m2864hashCodeimpl(this.unfocusedContainerColor)) * 31) + Color.m2864hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2864hashCodeimpl(this.errorContainerColor)) * 31) + Color.m2864hashCodeimpl(this.cursorColor)) * 31) + Color.m2864hashCodeimpl(this.errorCursorColor)) * 31) + this.textSelectionColors.hashCode()) * 31) + Color.m2864hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m2864hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m2864hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m2864hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m2864hashCodeimpl(this.focusedLeadingIconColor)) * 31) + Color.m2864hashCodeimpl(this.unfocusedLeadingIconColor)) * 31) + Color.m2864hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2864hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m2864hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m2864hashCodeimpl(this.unfocusedTrailingIconColor)) * 31) + Color.m2864hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2864hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m2864hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m2864hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m2864hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2864hashCodeimpl(this.errorLabelColor)) * 31) + Color.m2864hashCodeimpl(this.focusedPlaceholderColor)) * 31) + Color.m2864hashCodeimpl(this.unfocusedPlaceholderColor)) * 31) + Color.m2864hashCodeimpl(this.disabledPlaceholderColor)) * 31) + Color.m2864hashCodeimpl(this.errorPlaceholderColor)) * 31) + Color.m2864hashCodeimpl(this.focusedSupportingTextColor)) * 31) + Color.m2864hashCodeimpl(this.unfocusedSupportingTextColor)) * 31) + Color.m2864hashCodeimpl(this.disabledSupportingTextColor)) * 31) + Color.m2864hashCodeimpl(this.errorSupportingTextColor)) * 31) + Color.m2864hashCodeimpl(this.focusedPrefixColor)) * 31) + Color.m2864hashCodeimpl(this.unfocusedPrefixColor)) * 31) + Color.m2864hashCodeimpl(this.disabledPrefixColor)) * 31) + Color.m2864hashCodeimpl(this.errorPrefixColor)) * 31) + Color.m2864hashCodeimpl(this.focusedSuffixColor)) * 31) + Color.m2864hashCodeimpl(this.unfocusedSuffixColor)) * 31) + Color.m2864hashCodeimpl(this.disabledSuffixColor)) * 31) + Color.m2864hashCodeimpl(this.errorSuffixColor);
    }
