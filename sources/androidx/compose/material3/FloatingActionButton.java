...
public final class FloatingActionButton {
    ...
    private static final float LargeIconSize = FabPrimaryLargeTokens.INSTANCE.m2069getIconSizeD9Ej5fM();

    private FloatingActionButton() {
    }

    /* renamed from: getLargeIconSize-D9Ej5fM  reason: not valid java name */
    public final float m1452getLargeIconSizeD9Ej5fM() {
    ...
    public final FloatingActionButtonElevation m1451elevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FabPrimaryTokens.INSTANCE.m2086getContainerElevationD9Ej5fM();
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = FabPrimaryTokens.INSTANCE.m2096getPressedContainerElevationD9Ej5fM();
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = FabPrimaryTokens.INSTANCE.m2089getFocusContainerElevationD9Ej5fM();
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = FabPrimaryTokens.INSTANCE.m2090getHoverContainerElevationD9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m1453loweredElevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FabPrimaryTokens.INSTANCE.m2092getLoweredContainerElevationD9Ej5fM();
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = FabPrimaryTokens.INSTANCE.m2095getLoweredPressedContainerElevationD9Ej5fM();
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = FabPrimaryTokens.INSTANCE.m2093getLoweredFocusContainerElevationD9Ej5fM();
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = FabPrimaryTokens.INSTANCE.m2094getLoweredHoverContainerElevationD9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m1450bottomAppBarFabElevationa9UjIt4(float f, float f2, float f3, float f4) {
    ...
    public static /* synthetic */ FloatingActionButtonElevation m1449bottomAppBarFabElevationa9UjIt4$default(FloatingActionButton floatingActionButton, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return floatingActionButton.m1450bottomAppBarFabElevationa9UjIt4(f, f2, f3, f4);
    }
}
