...
public final class ChipColors {
    ...
    public final State<Color> containerColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2546boximpl(z ? this.containerColor : this.disabledContainerColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> labelColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2546boximpl(z ? this.labelColor : this.disabledLabelColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> leadingIconContentColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2546boximpl(z ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconContentColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2546boximpl(z ? this.trailingIconContentColor : this.disabledTrailingIconContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2557equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m2557equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m2557equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m2557equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m2557equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m2557equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m2557equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m2557equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m2563hashCodeimpl(this.containerColor) * 31) + Color.m2563hashCodeimpl(this.labelColor)) * 31) + Color.m2563hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m2563hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m2563hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2563hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2563hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m2563hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
