...
public final class ChipColors {
    ...
    public final State<Color> containerColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(z ? this.containerColor : this.disabledContainerColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> labelColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(z ? this.labelColor : this.disabledLabelColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> leadingIconContentColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(z ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconContentColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2847boximpl(z ? this.trailingIconContentColor : this.disabledTrailingIconContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2858equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m2858equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m2858equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m2858equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m2858equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m2858equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m2858equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m2858equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m2864hashCodeimpl(this.containerColor) * 31) + Color.m2864hashCodeimpl(this.labelColor)) * 31) + Color.m2864hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m2864hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m2864hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2864hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2864hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m2864hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
