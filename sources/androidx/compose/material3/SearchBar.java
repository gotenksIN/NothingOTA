...
public final class SearchBar implements PaddingValues {
    ...
    public final State<C0780Dp> getTopPadding() {
    ...
    public float mo699calculateTopPaddingD9Ej5fM() {
        return C0780Dp.m5351constructorimpl(this.topPadding.getValue().m5365unboximpl() * this.animationProgress.getValue().floatValue());
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateBottomPadding-D9Ej5fM */
    public float mo696calculateBottomPaddingD9Ej5fM() {
        return C0780Dp.m5351constructorimpl(SearchBarKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }
