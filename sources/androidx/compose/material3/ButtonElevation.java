...
public final class ButtonElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5048boximpl(f2), new ButtonElevation$animateElevation$2(animatable, f2, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-719929940);
            ComposerKt.sourceInformation(composer, "861@40988L546");
            EffectsKt.LaunchedEffect(Dp.m5048boximpl(f2), new ButtonElevation$animateElevation$3(animatable, this, f2, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m5055equalsimpl0(this.defaultElevation, buttonElevation.defaultElevation) && Dp.m5055equalsimpl0(this.pressedElevation, buttonElevation.pressedElevation) && Dp.m5055equalsimpl0(this.focusedElevation, buttonElevation.focusedElevation) && Dp.m5055equalsimpl0(this.hoveredElevation, buttonElevation.hoveredElevation) && Dp.m5055equalsimpl0(this.disabledElevation, buttonElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m5056hashCodeimpl(this.defaultElevation) * 31) + Dp.m5056hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5056hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5056hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m5056hashCodeimpl(this.disabledElevation);
    }
}
