...
@DebugMetadata(m31c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1", m30f = "FlowExt.kt", m29i = {0}, m28l = {C0032R.styleable.AppCompatTheme_radioButtonStyle}, m27m = "invokeSuspend", m26n = {"$this$callbackFlow"}, m25s = {"L$0"})
...
final class FlowExtKt$flowWithLifecycle$1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m31c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1$1", m30f = "FlowExt.kt", m29i = {}, m28l = {C0032R.styleable.AppCompatTheme_ratingBarStyle}, m27m = "invokeSuspend", m26n = {}, m25s = {})
    /* renamed from: androidx.lifecycle.FlowExtKt$flowWithLifecycle$1$1 */
    /* loaded from: classes.dex */
    public static final class C09751 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C09751(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C09751> continuation) {
            super(2, continuation);
            this.$this_flowWithLifecycle = flow;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C09751(this.$this_flowWithLifecycle, this.$$this$callbackFlow, continuation);
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (RepeatOnLifecycle.repeatOnLifecycle(this.$lifecycle, this.$minActiveState, new C09751(this.$this_flowWithLifecycle, producerScope2, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
