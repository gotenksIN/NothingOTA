...
public final class CoroutineLiveData<T> extends MediatorLiveData<T> {
    ...
    public CoroutineLiveData(CoroutineContext context, long j, Function2<? super LiveDataScope<T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        ...
        this.blockRunner = new BlockRunner<>(this, block, j, CoroutineScopeKt.CoroutineScope(Dispatchers.getMain().getImmediate().plus(context).plus(SupervisorKt.SupervisorJob((Job) context.get(Job.Key)))), new Functions<Unit>(this) { // from class: androidx.lifecycle.CoroutineLiveData.1
