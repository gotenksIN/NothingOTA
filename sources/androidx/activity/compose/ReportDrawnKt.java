...
public final class ReportDrawnKt {
    public static final void ReportDrawnWhen(final Functions<Boolean> predicate, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            }, startRestartGroup, ((i2 << 3) & C0032R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 8);
        } else {
    ...
    public static final void ReportDrawn(Composer composer, final int i) {
        ...
        if (i == 0 && startRestartGroup.getSkipping()) {
            ...
            ReportDrawnWhen(new Functions<Boolean>() { // from class: androidx.activity.compose.ReportDrawnKt$ReportDrawn$1
