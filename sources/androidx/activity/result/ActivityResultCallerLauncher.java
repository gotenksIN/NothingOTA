...
public final class ActivityResultCallerLauncher<I, O> extends ActivityResultLauncher<Unit> {
    ...
    public ActivityResultCallerLauncher(ActivityResultLauncher<I> launcher, ActivityResultContract<I, O> callerContract, I i) {
        ...
        this.callerInput = i;
        this.resultContract$delegate = LazyKt.lazy(new Functions<ActivityResultCallerLauncher$resultContract$2.C00261>(this) { // from class: androidx.activity.result.ActivityResultCallerLauncher$resultContract$2
