...
public final class Response<T> {
    ...
    public static <T> Response<T> success(@Nullable T t) {
        return success(t, new Response.Builder().code(ComposerKt.invocationKey).message("OK").protocol(Protocol.HTTP_1_1).request(new Request.Builder().url("http://localhost/").build()).build());
    }
    ...
    public static <T> Response<T> success(@Nullable T t, Headers headers) {
        ...
        return success(t, new Response.Builder().code(ComposerKt.invocationKey).message("OK").protocol(Protocol.HTTP_1_1).headers(headers).request(new Request.Builder().url("http://localhost/").build()).build());
    }
